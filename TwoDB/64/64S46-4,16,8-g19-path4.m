...
s`Degree := 64;
s`Filename := "64S46-4,16,8-g19-path4.m";
...
s`PassportSize := 2;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path27", "32S13-4,8,4-g7-path11", "64S46-4,16,8-g19-path4" ];
