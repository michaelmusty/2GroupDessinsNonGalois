...
{ IntegerRing() | 55, 60 }
@};
s`Child := "32S11-4,4,8-g7-path6";
s`Degree := 64;
s`Filename := "64S11-4,8,8-g17-path30.m";
...
s`PassportSize := 2;
s`PathNumber := 30;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T10-2,4,4-g1-path4", "32S11-4,4,8-g7-path6", "64S11-4,8,8-g17-path30" ];
