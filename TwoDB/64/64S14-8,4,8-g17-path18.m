...
{ IntegerRing() | 52, 59 }
@};
s`Child := "32S10-8,4,4-g7-path10";
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path18.m";
...
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S10-8,4,4-g7-path10", "64S14-8,4,8-g17-path18" ];
...
[ 18, 44, 48, 6, 3, 51, 5, 54, 62, 20, 1, 10, 12, 23, 35, 11, 19, 16, 32, 13, 50, 27, 25, 22, 59, 24, 26, 29, 34, 43, 36, 33, 17, 39, 31, 15, 49, 2, 28, 46, 37, 38, 21, 42, 55, 47, 58, 7, 52, 30, 56, 41, 9, 45, 8, 4, 61, 40, 14, 64, 60, 63, 53, 57 ],
[ 38, 53, 36, 43, 13, 11, 35, 29, 27, 52, 54, 34, 37, 6, 63, 44, 64, 55, 5, 28, 12, 7, 19, 57, 56, 3, 60, 17, 4, 20, 9, 61, 48, 32, 14, 25, 40, 23, 51, 1, 22, 62, 15, 59, 39, 21, 16, 10, 26, 31, 50, 47, 46, 41, 49, 18, 8, 30, 33, 45, 2, 58, 24, 42 ]
]
];
