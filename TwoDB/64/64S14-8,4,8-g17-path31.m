...
{ IntegerRing() | 52, 59 }
@};
s`Child := "32S10-8,4,4-g7-path6";
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path31.m";
...
s`PassportSize := 1;
s`PathNumber := 31;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S10-8,4,4-g7-path6", "64S14-8,4,8-g17-path31" ];
...
[ 25, 47, 59, 35, 49, 45, 23, 6, 64, 58, 37, 33, 46, 1, 22, 14, 38, 52, 12, 19, 39, 31, 3, 54, 16, 15, 55, 57, 21, 29, 26, 44, 20, 60, 51, 4, 18, 32, 30, 2, 5, 40, 53, 17, 56, 10, 42, 41, 48, 62, 36, 11, 50, 27, 24, 8, 34, 13, 7, 28, 9, 43, 61, 63 ],
[ 40, 61, 26, 29, 19, 14, 22, 57, 31, 48, 6, 21, 5, 35, 43, 47, 28, 56, 23, 30, 46, 41, 38, 63, 36, 49, 9, 20, 8, 58, 50, 34, 59, 12, 7, 3, 13, 1, 45, 37, 54, 64, 4, 16, 60, 53, 52, 33, 55, 51, 39, 10, 2, 11, 18, 25, 24, 62, 44, 27, 32, 42, 15, 17 ]
]
];
