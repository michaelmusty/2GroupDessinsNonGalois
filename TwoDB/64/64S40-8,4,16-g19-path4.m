...
s`Degree := 64;
s`Filename := "64S40-8,4,16-g19-path4.m";
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-4,2,8-g2-path2", "32S9-4,2,8-g3-path13", "64S40-8,4,16-g19-path4" ];
