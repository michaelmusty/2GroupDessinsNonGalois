...
s`Degree := 64;
s`Filename := "64S24-4,8,8-g17-path51.m";
...
s`PassportSize := 1;
s`PathNumber := 51;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path17", "32S2-4,4,4-g5-path56", "64S24-4,8,8-g17-path51" ];
