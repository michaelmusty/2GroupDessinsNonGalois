...
s`Degree := 64;
s`Filename := "64S6-8,8,4-g17-path30.m";
...
s`PassportSize := 2;
s`PathNumber := 30;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path2", "32S5-8,8,4-g9-path13", "64S6-8,8,4-g17-path30" ];
