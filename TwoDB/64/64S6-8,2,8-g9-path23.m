...
s`Degree := 64;
s`Filename := "64S6-8,2,8-g9-path23.m";
...
s`PassportSize := 2;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S5-8,2,8-g5-path10", "64S6-8,2,8-g9-path23" ];
