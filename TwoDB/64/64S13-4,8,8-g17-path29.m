...
{ IntegerRing() | 44, 47 }
@};
s`Child := "32S10-4,8,4-g7-path4";
s`Degree := 64;
s`Filename := "64S13-4,8,8-g17-path29.m";
...
s`PassportSize := 2;
s`PathNumber := 29;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S10-4,8,4-g7-path4", "64S13-4,8,8-g17-path29" ];
