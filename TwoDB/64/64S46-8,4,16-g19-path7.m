...
s`Degree := 64;
s`Filename := "64S46-8,4,16-g19-path7.m";
...
s`PassportSize := 2;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path17", "32S13-4,4,8-g7-path13", "64S46-8,4,16-g19-path7" ];
