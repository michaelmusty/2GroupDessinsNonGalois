...
{ IntegerRing() | 58, 64 }
@};
s`Child := "32S6-4,4,2-g1-path10";
s`Degree := 64;
s`Filename := "64S8-4,8,2-g5-path12.m";
...
s`PassportSize := 1;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S6-4,4,2-g1-path10", "64S8-4,8,2-g5-path12" ];
