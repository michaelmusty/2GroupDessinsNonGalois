...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path10.m";
...
s`PassportSize := 1;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S10-8,4,4-g7-path19", "64S21-8,4,4-g13-path10" ];
