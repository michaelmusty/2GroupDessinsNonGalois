...
s`Degree := 64;
s`Filename := "64S10-8,2,8-g9-path9.m";
...
[ 16, 7, 38, 14, 42, 50, 2, 12, 47, 29, 13, 8, 11, 4, 54, 1, 27, 43, 31, 53, 46, 28, 25, 40, 23, 51, 17, 22, 10, 61, 19, 60, 34, 33, 37, 49, 35, 3, 44, 24, 62, 5, 18, 39, 63, 21, 9, 52, 36, 6, 26, 48, 20, 15, 59, 57, 56, 64, 55, 32, 30, 41, 45, 58 ],
[ 13, 28, 2, 5, 7, 42, 37, 50, 8, 11, 12, 56, 25, 10, 29, 36, 16, 19, 1, 31, 17, 27, 60, 23, 33, 22, 41, 34, 26, 51, 3, 38, 64, 59, 54, 35, 57, 9, 32, 53, 40, 24, 6, 14, 46, 4, 21, 44, 39, 55, 43, 18, 15, 58, 49, 62, 61, 47, 63, 30, 45, 48, 20, 52 ]
]
];
s`PassportName := "64S10-8,2,8-g9";
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S11-4,2,8-g3-path7", "64S10-8,2,8-g9-path9" ];
