...
s`Degree := 64;
s`Filename := "64S21-4,4,8-g13-path57.m";
...
s`PassportSize := 1;
s`PathNumber := 57;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S14-4,4,8-g7-path15", "64S21-4,4,8-g13-path57" ];
