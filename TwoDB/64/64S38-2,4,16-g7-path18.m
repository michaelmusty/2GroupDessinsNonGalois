...
s`Degree := 64;
s`Filename := "64S38-2,4,16-g7-path18.m";
...
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S9-2,4,8-g3-path4", "64S38-2,4,16-g7-path18" ];
