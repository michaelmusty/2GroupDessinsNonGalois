...
s`Degree := 64;
s`Filename := "64S24-4,8,8-g17-path94.m";
...
s`PassportSize := 1;
s`PathNumber := 94;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S8-4,8,8-g9-path11", "64S24-4,8,8-g17-path94" ];
