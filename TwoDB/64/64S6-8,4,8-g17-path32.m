...
{ IntegerRing() | 52, 62 }
@};
s`Child := "32S5-8,4,8-g9-path14";
s`Degree := 64;
s`Filename := "64S6-8,4,8-g17-path32.m";
...
s`PassportSize := 2;
s`PathNumber := 32;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path3", "32S5-8,4,8-g9-path14", "64S6-8,4,8-g17-path32" ];
