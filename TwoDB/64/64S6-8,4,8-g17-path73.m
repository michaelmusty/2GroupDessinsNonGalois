...
s`Degree := 64;
s`Filename := "64S6-8,4,8-g17-path73.m";
...
s`PassportSize := 2;
s`PathNumber := 73;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T12-4,2,8-g2-path3", "32S9-4,2,8-g3-path14", "64S6-8,4,8-g17-path73" ];
