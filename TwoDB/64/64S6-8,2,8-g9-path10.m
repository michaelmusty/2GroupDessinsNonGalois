...
s`Degree := 64;
s`Filename := "64S6-8,2,8-g9-path10.m";
...
s`PassportSize := 2;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S11-4,2,8-g3-path8", "64S6-8,2,8-g9-path10" ];
