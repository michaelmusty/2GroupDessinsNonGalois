...
s`Degree := 64;
s`Filename := "64S21-4,8,4-g13-path34.m";
...
s`PassportSize := 1;
s`PathNumber := 34;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path7", "32S10-4,8,4-g7-path9", "64S21-4,8,4-g13-path34" ];
