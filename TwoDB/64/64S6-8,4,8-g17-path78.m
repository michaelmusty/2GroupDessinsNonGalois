...
s`Degree := 64;
s`Filename := "64S6-8,4,8-g17-path78.m";
...
s`PassportSize := 2;
s`PathNumber := 78;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S9-4,2,8-g3-path2", "64S6-8,4,8-g17-path78" ];
