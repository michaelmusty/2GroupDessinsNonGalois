...
s`Degree := 64;
s`Filename := "64S17-8,4,8-g17-path55.m";
...
s`PassportSize := 1;
s`PathNumber := 55;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S2-4,4,4-g5-path18", "64S17-8,4,8-g17-path55" ];
