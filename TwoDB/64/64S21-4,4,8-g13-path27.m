...
s`Degree := 64;
s`Filename := "64S21-4,4,8-g13-path27.m";
...
s`PassportSize := 1;
s`PathNumber := 27;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T14-4,4,8-g4-path3", "32S10-4,4,8-g7-path34", "64S21-4,4,8-g13-path27" ];
