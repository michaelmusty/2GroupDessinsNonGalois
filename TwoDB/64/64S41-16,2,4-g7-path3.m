...
s`Degree := 64;
s`Filename := "64S41-16,2,4-g7-path3.m";
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,2,4-g2-path1", "32S9-8,2,4-g3-path12", "64S41-16,2,4-g7-path3" ];
