...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path25.m";
...
s`PassportSize := 1;
s`PathNumber := 25;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T14-8,4,4-g4-path2", "32S10-8,4,4-g7-path32", "64S21-8,4,4-g13-path25" ];
