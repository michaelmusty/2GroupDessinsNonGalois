...
s`Degree := 64;
s`Filename := "64S48-4,4,16-g15-path8.m";
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path31", "32S14-4,4,8-g7-path17", "64S48-4,4,16-g15-path8" ];
