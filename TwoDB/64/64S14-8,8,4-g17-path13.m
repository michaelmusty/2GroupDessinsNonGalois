...
{ IntegerRing() | 49, 62 }
@};
s`Child := "32S10-4,8,4-g7-path24";
s`Degree := 64;
s`Filename := "64S14-8,8,4-g17-path13.m";
...
s`PassportSize := 1;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T12-2,8,4-g2-path2", "32S10-4,8,4-g7-path24", "64S14-8,8,4-g17-path13" ];
