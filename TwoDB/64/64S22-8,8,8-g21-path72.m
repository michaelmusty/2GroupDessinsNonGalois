...
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path72.m";
...
s`PassportSize := 3;
s`PathNumber := 72;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S2-4,4,4-g5-path11", "64S22-8,8,8-g21-path72" ];
