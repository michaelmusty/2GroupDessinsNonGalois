...
s`Degree := 64;
s`Filename := "64S27-16,8,16-g25-path12.m";
...
\[ 3, 10, 14, 6, 16, 27, 1, 36, 35, 18, 42, 2, 38, 19, 17, 48, 23, 31, 41, 22, 24, 50, 4, 59, 5, 63, 32, 29, 53, 34, 37, 33, 15, 7, 43, 12, 8, 40, 46, 9, 30, 52, 45, 11, 47, 49, 13, 54, 51, 57, 55, 61, 20, 64, 21, 26, 58, 28, 39, 62, 56, 25, 44, 60 ],
\[ 4, 7, 15, 20, 21, 28, 32, 1, 12, 41, 25, 14, 2, 27, 22, 49, 29, 3, 23, 44, 9, 56, 57, 13, 39, 5, 50, 11, 26, 6, 34, 53, 58, 17, 37, 30, 19, 8, 40, 18, 33, 64, 10, 48, 36, 47, 31, 59, 35, 42, 38, 16, 52, 55, 45, 54, 63, 61, 43, 24, 62, 51, 60, 46 ] >;
s`Name := "64S27-16,8,16-g25-path12";
s`Orders := \[ 16, 8, 16 ];
...
[ 60, 26, 62, 49, 30, 51, 64, 52, 28, 63, 8, 56, 50, 25, 59, 34, 39, 44, 5, 13, 15, 38, 46, 17, 41, 18, 55, 43, 45, 48, 11, 21, 24, 54, 29, 61, 42, 57, 4, 58, 16, 36, 53, 37, 20, 6, 22, 7, 27, 40, 32, 12, 47, 1, 33, 10, 9, 35, 23, 14, 2, 19, 31, 3 ],
...
s`PassportSize := 1;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,4,8-g5-path4", "32S17-16,8,16-g13-path7", "64S27-16,8,16-g25-path12" ];
...
[ 60, 26, 62, 49, 30, 51, 64, 52, 28, 63, 8, 56, 50, 25, 59, 34, 39, 44, 5, 13, 15, 38, 46, 17, 41, 18, 55, 43, 45, 48, 11, 21, 24, 54, 29, 61, 42, 57, 4, 58, 16, 36, 53, 37, 20, 6, 22, 7, 27, 40, 32, 12, 47, 1, 33, 10, 9, 35, 23, 14, 2, 19, 31, 3 ],
[ 44, 53, 56, 48, 12, 25, 52, 20, 27, 58, 40, 50, 32, 42, 54, 37, 5, 22, 63, 59, 14, 55, 60, 7, 18, 9, 64, 39, 21, 11, 29, 16, 62, 26, 23, 28, 57, 4, 3, 15, 61, 47, 33, 43, 6, 34, 17, 10, 19, 46, 1, 35, 49, 36, 30, 45, 24, 51, 41, 2, 38, 8, 13, 31 ]
]
];
