...
s`Degree := 64;
s`Filename := "64S4-8,8,4-g17-path3.m";
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path1", "32S5-8,8,4-g9-path12", "64S4-8,8,4-g17-path3" ];
