...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path172.m";
...
s`PassportSize := 3;
s`PathNumber := 172;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S2-4,4,4-g5-path62", "64S23-4,4,4-g9-path172" ];
