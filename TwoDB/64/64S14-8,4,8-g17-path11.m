...
{ IntegerRing() | 50, 58 }
@};
s`Child := "32S10-4,4,8-g7-path22";
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path11.m";
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S10-4,4,8-g7-path22", "64S14-8,4,8-g17-path11" ];
