...
s`Degree := 64;
s`Filename := "64S20-4,4,8-g13-path30.m";
...
s`PassportSize := 2;
s`PathNumber := 30;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S11-4,4,8-g7-path17", "64S20-4,4,8-g13-path30" ];
