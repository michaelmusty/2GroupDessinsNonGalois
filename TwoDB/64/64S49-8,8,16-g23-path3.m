...
{ IntegerRing() | 62, 64 }
@};
s`Child := "32S14-4,4,8-g7-path11";
s`Degree := 64;
s`Filename := "64S49-8,8,16-g23-path3.m";
...
s`PassportSize := 2;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T8-4,4,4-g3-path15", "32S14-4,4,8-g7-path11", "64S49-8,8,16-g23-path3" ];
