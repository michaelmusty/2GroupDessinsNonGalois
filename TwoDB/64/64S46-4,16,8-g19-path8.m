...
{ IntegerRing() | 50, 58 }
@};
s`Child := "32S13-4,8,4-g7-path13";
s`Degree := 64;
s`Filename := "64S46-4,16,8-g19-path8.m";
...
s`PassportSize := 2;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path33", "32S13-4,8,4-g7-path13", "64S46-4,16,8-g19-path8" ];
