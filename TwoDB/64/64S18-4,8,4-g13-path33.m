...
s`Degree := 64;
s`Filename := "64S18-4,8,4-g13-path33.m";
...
s`PassportSize := 1;
s`PathNumber := 33;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path1", "32S2-4,4,4-g5-path3", "64S18-4,8,4-g13-path33" ];
