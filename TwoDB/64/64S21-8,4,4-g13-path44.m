...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path44.m";
...
s`PassportSize := 1;
s`PathNumber := 44;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,2,4-g2-path2", "32S13-8,4,4-g7-path2", "64S21-8,4,4-g13-path44" ];
