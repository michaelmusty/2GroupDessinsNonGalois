...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path272.m";
...
s`PassportSize := 3;
s`PathNumber := 272;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path3", "32S6-4,4,2-g1-path5", "64S23-4,4,4-g9-path272" ];
