...
{ IntegerRing() | 52, 59 }
@};
s`Child := "32S10-8,4,4-g7-path20";
s`Degree := 64;
s`Filename := "64S14-8,8,4-g17-path26.m";
...
s`PassportSize := 1;
s`PathNumber := 26;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path7", "32S10-8,4,4-g7-path20", "64S14-8,8,4-g17-path26" ];
