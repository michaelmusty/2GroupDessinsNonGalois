...
s`Degree := 64;
s`Filename := "64S8-4,8,2-g5-path21.m";
...
s`PassportSize := 1;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S6-4,4,2-g1-path8", "64S8-4,8,2-g5-path21" ];
