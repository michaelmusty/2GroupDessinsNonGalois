...
{ IntegerRing() | 62, 64 }
@};
s`Child := "32S3-4,8,8-g9-path23";
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path15.m";
...
s`PassportSize := 3;
s`PathNumber := 15;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path1", "32S3-4,8,8-g9-path23", "64S3-8,8,8-g21-path15" ];
