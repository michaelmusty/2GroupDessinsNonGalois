...
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path33.m";
...
s`PassportSize := 3;
s`PathNumber := 33;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path11", "32S15-8,8,8-g11-path3", "64S22-8,8,8-g21-path33" ];
