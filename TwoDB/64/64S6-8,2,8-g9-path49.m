...
s`Degree := 64;
s`Filename := "64S6-8,2,8-g9-path49.m";
...
s`PassportSize := 2;
s`PathNumber := 49;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T6-8,2,8-g3-path4", "32S5-8,2,8-g5-path22", "64S6-8,2,8-g9-path49" ];
