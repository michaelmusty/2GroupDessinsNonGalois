...
s`Degree := 64;
s`Filename := "64S39-16,4,4-g15-path9.m";
...
s`PassportSize := 2;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T13-8,2,2-g0-path2", "32S20-16,4,4-g8-path2", "64S39-16,4,4-g15-path9" ];
