...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path91.m";
...
s`PassportSize := 3;
s`PathNumber := 91;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T4-4,4,4-g3-path5", "32S4-4,8,8-g9-path11", "64S3-8,8,8-g21-path91" ];
