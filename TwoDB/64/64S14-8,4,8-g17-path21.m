...
{ IntegerRing() | 52, 59 }
@};
s`Child := "32S10-8,4,4-g7-path26";
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path21.m";
...
s`PassportSize := 1;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,4,2-g2-path1", "32S10-8,4,4-g7-path26", "64S14-8,4,8-g17-path21" ];
