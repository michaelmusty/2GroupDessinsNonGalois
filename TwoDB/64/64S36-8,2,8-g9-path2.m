...
s`Degree := 64;
s`Filename := "64S36-8,2,8-g9-path2.m";
...
[ 3, 9, 1, 6, 13, 4, 24, 26, 2, 29, 33, 14, 5, 12, 41, 18, 19, 16, 17, 45, 22, 21, 52, 7, 46, 8, 44, 30, 10, 28, 36, 60, 11, 37, 42, 31, 34, 39, 38, 62, 15, 35, 57, 27, 20, 25, 48, 47, 56, 51, 50, 23, 59, 55, 54, 49, 43, 64, 53, 32, 63, 40, 61, 58 ],
[ 9, 26, 24, 41, 29, 3, 52, 17, 33, 21, 60, 42, 45, 1, 62, 27, 35, 6, 13, 38, 56, 4, 34, 46, 49, 44, 64, 20, 36, 2, 53, 55, 37, 15, 51, 14, 5, 32, 12, 25, 57, 47, 31, 54, 18, 19, 23, 16, 61, 11, 22, 59, 58, 10, 7, 30, 8, 50, 28, 63, 48, 39, 43, 40 ]
]
];
s`PassportName := "64S36-8,2,8-g9";
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S6-4,2,4-g1-path11", "64S36-8,2,8-g9-path2" ];
