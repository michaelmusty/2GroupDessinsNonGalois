...
s`Degree := 64;
s`Filename := "64S19-8,8,8-g21-path6.m";
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path2", "32S2-4,4,4-g5-path15", "64S19-8,8,8-g21-path6" ];
