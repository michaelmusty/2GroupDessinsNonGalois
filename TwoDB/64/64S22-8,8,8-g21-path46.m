...
{ IntegerRing() | 61, 63 }
@};
s`Child := "32S15-8,8,8-g11-path51";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path46.m";
...
s`PassportSize := 3;
s`PathNumber := 46;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path33", "32S15-8,8,8-g11-path51", "64S22-8,8,8-g21-path46" ];
