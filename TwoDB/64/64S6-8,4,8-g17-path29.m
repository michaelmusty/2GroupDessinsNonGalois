...
s`Degree := 64;
s`Filename := "64S6-8,4,8-g17-path29.m";
...
s`PassportSize := 2;
s`PathNumber := 29;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path2", "32S5-8,4,8-g9-path13", "64S6-8,4,8-g17-path29" ];
