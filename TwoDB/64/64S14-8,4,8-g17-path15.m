...
{ IntegerRing() | 50, 58 }
@};
s`Child := "32S10-4,4,8-g7-path29";
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path15.m";
...
s`PassportSize := 1;
s`PathNumber := 15;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T14-4,4,8-g4-path1", "32S10-4,4,8-g7-path29", "64S14-8,4,8-g17-path15" ];
