...
{ IntegerRing() | 58, 64 }
@};
s`Child := "32S6-4,4,4-g5-path11";
s`Degree := 64;
s`Filename := "64S32-4,8,4-g13-path2.m";
...
s`PassportSize := 2;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S6-4,4,4-g5-path11", "64S32-4,8,4-g13-path2" ];
