...
s`Degree := 64;
s`Filename := "64S37-8,4,8-g17-path17.m";
...
s`PassportSize := 2;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S6-4,4,4-g5-path17", "64S37-8,4,8-g17-path17" ];
