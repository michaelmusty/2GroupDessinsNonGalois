...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path123.m";
...
s`PassportSize := 3;
s`PathNumber := 123;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path11", "32S4-4,8,8-g9-path2", "64S3-8,8,8-g21-path123" ];
