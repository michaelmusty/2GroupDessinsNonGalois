...
{ IntegerRing() | 57, 63 }
@};
s`Child := "32S15-8,8,8-g11-path42";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path36.m";
...
s`PassportSize := 3;
s`PathNumber := 36;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S15-8,8,8-g11-path42", "64S22-8,8,8-g21-path36" ];
