...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path288.m";
...
s`PassportSize := 3;
s`PathNumber := 288;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S6-4,4,4-g5-path20", "64S23-4,4,4-g9-path288" ];
