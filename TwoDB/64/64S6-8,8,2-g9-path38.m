...
s`Degree := 64;
s`Filename := "64S6-8,8,2-g9-path38.m";
...
s`PassportSize := 2;
s`PathNumber := 38;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,2-g3-path6", "32S5-8,8,2-g5-path17", "64S6-8,8,2-g9-path38" ];
