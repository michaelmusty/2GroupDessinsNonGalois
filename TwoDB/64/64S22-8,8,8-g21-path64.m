...
{ IntegerRing() | 61, 63 }
@};
s`Child := "32S15-8,8,8-g11-path7";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path64.m";
...
s`PassportSize := 3;
s`PathNumber := 64;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T8-4,4,4-g3-path13", "32S15-8,8,8-g11-path7", "64S22-8,8,8-g21-path64" ];
