...
{ IntegerRing() | 52, 60 }
@};
s`Child := "32S15-8,8,8-g11-path60";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path56.m";
...
s`PassportSize := 3;
s`PathNumber := 56;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S15-8,8,8-g11-path60", "64S22-8,8,8-g21-path56" ];
