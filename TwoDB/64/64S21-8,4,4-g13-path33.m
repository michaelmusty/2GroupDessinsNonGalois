...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path33.m";
...
s`PassportSize := 1;
s`PathNumber := 33;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S10-8,4,4-g7-path8", "64S21-8,4,4-g13-path33" ];
