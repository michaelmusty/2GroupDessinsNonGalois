...
s`Degree := 64;
s`Filename := "64S6-8,8,4-g17-path74.m";
...
s`PassportSize := 2;
s`PathNumber := 74;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path1", "32S9-4,8,2-g3-path15", "64S6-8,8,4-g17-path74" ];
