...
{ IntegerRing() | 63, 64 }
@};
s`Child := "32S14-4,8,4-g7-path17";
s`Degree := 64;
s`Filename := "64S48-4,16,4-g15-path8.m";
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T8-4,4,4-g3-path9", "32S14-4,8,4-g7-path17", "64S48-4,16,4-g15-path8" ];
