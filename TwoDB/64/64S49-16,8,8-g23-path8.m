...
s`Degree := 64;
s`Filename := "64S49-16,8,8-g23-path8.m";
...
s`PassportSize := 2;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path2", "32S14-8,4,4-g7-path13", "64S49-16,8,8-g23-path8" ];
