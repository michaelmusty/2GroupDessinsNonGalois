...
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path38.m";
...
s`PassportSize := 1;
s`PathNumber := 38;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S12-8,8,4-g9-path44", "64S17-8,8,4-g17-path38" ];
