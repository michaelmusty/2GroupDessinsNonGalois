...
s`Degree := 64;
s`Filename := "64S2-8,8,8-g21-path71.m";
...
s`PassportSize := 1;
s`PathNumber := 71;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,2-g3-path6", "32S3-8,8,4-g9-path21", "64S2-8,8,8-g21-path71" ];
