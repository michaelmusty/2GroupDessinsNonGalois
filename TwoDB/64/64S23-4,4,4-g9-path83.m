...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path83.m";
...
s`PassportSize := 3;
s`PathNumber := 83;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path11", "32S2-4,4,4-g5-path35", "64S23-4,4,4-g9-path83" ];
