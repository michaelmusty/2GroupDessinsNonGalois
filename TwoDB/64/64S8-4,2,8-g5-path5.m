...
s`Degree := 64;
s`Filename := "64S8-4,2,8-g5-path5.m";
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S11-4,2,8-g3-path3", "64S8-4,2,8-g5-path5" ];
