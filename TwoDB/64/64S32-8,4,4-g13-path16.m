...
s`Degree := 64;
s`Filename := "64S32-8,4,4-g13-path16.m";
...
s`PassportSize := 2;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path3", "32S6-4,4,4-g5-path27", "64S32-8,4,4-g13-path16" ];
