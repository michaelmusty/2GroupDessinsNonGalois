...
s`Degree := 64;
s`Filename := "64S43-4,8,16-g19-path9.m";
...
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path10", "32S9-2,4,8-g3-path1", "64S43-4,8,16-g19-path9" ];
