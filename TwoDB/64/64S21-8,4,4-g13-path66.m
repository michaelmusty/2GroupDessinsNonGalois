...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path66.m";
...
s`PassportSize := 1;
s`PathNumber := 66;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T8-4,4,4-g3-path1", "32S14-8,4,4-g7-path7", "64S21-8,4,4-g13-path66" ];
