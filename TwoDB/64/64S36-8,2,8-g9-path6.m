...
s`Degree := 64;
s`Filename := "64S36-8,2,8-g9-path6.m";
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path2", "32S6-4,2,4-g1-path4", "64S36-8,2,8-g9-path6" ];
...
[ 51, 18, 62, 61, 57, 54, 36, 14, 52, 46, 56, 63, 47, 28, 45, 59, 64, 12, 30, 33, 53, 37, 6, 26, 32, 60, 41, 40, 38, 43, 44, 1, 17, 58, 29, 4, 55, 27, 19, 22, 9, 24, 23, 13, 21, 34, 11, 8, 35, 39, 16, 49, 42, 50, 48, 3, 25, 2, 5, 15, 20, 31, 10, 7 ]
]
];
