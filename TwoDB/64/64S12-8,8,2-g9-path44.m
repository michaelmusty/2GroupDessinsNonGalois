...
s`Degree := 64;
s`Filename := "64S12-8,8,2-g9-path44.m";
...
s`PassportSize := 1;
s`PathNumber := 44;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S9-8,4,2-g3-path8", "64S12-8,8,2-g9-path44" ];
