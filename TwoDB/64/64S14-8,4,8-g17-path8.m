...
{ IntegerRing() | 50, 58 }
@};
s`Child := "32S10-4,4,8-g7-path19";
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path8.m";
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S10-4,4,8-g7-path19", "64S14-8,4,8-g17-path8" ];
