...
s`Degree := 64;
s`Filename := "64S10-8,4,8-g17-path33.m";
...
s`PassportSize := 1;
s`PathNumber := 33;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S7-8,2,8-g5-path9", "64S10-8,4,8-g17-path33" ];
