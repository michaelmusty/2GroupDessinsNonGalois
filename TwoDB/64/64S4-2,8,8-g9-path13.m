...
{ IntegerRing() | 60, 63 }
@};
s`Child := "32S5-2,8,8-g5-path21";
s`Degree := 64;
s`Filename := "64S4-2,8,8-g9-path13.m";
...
s`PassportSize := 1;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-2,8,8-g3-path3", "32S5-2,8,8-g5-path21", "64S4-2,8,8-g9-path13" ];
