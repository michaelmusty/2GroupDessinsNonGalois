...
{ IntegerRing() | 44, 47 }
@};
s`Child := "32S10-4,8,4-g7-path26";
s`Degree := 64;
s`Filename := "64S13-4,8,8-g17-path21.m";
...
s`PassportSize := 2;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-4,8,2-g2-path1", "32S10-4,8,4-g7-path26", "64S13-4,8,8-g17-path21" ];
