...
{ IntegerRing() | 52, 63 }
@};
s`Child := "32S15-8,8,8-g11-path6";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path63.m";
...
s`PassportSize := 3;
s`PathNumber := 63;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T8-4,4,4-g3-path12", "32S15-8,8,8-g11-path6", "64S22-8,8,8-g21-path63" ];
