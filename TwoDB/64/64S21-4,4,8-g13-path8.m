...
s`Degree := 64;
s`Filename := "64S21-4,4,8-g13-path8.m";
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S10-4,4,8-g7-path17", "64S21-4,4,8-g13-path8" ];
