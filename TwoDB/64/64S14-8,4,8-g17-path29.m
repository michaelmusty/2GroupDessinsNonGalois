...
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path29.m";
...
s`PassportSize := 1;
s`PathNumber := 29;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path2", "32S10-8,4,4-g7-path4", "64S14-8,4,8-g17-path29" ];
