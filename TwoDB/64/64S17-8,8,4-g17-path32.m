...
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path32.m";
...
s`PassportSize := 1;
s`PathNumber := 32;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path18", "32S12-8,8,4-g9-path39", "64S17-8,8,4-g17-path32" ];
