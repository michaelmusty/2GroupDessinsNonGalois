...
{ IntegerRing() | 60, 63 }
@};
s`Child := "32S5-2,8,8-g5-path17";
s`Degree := 64;
s`Filename := "64S4-2,8,8-g9-path8.m";
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path6", "32S5-2,8,8-g5-path17", "64S4-2,8,8-g9-path8" ];
