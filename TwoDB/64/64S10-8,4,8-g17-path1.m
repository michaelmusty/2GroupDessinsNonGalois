...
{ IntegerRing() | 48, 59 }
@};
s`Child := "32S11-4,4,8-g7-path12";
s`Degree := 64;
s`Filename := "64S10-8,4,8-g17-path1.m";
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-4,4,8-g7-path12", "64S10-8,4,8-g17-path1" ];
