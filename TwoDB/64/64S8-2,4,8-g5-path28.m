...
s`Degree := 64;
s`Filename := "64S8-2,4,8-g5-path28.m";
...
s`PassportSize := 1;
s`PathNumber := 28;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T13-2,2,8-g0-path1", "32S9-2,4,8-g3-path15", "64S8-2,4,8-g5-path28" ];
