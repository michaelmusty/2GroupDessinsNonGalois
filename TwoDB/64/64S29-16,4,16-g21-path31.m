...
s`Degree := 64;
s`Filename := "64S29-16,4,16-g21-path31.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 28, 32, 11, 12, 2, 39, 29, 26, 15, 36, 20, 41, 6, 19, 42, 22, 37, 16, 25, 9, 14, 8, 13, 52, 33, 27, 57, 30, 24, 17, 31, 35, 34, 45, 43, 23, 62, 21, 44, 61, 47, 46, 48, 38, 51, 60, 64, 40, 53, 55, 54, 56, 59, 50, 49, 58, 63 ],
\[ 4, 3, 15, 19, 20, 22, 25, 1, 10, 36, 7, 37, 2, 5, 41, 42, 18, 43, 44, 45, 47, 46, 48, 6, 21, 23, 28, 17, 24, 8, 32, 29, 12, 9, 11, 26, 16, 39, 14, 13, 50, 61, 62, 59, 49, 63, 60, 64, 53, 56, 27, 30, 52, 31, 33, 57, 35, 34, 38, 40, 58, 54, 51, 55 ] >;
s`Name := "64S29-16,4,16-g21-path31";
s`Orders := \[ 16, 4, 16 ];
...
[ 8, 13, 2, 1, 14, 24, 11, 30, 34, 9, 35, 33, 40, 39, 3, 37, 28, 17, 4, 5, 25, 6, 26, 29, 7, 36, 51, 27, 32, 52, 54, 31, 55, 58, 57, 10, 12, 59, 38, 60, 15, 16, 18, 19, 20, 22, 21, 23, 45, 41, 63, 53, 49, 62, 64, 50, 56, 61, 44, 47, 42, 43, 46, 48 ]
]
];
s`PassportName := "64S29-16,4,16-g21";
s`PassportSize := 1;
s`PathNumber := 31;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,2,8-g3-path5", "32S5-8,2,8-g5-path23", "64S29-16,4,16-g21-path31" ];
