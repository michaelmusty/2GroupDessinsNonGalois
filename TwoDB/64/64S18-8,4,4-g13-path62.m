...
s`Degree := 64;
s`Filename := "64S18-8,4,4-g13-path62.m";
...
s`PassportSize := 1;
s`PathNumber := 62;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path26", "32S2-4,4,4-g5-path66", "64S18-8,4,4-g13-path62" ];
