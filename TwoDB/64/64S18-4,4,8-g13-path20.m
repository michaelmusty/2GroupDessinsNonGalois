...
s`Degree := 64;
s`Filename := "64S18-4,4,8-g13-path20.m";
...
s`PassportSize := 1;
s`PathNumber := 20;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S2-4,4,4-g5-path28", "64S18-4,4,8-g13-path20" ];
