...
{ IntegerRing() | 48, 59 }
@};
s`Child := "32S5-8,4,8-g9-path7";
s`Degree := 64;
s`Filename := "64S4-8,4,8-g17-path21.m";
...
[ 21, 44, 56, 31, 60, 32, 59, 2, 64, 34, 48, 30, 33, 9, 12, 29, 4, 42, 6, 15, 16, 39, 63, 45, 57, 58, 49, 40, 1, 20, 54, 55, 10, 13, 27, 51, 47, 35, 25, 37, 8, 11, 52, 41, 26, 62, 28, 18, 38, 23, 43, 36, 50, 17, 19, 7, 22, 24, 3, 46, 14, 5, 53, 61 ],
[ 15, 40, 41, 5, 8, 62, 2, 53, 32, 61, 12, 14, 9, 58, 35, 30, 18, 20, 48, 64, 52, 29, 24, 1, 21, 16, 22, 57, 51, 49, 11, 42, 38, 27, 54, 37, 39, 25, 56, 17, 47, 43, 28, 23, 7, 44, 31, 36, 4, 6, 63, 50, 26, 46, 60, 10, 59, 3, 13, 34, 19, 33, 55, 45 ]
]
];
s`PassportName := "64S4-8,4,8-g17";
s`PassportSize := 1;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S5-8,4,8-g9-path7", "64S4-8,4,8-g17-path21" ];
