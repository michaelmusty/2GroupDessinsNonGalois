...
s`Degree := 64;
s`Filename := "64S4-8,2,8-g9-path42.m";
...
s`PassportSize := 1;
s`PathNumber := 42;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S7-8,2,8-g5-path6", "64S4-8,2,8-g9-path42" ];
