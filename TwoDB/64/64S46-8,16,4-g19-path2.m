...
s`Degree := 64;
s`Filename := "64S46-8,16,4-g19-path2.m";
...
s`PassportSize := 2;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T8-4,4,4-g3-path21", "32S13-4,8,4-g7-path10", "64S46-8,16,4-g19-path2" ];
