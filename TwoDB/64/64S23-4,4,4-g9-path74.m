...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path74.m";
...
s`PassportSize := 3;
s`PathNumber := 74;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S2-4,4,4-g5-path32", "64S23-4,4,4-g9-path74" ];
