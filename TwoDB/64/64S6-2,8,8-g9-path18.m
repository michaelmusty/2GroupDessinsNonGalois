...
s`Degree := 64;
s`Filename := "64S6-2,8,8-g9-path18.m";
...
s`PassportSize := 2;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S11-2,8,4-g3-path5", "64S6-2,8,8-g9-path18" ];
