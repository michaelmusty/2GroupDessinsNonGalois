...
s`Degree := 64;
s`Filename := "64S2-8,8,8-g21-path5.m";
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T4-4,4,4-g3-path8", "32S3-4,8,8-g9-path14", "64S2-8,8,8-g21-path5" ];
