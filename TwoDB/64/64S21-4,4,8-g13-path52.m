...
s`Degree := 64;
s`Filename := "64S21-4,4,8-g13-path52.m";
...
s`PassportSize := 1;
s`PathNumber := 52;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T8-4,4,4-g3-path14", "32S14-4,4,8-g7-path10", "64S21-4,4,8-g13-path52" ];
