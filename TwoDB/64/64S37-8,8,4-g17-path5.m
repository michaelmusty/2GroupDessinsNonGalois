...
s`Degree := 64;
s`Filename := "64S37-8,8,4-g17-path5.m";
...
s`PassportSize := 2;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path1", "32S6-4,4,2-g1-path3", "64S37-8,8,4-g17-path5" ];
