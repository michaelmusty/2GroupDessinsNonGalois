...
{ IntegerRing() | 61, 63 }
@};
s`Child := "32S7-8,2,8-g5-path6";
s`Degree := 64;
s`Filename := "64S24-8,4,8-g17-path89.m";
...
[ 17, 14, 42, 40, 24, 51, 44, 2, 21, 29, 8, 28, 9, 11, 59, 58, 5, 53, 34, 50, 33, 30, 55, 1, 56, 31, 41, 10, 12, 27, 16, 19, 13, 39, 63, 64, 61, 57, 32, 20, 22, 7, 23, 3, 49, 45, 43, 52, 54, 4, 18, 60, 6, 46, 47, 15, 36, 26, 25, 62, 35, 48, 37, 38 ],
...
s`PassportSize := 1;
s`PathNumber := 89;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S7-8,2,8-g5-path6", "64S24-8,4,8-g17-path89" ];
