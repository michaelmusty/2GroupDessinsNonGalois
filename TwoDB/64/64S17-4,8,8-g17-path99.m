...
s`Degree := 64;
s`Filename := "64S17-4,8,8-g17-path99.m";
...
s`PassportSize := 1;
s`PathNumber := 99;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path19", "32S2-4,4,4-g5-path58", "64S17-4,8,8-g17-path99" ];
