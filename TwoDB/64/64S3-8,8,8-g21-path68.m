...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path68.m";
...
s`PassportSize := 3;
s`PathNumber := 68;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path4", "32S3-8,8,4-g9-path19", "64S3-8,8,8-g21-path68" ];
