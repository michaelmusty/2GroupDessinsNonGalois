...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path65.m";
...
s`PassportSize := 3;
s`PathNumber := 65;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1", "16T5-8,8,2-g3-path1", "32S3-8,8,4-g9-path16", "64S3-8,8,8-g21-path65" ];
