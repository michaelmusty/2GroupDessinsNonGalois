...
s`Degree := 64;
s`Filename := "64S8-4,8,4-g13-path54.m";
...
s`PassportSize := 2;
s`PathNumber := 54;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S9-2,8,4-g3-path2", "64S8-4,8,4-g13-path54" ];
