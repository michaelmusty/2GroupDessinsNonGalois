...
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path35.m";
...
s`PassportSize := 1;
s`PathNumber := 35;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S12-8,8,4-g9-path41", "64S17-8,8,4-g17-path35" ];
