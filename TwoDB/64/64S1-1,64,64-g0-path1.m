...
s`Degree := 64;
s`Filename := "64S1-1,64,64-g0-path1.m";
...
s`PassportName := "64S1-1,64,64-g0";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T1-1,16,16-g0-path1", "32S1-1,32,32-g0-path1", "64S1-1,64,64-g0-path1" ];
