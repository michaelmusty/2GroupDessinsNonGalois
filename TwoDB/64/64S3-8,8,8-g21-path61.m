...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path61.m";
...
s`PassportSize := 3;
s`PathNumber := 61;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T4-4,4,4-g3-path6", "32S3-8,8,4-g9-path12", "64S3-8,8,8-g21-path61" ];
