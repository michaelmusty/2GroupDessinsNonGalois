...
s`Degree := 64;
s`Filename := "64S8-4,4,8-g13-path44.m";
...
s`PassportSize := 2;
s`PathNumber := 44;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path7", "32S6-4,4,4-g5-path9", "64S8-4,4,8-g13-path44" ];
