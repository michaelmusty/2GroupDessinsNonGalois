...
s`Degree := 64;
s`Filename := "64S2-8,8,8-g21-path77.m";
...
s`PassportSize := 1;
s`PathNumber := 77;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,4-g5-path5", "32S3-8,8,4-g9-path27", "64S2-8,8,8-g21-path77" ];
