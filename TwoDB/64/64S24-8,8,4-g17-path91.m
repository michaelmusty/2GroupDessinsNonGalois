...
{ IntegerRing() | 59, 60 }
@};
s`Child := "32S7-8,8,2-g5-path8";
s`Degree := 64;
s`Filename := "64S24-8,8,4-g17-path91.m";
...
s`PassportSize := 1;
s`PathNumber := 91;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S7-8,8,2-g5-path8", "64S24-8,8,4-g17-path91" ];
