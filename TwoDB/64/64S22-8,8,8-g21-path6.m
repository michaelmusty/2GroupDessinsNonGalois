...
{ IntegerRing() | 61, 63 }
@};
s`Child := "32S15-8,8,8-g11-path15";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path6.m";
...
s`PassportSize := 3;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path17", "32S15-8,8,8-g11-path15", "64S22-8,8,8-g21-path6" ];
