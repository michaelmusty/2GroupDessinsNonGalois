...
s`Degree := 64;
s`Filename := "64S2-8,8,8-g21-path81.m";
...
s`PassportSize := 1;
s`PathNumber := 81;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T4-4,4,4-g3-path12", "32S3-8,8,4-g9-path3", "64S2-8,8,8-g21-path81" ];
