...
s`Degree := 64;
s`Filename := "64S18-4,4,8-g13-path72.m";
...
s`PassportSize := 1;
s`PathNumber := 72;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T8-4,4,4-g3-path3", "32S2-4,4,4-g5-path75", "64S18-4,4,8-g13-path72" ];
