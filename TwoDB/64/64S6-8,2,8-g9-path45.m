...
s`Degree := 64;
s`Filename := "64S6-8,2,8-g9-path45.m";
...
s`PassportSize := 2;
s`PathNumber := 45;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T6-8,2,8-g3-path2", "32S5-8,2,8-g5-path20", "64S6-8,2,8-g9-path45" ];
