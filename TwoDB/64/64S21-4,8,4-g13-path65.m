...
s`Degree := 64;
s`Filename := "64S21-4,8,4-g13-path65.m";
...
s`PassportSize := 1;
s`PathNumber := 65;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T14-4,8,4-g4-path3", "32S14-4,8,4-g7-path6", "64S21-4,8,4-g13-path65" ];
