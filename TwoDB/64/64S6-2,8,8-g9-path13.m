...
s`Degree := 64;
s`Filename := "64S6-2,8,8-g9-path13.m";
...
s`PassportSize := 2;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S11-2,8,4-g3-path11", "64S6-2,8,8-g9-path13" ];
