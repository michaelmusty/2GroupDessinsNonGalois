...
s`Degree := 64;
s`Filename := "64S4-8,8,2-g9-path4.m";
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2", "32S5-8,8,2-g5-path13", "64S4-8,8,2-g9-path4" ];
