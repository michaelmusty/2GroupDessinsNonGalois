...
s`Degree := 64;
s`Filename := "64S46-8,4,16-g19-path4.m";
...
s`PassportSize := 2;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T8-4,4,4-g3-path15", "32S13-4,4,8-g7-path11", "64S46-8,4,16-g19-path4" ];
