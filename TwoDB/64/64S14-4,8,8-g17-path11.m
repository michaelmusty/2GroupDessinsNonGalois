...
{ IntegerRing() | 56, 64 }
@};
s`Child := "32S10-4,4,8-g7-path3";
s`Degree := 64;
s`Filename := "64S14-4,8,8-g17-path11.m";
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path1", "32S10-4,4,8-g7-path3", "64S14-4,8,8-g17-path11" ];
