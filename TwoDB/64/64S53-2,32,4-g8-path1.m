...
s`Degree := 64;
s`Filename := "64S53-2,32,4-g8-path1.m";
...
s`PassportName := "64S53-2,32,4-g8";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path1", "32S18-2,16,2-g0-path1", "64S53-2,32,4-g8-path1" ];
