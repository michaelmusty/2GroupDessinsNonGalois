...
s`Degree := 64;
s`Filename := "64S24-8,8,4-g17-path69.m";
...
s`PassportSize := 1;
s`PathNumber := 69;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path31", "32S2-4,4,4-g5-path72", "64S24-8,8,4-g17-path69" ];
