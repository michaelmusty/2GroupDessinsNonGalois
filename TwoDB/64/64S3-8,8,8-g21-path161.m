...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path161.m";
...
s`PassportSize := 3;
s`PathNumber := 161;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,2,8-g3-path5", "32S4-8,4,8-g9-path20", "64S3-8,8,8-g21-path161" ];
