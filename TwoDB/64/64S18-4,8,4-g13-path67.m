...
s`Degree := 64;
s`Filename := "64S18-4,8,4-g13-path67.m";
...
s`PassportSize := 1;
s`PathNumber := 67;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path2", "32S2-4,4,4-g5-path70", "64S18-4,8,4-g13-path67" ];
