...
s`Degree := 64;
s`Filename := "64S6-8,4,8-g17-path26.m";
...
s`PassportSize := 2;
s`PathNumber := 26;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S5-8,4,8-g9-path11", "64S6-8,4,8-g17-path26" ];
