...
s`Degree := 64;
s`Filename := "64S20-4,4,8-g13-path58.m";
...
s`PassportSize := 2;
s`PathNumber := 58;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S2-4,4,4-g5-path16", "64S20-4,4,8-g13-path58" ];
