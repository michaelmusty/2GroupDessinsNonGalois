...
s`Degree := 64;
s`Filename := "64S39-4,4,16-g15-path3.m";
...
s`PassportSize := 2;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path3", "32S19-2,4,16-g4-path3", "64S39-4,4,16-g15-path3" ];
