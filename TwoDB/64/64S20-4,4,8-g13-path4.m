...
s`Degree := 64;
s`Filename := "64S20-4,4,8-g13-path4.m";
...
s`PassportSize := 2;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S11-2,4,8-g3-path2", "64S20-4,4,8-g13-path4" ];
