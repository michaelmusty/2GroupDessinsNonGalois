...
s`Degree := 64;
s`Filename := "64S20-4,8,4-g13-path40.m";
...
s`PassportSize := 2;
s`PathNumber := 40;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S11-4,8,4-g7-path5", "64S20-4,8,4-g13-path40" ];
