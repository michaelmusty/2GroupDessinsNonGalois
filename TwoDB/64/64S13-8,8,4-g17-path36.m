...
s`Degree := 64;
s`Filename := "64S13-8,8,4-g17-path36.m";
...
s`PassportSize := 2;
s`PathNumber := 36;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S8-8,8,4-g9-path10", "64S13-8,8,4-g17-path36" ];
