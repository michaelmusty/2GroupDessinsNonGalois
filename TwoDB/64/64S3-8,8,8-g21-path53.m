...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path53.m";
...
s`PassportSize := 3;
s`PathNumber := 53;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T4-4,4,4-g3-path13", "32S3-8,4,8-g9-path4", "64S3-8,8,8-g21-path53" ];
