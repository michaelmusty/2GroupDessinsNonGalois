...
s`Degree := 64;
s`Filename := "64S21-4,8,4-g13-path66.m";
...
s`PassportSize := 1;
s`PathNumber := 66;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T8-4,4,4-g3-path10", "32S14-4,8,4-g7-path7", "64S21-4,8,4-g13-path66" ];
