...
s`Degree := 64;
s`Filename := "64S17-4,8,8-g17-path24.m";
...
s`PassportSize := 1;
s`PathNumber := 24;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T8-4,4,4-g3-path24", "32S12-4,8,8-g9-path31", "64S17-4,8,8-g17-path24" ];
