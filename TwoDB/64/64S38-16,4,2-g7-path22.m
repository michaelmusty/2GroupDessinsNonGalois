...
s`Degree := 64;
s`Filename := "64S38-16,4,2-g7-path22.m";
...
s`PassportSize := 1;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S9-8,4,2-g3-path8", "64S38-16,4,2-g7-path22" ];
