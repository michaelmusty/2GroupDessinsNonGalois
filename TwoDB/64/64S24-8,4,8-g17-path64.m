...
s`Degree := 64;
s`Filename := "64S24-8,4,8-g17-path64.m";
...
s`PassportSize := 1;
s`PathNumber := 64;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S2-4,4,4-g5-path68", "64S24-8,4,8-g17-path64" ];
