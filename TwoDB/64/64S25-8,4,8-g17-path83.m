...
s`Degree := 64;
s`Filename := "64S25-8,4,8-g17-path83.m";
...
s`PassportSize := 2;
s`PathNumber := 83;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S2-4,4,4-g5-path48", "64S25-8,4,8-g17-path83" ];
