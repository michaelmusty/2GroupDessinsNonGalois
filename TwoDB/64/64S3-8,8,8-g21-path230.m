...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path230.m";
...
s`PassportSize := 3;
s`PathNumber := 230;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T4-4,4,4-g3-path15", "32S4-8,8,4-g9-path6", "64S3-8,8,8-g21-path230" ];
