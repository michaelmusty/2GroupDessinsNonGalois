...
{ IntegerRing() | 52, 60 }
@};
s`Child := "32S15-8,8,8-g11-path46";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path40.m";
...
s`PassportSize := 3;
s`PathNumber := 40;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path30", "32S15-8,8,8-g11-path46", "64S22-8,8,8-g21-path40" ];
