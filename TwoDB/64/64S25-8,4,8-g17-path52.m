...
s`Degree := 64;
s`Filename := "64S25-8,4,8-g17-path52.m";
...
s`PassportSize := 2;
s`PathNumber := 52;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S2-4,4,4-g5-path33", "64S25-8,4,8-g17-path52" ];
