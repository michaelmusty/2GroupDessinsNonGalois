...
{ IntegerRing() | 42, 57 }
@};
s`Child := "32S4-8,8,4-g9-path18";
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path204.m";
...
s`PassportSize := 3;
s`PathNumber := 204;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,2-g3-path3", "32S4-8,8,4-g9-path18", "64S3-8,8,8-g21-path204" ];
...
[ 23, 34, 33, 44, 52, 57, 58, 7, 46, 19, 53, 16, 12, 6, 20, 62, 28, 1, 50, 63, 13, 41, 39, 42, 27, 25, 22, 26, 51, 4, 61, 60, 56, 49, 31, 40, 45, 37, 36, 32, 48, 2, 3, 43, 24, 64, 29, 17, 38, 59, 5, 9, 15, 30, 10, 54, 11, 55, 8, 18, 21, 35, 14, 47 ]
]
];
