...
s`Degree := 64;
s`Filename := "64S13-4,8,8-g17-path60.m";
...
s`PassportSize := 2;
s`PathNumber := 60;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-2,4,8-g2-path2", "32S9-2,4,8-g3-path13", "64S13-4,8,8-g17-path60" ];
