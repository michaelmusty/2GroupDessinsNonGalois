...
{ IntegerRing() | 61, 63 }
@};
s`Child := "32S15-8,8,8-g11-path27";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path19.m";
...
s`PassportSize := 3;
s`PathNumber := 19;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S15-8,8,8-g11-path27", "64S22-8,8,8-g21-path19" ];
