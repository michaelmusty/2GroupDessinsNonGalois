...
s`Degree := 64;
s`Filename := "64S32-2,8,4-g5-path11.m";
...
s`PassportName := "64S32-2,8,4-g5";
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path7", "32S6-2,4,4-g1-path9", "64S32-2,8,4-g5-path11" ];
