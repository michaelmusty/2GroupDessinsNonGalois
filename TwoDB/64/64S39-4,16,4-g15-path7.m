...
s`Degree := 64;
s`Filename := "64S39-4,16,4-g15-path7.m";
...
s`PassportSize := 2;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path1", "32S20-4,16,4-g8-path1", "64S39-4,16,4-g15-path7" ];
