...
s`Degree := 64;
s`Filename := "64S10-8,8,2-g9-path5.m";
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path1", "32S11-4,8,2-g3-path3", "64S10-8,8,2-g9-path5" ];
