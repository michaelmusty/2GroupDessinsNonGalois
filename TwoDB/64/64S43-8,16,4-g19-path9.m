...
{ IntegerRing() | 63, 64 }
@};
s`Child := "32S9-4,8,2-g3-path1";
s`Degree := 64;
s`Filename := "64S43-8,16,4-g19-path9.m";
...
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S9-4,8,2-g3-path1", "64S43-8,16,4-g19-path9" ];
