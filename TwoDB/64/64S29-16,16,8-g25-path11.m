...
{ IntegerRing() | 62, 64 }
@};
s`Child := "32S16-16,16,8-g13-path2";
s`Degree := 64;
s`Filename := "64S29-16,16,8-g25-path11.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 31, 30, 18, 8, 2, 32, 43, 17, 44, 48, 50, 5, 22, 15, 47, 4, 45, 26, 49, 11, 21, 7, 37, 46, 51, 41, 13, 9, 42, 59, 34, 19, 12, 58, 63, 20, 55, 52, 23, 56, 61, 62, 28, 29, 33, 25, 36, 53, 64, 27, 60, 39, 57, 54, 35, 40, 38 ],
\[ 4, 7, 15, 20, 21, 25, 28, 1, 12, 5, 19, 39, 2, 24, 22, 6, 26, 3, 23, 52, 53, 54, 55, 47, 33, 36, 29, 43, 46, 11, 16, 8, 35, 27, 57, 9, 10, 40, 50, 51, 34, 13, 48, 17, 49, 14, 41, 56, 58, 44, 18, 64, 61, 38, 45, 42, 59, 30, 31, 32, 62, 63, 37, 60 ] >;
s`Name := "64S29-16,16,8-g25-path11";
s`Orders := \[ 16, 16, 8 ];
...
s`PassportSize := 2;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T1-16,16,8-g7-path1", "32S16-16,16,8-g13-path2", "64S29-16,16,8-g25-path11" ];
...
[ 10, 30, 31, 5, 8, 3, 11, 37, 41, 32, 13, 34, 58, 50, 16, 18, 14, 59, 2, 21, 1, 6, 7, 44, 15, 24, 9, 19, 12, 42, 51, 63, 22, 36, 54, 47, 60, 33, 27, 35, 26, 49, 23, 46, 43, 39, 17, 55, 48, 29, 57, 53, 4, 25, 28, 45, 38, 56, 40, 62, 20, 52, 64, 61 ]
]
];
