...
s`Degree := 64;
s`Filename := "64S13-8,4,8-g17-path63.m";
...
s`PassportSize := 2;
s`PathNumber := 63;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T13-2,2,8-g0-path2", "32S9-4,2,8-g3-path16", "64S13-8,4,8-g17-path63" ];
