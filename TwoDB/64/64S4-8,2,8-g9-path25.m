...
s`Degree := 64;
s`Filename := "64S4-8,2,8-g9-path25.m";
...
s`PassportSize := 1;
s`PathNumber := 25;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S6-4,2,4-g1-path11", "64S4-8,2,8-g9-path25" ];
...
[ 41, 20, 61, 53, 15, 27, 10, 31, 44, 7, 22, 32, 35, 52, 5, 23, 43, 51, 48, 2, 33, 11, 16, 29, 39, 36, 6, 55, 24, 60, 8, 12, 21, 59, 13, 26, 58, 45, 25, 49, 1, 47, 17, 9, 38, 54, 42, 19, 40, 62, 18, 14, 4, 46, 28, 63, 64, 37, 34, 30, 3, 50, 56, 57 ],
[ 29, 21, 44, 61, 9, 13, 38, 4, 36, 26, 58, 41, 24, 5, 46, 27, 35, 19, 3, 51, 53, 17, 12, 18, 48, 43, 64, 20, 33, 10, 52, 28, 14, 15, 50, 37, 1, 32, 34, 16, 62, 31, 57, 45, 6, 23, 25, 60, 11, 8, 59, 63, 30, 22, 42, 7, 2, 55, 56, 40, 54, 39, 49, 47 ]
]
];
