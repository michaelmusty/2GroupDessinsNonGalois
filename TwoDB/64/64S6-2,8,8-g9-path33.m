...
s`Degree := 64;
s`Filename := "64S6-2,8,8-g9-path33.m";
...
s`PassportSize := 2;
s`PathNumber := 33;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-2,8,8-g3-path4", "32S5-2,8,8-g5-path15", "64S6-2,8,8-g9-path33" ];
