...
s`Degree := 64;
s`Filename := "64S17-4,8,8-g17-path5.m";
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path7", "32S12-4,8,8-g9-path14", "64S17-4,8,8-g17-path5" ];
