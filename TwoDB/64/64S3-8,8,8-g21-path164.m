...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path164.m";
...
s`PassportSize := 3;
s`PathNumber := 164;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T6-8,4,8-g5-path2", "32S4-8,4,8-g9-path22", "64S3-8,8,8-g21-path164" ];
