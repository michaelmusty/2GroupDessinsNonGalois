...
s`Degree := 64;
s`Filename := "64S24-4,8,8-g17-path32.m";
...
s`PassportSize := 1;
s`PathNumber := 32;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T4-4,4,4-g3-path15", "32S2-4,4,4-g5-path39", "64S24-4,8,8-g17-path32" ];
