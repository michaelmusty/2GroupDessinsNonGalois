...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path41.m";
...
s`PassportSize := 1;
s`PathNumber := 41;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T8-4,4,4-g3-path4", "32S13-8,4,4-g7-path16", "64S21-8,4,4-g13-path41" ];
