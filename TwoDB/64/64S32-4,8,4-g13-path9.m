...
s`Degree := 64;
s`Filename := "64S32-4,8,4-g13-path9.m";
...
s`PassportSize := 2;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S6-4,4,4-g5-path28", "64S32-4,8,4-g13-path9" ];
