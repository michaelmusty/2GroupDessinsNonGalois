...
{ IntegerRing() | 52, 59 }
@};
s`Child := "32S10-8,4,4-g7-path14";
s`Degree := 64;
s`Filename := "64S14-8,8,4-g17-path20.m";
...
s`PassportSize := 1;
s`PathNumber := 20;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path1", "32S10-8,4,4-g7-path14", "64S14-8,8,4-g17-path20" ];
