...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path48.m";
...
s`PassportSize := 3;
s`PathNumber := 48;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S2-4,4,4-g5-path24", "64S23-4,4,4-g9-path48" ];
