...
s`Degree := 64;
s`Filename := "64S17-4,8,8-g17-path46.m";
...
s`PassportSize := 1;
s`PathNumber := 46;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T5-4,8,8-g5-path2", "32S12-4,8,8-g9-path9", "64S17-4,8,8-g17-path46" ];
