...
s`Degree := 64;
s`Filename := "64S4-8,2,8-g9-path11.m";
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S5-8,2,8-g5-path1", "64S4-8,2,8-g9-path11" ];
