...
{ IntegerRing() | 52, 63 }
@};
s`Child := "32S15-8,8,8-g11-path16";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path7.m";
...
s`PassportSize := 3;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path17", "32S15-8,8,8-g11-path16", "64S22-8,8,8-g21-path7" ];
