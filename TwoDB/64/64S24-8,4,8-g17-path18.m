...
s`Degree := 64;
s`Filename := "64S24-8,4,8-g17-path18.m";
...
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path2", "32S2-4,4,4-g5-path26", "64S24-8,4,8-g17-path18" ];
