...
{ IntegerRing() | 52, 59 }
@};
s`Child := "32S10-8,4,4-g7-path2";
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path25.m";
...
[ 61, 31, 43, 46, 21, 40, 50, 12, 49, 54, 60, 45, 55, 39, 2, 64, 24, 57, 26, 8, 48, 19, 34, 32, 29, 33, 17, 23, 14, 5, 42, 27, 22, 59, 38, 44, 53, 36, 25, 56, 9, 15, 7, 35, 20, 51, 6, 30, 63, 3, 58, 62, 52, 13, 10, 47, 11, 4, 28, 18, 16, 37, 41, 1 ],
[ 8, 14, 20, 1, 15, 30, 12, 37, 40, 29, 2, 41, 39, 32, 23, 45, 3, 42, 60, 49, 36, 64, 4, 5, 17, 61, 48, 6, 33, 35, 59, 7, 57, 56, 62, 53, 24, 9, 19, 50, 46, 25, 10, 63, 52, 11, 43, 31, 58, 13, 16, 27, 26, 28, 34, 21, 44, 18, 51, 38, 55, 22, 47, 54 ]
]
];
s`PassportName := "64S14-8,4,8-g17";
s`PassportSize := 1;
s`PathNumber := 25;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S10-8,4,4-g7-path2", "64S14-8,4,8-g17-path25" ];
