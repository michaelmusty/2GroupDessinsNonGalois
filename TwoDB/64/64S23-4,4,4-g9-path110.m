...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path110.m";
...
s`PassportSize := 3;
s`PathNumber := 110;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T4-4,4,4-g3-path4", "32S2-4,4,4-g5-path43", "64S23-4,4,4-g9-path110" ];
