...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path51.m";
...
s`PassportSize := 1;
s`PathNumber := 51;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23", "32S13-8,4,4-g7-path9", "64S21-8,4,4-g13-path51" ];
