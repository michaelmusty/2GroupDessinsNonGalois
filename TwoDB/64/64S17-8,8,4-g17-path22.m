...
{ IntegerRing() | 59, 64 }
@};
s`Child := "32S12-8,8,4-g9-path2";
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path22.m";
...
s`PassportSize := 1;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2", "32S12-8,8,4-g9-path2", "64S17-8,8,4-g17-path22" ];
