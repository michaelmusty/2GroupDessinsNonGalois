...
s`Degree := 64;
s`Filename := "64S21-4,8,4-g13-path53.m";
...
s`PassportSize := 1;
s`PathNumber := 53;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path27", "32S14-4,8,4-g7-path11", "64S21-4,8,4-g13-path53" ];
