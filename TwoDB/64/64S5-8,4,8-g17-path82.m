...
s`Degree := 64;
s`Filename := "64S5-8,4,8-g17-path82.m";
...
s`PassportSize := 2;
s`PathNumber := 82;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S8-8,4,8-g9-path5", "64S5-8,4,8-g17-path82" ];
