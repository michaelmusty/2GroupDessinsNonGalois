...
{ IntegerRing() | 63, 64 }
@};
s`Child := "32S9-2,4,8-g3-path16";
s`Degree := 64;
s`Filename := "64S40-4,8,16-g19-path7.m";
...
s`PassportSize := 1;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T13-2,2,8-g0-path2", "32S9-2,4,8-g3-path16", "64S40-4,8,16-g19-path7" ];
