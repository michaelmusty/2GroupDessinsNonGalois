...
s`Degree := 64;
s`Filename := "64S25-8,4,8-g17-path57.m";
...
s`PassportSize := 2;
s`PathNumber := 57;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T4-4,4,4-g3-path12", "32S2-4,4,4-g5-path36", "64S25-8,4,8-g17-path57" ];
