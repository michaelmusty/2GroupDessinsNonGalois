...
s`Degree := 64;
s`Filename := "64S21-4,8,4-g13-path23.m";
...
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T14-4,8,4-g4-path1", "32S10-4,8,4-g7-path30", "64S21-4,8,4-g13-path23" ];
