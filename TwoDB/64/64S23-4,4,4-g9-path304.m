...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path304.m";
...
s`PassportSize := 3;
s`PathNumber := 304;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S6-4,4,4-g5-path4", "64S23-4,4,4-g9-path304" ];
