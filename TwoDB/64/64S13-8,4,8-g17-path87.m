...
s`Degree := 64;
s`Filename := "64S13-8,4,8-g17-path87.m";
...
s`PassportSize := 2;
s`PathNumber := 87;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S9-8,2,4-g3-path6", "64S13-8,4,8-g17-path87" ];
