...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path52.m";
...
s`PassportSize := 1;
s`PathNumber := 52;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T8-4,4,4-g3-path24", "32S14-8,4,4-g7-path10", "64S21-8,4,4-g13-path52" ];
