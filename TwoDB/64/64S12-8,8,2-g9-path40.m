...
s`Degree := 64;
s`Filename := "64S12-8,8,2-g9-path40.m";
...
s`PassportSize := 1;
s`PathNumber := 40;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path2", "32S9-8,4,2-g3-path4", "64S12-8,8,2-g9-path40" ];
