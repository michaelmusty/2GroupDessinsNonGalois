...
s`Degree := 64;
s`Filename := "64S46-8,4,16-g19-path1.m";
...
s`PassportSize := 2;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T8-4,4,4-g3-path14", "32S13-4,4,8-g7-path10", "64S46-8,4,16-g19-path1" ];
