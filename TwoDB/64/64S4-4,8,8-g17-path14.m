...
s`Degree := 64;
s`Filename := "64S4-4,8,8-g17-path14.m";
...
s`PassportSize := 1;
s`PathNumber := 14;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T6-4,8,8-g5-path4", "32S5-4,8,8-g9-path22", "64S4-4,8,8-g17-path14" ];
