...
s`Degree := 64;
s`Filename := "64S4-8,2,8-g9-path7.m";
...
s`PassportSize := 1;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,2,8-g3-path5", "32S5-8,2,8-g5-path16", "64S4-8,2,8-g9-path7" ];
