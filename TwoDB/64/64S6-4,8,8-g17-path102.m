...
s`Degree := 64;
s`Filename := "64S6-4,8,8-g17-path102.m";
...
s`PassportSize := 2;
s`PathNumber := 102;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path7", "32S9-2,8,4-g3-path9", "64S6-4,8,8-g17-path102" ];
