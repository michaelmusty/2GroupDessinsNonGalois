...
s`Degree := 64;
s`Filename := "64S4-8,2,8-g9-path2.m";
...
[ 15, 7, 37, 39, 32, 41, 2, 11, 24, 20, 8, 17, 30, 19, 1, 43, 12, 42, 14, 10, 40, 38, 25, 9, 23, 29, 35, 33, 26, 13, 44, 5, 28, 36, 27, 34, 3, 22, 4, 21, 6, 18, 16, 31, 52, 51, 50, 49, 48, 47, 46, 45, 54, 53, 56, 55, 58, 57, 60, 59, 62, 61, 64, 63 ],
[ 7, 11, 2, 1, 20, 15, 25, 29, 8, 33, 36, 3, 10, 37, 44, 4, 5, 39, 32, 35, 6, 41, 54, 23, 56, 58, 26, 53, 60, 9, 28, 24, 55, 62, 34, 64, 31, 12, 13, 17, 30, 14, 19, 27, 16, 43, 18, 42, 21, 40, 22, 38, 63, 61, 59, 57, 45, 49, 47, 51, 46, 50, 48, 52 ]
]
];
s`PassportName := "64S4-8,2,8-g9";
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S5-8,2,8-g5-path11", "64S4-8,2,8-g9-path2" ];
