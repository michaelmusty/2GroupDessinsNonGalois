...
s`Degree := 64;
s`Filename := "64S20-4,8,4-g13-path16.m";
...
s`PassportSize := 2;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path1", "32S11-4,8,2-g3-path3", "64S20-4,8,4-g13-path16" ];
