...
s`Degree := 64;
s`Filename := "64S49-8,8,16-g23-path9.m";
...
s`PassportSize := 2;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path18", "32S14-4,4,8-g7-path14", "64S49-8,8,16-g23-path9" ];
