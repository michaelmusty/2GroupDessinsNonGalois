...
s`Degree := 64;
s`Filename := "64S6-8,8,4-g17-path70.m";
...
s`PassportSize := 2;
s`PathNumber := 70;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S9-4,8,2-g3-path11", "64S6-8,8,4-g17-path70" ];
