...
s`Degree := 64;
s`Filename := "64S10-8,8,4-g17-path5.m";
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path3", "32S11-4,8,4-g7-path16", "64S10-8,8,4-g17-path5" ];
