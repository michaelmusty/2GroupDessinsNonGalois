...
{ IntegerRing() | 50, 64 }
@};
s`Child := "32S5-8,8,4-g9-path2";
s`Degree := 64;
s`Filename := "64S5-8,8,4-g17-path39.m";
...
s`PassportSize := 2;
s`PathNumber := 39;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S5-8,8,4-g9-path2", "64S5-8,8,4-g17-path39" ];
