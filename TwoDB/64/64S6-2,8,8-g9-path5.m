...
s`Degree := 64;
s`Filename := "64S6-2,8,8-g9-path5.m";
...
s`PassportSize := 2;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path1", "32S11-2,4,8-g3-path3", "64S6-2,8,8-g9-path5" ];
