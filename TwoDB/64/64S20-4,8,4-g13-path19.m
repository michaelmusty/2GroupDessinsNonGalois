...
s`Degree := 64;
s`Filename := "64S20-4,8,4-g13-path19.m";
...
s`PassportSize := 2;
s`PathNumber := 19;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S11-4,8,2-g3-path6", "64S20-4,8,4-g13-path19" ];
