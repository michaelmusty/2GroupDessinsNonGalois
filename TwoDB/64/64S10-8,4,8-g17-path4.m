...
{ IntegerRing() | 48, 59 }
@};
s`Child := "32S11-4,4,8-g7-path15";
s`Degree := 64;
s`Filename := "64S10-8,4,8-g17-path4.m";
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path2", "32S11-4,4,8-g7-path15", "64S10-8,4,8-g17-path4" ];
