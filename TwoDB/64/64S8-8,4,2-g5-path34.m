...
s`Degree := 64;
s`Filename := "64S8-8,4,2-g5-path34.m";
...
s`PassportSize := 1;
s`PathNumber := 34;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path2", "32S9-8,4,2-g3-path4", "64S8-8,4,2-g5-path34" ];
