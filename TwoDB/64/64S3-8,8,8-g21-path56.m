...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path56.m";
...
s`PassportSize := 3;
s`PathNumber := 56;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T4-4,4,4-g3-path1", "32S3-8,4,8-g9-path7", "64S3-8,8,8-g21-path56" ];
