...
s`Degree := 64;
s`Filename := "64S17-8,4,8-g17-path32.m";
...
[ 43, 21, 26, 61, 25, 44, 42, 16, 7, 6, 48, 4, 15, 23, 22, 49, 20, 28, 47, 60, 46, 53, 62, 50, 64, 55, 19, 45, 5, 24, 11, 8, 1, 30, 37, 17, 41, 12, 3, 14, 58, 63, 59, 51, 52, 54, 56, 57, 32, 34, 10, 18, 13, 2, 39, 27, 31, 35, 33, 36, 38, 40, 9, 29 ],
...
s`PassportSize := 1;
s`PathNumber := 32;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S12-8,4,8-g9-path39", "64S17-8,4,8-g17-path32" ];
