...
s`Degree := 64;
s`Filename := "64S8-4,8,4-g13-path3.m";
...
s`PassportSize := 2;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S11-4,8,4-g7-path12", "64S8-4,8,4-g13-path3" ];
