...
s`Degree := 64;
s`Filename := "64S13-8,4,8-g17-path81.m";
...
s`PassportSize := 2;
s`PathNumber := 81;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S9-8,2,4-g3-path17", "64S13-8,4,8-g17-path81" ];
