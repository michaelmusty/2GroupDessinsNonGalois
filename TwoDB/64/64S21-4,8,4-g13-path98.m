...
s`Degree := 64;
s`Filename := "64S21-4,8,4-g13-path98.m";
...
s`PassportSize := 1;
s`PathNumber := 98;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T4-4,4,4-g3-path13", "32S2-4,4,4-g5-path37", "64S21-4,8,4-g13-path98" ];
