...
s`Degree := 64;
s`Filename := "64S24-8,4,8-g17-path61.m";
...
s`PassportSize := 1;
s`PathNumber := 61;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S2-4,4,4-g5-path65", "64S24-8,4,8-g17-path61" ];
