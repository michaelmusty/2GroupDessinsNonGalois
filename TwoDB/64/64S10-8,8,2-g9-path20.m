...
s`Degree := 64;
s`Filename := "64S10-8,8,2-g9-path20.m";
...
s`PassportSize := 1;
s`PathNumber := 20;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S11-8,4,2-g3-path7", "64S10-8,8,2-g9-path20" ];
