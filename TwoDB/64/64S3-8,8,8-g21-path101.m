...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path101.m";
...
s`PassportSize := 3;
s`PathNumber := 101;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-2,8,8-g3-path1", "32S4-4,8,8-g9-path16", "64S3-8,8,8-g21-path101" ];
