...
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path15.m";
...
s`PassportSize := 1;
s`PathNumber := 15;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T6-8,8,4-g5-path4", "32S12-8,8,4-g9-path23", "64S17-8,8,4-g17-path15" ];
