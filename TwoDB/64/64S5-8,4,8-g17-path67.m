...
s`Degree := 64;
s`Filename := "64S5-8,4,8-g17-path67.m";
...
s`PassportSize := 2;
s`PathNumber := 67;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S6-4,4,4-g5-path21", "64S5-8,4,8-g17-path67" ];
