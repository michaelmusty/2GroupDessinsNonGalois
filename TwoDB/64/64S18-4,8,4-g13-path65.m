...
s`Degree := 64;
s`Filename := "64S18-4,8,4-g13-path65.m";
...
s`PassportSize := 1;
s`PathNumber := 65;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S2-4,4,4-g5-path69", "64S18-4,8,4-g13-path65" ];
