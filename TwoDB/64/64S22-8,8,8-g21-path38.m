...
{ IntegerRing() | 57, 63 }
@};
s`Child := "32S15-8,8,8-g11-path44";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path38.m";
...
s`PassportSize := 3;
s`PathNumber := 38;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path2", "32S15-8,8,8-g11-path44", "64S22-8,8,8-g21-path38" ];
