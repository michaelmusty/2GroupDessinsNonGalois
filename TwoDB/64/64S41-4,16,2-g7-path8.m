...
s`Degree := 64;
s`Filename := "64S41-4,16,2-g7-path8.m";
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T13-2,8,2-g0-path3", "32S9-4,8,2-g3-path17", "64S41-4,16,2-g7-path8" ];
