...
s`Degree := 64;
s`Filename := "64S19-8,8,8-g21-path60.m";
...
s`PassportSize := 1;
s`PathNumber := 60;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T8-4,4,4-g3-path24", "32S2-4,4,4-g5-path64", "64S19-8,8,8-g21-path60" ];
