...
{ IntegerRing() | 62, 63 }
@};
s`Child := "32S11-2,8,4-g3-path9";
s`Degree := 64;
s`Filename := "64S10-2,8,8-g9-path22.m";
...
\[ 4, 9, 15, 19, 11, 22, 1, 27, 30, 6, 25, 2, 5, 8, 42, 36, 3, 33, 13, 48, 31, 12, 53, 56, 7, 10, 55, 45, 23, 26, 49, 20, 54, 52, 47, 44, 16, 35, 28, 14, 29, 37, 51, 17, 40, 18, 63, 46, 41, 21, 58, 64, 50, 59, 39, 62, 24, 61, 32, 34, 60, 38, 57, 43 ]:
 Order := 64 > |
[ 2, 1, 13, 18, 10, 21, 16, 26, 29, 5, 32, 28, 3, 37, 41, 7, 39, 4, 24, 23, 6, 51, 20, 19, 35, 8, 46, 12, 9, 34, 33, 11, 31, 30, 25, 50, 14, 55, 17, 57, 15, 43, 42, 60, 59, 27, 49, 58, 47, 36, 22, 54, 56, 52, 38, 53, 40, 48, 45, 44, 63, 64, 61, 62 ],
[ 3, 8, 14, 10, 16, 1, 24, 17, 5, 28, 2, 34, 35, 38, 7, 39, 43, 45, 32, 4, 15, 29, 6, 55, 18, 51, 12, 37, 36, 21, 9, 27, 11, 42, 40, 13, 60, 61, 57, 46, 56, 50, 63, 41, 26, 52, 19, 31, 20, 47, 44, 22, 33, 23, 59, 25, 64, 30, 58, 62, 54, 49, 53, 48 ],
[ 11, 6, 36, 25, 4, 30, 5, 45, 22, 9, 19, 10, 1, 28, 44, 15, 16, 20, 7, 54, 23, 26, 49, 47, 13, 2, 40, 27, 31, 12, 53, 33, 48, 58, 56, 42, 3, 24, 8, 39, 21, 17, 34, 37, 55, 32, 62, 59, 50, 29, 52, 61, 41, 46, 14, 63, 35, 64, 18, 51, 43, 57, 38, 60 ]
]
];
s`PassportName := "64S10-2,8,8-g9";
s`PassportSize := 1;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-2,4,4-g1-path7", "32S11-2,8,4-g3-path9", "64S10-2,8,8-g9-path22" ];
