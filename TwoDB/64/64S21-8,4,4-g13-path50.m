...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path50.m";
...
s`PassportSize := 1;
s`PathNumber := 50;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S13-8,4,4-g7-path8", "64S21-8,4,4-g13-path50" ];
