...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path273.m";
...
s`PassportSize := 3;
s`PathNumber := 273;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S6-4,4,2-g1-path6", "64S23-4,4,4-g9-path273" ];
