...
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path42.m";
...
s`PassportSize := 1;
s`PathNumber := 42;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path5", "32S12-8,8,4-g9-path5", "64S17-8,8,4-g17-path42" ];
