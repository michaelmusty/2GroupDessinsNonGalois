...
{ IntegerRing() | 60, 63 }
@};
s`Child := "32S5-8,2,8-g5-path23";
s`Degree := 64;
s`Filename := "64S4-8,2,8-g9-path15.m";
...
s`PassportSize := 1;
s`PathNumber := 15;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,2,8-g3-path5", "32S5-8,2,8-g5-path23", "64S4-8,2,8-g9-path15" ];
