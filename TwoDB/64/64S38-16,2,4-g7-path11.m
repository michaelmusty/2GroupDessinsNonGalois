...
s`Degree := 64;
s`Filename := "64S38-16,2,4-g7-path11.m";
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T12-8,2,4-g2-path3", "32S9-8,2,4-g3-path14", "64S38-16,2,4-g7-path11" ];
