...
s`Degree := 64;
s`Filename := "64S19-8,8,8-g21-path63.m";
...
s`PassportSize := 1;
s`PathNumber := 63;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path27", "32S2-4,4,4-g5-path67", "64S19-8,8,8-g21-path63" ];
