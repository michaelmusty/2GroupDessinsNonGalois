...
s`Degree := 64;
s`Filename := "64S2-8,8,8-g21-path6.m";
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9", "32S3-4,8,8-g9-path15", "64S2-8,8,8-g21-path6" ];
