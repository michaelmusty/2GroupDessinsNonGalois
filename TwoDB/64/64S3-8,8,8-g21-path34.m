...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path34.m";
...
s`PassportSize := 3;
s`PathNumber := 34;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T4-4,4,4-g3-path8", "32S3-8,4,8-g9-path14", "64S3-8,8,8-g21-path34" ];
