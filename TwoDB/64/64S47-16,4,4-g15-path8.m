...
s`Degree := 64;
s`Filename := "64S47-16,4,4-g15-path8.m";
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path5", "32S14-8,4,4-g7-path17", "64S47-16,4,4-g15-path8" ];
