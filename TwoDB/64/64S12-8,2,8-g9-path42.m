...
s`Degree := 64;
s`Filename := "64S12-8,2,8-g9-path42.m";
...
[ 15, 7, 32, 31, 36, 40, 2, 11, 49, 19, 8, 17, 27, 24, 1, 38, 12, 53, 10, 23, 51, 52, 20, 14, 61, 30, 13, 46, 43, 26, 4, 3, 45, 37, 64, 5, 34, 16, 63, 6, 48, 56, 29, 54, 33, 28, 59, 41, 9, 58, 21, 22, 18, 44, 62, 42, 60, 50, 47, 57, 25, 55, 39, 35 ],
[ 7, 11, 2, 1, 19, 15, 23, 14, 8, 30, 31, 3, 10, 32, 37, 4, 5, 36, 16, 6, 40, 20, 17, 29, 24, 33, 9, 26, 49, 12, 13, 28, 27, 21, 34, 22, 38, 18, 53, 42, 51, 52, 48, 43, 50, 25, 45, 61, 47, 46, 54, 39, 35, 64, 63, 41, 56, 62, 44, 58, 60, 59, 57, 55 ]
]
];
s`PassportName := "64S12-8,2,8-g9";
s`PassportSize := 1;
s`PathNumber := 42;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S9-8,2,4-g3-path6", "64S12-8,2,8-g9-path42" ];
