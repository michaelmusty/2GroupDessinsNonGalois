...
s`Degree := 64;
s`Filename := "64S5-8,4,8-g17-path30.m";
...
s`PassportSize := 2;
s`PathNumber := 30;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5", "32S5-8,4,8-g9-path16", "64S5-8,4,8-g17-path30" ];
