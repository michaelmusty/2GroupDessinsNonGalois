...
s`Degree := 64;
s`Filename := "64S17-4,8,8-g17-path2.m";
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-4,8,8-g5-path4", "32S12-4,8,8-g9-path11", "64S17-4,8,8-g17-path2" ];
