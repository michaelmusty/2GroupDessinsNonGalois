...
s`Degree := 64;
s`Filename := "64S21-4,8,4-g13-path48.m";
...
s`PassportSize := 1;
s`PathNumber := 48;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T12-4,8,2-g2-path3", "32S13-4,8,4-g7-path6", "64S21-4,8,4-g13-path48" ];
