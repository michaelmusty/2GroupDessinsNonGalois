...
{ IntegerRing() | 61, 64 }
@};
s`Child := "32S11-4,2,8-g3-path5";
s`Degree := 64;
s`Filename := "64S10-8,2,8-g9-path7.m";
...
[ 58, 45, 55, 56, 30, 32, 63, 44, 36, 41, 52, 39, 48, 57, 17, 64, 15, 23, 34, 22, 37, 20, 18, 26, 43, 24, 54, 53, 62, 5, 33, 6, 31, 19, 46, 9, 21, 59, 12, 51, 10, 61, 25, 8, 2, 35, 49, 13, 47, 60, 40, 11, 28, 27, 3, 4, 14, 1, 38, 50, 42, 29, 7, 16 ],
[ 52, 20, 63, 61, 45, 30, 46, 32, 39, 48, 44, 14, 18, 62, 41, 47, 58, 33, 64, 34, 54, 15, 6, 43, 19, 53, 29, 31, 40, 24, 59, 55, 1, 3, 17, 21, 4, 49, 50, 22, 26, 51, 60, 56, 37, 57, 35, 12, 8, 38, 23, 25, 27, 16, 9, 10, 5, 36, 2, 42, 7, 11, 28, 13 ]
]
];
s`PassportName := "64S10-8,2,8-g9";
s`PassportSize := 1;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S11-4,2,8-g3-path5", "64S10-8,2,8-g9-path7" ];
