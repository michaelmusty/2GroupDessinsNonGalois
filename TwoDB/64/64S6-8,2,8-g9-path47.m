...
s`Degree := 64;
s`Filename := "64S6-8,2,8-g9-path47.m";
...
s`PassportSize := 2;
s`PathNumber := 47;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T6-8,2,8-g3-path3", "32S5-8,2,8-g5-path21", "64S6-8,2,8-g9-path47" ];
