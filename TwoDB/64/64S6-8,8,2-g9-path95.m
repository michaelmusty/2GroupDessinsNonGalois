...
s`Degree := 64;
s`Filename := "64S6-8,8,2-g9-path95.m";
...
s`PassportSize := 2;
s`PathNumber := 95;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S9-8,4,2-g3-path2", "64S6-8,8,2-g9-path95" ];
