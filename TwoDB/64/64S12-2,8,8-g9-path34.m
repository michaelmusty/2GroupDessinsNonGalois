...
s`Degree := 64;
s`Filename := "64S12-2,8,8-g9-path34.m";
...
s`PassportSize := 1;
s`PathNumber := 34;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T13-2,8,2-g0-path1", "32S9-2,8,4-g3-path15", "64S12-2,8,8-g9-path34" ];
