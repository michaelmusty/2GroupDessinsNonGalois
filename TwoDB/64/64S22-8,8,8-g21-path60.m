...
{ IntegerRing() | 52, 60 }
@};
s`Child := "32S15-8,8,8-g11-path64";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path60.m";
...
[ 7, 13, 1, 26, 11, 24, 34, 37, 40, 2, 47, 39, 51, 52, 54, 3, 27, 5, 58, 31, 49, 4, 62, 56, 9, 33, 6, 60, 14, 16, 53, 57, 45, 21, 23, 8, 10, 28, 20, 63, 12, 55, 48, 36, 19, 32, 50, 38, 30, 64, 44, 25, 15, 41, 18, 46, 17, 61, 29, 35, 22, 43, 59, 42 ]
]
];
s`PassportName := "64S22-8,8,8-g21";
s`PassportSize := 3;
s`PathNumber := 60;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S15-8,8,8-g11-path64", "64S22-8,8,8-g21-path60" ];
