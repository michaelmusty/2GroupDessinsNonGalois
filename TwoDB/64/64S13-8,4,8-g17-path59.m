...
{ IntegerRing() | 62, 63 }
@};
s`Child := "32S9-4,2,8-g3-path12";
s`Degree := 64;
s`Filename := "64S13-8,4,8-g17-path59.m";
...
s`PassportSize := 2;
s`PathNumber := 59;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T12-4,2,8-g2-path1", "32S9-4,2,8-g3-path12", "64S13-8,4,8-g17-path59" ];
