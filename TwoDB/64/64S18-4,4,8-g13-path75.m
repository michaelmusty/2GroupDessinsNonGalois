...
s`Degree := 64;
s`Filename := "64S18-4,4,8-g13-path75.m";
...
s`PassportSize := 1;
s`PathNumber := 75;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S2-4,4,4-g5-path78", "64S18-4,4,8-g13-path75" ];
