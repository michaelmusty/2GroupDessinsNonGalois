...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path151.m";
...
s`PassportSize := 3;
s`PathNumber := 151;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T6-8,2,8-g3-path1", "32S4-8,4,8-g9-path16", "64S3-8,8,8-g21-path151" ];
