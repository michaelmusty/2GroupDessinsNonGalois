...
s`Degree := 64;
s`Filename := "64S14-8,4,8-g17-path43.m";
...
s`PassportSize := 1;
s`PathNumber := 43;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S7-8,2,8-g5-path7", "64S14-8,4,8-g17-path43" ];
...
[ 16, 36, 18, 47, 26, 21, 6, 35, 48, 5, 38, 1, 46, 37, 34, 30, 25, 13, 12, 23, 49, 62, 14, 15, 32, 41, 52, 3, 7, 45, 43, 11, 60, 2, 56, 40, 58, 50, 10, 22, 54, 4, 28, 20, 63, 61, 8, 42, 64, 27, 39, 17, 19, 57, 29, 9, 51, 33, 55, 44, 31, 24, 53, 59 ]
]
];
