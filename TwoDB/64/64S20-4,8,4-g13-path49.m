...
s`Degree := 64;
s`Filename := "64S20-4,8,4-g13-path49.m";
...
s`PassportSize := 2;
s`PathNumber := 49;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S2-4,4,4-g5-path12", "64S20-4,8,4-g13-path49" ];
