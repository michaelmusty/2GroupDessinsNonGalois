...
s`Degree := 64;
s`Filename := "64S10-8,2,8-g9-path14.m";
...
s`PassportSize := 1;
s`PathNumber := 14;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-8,2,4-g3-path1", "64S10-8,2,8-g9-path14" ];
...
[ 13, 30, 2, 5, 7, 41, 18, 53, 8, 11, 12, 32, 25, 10, 56, 49, 16, 19, 1, 57, 17, 33, 26, 23, 4, 55, 28, 29, 40, 14, 27, 3, 38, 58, 34, 54, 36, 51, 61, 9, 42, 21, 6, 15, 60, 45, 46, 22, 43, 39, 44, 20, 31, 59, 37, 48, 64, 50, 24, 52, 62, 63, 35, 47 ]
]
];
