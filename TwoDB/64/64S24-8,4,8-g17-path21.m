...
s`Degree := 64;
s`Filename := "64S24-8,4,8-g17-path21.m";
...
[ 31, 22, 2, 14, 63, 19, 18, 54, 33, 9, 52, 43, 53, 8, 7, 11, 51, 13, 59, 27, 50, 49, 30, 47, 56, 48, 1, 23, 64, 58, 37, 3, 57, 6, 34, 28, 62, 24, 60, 12, 29, 36, 17, 61, 15, 10, 35, 4, 16, 26, 44, 32, 25, 21, 40, 45, 41, 39, 38, 42, 55, 5, 20, 46 ]
]
];
s`PassportName := "64S24-8,4,8-g17";
s`PassportSize := 1;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S2-4,4,4-g5-path29", "64S24-8,4,8-g17-path21" ];
