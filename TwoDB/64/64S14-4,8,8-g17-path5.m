...
{ IntegerRing() | 56, 64 }
@};
s`Child := "32S10-4,4,8-g7-path27";
s`Degree := 64;
s`Filename := "64S14-4,8,8-g17-path5.m";
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-4,2,8-g2-path2", "32S10-4,4,8-g7-path27", "64S14-4,8,8-g17-path5" ];
