...
s`Degree := 64;
s`Filename := "64S10-2,8,8-g9-path21.m";
...
s`PassportSize := 1;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S11-2,8,4-g3-path8", "64S10-2,8,8-g9-path21" ];
