...
s`Degree := 64;
s`Filename := "64S39-16,4,4-g15-path2.m";
...
s`PassportSize := 2;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T13-8,2,2-g0-path2", "32S19-16,2,4-g4-path2", "64S39-16,4,4-g15-path2" ];
