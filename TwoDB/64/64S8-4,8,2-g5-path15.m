...
{ IntegerRing() | 58, 64 }
@};
s`Child := "32S6-4,4,2-g1-path2";
s`Degree := 64;
s`Filename := "64S8-4,8,2-g5-path15.m";
...
s`PassportSize := 1;
s`PathNumber := 15;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S6-4,4,2-g1-path2", "64S8-4,8,2-g5-path15" ];
