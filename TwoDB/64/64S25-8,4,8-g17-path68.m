...
{ IntegerRing() | 51, 58 }
@};
s`Child := "32S2-4,4,4-g5-path40";
s`Degree := 64;
s`Filename := "64S25-8,4,8-g17-path68.m";
...
s`PassportSize := 2;
s`PathNumber := 68;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T4-4,4,4-g3-path1", "32S2-4,4,4-g5-path40", "64S25-8,4,8-g17-path68" ];
