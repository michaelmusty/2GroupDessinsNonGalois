...
{ IntegerRing() | 61, 64 }
@};
s`Child := "32S11-4,2,8-g3-path10";
s`Degree := 64;
s`Filename := "64S10-8,2,8-g9-path1.m";
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S11-4,2,8-g3-path10", "64S10-8,2,8-g9-path1" ];
...
[ 59, 49, 64, 54, 62, 33, 51, 35, 63, 61, 40, 18, 47, 50, 34, 29, 57, 12, 60, 37, 39, 23, 22, 45, 44, 48, 31, 46, 16, 55, 27, 56, 6, 15, 8, 52, 20, 42, 21, 11, 58, 38, 53, 25, 24, 28, 13, 26, 2, 14, 7, 36, 43, 4, 30, 32, 17, 41, 1, 19, 10, 5, 9, 3 ],
[ 45, 44, 48, 64, 52, 58, 18, 15, 53, 63, 20, 31, 46, 59, 55, 51, 30, 57, 61, 56, 60, 32, 17, 21, 4, 39, 38, 14, 49, 36, 62, 41, 5, 10, 6, 43, 19, 40, 27, 8, 9, 47, 54, 34, 25, 33, 23, 28, 22, 29, 35, 37, 50, 42, 26, 3, 1, 24, 11, 16, 13, 2, 12, 7 ]
]
];
