...
s`Degree := 64;
s`Filename := "64S4-8,8,4-g17-path23.m";
...
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-4,4,2-g1-path7", "32S5-8,8,4-g9-path9", "64S4-8,8,4-g17-path23" ];
