...
{ IntegerRing() | 52, 59 }
@};
s`Child := "32S10-8,4,4-g7-path34";
s`Degree := 64;
s`Filename := "64S14-8,8,4-g17-path34.m";
...
s`PassportSize := 1;
s`PathNumber := 34;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T14-8,4,4-g4-path3", "32S10-8,4,4-g7-path34", "64S14-8,8,4-g17-path34" ];
