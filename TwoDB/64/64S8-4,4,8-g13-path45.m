...
s`Degree := 64;
s`Filename := "64S8-4,4,8-g13-path45.m";
...
s`PassportSize := 2;
s`PathNumber := 45;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path8", "32S9-2,4,8-g3-path10", "64S8-4,4,8-g13-path45" ];
