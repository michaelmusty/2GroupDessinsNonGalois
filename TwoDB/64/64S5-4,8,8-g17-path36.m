...
s`Degree := 64;
s`Filename := "64S5-4,8,8-g17-path36.m";
...
s`PassportSize := 2;
s`PathNumber := 36;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-4,8,8-g5-path3", "32S5-4,8,8-g9-path21", "64S5-4,8,8-g17-path36" ];
