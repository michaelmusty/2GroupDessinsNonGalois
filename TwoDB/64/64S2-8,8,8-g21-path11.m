...
s`Degree := 64;
s`Filename := "64S2-8,8,8-g21-path11.m";
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T4-4,4,4-g3-path10", "32S3-4,8,8-g9-path1", "64S2-8,8,8-g21-path11" ];
