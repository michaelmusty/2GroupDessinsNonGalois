...
s`Degree := 64;
s`Filename := "64S17-8,4,8-g17-path59.m";
...
s`PassportSize := 1;
s`PathNumber := 59;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S2-4,4,4-g5-path21", "64S17-8,4,8-g17-path59" ];
...
[ 43, 28, 62, 63, 12, 25, 56, 29, 4, 52, 38, 20, 6, 41, 55, 36, 5, 54, 53, 39, 46, 57, 16, 7, 35, 9, 64, 49, 21, 11, 58, 59, 50, 15, 44, 22, 17, 32, 1, 60, 48, 27, 37, 24, 23, 26, 40, 33, 30, 10, 19, 61, 34, 51, 18, 13, 3, 47, 2, 42, 14, 45, 8, 31 ]
]
];
