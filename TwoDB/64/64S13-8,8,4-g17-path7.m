...
s`Degree := 64;
s`Filename := "64S13-8,8,4-g17-path7.m";
...
s`PassportSize := 2;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T10-4,4,2-g1-path5", "32S10-4,8,4-g7-path18", "64S13-8,8,4-g17-path7" ];
