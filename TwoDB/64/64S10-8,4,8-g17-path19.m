...
{ IntegerRing() | 49, 64 }
@};
s`Child := "32S11-8,4,4-g7-path6";
s`Degree := 64;
s`Filename := "64S10-8,4,8-g17-path19.m";
...
s`PassportSize := 1;
s`PathNumber := 19;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S11-8,4,4-g7-path6", "64S10-8,4,8-g17-path19" ];
...
[ 29, 8, 59, 31, 62, 19, 55, 41, 14, 34, 48, 15, 33, 61, 20, 21, 4, 42, 54, 30, 1, 56, 63, 45, 39, 58, 35, 47, 16, 12, 53, 6, 10, 13, 38, 51, 40, 49, 22, 28, 44, 11, 52, 2, 26, 60, 37, 18, 27, 23, 43, 36, 17, 32, 3, 25, 9, 24, 7, 5, 57, 46, 64, 50 ],
