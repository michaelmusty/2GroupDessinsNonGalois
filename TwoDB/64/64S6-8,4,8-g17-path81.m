...
s`Degree := 64;
s`Filename := "64S6-8,4,8-g17-path81.m";
...
s`PassportSize := 2;
s`PathNumber := 81;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S9-4,2,8-g3-path5", "64S6-8,4,8-g17-path81" ];
