...
s`Degree := 64;
s`Filename := "64S25-8,8,4-g17-path75.m";
...
s`PassportSize := 2;
s`PathNumber := 75;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T4-4,4,4-g3-path5", "32S2-4,4,4-g5-path44", "64S25-8,8,4-g17-path75" ];
