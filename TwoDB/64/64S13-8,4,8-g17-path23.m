...
s`Degree := 64;
s`Filename := "64S13-8,4,8-g17-path23.m";
...
s`PassportSize := 2;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T12-8,4,2-g2-path3", "32S10-8,4,4-g7-path28", "64S13-8,4,8-g17-path23" ];
