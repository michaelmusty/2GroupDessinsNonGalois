...
s`Degree := 64;
s`Filename := "64S4-8,2,8-g9-path43.m";
...
s`PassportSize := 1;
s`PathNumber := 43;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S7-8,2,8-g5-path7", "64S4-8,2,8-g9-path43" ];
...
[ 9, 27, 24, 35, 31, 3, 46, 53, 33, 39, 19, 15, 47, 1, 62, 48, 58, 6, 13, 22, 43, 4, 34, 52, 29, 61, 37, 60, 5, 7, 16, 2, 51, 56, 57, 55, 41, 14, 12, 25, 50, 11, 32, 28, 18, 17, 36, 64, 38, 21, 54, 26, 59, 49, 63, 10, 8, 44, 20, 30, 45, 23, 42, 40 ]
]
];
