...
s`Degree := 64;
s`Filename := "64S8-8,4,4-g13-path24.m";
...
s`PassportSize := 2;
s`PathNumber := 24;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S6-4,4,4-g5-path13", "64S8-8,4,4-g13-path24" ];
