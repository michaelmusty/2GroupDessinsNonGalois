...
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path16.m";
...
s`PassportSize := 1;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T6-8,8,4-g5-path5", "32S12-8,8,4-g9-path24", "64S17-8,8,4-g17-path16" ];
