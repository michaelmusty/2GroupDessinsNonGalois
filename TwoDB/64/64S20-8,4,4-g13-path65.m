...
s`Degree := 64;
s`Filename := "64S20-8,4,4-g13-path65.m";
...
s`PassportSize := 2;
s`PathNumber := 65;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path10", "32S2-4,4,4-g5-path1", "64S20-8,4,4-g13-path65" ];
