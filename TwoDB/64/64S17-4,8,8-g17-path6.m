...
s`Degree := 64;
s`Filename := "64S17-4,8,8-g17-path6.m";
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-2,8,8-g3-path1", "32S12-4,8,8-g9-path15", "64S17-4,8,8-g17-path6" ];
