...
s`Degree := 64;
s`Filename := "64S18-4,8,4-g13-path74.m";
...
s`PassportSize := 1;
s`PathNumber := 74;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path5", "32S2-4,4,4-g5-path77", "64S18-4,8,4-g13-path74" ];
