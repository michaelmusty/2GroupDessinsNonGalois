...
s`Degree := 64;
s`Filename := "64S3-8,8,8-g21-path20.m";
...
s`PassportSize := 3;
s`PathNumber := 20;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-4,8,8-g5-path6", "32S3-4,8,8-g9-path28", "64S3-8,8,8-g21-path20" ];
