...
s`Degree := 64;
s`Filename := "64S10-8,8,2-g9-path24.m";
...
s`PassportSize := 1;
s`PathNumber := 24;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S7-8,8,2-g5-path11", "64S10-8,8,2-g9-path24" ];
