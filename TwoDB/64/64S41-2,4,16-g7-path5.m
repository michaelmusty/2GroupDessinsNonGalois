...
s`Degree := 64;
s`Filename := "64S41-2,4,16-g7-path5.m";
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T12-2,4,8-g2-path3", "32S9-2,4,8-g3-path14", "64S41-2,4,16-g7-path5" ];
