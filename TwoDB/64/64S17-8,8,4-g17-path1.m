...
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path1.m";
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,4-g5-path3", "32S12-8,8,4-g9-path10", "64S17-8,8,4-g17-path1" ];
