...
s`Degree := 64;
s`Filename := "64S8-8,4,2-g5-path8.m";
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4", "32S11-8,4,2-g3-path6", "64S8-8,4,2-g5-path8" ];
