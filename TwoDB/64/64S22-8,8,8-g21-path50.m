...
{ IntegerRing() | 61, 63 }
@};
s`Child := "32S15-8,8,8-g11-path55";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path50.m";
...
s`PassportSize := 3;
s`PathNumber := 50;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T8-4,4,4-g3-path4", "32S15-8,8,8-g11-path55", "64S22-8,8,8-g21-path50" ];
