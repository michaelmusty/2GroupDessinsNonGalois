...
s`Degree := 64;
s`Filename := "64S23-4,4,4-g9-path308.m";
...
s`PassportSize := 3;
s`PathNumber := 308;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S6-4,4,4-g5-path8", "64S23-4,4,4-g9-path308" ];
