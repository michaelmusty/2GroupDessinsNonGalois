...
{ IntegerRing() | 63, 64 }
@};
s`Child := "32S14-4,8,4-g7-path16";
s`Degree := 64;
s`Filename := "64S48-4,16,4-g15-path7.m";
...
s`PassportSize := 1;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T8-4,4,4-g3-path8", "32S14-4,8,4-g7-path16", "64S48-4,16,4-g15-path7" ];
