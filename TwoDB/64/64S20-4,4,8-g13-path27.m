...
s`Degree := 64;
s`Filename := "64S20-4,4,8-g13-path27.m";
...
s`PassportSize := 2;
s`PathNumber := 27;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S11-4,4,8-g7-path14", "64S20-4,4,8-g13-path27" ];
