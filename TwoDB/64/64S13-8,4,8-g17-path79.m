...
s`Degree := 64;
s`Filename := "64S13-8,4,8-g17-path79.m";
...
s`PassportSize := 2;
s`PathNumber := 79;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S9-8,2,4-g3-path15", "64S13-8,4,8-g17-path79" ];
