...
{ IntegerRing() | 61, 63 }
@};
s`Child := "32S15-8,8,8-g11-path21";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path13.m";
...
s`PassportSize := 3;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T8-4,4,4-g3-path1", "32S15-8,8,8-g11-path21", "64S22-8,8,8-g21-path13" ];
