...
s`Degree := 64;
s`Filename := "64S21-8,4,4-g13-path82.m";
...
s`PassportSize := 1;
s`PathNumber := 82;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S2-4,4,4-g5-path22", "64S21-8,4,4-g13-path82" ];
