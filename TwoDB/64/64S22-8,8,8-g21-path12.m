...
{ IntegerRing() | 52, 60 }
@};
s`Child := "32S15-8,8,8-g11-path20";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path12.m";
...
s`PassportSize := 3;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path19", "32S15-8,8,8-g11-path20", "64S22-8,8,8-g21-path12" ];
