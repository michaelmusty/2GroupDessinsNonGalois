...
{ IntegerRing() | 52, 63 }
@};
s`Child := "32S15-8,8,8-g11-path18";
s`Degree := 64;
s`Filename := "64S22-8,8,8-g21-path9.m";
...
s`PassportSize := 3;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path18", "32S15-8,8,8-g11-path18", "64S22-8,8,8-g21-path9" ];
