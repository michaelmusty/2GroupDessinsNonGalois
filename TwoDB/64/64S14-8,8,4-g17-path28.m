...
{ IntegerRing() | 52, 59 }
@};
s`Child := "32S10-8,4,4-g7-path22";
s`Degree := 64;
s`Filename := "64S14-8,8,4-g17-path28.m";
...
s`PassportSize := 1;
s`PathNumber := 28;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S10-8,4,4-g7-path22", "64S14-8,8,4-g17-path28" ];
