...
s`Degree := 64;
s`Filename := "64S46-8,16,4-g19-path9.m";
...
s`PassportSize := 2;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S13-4,8,4-g7-path14", "64S46-8,16,4-g19-path9" ];
