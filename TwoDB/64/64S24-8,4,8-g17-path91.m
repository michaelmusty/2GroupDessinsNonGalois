...
{ IntegerRing() | 61, 63 }
@};
s`Child := "32S7-8,2,8-g5-path8";
s`Degree := 64;
s`Filename := "64S24-8,4,8-g17-path91.m";
...
s`PassportSize := 1;
s`PathNumber := 91;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S7-8,2,8-g5-path8", "64S24-8,4,8-g17-path91" ];
...
[ 60, 55, 62, 64, 48, 36, 52, 39, 51, 47, 43, 23, 25, 19, 63, 35, 29, 38, 59, 57, 15, 58, 16, 28, 61, 37, 31, 32, 34, 20, 17, 18, 53, 6, 54, 49, 45, 46, 56, 7, 4, 12, 50, 10, 33, 22, 26, 41, 27, 3, 42, 21, 44, 9, 40, 5, 14, 24, 1, 30, 11, 13, 2, 8 ]
]
];
