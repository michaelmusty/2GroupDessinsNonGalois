...
s`Degree := 64;
s`Filename := "64S8-8,4,2-g5-path29.m";
...
s`PassportSize := 1;
s`PathNumber := 29;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T13-8,2,2-g0-path2", "32S9-8,4,2-g3-path16", "64S8-8,4,2-g5-path29" ];
