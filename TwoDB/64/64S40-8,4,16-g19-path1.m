...
s`Degree := 64;
s`Filename := "64S40-8,4,16-g19-path1.m";
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S9-4,2,8-g3-path10", "64S40-8,4,16-g19-path1" ];
