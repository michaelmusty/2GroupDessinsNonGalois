...
s`Degree := 64;
s`Filename := "64S21-4,4,8-g13-path85.m";
...
s`PassportSize := 1;
s`PathNumber := 85;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path1", "32S2-4,4,4-g5-path25", "64S21-4,4,8-g13-path85" ];
