...
s`Degree := 64;
s`Filename := "64S8-8,4,4-g13-path17.m";
...
s`PassportSize := 2;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path2", "32S11-8,4,4-g7-path4", "64S8-8,4,4-g13-path17" ];
