...
s`Degree := 64;
s`Filename := "64S41-16,2,4-g7-path11.m";
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S9-8,2,4-g3-path3", "64S41-16,2,4-g7-path11" ];
