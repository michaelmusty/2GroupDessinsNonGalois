...
{ IntegerRing() | 49, 62 }
@};
s`Child := "32S10-4,8,4-g7-path32";
s`Degree := 64;
s`Filename := "64S14-8,8,4-g17-path16.m";
...
s`PassportSize := 1;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T14-4,8,4-g4-path2", "32S10-4,8,4-g7-path32", "64S14-8,8,4-g17-path16" ];
