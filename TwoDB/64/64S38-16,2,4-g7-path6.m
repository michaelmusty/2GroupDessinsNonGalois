...
{ IntegerRing() | 56, 64 }
@};
s`Child := "32S19-16,2,4-g4-path3";
s`Degree := 64;
s`Filename := "64S38-16,2,4-g7-path6.m";
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S19-16,2,4-g4-path3", "64S38-16,2,4-g7-path6" ];
