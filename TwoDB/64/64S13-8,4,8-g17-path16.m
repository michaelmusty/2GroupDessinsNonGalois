...
s`Degree := 64;
s`Filename := "64S13-8,4,8-g17-path16.m";
...
s`PassportSize := 2;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T14-4,4,8-g4-path2", "32S10-4,4,8-g7-path31", "64S13-8,4,8-g17-path16" ];
