...
s`Degree := 64;
s`Filename := "64S6-8,2,8-g9-path9.m";
...
s`PassportSize := 2;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S11-4,2,8-g3-path7", "64S6-8,2,8-g9-path9" ];
