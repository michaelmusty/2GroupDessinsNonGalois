...
s`Degree := 64;
s`Filename := "64S20-4,8,4-g13-path6.m";
...
s`PassportSize := 2;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S11-2,8,4-g3-path4", "64S20-4,8,4-g13-path6" ];
