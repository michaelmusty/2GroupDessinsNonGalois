...
s`Degree := 64;
s`Filename := "64S2-8,8,8-g21-path86.m";
...
s`PassportSize := 1;
s`PathNumber := 86;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T4-4,4,4-g3-path2", "32S3-8,8,4-g9-path8", "64S2-8,8,8-g21-path86" ];
