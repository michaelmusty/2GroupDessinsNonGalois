...
s`Degree := 64;
s`Filename := "64S8-4,8,2-g5-path7.m";
...
s`PassportSize := 1;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path3", "32S11-4,8,2-g3-path5", "64S8-4,8,2-g5-path7" ];
