...
s`Degree := 64;
s`Filename := "64S13-8,8,4-g17-path45.m";
...
s`PassportSize := 2;
s`PathNumber := 45;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T10-4,4,2-g1-path2", "32S8-8,8,4-g9-path4", "64S13-8,8,4-g17-path45" ];
