...
s`Degree := 64;
s`Filename := "64S17-8,8,4-g17-path61.m";
...
s`PassportSize := 1;
s`PathNumber := 61;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S2-4,4,4-g5-path23", "64S17-8,8,4-g17-path61" ];
