...
s`Degree := 64;
s`Filename := "64S13-8,8,4-g17-path40.m";
...
s`PassportSize := 2;
s`PathNumber := 40;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S8-8,8,4-g9-path1", "64S13-8,8,4-g17-path40" ];
