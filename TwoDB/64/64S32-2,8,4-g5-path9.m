...
s`Degree := 64;
s`Filename := "64S32-2,8,4-g5-path9.m";
...
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path5", "32S6-2,4,4-g1-path7", "64S32-2,8,4-g5-path9" ];
