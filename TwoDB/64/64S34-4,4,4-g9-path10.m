...
s`Degree := 64;
s`Filename := "64S34-4,4,4-g9-path10.m";
...
s`PassportSize := 3;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S6-4,4,4-g5-path19", "64S34-4,4,4-g9-path10" ];
...
[ 7, 13, 1, 25, 11, 24, 16, 33, 37, 2, 46, 35, 20, 51, 53, 3, 31, 5, 58, 10, 40, 4, 57, 61, 62, 6, 59, 48, 32, 19, 45, 8, 29, 9, 54, 27, 43, 30, 23, 49, 12, 60, 34, 52, 56, 18, 50, 42, 55, 14, 47, 15, 44, 41, 21, 17, 64, 38, 63, 28, 26, 22, 36, 39 ]
]
];
