...
s`Degree := 64;
s`Filename := "64S6-8,2,8-g9-path92.m";
...
s`PassportSize := 2;
s`PathNumber := 92;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T13-8,2,2-g0-path2", "32S9-8,2,4-g3-path16", "64S6-8,2,8-g9-path92" ];
