...
{ IntegerRing() | 56, 64 }
@};
s`Child := "32S19-2,4,16-g4-path1";
s`Degree := 64;
s`Filename := "64S38-2,4,16-g7-path4.m";
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T13-2,2,8-g0-path1", "32S19-2,4,16-g4-path1", "64S38-2,4,16-g7-path4" ];
