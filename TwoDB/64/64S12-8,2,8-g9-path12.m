...
s`Degree := 64;
s`Filename := "64S12-8,2,8-g9-path12.m";
...
[ 52, 42, 59, 49, 58, 56, 29, 46, 61, 55, 30, 36, 63, 43, 23, 40, 62, 48, 45, 53, 60, 51, 15, 64, 31, 57, 39, 41, 7, 11, 25, 54, 35, 50, 33, 12, 47, 44, 27, 16, 28, 2, 14, 38, 19, 8, 37, 18, 4, 34, 22, 1, 20, 32, 10, 6, 26, 5, 3, 21, 9, 17, 13, 24 ],
[ 42, 46, 29, 23, 55, 52, 53, 48, 30, 60, 49, 11, 45, 59, 57, 7, 39, 58, 64, 35, 56, 15, 36, 43, 14, 41, 61, 62, 31, 44, 2, 28, 63, 33, 40, 1, 19, 27, 54, 6, 51, 16, 47, 8, 50, 12, 18, 25, 3, 10, 21, 22, 4, 5, 37, 34, 20, 38, 9, 32, 24, 13, 26, 17 ]
]
];
s`PassportName := "64S12-8,2,8-g9";
s`PassportSize := 1;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S9-4,2,8-g3-path10", "64S12-8,2,8-g9-path12" ];
