...
s`Degree := 64;
s`Filename := "64S41-4,2,16-g7-path14.m";
...
s`PassportSize := 1;
s`PathNumber := 14;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S9-4,2,8-g3-path6", "64S41-4,2,16-g7-path14" ];
