...
s`Degree := 64;
s`Filename := "64S17-8,4,8-g17-path40.m";
...
s`PassportSize := 1;
s`PathNumber := 40;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T8-4,4,4-g3-path9", "32S12-8,4,8-g9-path46", "64S17-8,4,8-g17-path40" ];
