...
s`Degree := 64;
s`Filename := "64S17-8,4,8-g17-path23.m";
...
[ 31, 44, 2, 14, 61, 19, 18, 47, 59, 9, 53, 42, 56, 8, 7, 11, 40, 13, 35, 27, 48, 32, 30, 54, 52, 58, 1, 23, 33, 36, 37, 3, 45, 38, 34, 39, 46, 16, 49, 12, 20, 21, 50, 24, 10, 63, 51, 26, 25, 4, 64, 28, 6, 62, 15, 60, 55, 17, 5, 57, 29, 22, 41, 43 ]
]
];
s`PassportName := "64S17-8,4,8-g17";
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path20", "32S12-8,4,8-g9-path30", "64S17-8,4,8-g17-path23" ];
