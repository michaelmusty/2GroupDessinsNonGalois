...
s`Degree := 64;
s`Filename := "64S13-8,8,4-g17-path30.m";
...
s`PassportSize := 2;
s`PathNumber := 30;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,2,4-g2-path2", "32S10-8,4,4-g7-path24", "64S13-8,8,4-g17-path30" ];
