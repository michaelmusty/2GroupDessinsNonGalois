...
s`Degree := 64;
s`Filename := "64S24-4,8,8-g17-path23.m";
...
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-4,4,2-g1-path6", "32S2-4,4,4-g5-path30", "64S24-4,8,8-g17-path23" ];
