...
s`Degree := 4;
s`Filename := "4T1-4,4,1-g0-path1.m";
...
\[ 2, 3, 4, 1 ],
\[ 1, 2, 3, 4 ] >;
s`Name := "4T1-4,4,1-g0-path1";
s`Orders := \[ 4, 4, 1 ];
s`Parents := [ Strings() | "8T2-4,4,2-g1-path1", "8T1-8,8,1-g0-path1", "8T1-8,8,2-g2-path1" ];
...
s`PassportName := "4T1-4,4,1-g0";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1" ];
