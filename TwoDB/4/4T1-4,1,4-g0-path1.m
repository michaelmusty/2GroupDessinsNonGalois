...
s`Degree := 4;
s`Filename := "4T1-4,1,4-g0-path1.m";
...
\[ 1, 2, 3, 4 ],
\[ 2, 3, 4, 1 ] >;
s`Name := "4T1-4,1,4-g0-path1";
s`Orders := \[ 4, 1, 4 ];
s`Parents := [ Strings() | "8T2-4,2,4-g1-path1", "8T1-8,1,8-g0-path1", "8T1-8,2,8-g2-path1" ];
...
s`PassportName := "4T1-4,1,4-g0";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1" ];
