...
s`Degree := 4;
s`Filename := "4T2-2,2,2-g0-path1.m";
...
\[ 2, 1, 4, 3 ],
\[ 4, 3, 2, 1 ] >;
s`Name := "4T2-2,2,2-g0-path1";
s`Orders := \[ 2, 2, 2 ];
s`Parents := [ Strings() | "8T4-4,2,2-g0-path1", "8T4-2,4,2-g0-path1", "8T2-4,4,2-g1-path3", "8T4-2,2,4-g0-path1", "8T2-4,2,4-g1-path3", "8T2-2,4,4-g1-path3", "8T5-4,4,4-g2-path1" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1" ];
