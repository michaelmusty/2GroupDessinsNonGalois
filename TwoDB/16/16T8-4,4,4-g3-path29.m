...
{ IntegerRing() | 9, 13 }
@};
s`Child := "8T5-4,4,4-g2-path2";
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path29.m";
...
\[ 3, 10, 13, 6, 14, 8, 1, 11, 16, 15, 4, 2, 7, 9, 12, 5 ],
\[ 4, 7, 2, 13, 10, 14, 15, 1, 12, 9, 16, 5, 8, 11, 3, 6 ] >;
s`Name := "16T8-4,4,4-g3-path29";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S14-8,4,4-g7-path12", "32S12-4,8,8-g9-path35", "32S15-8,8,8-g11-path41", "32S13-8,4,4-g7-path12", "32S12-4,8,8-g9-path36", "32S15-8,8,8-g11-path42", "32S2-4,4,4-g5-path69" ];
...
s`PassportSize := 3;
s`PathNumber := 29;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29" ];
