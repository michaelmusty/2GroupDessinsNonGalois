...
s`Degree := 16;
s`Filename := "16T6-8,4,8-g5-path5.m";
...
\[ 3, 8, 5, 14, 7, 4, 1, 10, 12, 11, 2, 15, 6, 13, 16, 9 ],
\[ 4, 3, 6, 15, 13, 16, 14, 1, 8, 7, 5, 2, 9, 12, 11, 10 ] >;
s`Name := "16T6-8,4,8-g5-path5";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "32S5-8,4,8-g9-path23", "32S12-8,4,8-g9-path24", "32S4-8,4,8-g9-path25" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,4,8-g5-path5" ];
