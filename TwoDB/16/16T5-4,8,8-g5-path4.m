...
s`Degree := 16;
s`Filename := "16T5-4,8,8-g5-path4.m";
...
\[ 3, 9, 11, 2, 12, 8, 1, 13, 16, 5, 10, 15, 4, 6, 7, 14 ],
\[ 4, 10, 2, 11, 14, 7, 13, 1, 5, 16, 9, 6, 3, 15, 8, 12 ] >;
s`Name := "16T5-4,8,8-g5-path4";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "32S16-8,16,16-g13-path11", "32S17-8,16,16-g13-path7", "32S16-8,16,16-g13-path12", "32S17-8,16,16-g13-path8", "32S12-4,8,8-g9-path11", "32S3-4,8,8-g9-path26", "32S5-4,8,8-g9-path15" ];
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-4,8,8-g5-path4" ];
