...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path18.m";
...
\[ 3, 4, 5, 6, 7, 9, 1, 11, 2, 13, 12, 15, 14, 16, 8, 10 ],
\[ 4, 7, 11, 13, 9, 3, 15, 1, 16, 2, 14, 5, 8, 6, 10, 12 ] >;
s`Name := "16T8-4,4,4-g3-path18";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S12-8,8,4-g9-path39", "32S14-4,4,8-g7-path14", "32S15-8,8,8-g11-path17", "32S12-8,8,4-g9-path40", "32S13-4,4,8-g7-path14", "32S15-8,8,8-g11-path18", "32S2-4,4,4-g5-path57" ];
...
s`PassportSize := 3;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T8-4,4,4-g3-path18" ];
