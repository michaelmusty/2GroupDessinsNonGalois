...
s`Degree := 16;
s`Filename := "16T1-16,2,16-g4-path1.m";
...
\[ 4, 6, 8, 1, 10, 2, 12, 3, 14, 5, 16, 7, 15, 9, 13, 11 ],
\[ 8, 4, 12, 3, 6, 1, 16, 7, 10, 2, 13, 11, 14, 5, 9, 15 ] >;
s`Name := "16T1-16,2,16-g4-path1";
s`Orders := \[ 16, 2, 16 ];
s`Parents := [ Strings() | "32S1-32,4,32-g12-path1", "32S16-16,2,16-g7-path2" ];
...
s`PassportName := "16T1-16,2,16-g4";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T1-16,2,16-g4-path1" ];
