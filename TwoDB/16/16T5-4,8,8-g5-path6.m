...
s`Degree := 16;
s`Filename := "16T5-4,8,8-g5-path6.m";
...
\[ 3, 9, 11, 2, 12, 8, 1, 13, 16, 5, 10, 15, 4, 6, 7, 14 ],
\[ 4, 10, 2, 11, 14, 7, 13, 1, 5, 16, 9, 6, 3, 15, 8, 12 ] >;
s`Name := "16T5-4,8,8-g5-path6";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "32S16-8,16,16-g13-path15", "32S17-8,16,16-g13-path11", "32S16-8,16,16-g13-path16", "32S17-8,16,16-g13-path12", "32S12-4,8,8-g9-path13", "32S3-4,8,8-g9-path28", "32S5-4,8,8-g9-path17" ];
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-4,8,8-g5-path6" ];
