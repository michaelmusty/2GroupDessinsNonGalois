...
s`Degree := 16;
s`Filename := "16T13-2,2,8-g0-path3.m";
...
\[ 3, 7, 1, 9, 8, 12, 2, 5, 4, 14, 16, 6, 15, 10, 13, 11 ],
\[ 4, 8, 12, 13, 7, 1, 14, 16, 3, 2, 5, 10, 11, 6, 9, 15 ] >;
s`Name := "16T13-2,2,8-g0-path3";
s`Orders := \[ 2, 2, 8 ];
s`Parents := [ Strings() | "32S19-4,2,16-g4-path3", "32S19-2,4,16-g4-path3", "32S14-4,4,8-g7-path3", "32S18-2,2,16-g0-path3", "32S9-4,2,8-g3-path17", "32S9-2,4,8-g3-path17", "32S20-4,4,16-g8-path3" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path3" ];
