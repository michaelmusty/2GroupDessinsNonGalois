...
s`Degree := 16;
s`Filename := "16T12-4,2,8-g2-path2.m";
...
\[ 3, 8, 1, 6, 11, 4, 15, 2, 14, 12, 5, 10, 16, 9, 7, 13 ],
\[ 4, 3, 10, 14, 8, 11, 1, 16, 2, 13, 15, 5, 6, 12, 9, 7 ] >;
s`Name := "16T12-4,2,8-g2-path2";
s`Orders := \[ 4, 2, 8 ];
s`Parents := [ Strings() | "32S13-4,4,8-g7-path5", "32S10-4,4,8-g7-path27", "32S9-4,2,8-g3-path13" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-4,2,8-g2-path2" ];
