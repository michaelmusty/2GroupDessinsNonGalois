...
s`Degree := 16;
s`Filename := "16T5-8,2,8-g3-path5.m";
...
\[ 3, 7, 1, 6, 11, 4, 2, 10, 16, 8, 5, 14, 15, 12, 13, 9 ],
\[ 4, 3, 6, 12, 13, 14, 1, 7, 11, 2, 15, 16, 8, 9, 10, 5 ] >;
s`Name := "16T5-8,2,8-g3-path5";
s`Orders := \[ 8, 2, 8 ];
s`Parents := [ Strings() | "32S3-8,4,8-g9-path20", "32S12-8,4,8-g9-path5", "32S16-16,2,16-g7-path7", "32S16-16,4,16-g11-path7", "32S17-16,2,16-g7-path5", "32S17-16,4,16-g11-path5", "32S5-8,2,8-g5-path16" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,2,8-g3-path5" ];
