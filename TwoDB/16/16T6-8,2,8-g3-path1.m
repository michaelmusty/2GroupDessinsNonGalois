...
s`Degree := 16;
s`Filename := "16T6-8,2,8-g3-path1.m";
...
\[ 3, 9, 1, 6, 13, 4, 10, 15, 2, 7, 16, 14, 5, 12, 8, 11 ],
\[ 4, 3, 12, 8, 14, 11, 1, 9, 5, 13, 2, 15, 6, 16, 10, 7 ] >;
s`Name := "16T6-8,2,8-g3-path1";
s`Orders := \[ 8, 2, 8 ];
s`Parents := [ Strings() | "32S12-8,4,8-g9-path15", "32S4-8,4,8-g9-path16", "32S5-8,2,8-g5-path19" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T6-8,2,8-g3-path1" ];
