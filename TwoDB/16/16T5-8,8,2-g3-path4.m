...
s`Degree := 16;
s`Filename := "16T5-8,8,2-g3-path4.m";
...
\[ 3, 4, 11, 6, 12, 13, 1, 7, 14, 2, 16, 8, 9, 15, 10, 5 ],
\[ 4, 7, 6, 1, 14, 3, 2, 10, 16, 8, 13, 15, 11, 5, 12, 9 ] >;
s`Name := "16T5-8,8,2-g3-path4";
s`Orders := \[ 8, 8, 2 ];
s`Parents := [ Strings() | "32S3-8,8,4-g9-path19", "32S12-8,8,4-g9-path4", "32S16-16,16,2-g7-path6", "32S16-16,16,4-g11-path6", "32S17-16,16,2-g7-path4", "32S17-16,16,4-g11-path4", "32S5-8,8,2-g5-path15" ];
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path4" ];
