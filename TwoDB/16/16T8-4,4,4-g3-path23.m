...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path23.m";
...
\[ 3, 10, 5, 6, 7, 8, 1, 14, 15, 11, 12, 2, 9, 4, 16, 13 ],
\[ 4, 7, 2, 5, 8, 13, 11, 1, 12, 9, 3, 16, 14, 15, 6, 10 ] >;
s`Name := "16T8-4,4,4-g3-path23";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S14-8,4,4-g7-path9", "32S12-4,8,8-g9-path29", "32S15-8,8,8-g11-path29", "32S13-8,4,4-g7-path9", "32S12-4,8,8-g9-path30", "32S15-8,8,8-g11-path30", "32S2-4,4,4-g5-path63" ];
...
s`PassportSize := 3;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T8-4,4,4-g3-path23" ];
