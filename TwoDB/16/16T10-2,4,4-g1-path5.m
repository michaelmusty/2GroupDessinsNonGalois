...
s`Degree := 16;
s`Filename := "16T10-2,4,4-g1-path5.m";
...
\[ 3, 8, 11, 2, 10, 1, 16, 12, 7, 14, 6, 4, 5, 13, 9, 15 ],
\[ 4, 6, 9, 14, 15, 16, 1, 5, 13, 2, 8, 3, 12, 7, 11, 10 ] >;
s`Name := "16T10-2,4,4-g1-path5";
s`Orders := \[ 2, 4, 4 ];
s`Parents := [ Strings() | "32S6-4,4,4-g5-path7", "32S9-2,8,4-g3-path7", "32S11-4,8,4-g7-path7", "32S9-2,4,8-g3-path7", "32S11-4,4,8-g7-path7", "32S7-2,8,8-g5-path7", "32S5-4,8,8-g9-path7", "32S2-4,4,4-g5-path7", "32S11-2,8,4-g3-path7", "32S10-4,8,4-g7-path7", "32S11-2,4,8-g3-path7", "32S10-4,4,8-g7-path7", "32S5-2,8,8-g5-path7", "32S8-4,8,8-g9-path7", "32S6-2,4,4-g1-path7" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path5" ];
