...
s`Degree := 16;
s`Filename := "16T12-8,4,2-g2-path2.m";
...
\[ 3, 9, 5, 14, 7, 4, 1, 13, 10, 11, 2, 6, 16, 12, 8, 15 ],
\[ 4, 3, 2, 1, 12, 15, 10, 9, 8, 7, 16, 5, 14, 13, 6, 11 ] >;
s`Name := "16T12-8,4,2-g2-path2";
s`Orders := \[ 8, 4, 2 ];
s`Parents := [ Strings() | "32S13-8,4,4-g7-path5", "32S10-8,4,4-g7-path27", "32S9-8,4,2-g3-path13" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,4,2-g2-path2" ];
