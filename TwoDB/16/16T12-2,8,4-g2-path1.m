...
s`Degree := 16;
s`Filename := "16T12-2,8,4-g2-path1.m";
...
\[ 3, 8, 11, 10, 13, 1, 2, 14, 5, 15, 9, 7, 16, 4, 12, 6 ],
\[ 4, 9, 12, 5, 7, 2, 1, 16, 10, 6, 8, 13, 14, 3, 11, 15 ] >;
s`Name := "16T12-2,8,4-g2-path1";
s`Orders := \[ 2, 8, 4 ];
s`Parents := [ Strings() | "32S13-4,8,4-g7-path1", "32S10-4,8,4-g7-path23", "32S9-2,8,4-g3-path12" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-2,8,4-g2-path1" ];
