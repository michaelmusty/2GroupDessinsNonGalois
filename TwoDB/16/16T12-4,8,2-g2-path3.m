...
s`Degree := 16;
s`Filename := "16T12-4,8,2-g2-path3.m";
...
\[ 3, 8, 11, 2, 13, 15, 1, 12, 5, 6, 9, 10, 16, 4, 14, 7 ],
\[ 4, 9, 12, 1, 10, 7, 6, 16, 2, 5, 15, 3, 14, 13, 11, 8 ] >;
s`Name := "16T12-4,8,2-g2-path3";
s`Orders := \[ 4, 8, 2 ];
s`Parents := [ Strings() | "32S13-4,8,4-g7-path6", "32S10-4,8,4-g7-path28", "32S9-4,8,2-g3-path14" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T12-4,8,2-g2-path3" ];
