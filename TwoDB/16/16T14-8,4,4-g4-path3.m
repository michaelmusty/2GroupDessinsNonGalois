...
s`Degree := 16;
s`Filename := "16T14-8,4,4-g4-path3.m";
...
\[ 3, 10, 5, 6, 7, 8, 1, 14, 13, 11, 12, 2, 15, 4, 16, 9 ],
\[ 4, 7, 2, 5, 8, 13, 11, 1, 12, 9, 3, 15, 14, 16, 10, 6 ] >;
s`Name := "16T14-8,4,4-g4-path3";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "32S10-8,4,4-g7-path33", "32S14-8,4,4-g7-path6", "32S10-8,4,4-g7-path34" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T14-8,4,4-g4-path3" ];
