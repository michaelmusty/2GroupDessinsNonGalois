...
s`Degree := 16;
s`Filename := "16T14-4,8,4-g4-path3.m";
...
\[ 3, 9, 11, 6, 13, 15, 1, 2, 12, 5, 10, 4, 16, 8, 14, 7 ],
\[ 4, 7, 12, 5, 8, 10, 6, 1, 16, 2, 9, 13, 14, 3, 11, 15 ] >;
s`Name := "16T14-4,8,4-g4-path3";
s`Orders := \[ 4, 8, 4 ];
s`Parents := [ Strings() | "32S10-4,8,4-g7-path33", "32S14-4,8,4-g7-path6", "32S10-4,8,4-g7-path34" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T14-4,8,4-g4-path3" ];
