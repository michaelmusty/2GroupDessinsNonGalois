...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path20.m";
...
\[ 3, 9, 11, 6, 13, 15, 1, 2, 14, 5, 7, 4, 16, 8, 12, 10 ],
\[ 4, 7, 12, 5, 8, 10, 6, 1, 11, 2, 15, 13, 14, 3, 16, 9 ] >;
s`Name := "16T8-4,4,4-g3-path20";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S12-8,4,8-g9-path29", "32S14-4,8,4-g7-path9", "32S15-8,8,8-g11-path23", "32S12-8,4,8-g9-path30", "32S13-4,8,4-g7-path9", "32S15-8,8,8-g11-path24", "32S2-4,4,4-g5-path60" ];
...
s`PassportSize := 3;
s`PathNumber := 20;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path20" ];
