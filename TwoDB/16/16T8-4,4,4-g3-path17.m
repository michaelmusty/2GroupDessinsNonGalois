...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path17.m";
...
\[ 3, 4, 5, 6, 7, 9, 1, 11, 2, 13, 12, 15, 14, 16, 8, 10 ],
\[ 4, 7, 11, 13, 9, 3, 15, 1, 16, 2, 14, 5, 8, 6, 10, 12 ] >;
s`Name := "16T8-4,4,4-g3-path17";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S12-8,8,4-g9-path37", "32S14-4,4,8-g7-path13", "32S15-8,8,8-g11-path15", "32S12-8,8,4-g9-path38", "32S13-4,4,8-g7-path13", "32S15-8,8,8-g11-path16", "32S2-4,4,4-g5-path56" ];
...
s`PassportSize := 3;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T8-4,4,4-g3-path17" ];
