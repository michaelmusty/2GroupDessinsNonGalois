...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path5.m";
...
\[ 3, 8, 12, 2, 10, 11, 1, 15, 5, 16, 13, 7, 14, 6, 4, 9 ],
\[ 4, 9, 6, 12, 14, 7, 13, 1, 15, 2, 5, 8, 3, 16, 10, 11 ] >;
s`Name := "16T8-4,4,4-g3-path5";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S14-8,4,4-g7-path17", "32S12-4,8,8-g9-path45", "32S15-8,8,8-g11-path57", "32S13-8,4,4-g7-path17", "32S12-4,8,8-g9-path46", "32S15-8,8,8-g11-path58", "32S2-4,4,4-g5-path77" ];
...
s`PassportSize := 3;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path5" ];
