...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path24.m";
...
\[ 3, 10, 5, 6, 7, 8, 1, 14, 15, 11, 12, 2, 9, 4, 16, 13 ],
\[ 4, 7, 2, 5, 8, 13, 11, 1, 12, 9, 3, 16, 14, 15, 6, 10 ] >;
s`Name := "16T8-4,4,4-g3-path24";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S14-8,4,4-g7-path10", "32S12-4,8,8-g9-path31", "32S15-8,8,8-g11-path31", "32S13-8,4,4-g7-path10", "32S12-4,8,8-g9-path32", "32S15-8,8,8-g11-path32", "32S2-4,4,4-g5-path64" ];
...
s`PassportSize := 3;
s`PathNumber := 24;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T8-4,4,4-g3-path24" ];
