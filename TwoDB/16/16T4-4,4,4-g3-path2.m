...
s`Degree := 16;
s`Filename := "16T4-4,4,4-g3-path2.m";
...
\[ 3, 9, 11, 2, 12, 8, 1, 13, 16, 5, 7, 14, 15, 10, 6, 4 ],
\[ 4, 10, 2, 14, 15, 7, 16, 1, 5, 13, 9, 6, 3, 8, 11, 12 ] >;
s`Name := "16T4-4,4,4-g3-path2";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S3-8,4,8-g9-path8", "32S3-4,8,8-g9-path8", "32S3-8,8,4-g9-path8", "32S4-8,4,8-g9-path8", "32S4-4,8,8-g9-path8", "32S4-8,8,4-g9-path8", "32S2-4,4,4-g5-path41" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T4-4,4,4-g3-path2" ];
