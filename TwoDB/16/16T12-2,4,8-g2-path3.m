...
s`Degree := 16;
s`Filename := "16T12-2,4,8-g2-path3.m";
...
\[ 3, 8, 5, 2, 6, 1, 15, 9, 4, 13, 7, 16, 12, 11, 14, 10 ],
\[ 4, 6, 11, 13, 8, 15, 1, 16, 3, 2, 10, 9, 14, 5, 12, 7 ] >;
s`Name := "16T12-2,4,8-g2-path3";
s`Orders := \[ 2, 4, 8 ];
s`Parents := [ Strings() | "32S13-4,4,8-g7-path3", "32S10-4,4,8-g7-path25", "32S9-2,4,8-g3-path14" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T12-2,4,8-g2-path3" ];
