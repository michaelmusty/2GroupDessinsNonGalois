...
s`Degree := 16;
s`Filename := "16T5-8,4,8-g5-path5.m";
...
\[ 3, 10, 5, 13, 7, 4, 1, 2, 16, 11, 8, 9, 14, 6, 12, 15 ],
\[ 4, 3, 13, 9, 14, 12, 6, 1, 10, 5, 7, 2, 16, 15, 8, 11 ] >;
s`Name := "16T5-8,4,8-g5-path5";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "32S16-16,8,16-g13-path13", "32S17-16,8,16-g13-path9", "32S16-16,8,16-g13-path14", "32S17-16,8,16-g13-path10", "32S12-8,4,8-g9-path12", "32S3-8,4,8-g9-path27", "32S5-8,4,8-g9-path16" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5" ];
