...
s`Degree := 16;
s`Filename := "16T4-4,4,4-g3-path11.m";
...
\[ 3, 4, 13, 14, 15, 16, 1, 6, 10, 5, 8, 2, 7, 12, 9, 11 ],
\[ 4, 10, 14, 5, 8, 3, 2, 1, 16, 11, 7, 9, 12, 15, 6, 13 ] >;
s`Name := "16T4-4,4,4-g3-path11";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S3-8,4,8-g9-path2", "32S3-4,8,8-g9-path2", "32S3-8,8,4-g9-path2", "32S4-8,4,8-g9-path2", "32S4-4,8,8-g9-path2", "32S4-8,8,4-g9-path2", "32S2-4,4,4-g5-path35" ];
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path11" ];
