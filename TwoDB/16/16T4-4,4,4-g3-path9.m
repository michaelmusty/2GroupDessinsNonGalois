...
s`Degree := 16;
s`Filename := "16T4-4,4,4-g3-path9.m";
...
\[ 3, 10, 5, 13, 7, 4, 1, 2, 16, 11, 8, 9, 15, 12, 6, 14 ],
\[ 4, 3, 13, 14, 15, 16, 6, 1, 10, 5, 7, 2, 12, 8, 9, 11 ] >;
s`Name := "16T4-4,4,4-g3-path9";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S3-8,4,8-g9-path15", "32S3-4,8,8-g9-path15", "32S3-8,8,4-g9-path15", "32S4-8,4,8-g9-path15", "32S4-4,8,8-g9-path15", "32S4-8,8,4-g9-path15", "32S2-4,4,4-g5-path48" ];
...
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T4-4,4,4-g3-path9" ];
