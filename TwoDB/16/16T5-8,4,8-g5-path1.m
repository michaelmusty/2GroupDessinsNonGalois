...
s`Degree := 16;
s`Filename := "16T5-8,4,8-g5-path1.m";
...
\[ 11, 15, 16, 13, 3, 9, 5, 12, 8, 14, 10, 6, 2, 1, 4, 7 ],
\[ 12, 14, 13, 11, 4, 16, 15, 5, 7, 9, 6, 3, 10, 8, 1, 2 ] >;
s`Name := "16T5-8,4,8-g5-path1";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "32S16-16,8,16-g13-path5", "32S17-16,8,16-g13-path1", "32S16-16,8,16-g13-path6", "32S17-16,8,16-g13-path2", "32S12-8,4,8-g9-path8", "32S3-8,4,8-g9-path23", "32S5-8,4,8-g9-path12" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path1" ];
