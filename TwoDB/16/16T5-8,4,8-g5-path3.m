...
s`Degree := 16;
s`Filename := "16T5-8,4,8-g5-path3.m";
...
\[ 3, 10, 5, 13, 7, 4, 1, 2, 16, 11, 8, 9, 14, 6, 12, 15 ],
\[ 4, 3, 13, 9, 14, 12, 6, 1, 10, 5, 7, 2, 16, 15, 8, 11 ] >;
s`Name := "16T5-8,4,8-g5-path3";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "32S16-16,8,16-g13-path9", "32S17-16,8,16-g13-path5", "32S16-16,8,16-g13-path10", "32S17-16,8,16-g13-path6", "32S12-8,4,8-g9-path10", "32S3-8,4,8-g9-path25", "32S5-8,4,8-g9-path14" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,4,8-g5-path3" ];
