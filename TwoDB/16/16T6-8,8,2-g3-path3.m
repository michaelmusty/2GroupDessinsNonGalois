...
s`Degree := 16;
s`Filename := "16T6-8,8,2-g3-path3.m";
...
\[ 3, 9, 8, 6, 13, 11, 1, 15, 12, 4, 2, 14, 16, 10, 5, 7 ],
\[ 4, 7, 12, 1, 9, 13, 2, 11, 5, 15, 8, 3, 6, 16, 10, 14 ] >;
s`Name := "16T6-8,8,2-g3-path3";
s`Orders := \[ 8, 8, 2 ];
s`Parents := [ Strings() | "32S12-8,8,4-g9-path17", "32S4-8,8,4-g9-path18", "32S5-8,8,2-g5-path21" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,2-g3-path3" ];
