...
s`Degree := 16;
s`Filename := "16T12-8,2,4-g2-path2.m";
...
\[ 3, 9, 1, 14, 10, 7, 6, 15, 2, 5, 12, 11, 16, 4, 8, 13 ],
\[ 4, 10, 2, 5, 7, 15, 1, 12, 8, 11, 3, 16, 6, 13, 14, 9 ] >;
s`Name := "16T12-8,2,4-g2-path2";
s`Orders := \[ 8, 2, 4 ];
s`Parents := [ Strings() | "32S13-8,4,4-g7-path2", "32S10-8,4,4-g7-path24", "32S9-8,2,4-g3-path13" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,2,4-g2-path2" ];
