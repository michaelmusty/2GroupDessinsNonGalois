...
s`Degree := 16;
s`Filename := "16T1-8,16,16-g7-path2.m";
...
\[ 3, 8, 2, 6, 12, 7, 1, 9, 11, 13, 15, 10, 14, 4, 16, 5 ],
\[ 4, 7, 6, 10, 11, 13, 14, 1, 3, 16, 2, 15, 5, 12, 8, 9 ] >;
s`Name := "16T1-8,16,16-g7-path2";
s`Orders := \[ 8, 16, 16 ];
s`Parents := [ Strings() | "32S1-16,32,32-g15-path3", "32S1-16,32,32-g15-path4", "32S16-8,16,16-g13-path3", "32S16-8,16,16-g13-path4" ];
...
s`PassportSize := 4;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T1-8,16,16-g7-path2" ];
