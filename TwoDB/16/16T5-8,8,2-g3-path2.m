...
s`Degree := 16;
s`Filename := "16T5-8,8,2-g3-path2.m";
...
\[ 11, 12, 16, 13, 3, 15, 5, 14, 4, 9, 10, 6, 8, 1, 7, 2 ],
\[ 12, 14, 13, 5, 4, 11, 9, 16, 7, 15, 6, 1, 3, 2, 10, 8 ] >;
s`Name := "16T5-8,8,2-g3-path2";
s`Orders := \[ 8, 8, 2 ];
s`Parents := [ Strings() | "32S3-8,8,4-g9-path17", "32S12-8,8,4-g9-path2", "32S16-16,16,2-g7-path4", "32S16-16,16,4-g11-path4", "32S17-16,16,2-g7-path2", "32S17-16,16,4-g11-path2", "32S5-8,8,2-g5-path13" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2" ];
