...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path30.m";
...
\[ 3, 10, 13, 6, 12, 16, 1, 2, 15, 14, 4, 9, 7, 8, 5, 11 ],
\[ 4, 7, 11, 9, 10, 12, 6, 1, 8, 13, 15, 2, 16, 3, 14, 5 ] >;
s`Name := "16T8-4,4,4-g3-path30";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S12-8,4,8-g9-path35", "32S14-4,8,4-g7-path12", "32S15-8,8,8-g11-path45", "32S12-8,4,8-g9-path36", "32S13-4,8,4-g7-path12", "32S15-8,8,8-g11-path46", "32S2-4,4,4-g5-path71" ];
...
s`PassportSize := 3;
s`PathNumber := 30;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path30" ];
