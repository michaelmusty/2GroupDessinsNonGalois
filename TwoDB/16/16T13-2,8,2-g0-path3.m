...
s`Degree := 16;
s`Filename := "16T13-2,8,2-g0-path3.m";
...
\[ 3, 7, 9, 2, 11, 1, 15, 16, 13, 4, 14, 8, 5, 6, 12, 10 ],
\[ 4, 6, 10, 1, 12, 2, 14, 13, 16, 3, 15, 5, 8, 7, 11, 9 ] >;
s`Name := "16T13-2,8,2-g0-path3";
s`Orders := \[ 2, 8, 2 ];
s`Parents := [ Strings() | "32S9-4,8,2-g3-path17", "32S9-2,8,4-g3-path17", "32S14-4,8,4-g7-path3", "32S18-2,16,2-g0-path3", "32S19-4,16,2-g4-path3", "32S19-2,16,4-g4-path3", "32S20-4,16,4-g8-path3" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T13-2,8,2-g0-path3" ];
