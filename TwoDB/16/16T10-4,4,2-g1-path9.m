...
s`Degree := 16;
s`Filename := "16T10-4,4,2-g1-path9.m";
...
\[ 3, 9, 5, 14, 7, 4, 1, 15, 10, 11, 2, 6, 8, 12, 16, 13 ],
\[ 4, 3, 2, 1, 12, 15, 10, 9, 8, 7, 16, 5, 14, 13, 6, 11 ] >;
s`Name := "16T10-4,4,2-g1-path9";
s`Orders := \[ 4, 4, 2 ];
s`Parents := [ Strings() | "32S9-8,4,2-g3-path11", "32S9-4,8,2-g3-path11", "32S7-8,8,2-g5-path11", "32S6-4,4,4-g5-path33", "32S11-8,4,4-g7-path22", "32S11-4,8,4-g7-path22", "32S5-8,8,4-g9-path11", "32S11-8,4,2-g3-path11", "32S11-4,8,2-g3-path11", "32S5-8,8,2-g5-path11", "32S2-4,4,4-g5-path33", "32S10-8,4,4-g7-path22", "32S10-4,8,4-g7-path22", "32S8-8,8,4-g9-path11", "32S6-4,4,2-g1-path11" ];
...
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9" ];
