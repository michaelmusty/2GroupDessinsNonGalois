...
s`Degree := 16;
s`Filename := "16T5-8,4,8-g5-path6.m";
...
\[ 3, 10, 5, 13, 7, 4, 1, 2, 16, 11, 8, 9, 14, 6, 12, 15 ],
\[ 4, 3, 13, 9, 14, 12, 6, 1, 10, 5, 7, 2, 16, 15, 8, 11 ] >;
s`Name := "16T5-8,4,8-g5-path6";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "32S16-16,8,16-g13-path15", "32S17-16,8,16-g13-path11", "32S16-16,8,16-g13-path16", "32S17-16,8,16-g13-path12", "32S12-8,4,8-g9-path13", "32S3-8,4,8-g9-path28", "32S5-8,4,8-g9-path17" ];
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,4,8-g5-path6" ];
