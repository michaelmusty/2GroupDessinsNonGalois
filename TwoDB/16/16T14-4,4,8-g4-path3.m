...
s`Degree := 16;
s`Filename := "16T14-4,4,8-g4-path3.m";
...
\[ 3, 9, 5, 2, 7, 4, 1, 12, 6, 16, 15, 11, 10, 13, 8, 14 ],
\[ 4, 3, 12, 13, 9, 7, 15, 1, 16, 2, 5, 14, 11, 6, 10, 8 ] >;
s`Name := "16T14-4,4,8-g4-path3";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "32S10-4,4,8-g7-path33", "32S14-4,4,8-g7-path6", "32S10-4,4,8-g7-path34" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T14-4,4,8-g4-path3" ];
