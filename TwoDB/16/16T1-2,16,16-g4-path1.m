...
s`Degree := 16;
s`Filename := "16T1-2,16,16-g4-path1.m";
...
\[ 2, 5, 1, 6, 9, 10, 3, 4, 13, 14, 7, 8, 16, 15, 11, 12 ],
\[ 8, 4, 12, 3, 6, 1, 16, 7, 10, 2, 13, 11, 14, 5, 9, 15 ] >;
s`Name := "16T1-2,16,16-g4-path1";
s`Orders := \[ 2, 16, 16 ];
s`Parents := [ Strings() | "32S1-4,32,32-g12-path1", "32S16-2,16,16-g7-path2" ];
...
s`PassportName := "16T1-2,16,16-g4";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T1-2,16,16-g4-path1" ];
