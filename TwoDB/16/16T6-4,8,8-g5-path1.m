...
s`Degree := 16;
s`Filename := "16T6-4,8,8-g5-path1.m";
...
\[ 3, 9, 11, 6, 12, 8, 1, 16, 13, 2, 14, 15, 4, 5, 7, 10 ],
\[ 4, 7, 2, 15, 10, 14, 16, 1, 5, 11, 8, 6, 3, 13, 9, 12 ] >;
s`Name := "16T6-4,8,8-g5-path1";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "32S5-4,8,8-g9-path19", "32S12-4,8,8-g9-path20", "32S4-4,8,8-g9-path21" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-4,8,8-g5-path1" ];
