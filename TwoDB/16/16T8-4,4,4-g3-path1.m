...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path1.m";
...
\[ 3, 8, 12, 2, 10, 11, 1, 15, 5, 16, 13, 7, 14, 6, 4, 9 ],
\[ 4, 9, 6, 12, 14, 7, 13, 1, 15, 2, 5, 8, 3, 16, 10, 11 ] >;
s`Name := "16T8-4,4,4-g3-path1";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S14-8,4,4-g7-path7", "32S12-4,8,8-g9-path25", "32S15-8,8,8-g11-path21", "32S13-8,4,4-g7-path7", "32S12-4,8,8-g9-path26", "32S15-8,8,8-g11-path22", "32S2-4,4,4-g5-path59" ];
...
s`PassportSize := 3;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T8-4,4,4-g3-path1" ];
