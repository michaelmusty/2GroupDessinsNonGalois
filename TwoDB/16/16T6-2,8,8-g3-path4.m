...
s`Degree := 16;
s`Filename := "16T6-2,8,8-g3-path4.m";
...
\[ 3, 7, 12, 9, 13, 1, 15, 5, 11, 2, 14, 8, 16, 10, 4, 6 ],
\[ 4, 8, 2, 12, 10, 14, 1, 15, 6, 16, 5, 11, 9, 3, 13, 7 ] >;
s`Name := "16T6-2,8,8-g3-path4";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "32S12-4,8,8-g9-path18", "32S4-4,8,8-g9-path19", "32S5-2,8,8-g5-path22" ];
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T6-2,8,8-g3-path4" ];
