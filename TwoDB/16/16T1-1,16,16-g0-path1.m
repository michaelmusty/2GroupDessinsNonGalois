...
s`Degree := 16;
s`Filename := "16T1-1,16,16-g0-path1.m";
...
\[ 2, 5, 1, 6, 9, 10, 3, 4, 13, 14, 7, 8, 16, 15, 11, 12 ],
\[ 3, 1, 7, 8, 2, 4, 11, 12, 5, 6, 15, 16, 9, 10, 14, 13 ] >;
s`Name := "16T1-1,16,16-g0-path1";
s`Orders := \[ 1, 16, 16 ];
s`Parents := [ Strings() | "32S16-2,16,16-g7-path1", "32S1-2,32,32-g8-path1", "32S1-1,32,32-g0-path1" ];
...
s`PassportName := "16T1-1,16,16-g0";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T1-1,16,16-g0-path1" ];
