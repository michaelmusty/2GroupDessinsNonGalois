...
s`Degree := 16;
s`Filename := "16T5-8,4,8-g5-path2.m";
...
\[ 10, 12, 15, 3, 16, 4, 5, 7, 13, 9, 14, 11, 1, 2, 6, 8 ],
\[ 7, 13, 12, 2, 4, 14, 6, 15, 16, 5, 10, 1, 8, 9, 11, 3 ] >;
s`Name := "16T5-8,4,8-g5-path2";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "32S16-16,8,16-g13-path7", "32S17-16,8,16-g13-path3", "32S16-16,8,16-g13-path8", "32S17-16,8,16-g13-path4", "32S12-8,4,8-g9-path9", "32S3-8,4,8-g9-path24", "32S5-8,4,8-g9-path13" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path2" ];
