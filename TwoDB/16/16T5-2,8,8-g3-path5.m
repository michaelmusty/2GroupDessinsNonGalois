...
s`Degree := 16;
s`Filename := "16T5-2,8,8-g3-path5.m";
...
\[ 3, 7, 9, 2, 10, 1, 11, 16, 15, 12, 13, 6, 8, 4, 5, 14 ],
\[ 4, 6, 2, 12, 13, 14, 1, 15, 7, 8, 3, 16, 9, 10, 11, 5 ] >;
s`Name := "16T5-2,8,8-g3-path5";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "32S3-4,8,8-g9-path20", "32S12-4,8,8-g9-path5", "32S16-2,16,16-g7-path7", "32S16-4,16,16-g11-path7", "32S17-2,16,16-g7-path5", "32S17-4,16,16-g11-path5", "32S5-2,8,8-g5-path16" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path5" ];
