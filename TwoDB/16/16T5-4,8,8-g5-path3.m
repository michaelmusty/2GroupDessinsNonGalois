...
s`Degree := 16;
s`Filename := "16T5-4,8,8-g5-path3.m";
...
\[ 3, 9, 11, 2, 12, 8, 1, 13, 16, 5, 10, 15, 4, 6, 7, 14 ],
\[ 4, 10, 2, 11, 14, 7, 13, 1, 5, 16, 9, 6, 3, 15, 8, 12 ] >;
s`Name := "16T5-4,8,8-g5-path3";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "32S16-8,16,16-g13-path9", "32S17-8,16,16-g13-path5", "32S16-8,16,16-g13-path10", "32S17-8,16,16-g13-path6", "32S12-4,8,8-g9-path10", "32S3-4,8,8-g9-path25", "32S5-4,8,8-g9-path14" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path3" ];
