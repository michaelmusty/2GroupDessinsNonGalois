...
s`Degree := 16;
s`Filename := "16T6-8,8,4-g5-path2.m";
...
\[ 3, 8, 13, 15, 14, 16, 1, 6, 7, 5, 4, 2, 10, 9, 12, 11 ],
\[ 4, 10, 6, 5, 8, 14, 2, 1, 16, 11, 7, 9, 12, 15, 3, 13 ] >;
s`Name := "16T6-8,8,4-g5-path2";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "32S5-8,8,4-g9-path20", "32S12-8,8,4-g9-path21", "32S4-8,8,4-g9-path22" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T6-8,8,4-g5-path2" ];
