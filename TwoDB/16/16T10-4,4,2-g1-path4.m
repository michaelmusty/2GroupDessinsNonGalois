...
s`Degree := 16;
s`Filename := "16T10-4,4,2-g1-path4.m";
...
\[ 3, 4, 13, 15, 14, 16, 1, 9, 5, 12, 2, 6, 7, 8, 11, 10 ],
\[ 4, 9, 6, 1, 12, 3, 10, 16, 2, 7, 13, 5, 11, 15, 14, 8 ] >;
s`Name := "16T10-4,4,2-g1-path4";
s`Orders := \[ 4, 4, 2 ];
s`Parents := [ Strings() | "32S9-8,4,2-g3-path6", "32S9-4,8,2-g3-path6", "32S7-8,8,2-g5-path6", "32S6-4,4,4-g5-path28", "32S11-8,4,4-g7-path17", "32S11-4,8,4-g7-path17", "32S5-8,8,4-g9-path6", "32S11-8,4,2-g3-path6", "32S11-4,8,2-g3-path6", "32S5-8,8,2-g5-path6", "32S2-4,4,4-g5-path28", "32S10-8,4,4-g7-path17", "32S10-4,8,4-g7-path17", "32S8-8,8,4-g9-path6", "32S6-4,4,2-g1-path6" ];
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T10-4,4,2-g1-path4" ];
