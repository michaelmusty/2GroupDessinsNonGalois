...
s`Degree := 16;
s`Filename := "16T8-4,4,4-g3-path27.m";
...
\[ 3, 10, 13, 6, 12, 16, 1, 2, 15, 14, 4, 9, 7, 8, 5, 11 ],
\[ 4, 7, 11, 9, 10, 12, 6, 1, 8, 13, 15, 2, 16, 3, 14, 5 ] >;
s`Name := "16T8-4,4,4-g3-path27";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S12-8,4,8-g9-path33", "32S14-4,8,4-g7-path11", "32S15-8,8,8-g11-path37", "32S12-8,4,8-g9-path34", "32S13-4,8,4-g7-path11", "32S15-8,8,8-g11-path38", "32S2-4,4,4-g5-path67" ];
...
s`PassportSize := 3;
s`PathNumber := 27;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path27" ];
