...
s`Degree := 16;
s`Filename := "16T4-4,4,4-g3-path14.m";
...
\[ 3, 4, 13, 14, 15, 16, 1, 6, 10, 5, 8, 2, 7, 12, 9, 11 ],
\[ 4, 10, 14, 5, 8, 3, 2, 1, 16, 11, 7, 9, 12, 15, 6, 13 ] >;
s`Name := "16T4-4,4,4-g3-path14";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "32S3-8,4,8-g9-path5", "32S3-4,8,8-g9-path5", "32S3-8,8,4-g9-path5", "32S4-8,4,8-g9-path5", "32S4-4,8,8-g9-path5", "32S4-8,8,4-g9-path5", "32S2-4,4,4-g5-path38" ];
...
s`PassportSize := 1;
s`PathNumber := 14;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T4-4,4,4-g3-path14" ];
