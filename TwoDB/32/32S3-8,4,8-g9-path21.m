...
s`Degree := 32;
s`Filename := "32S3-8,4,8-g9-path21.m";
...
\[ 3, 10, 5, 13, 7, 4, 1, 2, 20, 11, 8, 9, 15, 23, 6, 14, 16, 12, 28, 18, 19, 21, 17, 27, 24, 25, 26, 22, 32, 29, 30, 31 ],
\[ 4, 3, 13, 14, 15, 16, 6, 1, 10, 5, 7, 2, 23, 24, 17, 25, 26, 8, 20, 11, 9, 12, 27, 29, 30, 31, 32, 18, 28, 19, 21, 22 ] >;
s`Name := "32S3-8,4,8-g9-path21";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path42", "64S3-8,8,8-g21-path42", "64S26-16,4,16-g21-path31", "64S26-16,8,16-g25-path31", "64S27-16,4,16-g21-path27", "64S27-16,8,16-g25-path27", "64S17-8,4,8-g17-path140" ];
...
s`PassportSize := 1;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,2,8-g3-path6", "32S3-8,4,8-g9-path21" ];
