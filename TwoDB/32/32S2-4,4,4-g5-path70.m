...
{ IntegerRing() | 31, 32 }
@};
s`Child := "16T8-4,4,4-g3-path2";
s`Degree := 32;
s`Filename := "32S2-4,4,4-g5-path70.m";
...
\[ 3, 10, 15, 20, 16, 8, 1, 29, 25, 26, 5, 17, 2, 23, 7, 21, 18, 27, 9, 14, 11, 6, 4, 30, 32, 13, 12, 31, 22, 28, 24, 19 ],
\[ 4, 11, 2, 21, 22, 24, 26, 1, 27, 9, 18, 7, 32, 5, 14, 12, 30, 3, 29, 19, 8, 15, 25, 23, 6, 16, 31, 20, 28, 13, 10, 17 ] >;
s`Name := "32S2-4,4,4-g5-path70";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S20-8,4,4-g13-path177", "64S21-4,8,4-g13-path135", "64S25-8,8,4-g17-path133", "64S21-4,4,8-g13-path135", "64S17-8,4,8-g17-path113", "64S24-4,8,8-g17-path67", "64S22-8,8,8-g21-path265", "64S21-8,4,4-g13-path135", "64S18-4,8,4-g13-path67", "64S24-8,8,4-g17-path67", "64S20-4,4,8-g13-path177", "64S24-8,4,8-g17-path67", "64S25-4,8,8-g17-path133", "64S19-8,8,8-g21-path67", "64S20-8,4,4-g13-path178", "64S20-4,8,4-g13-path177", "64S17-8,8,4-g17-path113", "64S20-4,4,8-g13-path178", "64S25-8,4,8-g17-path133", "64S17-4,8,8-g17-path113", "64S22-8,8,8-g21-path266", "64S18-8,4,4-g13-path67", "64S20-4,8,4-g13-path178", "64S25-8,8,4-g17-path134", "64S18-4,4,8-g13-path67", "64S25-8,4,8-g17-path134", "64S25-4,8,8-g17-path134", "64S22-8,8,8-g21-path267", "64S23-4,4,4-g9-path199", "64S23-4,4,4-g9-path200", "64S23-4,4,4-g9-path201" ];
...
s`PassportSize := 1;
s`PathNumber := 70;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T8-4,4,4-g3-path2", "32S2-4,4,4-g5-path70" ];
