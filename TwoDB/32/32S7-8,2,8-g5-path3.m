...
s`Degree := 32;
s`Filename := "32S7-8,2,8-g5-path3.m";
...
\[ 3, 9, 1, 6, 13, 4, 22, 24, 2, 26, 16, 14, 5, 12, 30, 11, 18, 17, 32, 21, 20, 7, 28, 8, 27, 10, 25, 23, 31, 15, 29, 19 ],
\[ 4, 3, 12, 16, 17, 20, 1, 9, 25, 13, 2, 28, 29, 8, 6, 19, 23, 24, 5, 22, 26, 27, 7, 32, 31, 30, 18, 10, 11, 14, 21, 15 ] >;
s`Name := "32S7-8,2,8-g5-path3";
s`Orders := \[ 8, 2, 8 ];
s`Parents := [ Strings() | "64S10-8,4,8-g17-path27", "64S14-8,4,8-g17-path39", "64S4-8,4,8-g17-path39", "64S24-8,4,8-g17-path86", "64S4-8,2,8-g9-path39", "64S12-8,2,8-g9-path5", "64S10-8,2,8-g9-path27" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S7-8,2,8-g5-path3" ];
...
[ 13, 26, 5, 18, 3, 17, 32, 20, 10, 9, 23, 31, 1, 29, 25, 28, 6, 4, 22, 8, 24, 19, 11, 21, 15, 2, 30, 16, 14, 27, 12, 7 ],
[ 9, 24, 22, 30, 26, 3, 21, 17, 16, 20, 6, 15, 32, 1, 10, 31, 25, 13, 8, 29, 4, 28, 14, 12, 7, 23, 2, 18, 27, 19, 5, 11 ]
]
];
