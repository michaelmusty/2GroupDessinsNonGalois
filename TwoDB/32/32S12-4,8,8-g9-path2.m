...
s`Degree := 32;
s`Filename := "32S12-4,8,8-g9-path2.m";
...
\[ 3, 8, 12, 2, 10, 11, 1, 18, 5, 20, 13, 21, 23, 7, 6, 4, 15, 22, 9, 28, 29, 31, 30, 16, 14, 19, 17, 32, 25, 27, 24, 26 ],
\[ 4, 9, 6, 14, 15, 7, 17, 1, 16, 2, 5, 8, 3, 24, 19, 26, 25, 10, 27, 11, 13, 12, 20, 29, 30, 31, 32, 18, 22, 21, 28, 23 ] >;
s`Name := "32S12-4,8,8-g9-path2";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path22", "64S44-4,16,16-g21-path19", "64S45-8,16,16-g25-path19", "64S44-4,16,16-g21-path20", "64S45-8,16,16-g25-path20", "64S15-8,8,8-g21-path22", "64S17-4,8,8-g17-path22" ];
...
s`PassportSize := 2;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T5-2,8,8-g3-path2", "32S12-4,8,8-g9-path2" ];
