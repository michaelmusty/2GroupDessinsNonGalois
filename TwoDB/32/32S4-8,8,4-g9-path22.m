...
s`Degree := 32;
s`Filename := "32S4-8,8,4-g9-path22.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 30, 22, 18, 4, 2, 20, 19, 17, 25, 11, 27, 32, 21, 9, 5, 15, 28, 13, 29, 31, 23, 7, 12, 8, 26 ],
\[ 4, 7, 15, 20, 10, 16, 28, 1, 12, 32, 22, 14, 2, 24, 21, 30, 25, 3, 11, 8, 18, 31, 5, 9, 27, 6, 29, 13, 17, 26, 19, 23 ] >;
s`Name := "32S4-8,8,4-g9-path22";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path214", "64S28-16,16,4-g21-path27", "64S28-16,16,8-g25-path27", "64S3-8,8,8-g21-path215", "64S28-16,16,4-g21-path28", "64S28-16,16,8-g25-path28", "64S17-8,8,4-g17-path170" ];
...
s`PassportSize := 1;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T6-8,8,4-g5-path2", "32S4-8,8,4-g9-path22" ];
