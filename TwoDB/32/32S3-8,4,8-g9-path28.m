...
s`Degree := 32;
s`Filename := "32S3-8,4,8-g9-path28.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 25, 7, 29, 20, 11, 19, 21, 24, 4, 30, 5, 31, 32, 27, 18, 9, 10, 22, 26, 28, 17 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 13, 2, 15, 21, 24, 3, 28, 9, 10, 32, 12, 26, 5, 23, 8, 27, 16, 29, 30, 25, 14, 31 ] >;
s`Name := "32S3-8,4,8-g9-path28";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path49", "64S3-8,8,8-g21-path49", "64S26-16,4,16-g21-path38", "64S26-16,8,16-g25-path38", "64S27-16,4,16-g21-path34", "64S27-16,8,16-g25-path34", "64S17-8,4,8-g17-path147" ];
...
s`PassportSize := 1;
s`PathNumber := 28;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,4,8-g5-path6", "32S3-8,4,8-g9-path28" ];
