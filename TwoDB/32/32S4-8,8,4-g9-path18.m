...
s`Degree := 32;
s`Filename := "32S4-8,8,4-g9-path18.m";
...
\[ 3, 10, 14, 20, 16, 22, 1, 6, 19, 15, 5, 27, 2, 29, 26, 9, 30, 17, 31, 13, 4, 12, 28, 11, 24, 21, 18, 7, 32, 8, 25, 23 ],
\[ 4, 11, 15, 5, 8, 23, 2, 1, 22, 31, 12, 7, 9, 13, 16, 18, 28, 3, 30, 25, 19, 14, 20, 17, 6, 24, 32, 26, 21, 29, 27, 10 ] >;
s`Name := "32S4-8,8,4-g9-path18";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path204", "64S28-16,16,4-g21-path17", "64S28-16,16,8-g25-path17", "64S3-8,8,8-g21-path205", "64S28-16,16,4-g21-path18", "64S28-16,16,8-g25-path18", "64S17-8,8,4-g17-path165" ];
...
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T6-8,8,2-g3-path3", "32S4-8,8,4-g9-path18" ];
