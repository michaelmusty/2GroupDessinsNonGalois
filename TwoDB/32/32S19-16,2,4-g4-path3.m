...
s`Degree := 32;
s`Filename := "32S19-16,2,4-g4-path3.m";
...
\[ 3, 9, 1, 14, 10, 7, 6, 18, 2, 5, 12, 11, 16, 4, 22, 13, 26, 8, 20, 19, 30, 15, 24, 23, 31, 17, 28, 27, 32, 21, 25, 29 ],
\[ 4, 10, 2, 5, 7, 15, 1, 12, 8, 11, 3, 19, 6, 13, 14, 21, 20, 17, 9, 27, 22, 23, 16, 31, 28, 25, 18, 32, 24, 29, 30, 26 ] >;
s`Name := "32S19-16,2,4-g4-path3";
s`Orders := \[ 16, 2, 4 ];
s`Parents := [ Strings() | "64S48-16,4,4-g15-path20", "64S39-16,4,4-g15-path3", "64S38-16,2,4-g7-path6" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T13-8,2,2-g0-path3", "32S19-16,2,4-g4-path3" ];
