...
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path47", "64S15-8,8,8-g21-path47", "64S45-16,4,16-g21-path1", "64S44-16,8,16-g25-path1", "64S45-16,4,16-g21-path2", "64S44-16,8,16-g25-path2", "64S17-8,4,8-g17-path1" ];
