...
s`Degree := 32;
s`Filename := "32S1-32,8,32-g14-path1.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 22, 2, 18, 21, 24, 31, 28, 20, 23, 4, 25, 5, 30, 26, 7, 19, 29, 9, 10, 32, 11, 17, 27 ],
\[ 4, 7, 6, 12, 17, 18, 19, 1, 11, 21, 24, 2, 15, 20, 23, 3, 29, 8, 9, 32, 31, 5, 16, 25, 27, 28, 30, 13, 10, 14, 26, 22 ] >;
s`Name := "32S1-32,8,32-g14-path1";
s`Orders := \[ 32, 8, 32 ];
s`Parents := [ Strings() | "64S1-64,16,64-g30-path1", "64S1-64,16,64-g30-path2", "64S50-32,8,32-g27-path1", "64S50-32,8,32-g27-path2" ];
...
s`PassportName := "32S1-32,8,32-g14";
s`PassportSize := 4;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,2,8-g2-path1", "16T1-16,4,16-g6-path1", "32S1-32,8,32-g14-path1" ];
