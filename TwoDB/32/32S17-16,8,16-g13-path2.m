...
s`Degree := 32;
s`Filename := "32S17-16,8,16-g13-path2.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 29, 24, 18, 8, 2, 30, 19, 17, 28, 22, 26, 5, 13, 15, 4, 27, 25, 32, 11, 21, 7, 12, 31, 9, 20 ],
\[ 4, 7, 15, 20, 21, 24, 27, 1, 12, 5, 19, 14, 2, 23, 13, 6, 25, 3, 22, 26, 9, 31, 30, 11, 10, 28, 32, 17, 16, 8, 18, 29 ] >;
s`Name := "32S17-16,8,16-g13-path2";
s`Orders := \[ 16, 8, 16 ];
s`Parents := [ Strings() | "64S27-16,8,16-g25-path7", "64S29-16,8,16-g25-path25", "64S44-16,8,16-g25-path71" ];
...
s`PassportSize := 2;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path1", "32S17-16,8,16-g13-path2" ];
