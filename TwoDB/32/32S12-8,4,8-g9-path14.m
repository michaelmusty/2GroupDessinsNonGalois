...
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path14.m";
...
\[ 3, 8, 15, 19, 16, 23, 1, 27, 13, 5, 14, 2, 32, 18, 7, 30, 22, 25, 17, 6, 24, 4, 26, 31, 11, 20, 12, 21, 9, 10, 28, 29 ],
\[ 4, 10, 6, 9, 20, 13, 26, 1, 25, 22, 7, 15, 2, 5, 17, 19, 32, 3, 21, 28, 11, 31, 24, 8, 30, 29, 16, 12, 27, 23, 18, 14 ] >;
s`Name := "32S12-8,4,8-g9-path14";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path51", "64S15-8,8,8-g21-path51", "64S45-16,4,16-g21-path9", "64S44-16,8,16-g25-path9", "64S45-16,4,16-g21-path10", "64S44-16,8,16-g25-path10", "64S17-8,4,8-g17-path5" ];
...
s`PassportSize := 2;
s`PathNumber := 14;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path7", "32S12-8,4,8-g9-path14" ];
