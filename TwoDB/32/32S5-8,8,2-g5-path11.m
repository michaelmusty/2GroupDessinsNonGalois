...
s`Degree := 32;
s`Filename := "32S5-8,8,2-g5-path11.m";
...
\[ 3, 9, 12, 6, 14, 21, 1, 16, 13, 28, 2, 20, 15, 25, 10, 27, 19, 4, 24, 5, 30, 23, 31, 18, 7, 8, 22, 29, 11, 17, 32, 26 ],
\[ 4, 7, 13, 1, 17, 22, 2, 11, 27, 20, 8, 21, 3, 29, 23, 18, 5, 16, 26, 10, 12, 6, 15, 25, 24, 19, 9, 32, 14, 31, 30, 28 ] >;
s`Name := "32S5-8,8,2-g5-path11";
s`Orders := \[ 8, 8, 2 ];
s`Parents := [ Strings() | "64S17-8,8,4-g17-path183", "64S7-8,8,4-g17-path115", "64S7-8,8,4-g17-path116", "64S5-8,8,4-g17-path2", "64S29-16,16,2-g13-path18", "64S29-16,16,4-g21-path18", "64S31-16,16,2-g13-path3", "64S31-16,16,4-g21-path3", "64S31-16,16,2-g13-path4", "64S31-16,16,4-g21-path4", "64S30-16,16,2-g13-path2", "64S30-16,16,4-g21-path2", "64S6-8,8,2-g9-path25", "64S6-8,8,2-g9-path26", "64S4-8,8,2-g9-path2" ];
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S5-8,8,2-g5-path11" ];
