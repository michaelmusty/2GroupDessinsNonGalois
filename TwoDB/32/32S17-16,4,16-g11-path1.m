...
s`Degree := 32;
s`Filename := "32S17-16,4,16-g11-path1.m";
...
\[ 3, 8, 5, 14, 7, 4, 1, 10, 12, 11, 2, 20, 6, 13, 17, 15, 23, 9, 21, 18, 28, 19, 16, 26, 24, 27, 25, 22, 30, 32, 29, 31 ],
\[ 4, 3, 6, 15, 13, 17, 14, 1, 8, 7, 5, 2, 23, 16, 24, 26, 25, 10, 12, 11, 9, 20, 27, 32, 31, 30, 29, 18, 21, 19, 28, 22 ] >;
s`Name := "32S17-16,4,16-g11-path1";
s`Orders := \[ 16, 4, 16 ];
s`Parents := [ Strings() | "64S29-16,4,16-g21-path10", "64S44-16,4,16-g21-path72", "64S27-16,4,16-g21-path8" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T5-8,2,8-g3-path1", "32S17-16,4,16-g11-path1" ];
