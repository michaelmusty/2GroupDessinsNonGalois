...
s`Degree := 32;
s`Filename := "32S11-2,8,4-g3-path1.m";
...
\[ 3, 8, 11, 2, 13, 1, 24, 14, 26, 28, 19, 7, 23, 17, 25, 15, 9, 4, 5, 22, 12, 21, 6, 29, 10, 18, 16, 31, 32, 27, 30, 20 ],
\[ 4, 6, 12, 16, 17, 22, 1, 25, 19, 2, 8, 31, 32, 3, 18, 7, 28, 13, 24, 5, 23, 10, 26, 27, 29, 30, 9, 20, 11, 21, 14, 15 ] >;
s`Name := "32S11-2,8,4-g3-path1";
s`Orders := \[ 2, 8, 4 ];
s`Parents := [ Strings() | "64S20-4,8,4-g13-path3", "64S6-2,8,8-g9-path14", "64S7-4,8,8-g17-path82", "64S9-4,8,4-g13-path71", "64S10-2,8,8-g9-path14", "64S11-4,8,8-g17-path14", "64S8-2,8,4-g5-path3" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T10-2,4,4-g1-path10", "32S11-2,8,4-g3-path1" ];
