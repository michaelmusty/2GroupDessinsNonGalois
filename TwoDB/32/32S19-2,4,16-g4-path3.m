...
s`Degree := 32;
s`Filename := "32S19-2,4,16-g4-path3.m";
...
\[ 3, 8, 5, 2, 6, 1, 15, 9, 4, 13, 7, 17, 12, 11, 14, 20, 10, 25, 23, 19, 22, 18, 16, 31, 21, 30, 28, 24, 32, 29, 27, 26 ],
\[ 4, 6, 11, 13, 8, 15, 1, 17, 3, 2, 20, 9, 22, 5, 23, 7, 25, 10, 14, 28, 12, 30, 31, 16, 32, 18, 19, 26, 21, 27, 29, 24 ] >;
s`Name := "32S19-2,4,16-g4-path3";
s`Orders := \[ 2, 4, 16 ];
s`Parents := [ Strings() | "64S39-4,4,16-g15-path3", "64S48-4,4,16-g15-path20", "64S38-2,4,16-g7-path6" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path3", "32S19-2,4,16-g4-path3" ];
