...
s`Degree := 32;
s`Filename := "32S6-4,4,4-g5-path21.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 25, 21, 11, 12, 2, 19, 26, 24, 15, 31, 20, 29, 6, 27, 30, 16, 23, 14, 8, 28, 9, 32, 17, 22, 13 ],
\[ 4, 3, 15, 19, 20, 21, 23, 1, 10, 30, 7, 31, 2, 5, 13, 9, 18, 28, 8, 32, 25, 6, 29, 27, 22, 17, 12, 26, 11, 16, 24, 14 ] >;
s`Name := "32S6-4,4,4-g5-path21";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S8-8,4,4-g13-path32", "64S8-4,4,8-g13-path35", "64S4-8,4,8-g17-path33", "64S9-8,4,4-g13-path144", "64S9-4,4,8-g13-path147", "64S5-8,4,8-g17-path67", "64S32-8,4,4-g13-path10", "64S32-4,4,8-g13-path13", "64S36-8,4,8-g17-path10", "64S33-8,4,4-g13-path32", "64S33-4,4,8-g13-path35", "64S37-8,4,8-g17-path21", "64S23-4,4,4-g9-path289", "64S34-4,4,4-g9-path13", "64S35-4,4,4-g9-path46" ];
...
s`PassportSize := 3;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S6-4,4,4-g5-path21" ];
