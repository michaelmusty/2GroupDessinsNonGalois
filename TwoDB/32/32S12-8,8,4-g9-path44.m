...
s`Degree := 32;
s`Filename := "32S12-8,8,4-g9-path44.m";
...
\[ 3, 10, 9, 6, 15, 12, 1, 26, 21, 17, 4, 2, 19, 16, 23, 27, 30, 29, 20, 31, 5, 14, 7, 32, 22, 28, 8, 25, 24, 11, 18, 13 ],
\[ 4, 7, 14, 19, 10, 15, 25, 1, 12, 29, 21, 31, 2, 20, 26, 23, 3, 11, 8, 17, 27, 5, 30, 6, 13, 24, 18, 9, 22, 32, 28, 16 ] >;
s`Name := "32S12-8,8,4-g9-path44";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S44-16,16,8-g25-path39", "64S44-16,16,8-g25-path40", "64S45-16,16,4-g21-path39", "64S16-8,8,8-g21-path130", "64S45-16,16,4-g21-path40", "64S15-8,8,8-g21-path130", "64S17-8,8,4-g17-path38" ];
...
s`PassportSize := 2;
s`PathNumber := 44;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S12-8,8,4-g9-path44" ];
