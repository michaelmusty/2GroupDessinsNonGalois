...
s`Degree := 32;
s`Filename := "32S5-2,8,8-g5-path8.m";
...
\[ 3, 8, 11, 2, 13, 1, 24, 14, 27, 25, 19, 7, 23, 17, 26, 15, 9, 4, 5, 22, 12, 21, 6, 29, 31, 10, 18, 16, 30, 20, 32, 28 ],
\[ 4, 6, 12, 16, 17, 22, 1, 26, 19, 2, 8, 15, 30, 3, 18, 20, 25, 13, 24, 5, 23, 28, 27, 10, 7, 21, 32, 9, 11, 31, 14, 29 ] >;
s`Name := "32S5-2,8,8-g5-path8";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "64S17-4,8,8-g17-path203", "64S7-4,8,8-g17-path155", "64S7-4,8,8-g17-path156", "64S5-4,8,8-g17-path22", "64S29-2,16,16-g13-path38", "64S29-4,16,16-g21-path38", "64S31-2,16,16-g13-path43", "64S31-4,16,16-g21-path43", "64S31-2,16,16-g13-path44", "64S31-4,16,16-g21-path44", "64S30-2,16,16-g13-path22", "64S30-4,16,16-g21-path22", "64S6-2,8,8-g9-path65", "64S6-2,8,8-g9-path66", "64S4-2,8,8-g9-path22" ];
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S5-2,8,8-g5-path8" ];
