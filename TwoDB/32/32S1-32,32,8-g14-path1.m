...
s`Degree := 32;
s`Filename := "32S1-32,32,8-g14-path1.m";
...
\[ 3, 8, 11, 6, 13, 14, 1, 15, 12, 22, 2, 24, 28, 7, 9, 18, 20, 23, 4, 31, 5, 32, 19, 25, 27, 29, 30, 10, 16, 17, 21, 26 ],
\[ 4, 7, 6, 16, 17, 18, 19, 1, 11, 21, 14, 2, 20, 23, 3, 22, 24, 32, 29, 25, 30, 5, 26, 8, 15, 28, 9, 31, 10, 12, 27, 13 ] >;
s`Name := "32S1-32,32,8-g14-path1";
s`Orders := \[ 32, 32, 8 ];
s`Parents := [ Strings() | "64S1-64,64,16-g30-path1", "64S1-64,64,16-g30-path2", "64S50-32,32,8-g27-path1", "64S50-32,32,8-g27-path2" ];
...
s`PassportName := "32S1-32,32,8-g14";
s`PassportSize := 4;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T1-16,16,4-g6-path1", "32S1-32,32,8-g14-path1" ];
