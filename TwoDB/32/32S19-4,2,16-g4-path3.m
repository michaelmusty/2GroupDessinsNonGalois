...
s`Degree := 32;
s`Filename := "32S19-4,2,16-g4-path3.m";
...
\[ 3, 8, 1, 6, 11, 4, 15, 2, 14, 12, 5, 10, 17, 9, 7, 20, 13, 25, 23, 16, 22, 21, 19, 31, 18, 30, 28, 27, 32, 26, 24, 29 ],
\[ 4, 3, 10, 14, 8, 11, 1, 17, 2, 20, 15, 5, 6, 22, 23, 7, 25, 9, 12, 28, 13, 30, 31, 16, 32, 18, 19, 29, 21, 27, 26, 24 ] >;
s`Name := "32S19-4,2,16-g4-path3";
s`Orders := \[ 4, 2, 16 ];
s`Parents := [ Strings() | "64S48-4,4,16-g15-path23", "64S39-4,4,16-g15-path6", "64S38-4,2,16-g7-path6" ];
...
s`PassportName := "32S19-4,2,16-g4";
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path3", "32S19-4,2,16-g4-path3" ];
