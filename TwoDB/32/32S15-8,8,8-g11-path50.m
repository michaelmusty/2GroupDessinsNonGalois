...
s`Degree := 32;
s`Filename := "32S15-8,8,8-g11-path50.m";
...
\[ 3, 10, 15, 20, 16, 8, 1, 22, 28, 29, 5, 17, 2, 31, 11, 27, 18, 13, 24, 14, 6, 4, 9, 25, 30, 12, 7, 32, 26, 23, 21, 19 ],
\[ 4, 11, 2, 15, 21, 23, 18, 1, 26, 9, 29, 7, 30, 5, 14, 12, 24, 3, 31, 19, 27, 28, 22, 13, 6, 32, 8, 20, 16, 10, 25, 17 ] >;
s`Name := "32S15-8,8,8-g11-path50";
s`Orders := \[ 8, 8, 8 ];
s`Parents := [ Strings() | "64S15-8,8,8-g21-path285", "64S16-8,8,8-g21-path285", "64S22-8,8,8-g21-path45" ];
...
[ 29, 32, 21, 25, 18, 15, 14, 19, 31, 7, 8, 30, 16, 23, 12, 4, 11, 9, 10, 27, 28, 5, 17, 22, 26, 3, 2, 13, 24, 20, 1, 6 ]
],
[ PermutationGroup<32 |  
\[ 12, 24, 8, 23, 2, 5, 21, 25, 6, 3, 4, 9, 7, 28, 18, 14, 16, 32, 26, 1, 19, 27, 13, 20, 17, 11, 29, 10, 30, 31, 15, 22 ],
\[ 3, 10, 15, 20, 16, 8, 1, 22, 28, 29, 5, 17, 2, 31, 11, 27, 18, 13, 24, 14, 6, 4, 9, 25, 30, 12, 7, 32, 26, 23, 21, 19 ],
...
s`PassportSize := 6;
s`PathNumber := 50;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3", "16T8-4,4,4-g3-path32", "32S15-8,8,8-g11-path50" ];
