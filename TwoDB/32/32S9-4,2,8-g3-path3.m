...
s`Degree := 32;
s`Filename := "32S9-4,2,8-g3-path3.m";
...
\[ 3, 9, 1, 6, 13, 4, 21, 20, 2, 25, 16, 14, 5, 12, 24, 11, 18, 17, 31, 8, 7, 26, 32, 15, 10, 22, 29, 30, 27, 28, 19, 23 ],
\[ 4, 3, 12, 16, 17, 20, 1, 9, 24, 13, 2, 26, 27, 8, 6, 19, 22, 32, 5, 21, 30, 7, 25, 29, 28, 10, 11, 14, 23, 18, 15, 31 ] >;
s`Name := "32S9-4,2,8-g3-path3";
s`Orders := \[ 4, 2, 8 ];
s`Parents := [ Strings() | "64S12-8,2,8-g9-path22", "64S41-4,4,16-g15-path28", "64S40-8,4,16-g19-path11", "64S6-8,2,8-g9-path79", "64S39-4,4,16-g15-path40", "64S43-8,4,16-g19-path11", "64S38-4,2,16-g7-path17", "64S42-8,2,16-g11-path11", "64S8-4,4,8-g13-path72", "64S6-8,4,8-g17-path79", "64S41-4,2,16-g7-path11", "64S40-8,2,16-g11-path11", "64S21-4,4,8-g13-path177", "64S13-8,4,8-g17-path67", "64S8-4,2,8-g5-path33" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S9-4,2,8-g3-path3" ];
