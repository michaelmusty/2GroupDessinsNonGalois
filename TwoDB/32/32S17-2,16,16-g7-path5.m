...
s`Degree := 32;
s`Filename := "32S17-2,16,16-g7-path5.m";
...
\[ 3, 7, 12, 9, 13, 1, 19, 5, 11, 2, 14, 21, 20, 23, 8, 4, 10, 6, 22, 24, 29, 31, 30, 32, 17, 15, 18, 16, 26, 25, 28, 27 ],
\[ 4, 8, 2, 15, 10, 17, 1, 16, 6, 18, 5, 11, 9, 3, 25, 27, 26, 28, 13, 7, 19, 12, 20, 14, 32, 31, 30, 29, 23, 21, 24, 22 ] >;
s`Name := "32S17-2,16,16-g7-path5";
s`Orders := \[ 2, 16, 16 ];
s`Parents := [ Strings() | "64S44-4,16,16-g21-path69", "64S27-4,16,16-g21-path5", "64S29-2,16,16-g13-path14" ];
...
s`PassportName := "32S17-2,16,16-g7";
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-2,8,8-g3-path5", "32S17-2,16,16-g7-path5" ];
