...
s`Degree := 32;
s`Filename := "32S12-8,8,4-g9-path43.m";
...
\[ 3, 4, 13, 6, 15, 23, 1, 14, 7, 18, 2, 17, 21, 16, 9, 31, 19, 20, 30, 11, 5, 29, 10, 25, 8, 32, 28, 12, 24, 26, 22, 27 ],
\[ 4, 7, 14, 17, 18, 3, 25, 1, 11, 21, 28, 2, 23, 19, 29, 13, 8, 32, 6, 15, 31, 5, 30, 9, 12, 10, 20, 24, 27, 16, 26, 22 ] >;
s`Name := "32S12-8,8,4-g9-path43";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path129", "64S15-8,8,8-g21-path129", "64S44-16,16,4-g21-path35", "64S45-16,16,8-g25-path35", "64S44-16,16,4-g21-path36", "64S45-16,16,8-g25-path36", "64S17-8,8,4-g17-path37" ];
...
s`PassportSize := 2;
s`PathNumber := 43;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path28", "32S12-8,8,4-g9-path43" ];
