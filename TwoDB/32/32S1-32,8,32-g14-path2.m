...
s`Degree := 32;
s`Filename := "32S1-32,8,32-g14-path2.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 22, 2, 24, 21, 23, 29, 26, 9, 20, 4, 30, 5, 28, 7, 31, 27, 10, 32, 11, 18, 19, 25, 17 ],
\[ 4, 7, 6, 17, 18, 9, 19, 1, 11, 21, 23, 2, 15, 20, 12, 3, 28, 31, 32, 25, 29, 5, 30, 8, 26, 13, 10, 14, 24, 27, 16, 22 ] >;
s`Name := "32S1-32,8,32-g14-path2";
s`Orders := \[ 32, 8, 32 ];
s`Parents := [ Strings() | "64S1-64,16,64-g30-path3", "64S1-64,16,64-g30-path4", "64S50-32,8,32-g27-path3", "64S50-32,8,32-g27-path4" ];
...
s`PassportSize := 4;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,2,8-g2-path1", "16T1-16,4,16-g6-path1", "32S1-32,8,32-g14-path2" ];
