...
s`Degree := 32;
s`Filename := "32S10-8,4,4-g7-path3.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 28, 27, 11, 12, 2, 32, 29, 26, 15, 31, 20, 13, 6, 19, 9, 22, 30, 16, 25, 23, 14, 8, 17, 24, 21 ],
\[ 4, 3, 15, 19, 20, 22, 25, 1, 10, 30, 7, 31, 2, 5, 13, 23, 18, 27, 8, 32, 11, 29, 12, 6, 21, 9, 28, 17, 24, 26, 16, 14 ] >;
s`Name := "32S10-8,4,4-g7-path3";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S7-8,4,8-g17-path55", "64S13-8,4,8-g17-path28", "64S7-8,4,8-g17-path56", "64S14-8,4,8-g17-path28", "64S9-8,4,4-g13-path55", "64S21-8,4,4-g13-path28", "64S9-8,4,4-g13-path56" ];
...
s`PassportSize := 2;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S10-8,4,4-g7-path3" ];
