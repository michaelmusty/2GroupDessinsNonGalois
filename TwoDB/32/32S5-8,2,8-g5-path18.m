...
{ IntegerRing() | 30, 31 }
@};
s`Child := "16T5-8,2,8-g3-path7";
s`Degree := 32;
s`Filename := "32S5-8,2,8-g5-path18.m";
...
\[ 3, 7, 1, 13, 9, 15, 2, 11, 5, 12, 8, 10, 4, 17, 6, 18, 14, 16, 20, 19, 22, 21, 24, 23, 27, 28, 25, 26, 30, 29, 32, 31 ],
\[ 4, 9, 6, 14, 15, 17, 1, 12, 13, 3, 2, 5, 16, 25, 18, 27, 26, 28, 10, 7, 19, 8, 20, 11, 29, 30, 31, 32, 23, 21, 24, 22 ] >;
s`Name := "32S5-8,2,8-g5-path18";
s`Orders := \[ 8, 2, 8 ];
s`Parents := [ Strings() | "64S17-8,4,8-g17-path190", "64S7-8,4,8-g17-path129", "64S7-8,4,8-g17-path130", "64S5-8,4,8-g17-path9", "64S29-16,2,16-g13-path25", "64S29-16,4,16-g21-path25", "64S31-16,2,16-g13-path17", "64S31-16,4,16-g21-path17", "64S31-16,2,16-g13-path18", "64S31-16,4,16-g21-path18", "64S30-16,2,16-g13-path9", "64S30-16,4,16-g21-path9", "64S6-8,2,8-g9-path39", "64S6-8,2,8-g9-path40", "64S4-8,2,8-g9-path9" ];
...
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,2,8-g3-path7", "32S5-8,2,8-g5-path18" ];
...
[ 13, 5, 15, 17, 6, 14, 3, 10, 4, 1, 7, 9, 18, 27, 16, 25, 28, 26, 12, 2, 20, 11, 19, 8, 30, 29, 32, 31, 24, 22, 23, 21 ],
[ 3, 7, 1, 13, 9, 15, 2, 11, 5, 12, 8, 10, 4, 17, 6, 18, 14, 16, 20, 19, 22, 21, 24, 23, 27, 28, 25, 26, 30, 29, 32, 31 ],
[ 12, 19, 2, 5, 7, 9, 8, 23, 10, 11, 21, 20, 3, 15, 1, 6, 13, 4, 24, 22, 31, 29, 32, 30, 18, 16, 17, 14, 28, 27, 26, 25 ]
]
];
