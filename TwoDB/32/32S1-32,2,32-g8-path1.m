...
s`Degree := 32;
s`Filename := "32S1-32,2,32-g8-path1.m";
...
\[ 4, 6, 8, 1, 10, 2, 12, 3, 14, 5, 16, 7, 18, 9, 20, 11, 22, 13, 24, 15, 26, 17, 28, 19, 30, 21, 32, 23, 31, 25, 29, 27 ],
\[ 8, 4, 12, 3, 6, 1, 16, 7, 10, 2, 20, 11, 14, 5, 24, 15, 18, 9, 28, 19, 22, 13, 32, 23, 26, 17, 29, 27, 30, 21, 25, 31 ] >;
s`Name := "32S1-32,2,32-g8-path1";
s`Orders := \[ 32, 2, 32 ];
s`Parents := [ Strings() | "64S1-64,4,64-g24-path1", "64S50-32,2,32-g15-path2" ];
...
s`PassportName := "32S1-32,2,32-g8";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T1-16,1,16-g0-path1", "32S1-32,2,32-g8-path1" ];
