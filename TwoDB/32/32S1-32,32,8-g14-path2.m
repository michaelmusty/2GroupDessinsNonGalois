...
s`Degree := 32;
s`Filename := "32S1-32,32,8-g14-path2.m";
...
\[ 3, 8, 13, 6, 14, 9, 1, 15, 12, 22, 2, 24, 28, 29, 30, 18, 20, 11, 4, 25, 5, 31, 7, 32, 27, 10, 16, 17, 19, 21, 23, 26 ],
\[ 4, 7, 6, 16, 17, 18, 19, 1, 11, 21, 23, 2, 9, 20, 3, 22, 24, 31, 27, 32, 28, 5, 29, 8, 26, 30, 10, 12, 25, 13, 14, 15 ] >;
s`Name := "32S1-32,32,8-g14-path2";
s`Orders := \[ 32, 32, 8 ];
s`Parents := [ Strings() | "64S1-64,64,16-g30-path3", "64S1-64,64,16-g30-path4", "64S50-32,32,8-g27-path3", "64S50-32,32,8-g27-path4" ];
...
s`PassportSize := 4;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T1-16,16,4-g6-path1", "32S1-32,32,8-g14-path2" ];
