...
s`Degree := 32;
s`Filename := "32S9-2,8,4-g3-path13.m";
...
\[ 3, 8, 14, 10, 16, 1, 21, 15, 5, 24, 2, 29, 27, 12, 7, 32, 4, 22, 28, 17, 26, 6, 19, 31, 9, 30, 20, 25, 18, 11, 13, 23 ],
\[ 4, 9, 15, 19, 11, 21, 1, 14, 27, 6, 29, 2, 5, 20, 28, 31, 3, 30, 7, 25, 23, 24, 10, 32, 8, 22, 12, 17, 13, 16, 18, 26 ] >;
s`Name := "32S9-2,8,4-g3-path13";
s`Orders := \[ 2, 8, 4 ];
s`Parents := [ Strings() | "64S8-4,8,4-g13-path48", "64S12-2,8,8-g9-path32", "64S6-4,8,8-g17-path89", "64S21-4,8,4-g13-path153", "64S6-2,8,8-g9-path89", "64S13-4,8,8-g17-path77", "64S38-2,16,4-g7-path10", "64S41-4,16,4-g15-path4", "64S42-2,16,8-g11-path4", "64S40-4,16,8-g19-path4", "64S41-2,16,4-g7-path4", "64S39-4,16,4-g15-path16", "64S40-2,16,8-g11-path4", "64S43-4,16,8-g19-path4", "64S8-2,8,4-g5-path26" ];
...
s`PassportSize := 1;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T12-2,8,4-g2-path2", "32S9-2,8,4-g3-path13" ];
