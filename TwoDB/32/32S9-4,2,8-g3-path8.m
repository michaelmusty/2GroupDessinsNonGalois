...
s`Degree := 32;
s`Filename := "32S9-4,2,8-g3-path8.m";
...
\[ 3, 9, 1, 6, 13, 4, 21, 20, 2, 25, 16, 14, 5, 12, 24, 11, 18, 17, 31, 8, 7, 26, 32, 15, 10, 22, 29, 30, 27, 28, 19, 23 ],
\[ 4, 3, 12, 16, 17, 20, 1, 9, 24, 13, 2, 26, 27, 8, 6, 19, 22, 32, 5, 21, 30, 7, 25, 29, 28, 10, 11, 14, 23, 18, 15, 31 ] >;
s`Name := "32S9-4,2,8-g3-path8";
s`Orders := \[ 4, 2, 8 ];
s`Parents := [ Strings() | "64S12-8,2,8-g9-path27", "64S41-4,4,16-g15-path33", "64S40-8,4,16-g19-path16", "64S6-8,2,8-g9-path84", "64S39-4,4,16-g15-path45", "64S43-8,4,16-g19-path16", "64S38-4,2,16-g7-path22", "64S42-8,2,16-g11-path16", "64S8-4,4,8-g13-path77", "64S6-8,4,8-g17-path84", "64S41-4,2,16-g7-path16", "64S40-8,2,16-g11-path16", "64S21-4,4,8-g13-path182", "64S13-8,4,8-g17-path72", "64S8-4,2,8-g5-path38" ];
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-4,2,4-g1-path6", "32S9-4,2,8-g3-path8" ];
