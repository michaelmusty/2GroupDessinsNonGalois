...
s`Degree := 32;
s`Filename := "32S5-4,8,8-g9-path18.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 26, 28, 18, 8, 2, 29, 24, 17, 20, 32, 4, 5, 22, 15, 30, 31, 9, 11, 21, 7, 27, 19, 13, 12, 25 ],
\[ 4, 7, 15, 20, 21, 24, 26, 1, 12, 5, 19, 29, 2, 23, 22, 6, 9, 3, 18, 17, 14, 31, 30, 32, 27, 16, 10, 11, 8, 25, 28, 13 ] >;
s`Name := "32S5-4,8,8-g9-path18";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S29-8,16,16-g25-path49", "64S31-8,16,16-g25-path33", "64S31-8,16,16-g25-path34", "64S30-8,16,16-g25-path17", "64S31-8,16,16-g25-path35", "64S29-8,16,16-g25-path50", "64S30-8,16,16-g25-path18", "64S31-8,16,16-g25-path36", "64S7-4,8,8-g17-path175", "64S6-4,8,8-g17-path39", "64S5-4,8,8-g17-path32", "64S6-4,8,8-g17-path40", "64S17-4,8,8-g17-path213", "64S4-4,8,8-g17-path9", "64S7-4,8,8-g17-path176" ];
...
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path7", "32S5-4,8,8-g9-path18" ];
