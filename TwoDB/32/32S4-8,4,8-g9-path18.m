...
{ IntegerRing() | 31, 32 }
@};
s`Child := "16T6-8,2,8-g3-path3";
s`Degree := 32;
s`Filename := "32S4-8,4,8-g9-path18.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 28, 21, 11, 12, 2, 23, 29, 26, 15, 31, 20, 27, 6, 19, 30, 22, 32, 16, 25, 9, 14, 8, 13, 24, 17 ],
\[ 4, 3, 15, 19, 20, 22, 25, 1, 10, 31, 7, 32, 2, 5, 27, 30, 18, 13, 12, 9, 29, 11, 14, 6, 21, 23, 28, 17, 24, 8, 26, 16 ] >;
s`Name := "32S4-8,4,8-g9-path18";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S28-16,8,16-g25-path17", "64S28-16,4,16-g21-path17", "64S3-8,8,8-g21-path154", "64S28-16,8,16-g25-path18", "64S28-16,4,16-g21-path18", "64S3-8,8,8-g21-path155", "64S17-8,4,8-g17-path165" ];
...
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T6-8,2,8-g3-path3", "32S4-8,4,8-g9-path18" ];
