...
s`Degree := 32;
s`Filename := "32S1-4,32,32-g12-path1.m";
...
\[ 3, 9, 11, 2, 12, 8, 1, 13, 19, 5, 21, 18, 22, 10, 6, 4, 7, 23, 28, 15, 29, 30, 31, 20, 14, 16, 17, 32, 26, 27, 24, 25 ],
\[ 4, 10, 2, 14, 15, 7, 16, 1, 5, 20, 9, 6, 3, 24, 17, 25, 26, 8, 12, 27, 19, 11, 13, 30, 31, 32, 29, 18, 28, 21, 22, 23 ] >;
s`Name := "32S1-4,32,32-g12-path1";
s`Orders := \[ 4, 32, 32 ];
s`Parents := [ Strings() | "64S1-8,64,64-g28-path1", "64S1-8,64,64-g28-path2", "64S50-4,32,32-g23-path1", "64S50-4,32,32-g23-path2" ];
...
s`PassportName := "32S1-4,32,32-g12";
s`PassportSize := 2;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T1-2,16,16-g4-path1", "32S1-4,32,32-g12-path1" ];
