...
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S28-16,8,16-g25-path5", "64S28-16,4,16-g21-path5", "64S3-8,8,8-g21-path142", "64S28-16,8,16-g25-path6", "64S28-16,4,16-g21-path6", "64S3-8,8,8-g21-path143", "64S17-8,4,8-g17-path159" ];
