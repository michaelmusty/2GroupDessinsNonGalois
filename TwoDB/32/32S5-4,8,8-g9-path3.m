...
s`Degree := 32;
s`Filename := "32S5-4,8,8-g9-path3.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 29, 5, 18, 31, 10, 12, 26, 4, 30, 17, 6, 32, 16, 28, 14, 23, 27, 7, 8, 20, 19, 22, 25, 11 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 30, 31, 2, 5, 9, 17, 27, 3, 29, 12, 28, 16, 32, 6, 13, 11, 26, 21, 20, 8, 15, 25, 22, 23 ] >;
s`Name := "32S5-4,8,8-g9-path3";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S29-8,16,16-g25-path65", "64S31-8,16,16-g25-path65", "64S31-8,16,16-g25-path66", "64S30-8,16,16-g25-path33", "64S31-8,16,16-g25-path67", "64S29-8,16,16-g25-path66", "64S30-8,16,16-g25-path34", "64S31-8,16,16-g25-path68", "64S7-4,8,8-g17-path191", "64S6-4,8,8-g17-path55", "64S5-4,8,8-g17-path40", "64S6-4,8,8-g17-path56", "64S17-4,8,8-g17-path221", "64S4-4,8,8-g17-path17", "64S7-4,8,8-g17-path192" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path1", "32S5-4,8,8-g9-path3" ];
