...
s`Degree := 32;
s`Filename := "32S1-32,16,32-g15-path2.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 4, 12, 19, 2, 7, 20, 27, 28, 17, 29, 5, 16, 30, 24, 26, 9, 11, 10, 18, 31, 32, 21, 22, 23, 25 ],
\[ 4, 7, 6, 3, 16, 13, 8, 1, 11, 18, 12, 2, 15, 17, 20, 14, 27, 19, 5, 28, 23, 25, 24, 9, 26, 10, 29, 30, 31, 32, 21, 22 ] >;
s`Name := "32S1-32,16,32-g15-path2";
s`Orders := \[ 32, 16, 32 ];
s`Parents := [ Strings() | "64S1-64,32,64-g31-path3", "64S1-64,32,64-g31-path4", "64S50-32,16,32-g29-path3", "64S50-32,16,32-g29-path4" ];
...
s`PassportSize := 8;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T1-16,8,16-g7-path1", "32S1-32,16,32-g15-path2" ];
