...
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path102", "64S28-4,16,16-g21-path15", "64S28-8,16,16-g25-path15", "64S3-8,8,8-g21-path103", "64S28-4,16,16-g21-path16", "64S28-8,16,16-g25-path16", "64S17-4,8,8-g17-path164" ];
