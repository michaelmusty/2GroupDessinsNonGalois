...
s`Degree := 32;
s`Filename := "32S10-4,8,4-g7-path24.m";
...
\[ 3, 9, 12, 6, 14, 22, 1, 28, 13, 2, 18, 11, 15, 30, 25, 10, 31, 19, 27, 4, 5, 29, 32, 20, 26, 16, 7, 24, 8, 23, 21, 17 ],
\[ 4, 7, 13, 18, 10, 21, 25, 1, 30, 32, 2, 24, 19, 29, 5, 3, 20, 8, 16, 14, 28, 12, 6, 27, 11, 31, 22, 23, 17, 26, 9, 15 ] >;
s`Name := "32S10-4,8,4-g7-path24";
s`Orders := \[ 4, 8, 4 ];
s`Parents := [ Strings() | "64S7-8,8,4-g17-path25", "64S13-8,8,4-g17-path13", "64S7-8,8,4-g17-path26", "64S14-8,8,4-g17-path13", "64S9-4,8,4-g13-path31", "64S21-4,8,4-g13-path16", "64S9-4,8,4-g13-path32" ];
...
s`PassportSize := 2;
s`PathNumber := 24;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T12-2,8,4-g2-path2", "32S10-4,8,4-g7-path24" ];
