...
s`Degree := 32;
s`Filename := "32S9-4,8,2-g3-path16.m";
...
\[ 3, 8, 11, 2, 13, 15, 1, 17, 5, 6, 19, 10, 21, 4, 23, 7, 25, 9, 27, 14, 29, 12, 31, 16, 30, 18, 24, 22, 32, 20, 28, 26 ],
\[ 4, 9, 12, 1, 10, 7, 6, 16, 2, 5, 20, 3, 14, 13, 18, 8, 26, 15, 28, 11, 22, 21, 24, 23, 27, 17, 25, 19, 30, 29, 32, 31 ] >;
s`Name := "32S9-4,8,2-g3-path16";
s`Orders := \[ 4, 8, 2 ];
s`Parents := [ Strings() | "64S12-8,8,2-g9-path18", "64S8-4,8,4-g13-path68", "64S6-8,8,4-g17-path75", "64S6-8,8,2-g9-path75", "64S21-4,8,4-g13-path173", "64S13-8,8,4-g17-path63", "64S38-4,16,2-g7-path13", "64S42-8,16,2-g11-path7", "64S41-4,16,4-g15-path24", "64S40-8,16,4-g19-path7", "64S41-4,16,2-g7-path7", "64S40-8,16,2-g11-path7", "64S39-4,16,4-g15-path36", "64S43-8,16,4-g19-path7", "64S8-4,8,2-g5-path29" ];
...
s`PassportSize := 1;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path2", "32S9-4,8,2-g3-path16" ];
