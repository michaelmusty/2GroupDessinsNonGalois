...
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path21.m";
...
\[ 3, 10, 13, 6, 15, 23, 1, 2, 25, 16, 29, 9, 7, 4, 31, 8, 19, 20, 27, 28, 5, 11, 14, 17, 30, 18, 24, 26, 32, 12, 21, 22 ],
\[ 4, 7, 14, 17, 18, 24, 6, 1, 8, 13, 21, 2, 23, 19, 26, 3, 29, 30, 11, 25, 20, 5, 27, 32, 16, 12, 22, 9, 31, 10, 28, 15 ] >;
s`Name := "32S12-8,4,8-g9-path21";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S45-16,8,16-g25-path5", "64S45-16,8,16-g25-path6", "64S44-16,4,16-g21-path5", "64S16-8,8,8-g21-path59", "64S44-16,4,16-g21-path6", "64S15-8,8,8-g21-path59", "64S17-8,4,8-g17-path13" ];
...
s`PassportSize := 2;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T6-8,4,8-g5-path2", "32S12-8,4,8-g9-path21" ];
