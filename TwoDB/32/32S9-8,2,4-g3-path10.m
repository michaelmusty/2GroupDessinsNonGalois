...
s`Degree := 32;
s`Filename := "32S9-8,2,4-g3-path10.m";
...
\[ 3, 9, 1, 6, 13, 4, 22, 23, 2, 25, 16, 14, 5, 12, 30, 11, 18, 17, 32, 21, 20, 7, 8, 26, 10, 24, 31, 29, 28, 15, 27, 19 ],
\[ 4, 3, 12, 16, 17, 20, 1, 9, 24, 13, 2, 11, 28, 8, 6, 7, 31, 23, 5, 22, 25, 15, 32, 14, 30, 18, 10, 27, 21, 29, 19, 26 ] >;
s`Name := "32S9-8,2,4-g3-path10";
s`Orders := \[ 8, 2, 4 ];
s`Parents := [ Strings() | "64S8-8,4,4-g13-path45", "64S12-8,2,8-g9-path29", "64S6-8,4,8-g17-path86", "64S21-8,4,4-g13-path150", "64S6-8,2,8-g9-path86", "64S13-8,4,8-g17-path74", "64S38-16,2,4-g7-path7", "64S41-16,4,4-g15-path1", "64S42-16,2,8-g11-path1", "64S40-16,4,8-g19-path1", "64S41-16,2,4-g7-path1", "64S39-16,4,4-g15-path13", "64S40-16,2,8-g11-path1", "64S43-16,4,8-g19-path1", "64S8-8,2,4-g5-path23" ];
...
s`PassportSize := 1;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-4,2,4-g1-path8", "32S9-8,2,4-g3-path10" ];
