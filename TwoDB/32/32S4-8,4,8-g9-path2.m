...
s`Degree := 32;
s`Filename := "32S4-8,4,8-g9-path2.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 30, 29, 18, 8, 2, 31, 7, 17, 32, 28, 12, 5, 22, 15, 9, 4, 23, 26, 13, 11, 21, 20, 27, 25, 19 ],
\[ 4, 7, 15, 20, 21, 25, 28, 1, 12, 5, 19, 32, 2, 24, 22, 6, 26, 3, 23, 10, 31, 30, 13, 9, 18, 27, 14, 29, 11, 16, 8, 17 ] >;
s`Name := "32S4-8,4,8-g9-path2";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S28-16,8,16-g25-path35", "64S28-16,4,16-g21-path35", "64S3-8,8,8-g21-path172", "64S28-16,8,16-g25-path36", "64S28-16,4,16-g21-path36", "64S3-8,8,8-g21-path173", "64S17-8,4,8-g17-path174" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path11", "32S4-8,4,8-g9-path2" ];
