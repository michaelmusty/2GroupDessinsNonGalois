...
{ IntegerRing() | 30, 31 }
@};
s`Child := "16T5-2,8,8-g3-path2";
s`Degree := 32;
s`Filename := "32S5-2,8,8-g5-path13.m";
...
\[ 3, 8, 11, 2, 10, 1, 19, 12, 7, 20, 21, 23, 5, 13, 9, 4, 15, 6, 22, 24, 29, 31, 30, 32, 17, 14, 18, 16, 27, 28, 25, 26 ],
\[ 4, 6, 9, 14, 15, 17, 1, 5, 13, 2, 8, 3, 16, 25, 18, 27, 26, 28, 10, 7, 19, 11, 20, 12, 29, 30, 31, 32, 23, 21, 24, 22 ] >;
s`Name := "32S5-2,8,8-g5-path13";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "64S17-4,8,8-g17-path185", "64S7-4,8,8-g17-path119", "64S7-4,8,8-g17-path120", "64S5-4,8,8-g17-path4", "64S29-2,16,16-g13-path20", "64S29-4,16,16-g21-path20", "64S31-2,16,16-g13-path7", "64S31-4,16,16-g21-path7", "64S31-2,16,16-g13-path8", "64S31-4,16,16-g21-path8", "64S30-2,16,16-g13-path4", "64S30-4,16,16-g21-path4", "64S6-2,8,8-g9-path29", "64S6-2,8,8-g9-path30", "64S4-2,8,8-g9-path4" ];
...
s`PassportSize := 1;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T5-2,8,8-g3-path2", "32S5-2,8,8-g5-path13" ];
