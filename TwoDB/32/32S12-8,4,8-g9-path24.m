...
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S45-16,8,16-g25-path11", "64S45-16,8,16-g25-path12", "64S44-16,4,16-g21-path11", "64S16-8,8,8-g21-path62", "64S44-16,4,16-g21-path12", "64S15-8,8,8-g21-path62", "64S17-8,4,8-g17-path16" ];
