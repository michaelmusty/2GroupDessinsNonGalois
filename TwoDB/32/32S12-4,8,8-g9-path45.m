...
s`Degree := 32;
s`Filename := "32S12-4,8,8-g9-path45.m";
...
\[ 3, 10, 13, 6, 14, 8, 1, 25, 23, 15, 27, 2, 21, 17, 29, 9, 7, 20, 4, 22, 5, 19, 28, 12, 18, 32, 24, 31, 11, 16, 26, 30 ],
\[ 4, 7, 2, 17, 18, 16, 24, 1, 12, 9, 21, 30, 8, 11, 3, 19, 22, 13, 32, 31, 15, 5, 6, 14, 23, 29, 26, 10, 28, 27, 25, 20 ] >;
s`Name := "32S12-4,8,8-g9-path45";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path39", "64S44-4,16,16-g21-path37", "64S45-8,16,16-g25-path37", "64S44-4,16,16-g21-path38", "64S45-8,16,16-g25-path38", "64S15-8,8,8-g21-path39", "64S17-4,8,8-g17-path39" ];
...
s`PassportSize := 2;
s`PathNumber := 45;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T8-4,4,4-g3-path5", "32S12-4,8,8-g9-path45" ];
