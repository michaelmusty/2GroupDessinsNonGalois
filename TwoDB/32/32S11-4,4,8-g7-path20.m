...
s`Degree := 32;
s`Filename := "32S11-4,4,8-g7-path20.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 25, 21, 11, 12, 2, 19, 26, 24, 15, 32, 20, 30, 6, 28, 31, 16, 23, 14, 8, 13, 29, 9, 27, 17, 22 ],
\[ 4, 3, 15, 19, 20, 21, 23, 1, 10, 31, 7, 32, 2, 5, 30, 9, 18, 29, 14, 27, 25, 6, 13, 28, 17, 22, 8, 12, 26, 11, 24, 16 ] >;
s`Name := "32S11-4,4,8-g7-path20";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S6-8,4,8-g17-path9", "64S7-8,4,8-g17-path88", "64S10-8,4,8-g17-path9", "64S11-8,4,8-g17-path20", "64S20-4,4,8-g13-path34", "64S8-4,4,8-g13-path12", "64S9-4,4,8-g13-path102" ];
...
s`PassportSize := 2;
s`PathNumber := 20;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S11-4,4,8-g7-path20" ];
