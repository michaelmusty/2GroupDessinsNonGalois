...
s`Degree := 32;
s`Filename := "32S11-2,4,8-g3-path2.m";
...
\[ 3, 8, 11, 2, 13, 1, 23, 18, 26, 24, 6, 7, 27, 17, 29, 15, 9, 4, 5, 22, 30, 21, 31, 32, 10, 14, 19, 16, 28, 20, 12, 25 ],
\[ 4, 6, 12, 16, 17, 22, 1, 25, 19, 2, 26, 15, 30, 3, 18, 20, 24, 13, 23, 5, 11, 28, 10, 7, 21, 29, 8, 9, 31, 32, 27, 14 ] >;
s`Name := "32S11-2,4,8-g3-path2";
s`Orders := \[ 2, 4, 8 ];
s`Parents := [ Strings() | "64S20-4,4,8-g13-path4", "64S6-2,8,8-g9-path4", "64S7-4,8,8-g17-path72", "64S9-4,4,8-g13-path72", "64S10-2,8,8-g9-path4", "64S11-4,8,8-g17-path4", "64S8-2,4,8-g5-path4" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S11-2,4,8-g3-path2" ];
