...
s`Degree := 32;
s`Filename := "32S17-4,16,16-g11-path2.m";
...
\[ 3, 9, 11, 6, 12, 8, 1, 18, 13, 2, 21, 19, 23, 5, 7, 4, 10, 22, 28, 14, 29, 31, 30, 16, 15, 20, 17, 32, 26, 24, 27, 25 ],
\[ 4, 7, 2, 15, 10, 14, 17, 1, 5, 20, 8, 6, 3, 16, 24, 26, 25, 12, 9, 27, 13, 11, 19, 32, 31, 30, 29, 18, 22, 21, 28, 23 ] >;
s`Name := "32S17-4,16,16-g11-path2";
s`Orders := \[ 4, 16, 16 ];
s`Parents := [ Strings() | "64S29-4,16,16-g21-path11", "64S44-4,16,16-g21-path73", "64S27-4,16,16-g21-path9" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T5-2,8,8-g3-path2", "32S17-4,16,16-g11-path2" ];
