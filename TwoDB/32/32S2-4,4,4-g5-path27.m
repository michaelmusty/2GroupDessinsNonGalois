...
{ IntegerRing() | 30, 31 }
@};
s`Child := "16T10-4,4,2-g1-path3";
s`Degree := 32;
s`Filename := "32S2-4,4,4-g5-path27.m";
...
\[ 3, 10, 14, 20, 16, 22, 1, 6, 19, 15, 5, 26, 2, 7, 13, 32, 12, 17, 30, 25, 4, 28, 29, 9, 21, 18, 31, 8, 27, 24, 23, 11 ],
\[ 4, 11, 15, 5, 8, 23, 2, 1, 17, 30, 12, 7, 9, 25, 16, 18, 29, 3, 28, 24, 19, 14, 20, 6, 32, 31, 21, 27, 13, 26, 10, 22 ] >;
s`Name := "32S2-4,4,4-g5-path27";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S20-8,4,4-g13-path81", "64S21-4,8,4-g13-path87", "64S25-8,8,4-g17-path37", "64S21-4,4,8-g13-path87", "64S17-8,4,8-g17-path65", "64S24-4,8,8-g17-path19", "64S22-8,8,8-g21-path121", "64S21-8,4,4-g13-path87", "64S18-4,8,4-g13-path19", "64S24-8,8,4-g17-path19", "64S20-4,4,8-g13-path81", "64S24-8,4,8-g17-path19", "64S25-4,8,8-g17-path37", "64S19-8,8,8-g21-path19", "64S20-8,4,4-g13-path82", "64S20-4,8,4-g13-path81", "64S17-8,8,4-g17-path65", "64S20-4,4,8-g13-path82", "64S25-8,4,8-g17-path37", "64S17-4,8,8-g17-path65", "64S22-8,8,8-g21-path122", "64S18-8,4,4-g13-path19", "64S20-4,8,4-g13-path82", "64S25-8,8,4-g17-path38", "64S18-4,4,8-g13-path19", "64S25-8,4,8-g17-path38", "64S25-4,8,8-g17-path38", "64S22-8,8,8-g21-path123", "64S23-4,4,4-g9-path55", "64S23-4,4,4-g9-path56", "64S23-4,4,4-g9-path57" ];
...
s`PassportSize := 1;
s`PathNumber := 27;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path3", "32S2-4,4,4-g5-path27" ];
