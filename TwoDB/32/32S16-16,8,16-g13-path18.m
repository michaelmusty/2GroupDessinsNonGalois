...
s`Degree := 32;
s`Filename := "32S16-16,8,16-g13-path18.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 26, 22, 25, 27, 29, 19, 21, 24, 4, 31, 5, 30, 28, 7, 32, 18, 9, 10, 11, 20, 17 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 25, 2, 15, 21, 24, 3, 29, 9, 10, 32, 12, 27, 5, 23, 31, 8, 28, 30, 13, 14, 26, 16 ] >;
s`Name := "32S16-16,8,16-g13-path18";
s`Orders := \[ 16, 8, 16 ];
s`Parents := [ Strings() | "64S50-32,16,32-g29-path25", "64S51-32,16,32-g29-path17", "64S50-32,16,32-g29-path26", "64S51-32,16,32-g29-path18", "64S29-16,8,16-g25-path9", "64S26-16,8,16-g25-path9", "64S44-16,8,16-g25-path55" ];
...
s`PassportSize := 2;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T5-8,4,8-g5-path7", "32S16-16,8,16-g13-path18" ];
