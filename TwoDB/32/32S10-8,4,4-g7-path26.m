...
s`Degree := 32;
s`Filename := "32S10-8,4,4-g7-path26.m";
...
\[ 3, 10, 14, 6, 16, 22, 1, 21, 23, 18, 27, 2, 5, 7, 17, 32, 11, 12, 30, 4, 26, 20, 24, 28, 31, 29, 15, 9, 8, 25, 19, 13 ],
\[ 4, 7, 15, 5, 8, 23, 11, 1, 12, 31, 13, 30, 2, 22, 16, 18, 9, 3, 20, 28, 25, 32, 21, 10, 6, 14, 24, 29, 19, 17, 27, 26 ] >;
s`Name := "32S10-8,4,4-g7-path26";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S7-8,4,8-g17-path41", "64S13-8,4,8-g17-path21", "64S7-8,4,8-g17-path42", "64S14-8,4,8-g17-path21", "64S9-8,4,4-g13-path35", "64S21-8,4,4-g13-path18", "64S9-8,4,4-g13-path36" ];
...
s`PassportSize := 2;
s`PathNumber := 26;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,4,2-g2-path1", "32S10-8,4,4-g7-path26" ];
