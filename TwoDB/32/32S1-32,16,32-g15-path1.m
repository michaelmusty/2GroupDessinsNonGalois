...
s`Degree := 32;
s`Filename := "32S1-32,16,32-g15-path1.m";
...
\[ 3, 8, 10, 6, 11, 2, 1, 12, 19, 20, 21, 22, 15, 17, 7, 4, 9, 5, 23, 24, 31, 32, 25, 26, 27, 29, 16, 13, 18, 14, 28, 30 ],
\[ 4, 7, 6, 13, 14, 15, 16, 1, 18, 2, 17, 3, 25, 26, 27, 28, 29, 30, 5, 8, 9, 10, 11, 12, 21, 22, 31, 23, 32, 24, 19, 20 ] >;
s`Name := "32S1-32,16,32-g15-path1";
s`Orders := \[ 32, 16, 32 ];
s`Parents := [ Strings() | "64S1-64,32,64-g31-path1", "64S1-64,32,64-g31-path2", "64S50-32,16,32-g29-path1", "64S50-32,16,32-g29-path2" ];
...
s`PassportSize := 8;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T1-16,8,16-g7-path1", "32S1-32,16,32-g15-path1" ];
