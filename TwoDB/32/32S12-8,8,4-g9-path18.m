...
s`Degree := 32;
s`Filename := "32S12-8,8,4-g9-path18.m";
...
\[ 3, 10, 9, 19, 15, 13, 1, 6, 18, 14, 5, 24, 2, 31, 28, 20, 16, 29, 27, 4, 32, 7, 22, 17, 30, 8, 12, 25, 23, 21, 26, 11 ],
\[ 4, 11, 14, 5, 8, 21, 2, 1, 27, 29, 12, 7, 9, 15, 17, 32, 3, 26, 23, 18, 19, 16, 6, 30, 20, 25, 28, 13, 24, 10, 22, 31 ] >;
s`Name := "32S12-8,8,4-g9-path18";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S44-16,16,8-g25-path17", "64S44-16,16,8-g25-path18", "64S45-16,16,4-g21-path17", "64S16-8,8,8-g21-path101", "64S45-16,16,4-g21-path18", "64S15-8,8,8-g21-path101", "64S17-8,8,4-g17-path9" ];
...
s`PassportSize := 2;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T6-8,8,2-g3-path4", "32S12-8,8,4-g9-path18" ];
