...
s`Degree := 32;
s`Filename := "32S6-4,4,4-g5-path3.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 16, 5, 18, 29, 7, 12, 28, 4, 30, 17, 6, 27, 32, 31, 26, 23, 14, 8, 22, 10, 25, 11, 20, 19 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 27, 29, 2, 5, 21, 20, 26, 3, 32, 8, 31, 16, 30, 6, 28, 22, 13, 17, 23, 9, 11, 25, 12, 15 ] >;
s`Name := "32S6-4,4,4-g5-path3";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S8-4,8,4-g13-path38", "64S8-4,4,8-g13-path38", "64S4-4,8,8-g17-path28", "64S9-4,8,4-g13-path150", "64S9-4,4,8-g13-path150", "64S5-4,8,8-g17-path62", "64S32-4,8,4-g13-path16", "64S32-4,4,8-g13-path16", "64S36-4,8,8-g17-path5", "64S33-4,8,4-g13-path38", "64S33-4,4,8-g13-path38", "64S37-4,8,8-g17-path16", "64S23-4,4,4-g9-path303", "64S34-4,4,4-g9-path27", "64S35-4,4,4-g9-path60" ];
...
s`PassportSize := 3;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path1", "32S6-4,4,4-g5-path3" ];
