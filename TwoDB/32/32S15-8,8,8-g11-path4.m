...
s`Degree := 32;
s`Filename := "32S15-8,8,8-g11-path4.m";
...
\[ 3, 10, 9, 6, 15, 12, 1, 26, 21, 17, 4, 2, 19, 16, 23, 27, 30, 28, 20, 31, 5, 14, 7, 32, 22, 29, 8, 24, 25, 11, 18, 13 ],
\[ 4, 7, 14, 19, 10, 15, 25, 1, 12, 28, 21, 31, 2, 24, 26, 23, 3, 11, 22, 17, 27, 5, 30, 6, 18, 20, 13, 8, 9, 32, 16, 29 ] >;
s`Name := "32S15-8,8,8-g11-path4";
s`Orders := \[ 8, 8, 8 ];
s`Parents := [ Strings() | "64S15-8,8,8-g21-path284", "64S16-8,8,8-g21-path284", "64S22-8,8,8-g21-path44" ];
...
s`PassportSize := 6;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path11", "32S15-8,8,8-g11-path4" ];
