...
s`Degree := 32;
s`Filename := "32S12-8,8,4-g9-path5.m";
...
\[ 3, 4, 13, 6, 15, 17, 1, 14, 7, 8, 2, 5, 23, 16, 24, 26, 25, 10, 11, 12, 9, 20, 29, 27, 30, 31, 32, 18, 21, 19, 28, 22 ],
\[ 4, 7, 14, 5, 8, 3, 10, 1, 11, 12, 20, 2, 17, 15, 6, 13, 24, 9, 21, 18, 28, 19, 26, 16, 23, 27, 25, 22, 30, 32, 29, 31 ] >;
s`Name := "32S12-8,8,4-g9-path5";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path134", "64S15-8,8,8-g21-path134", "64S44-16,16,4-g21-path41", "64S45-16,16,8-g25-path41", "64S44-16,16,4-g21-path42", "64S45-16,16,8-g25-path42", "64S17-8,8,4-g17-path42" ];
...
s`PassportSize := 2;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,2-g3-path5", "32S12-8,8,4-g9-path5" ];
