...
{ IntegerRing() | 24, 31 }
@};
s`Child := "16T12-8,4,2-g2-path1";
s`Degree := 32;
s`Filename := "32S13-8,4,4-g7-path4.m";
...
\[ 3, 10, 14, 20, 16, 22, 1, 6, 23, 15, 5, 27, 2, 7, 13, 32, 12, 17, 30, 26, 4, 29, 31, 19, 24, 21, 18, 9, 8, 25, 28, 11 ],
\[ 4, 11, 15, 5, 8, 23, 2, 1, 17, 31, 12, 7, 9, 26, 16, 18, 30, 3, 29, 25, 19, 14, 20, 10, 6, 32, 24, 21, 28, 13, 27, 22 ] >;
s`Name := "32S13-8,4,4-g7-path4";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S46-16,8,4-g19-path23", "64S46-16,4,8-g19-path23", "64S15-8,8,8-g21-path229", "64S46-16,8,4-g19-path24", "64S46-16,4,8-g19-path24", "64S15-8,8,8-g21-path230", "64S21-8,4,4-g13-path46" ];
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,4,2-g2-path1", "32S13-8,4,4-g7-path4" ];
