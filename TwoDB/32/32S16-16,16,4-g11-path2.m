...
s`Degree := 32;
s`Filename := "32S16-16,16,4-g11-path2.m";
...
\[ 14, 22, 27, 20, 3, 24, 5, 28, 26, 8, 10, 29, 31, 13, 32, 30, 6, 25, 17, 9, 1, 15, 21, 12, 2, 16, 19, 23, 18, 11, 4, 7 ],
\[ 17, 21, 20, 29, 4, 30, 31, 5, 25, 7, 32, 10, 24, 6, 14, 22, 16, 28, 26, 18, 19, 1, 27, 11, 23, 2, 9, 3, 8, 15, 12, 13 ] >;
s`Name := "32S16-16,16,4-g11-path2";
s`Orders := \[ 16, 16, 4 ];
s`Parents := [ Strings() | "64S50-32,32,8-g27-path7", "64S51-32,32,8-g27-path3", "64S50-32,32,8-g27-path8", "64S51-32,32,8-g27-path4", "64S44-16,16,4-g21-path57", "64S26-16,16,4-g21-path11", "64S29-16,16,4-g21-path2" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T1-16,16,4-g6-path1", "32S16-16,16,4-g11-path2" ];
