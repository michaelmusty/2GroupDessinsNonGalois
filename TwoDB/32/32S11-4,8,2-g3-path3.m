...
s`Degree := 32;
s`Filename := "32S11-4,8,2-g3-path3.m";
...
\[ 3, 9, 12, 6, 14, 21, 1, 25, 13, 28, 2, 20, 15, 24, 10, 32, 19, 4, 23, 5, 31, 8, 18, 7, 27, 16, 29, 30, 26, 11, 17, 22 ],
\[ 4, 7, 13, 1, 17, 22, 2, 11, 27, 20, 8, 21, 3, 30, 26, 18, 5, 16, 29, 10, 12, 6, 24, 23, 31, 15, 9, 32, 19, 14, 25, 28 ] >;
s`Name := "32S11-4,8,2-g3-path3";
s`Orders := \[ 4, 8, 2 ];
s`Parents := [ Strings() | "64S6-8,8,2-g9-path5", "64S20-4,8,4-g13-path16", "64S7-8,8,4-g17-path73", "64S10-8,8,2-g9-path5", "64S9-4,8,4-g13-path84", "64S11-8,8,4-g17-path5", "64S8-4,8,2-g5-path5" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T10-4,4,2-g1-path1", "32S11-4,8,2-g3-path3" ];
