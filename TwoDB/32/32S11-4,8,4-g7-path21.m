...
s`Degree := 32;
s`Filename := "32S11-4,8,4-g7-path21.m";
...
\[ 3, 10, 14, 19, 16, 21, 1, 6, 26, 15, 5, 24, 2, 11, 28, 25, 13, 31, 32, 4, 20, 29, 9, 17, 7, 30, 8, 12, 18, 22, 23, 27 ],
\[ 4, 11, 15, 5, 8, 22, 2, 1, 28, 30, 12, 7, 9, 32, 16, 17, 3, 27, 23, 18, 14, 19, 6, 31, 21, 20, 26, 29, 13, 24, 10, 25 ] >;
s`Name := "32S11-4,8,4-g7-path21";
s`Orders := \[ 4, 8, 4 ];
s`Parents := [ Strings() | "64S6-8,8,4-g17-path10", "64S7-8,8,4-g17-path89", "64S10-8,8,4-g17-path10", "64S11-8,8,4-g17-path21", "64S20-4,8,4-g13-path35", "64S8-4,8,4-g13-path13", "64S9-4,8,4-g13-path103" ];
...
s`PassportSize := 2;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S11-4,8,4-g7-path21" ];
