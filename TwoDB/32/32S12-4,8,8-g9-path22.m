...
s`Degree := 32;
s`Filename := "32S12-4,8,8-g9-path22.m";
...
\[ 3, 10, 13, 6, 14, 8, 1, 25, 23, 15, 27, 2, 31, 30, 18, 9, 7, 20, 4, 22, 5, 24, 28, 12, 29, 32, 19, 21, 11, 16, 26, 17 ],
\[ 4, 7, 2, 17, 18, 16, 24, 1, 12, 9, 21, 30, 8, 11, 3, 19, 27, 28, 14, 31, 25, 5, 6, 32, 23, 29, 26, 10, 13, 22, 15, 20 ] >;
s`Name := "32S12-4,8,8-g9-path22";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path14", "64S44-4,16,16-g21-path7", "64S45-8,16,16-g25-path7", "64S44-4,16,16-g21-path8", "64S45-8,16,16-g25-path8", "64S15-8,8,8-g21-path14", "64S17-4,8,8-g17-path14" ];
...
s`PassportSize := 2;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-4,8,8-g5-path3", "32S12-4,8,8-g9-path22" ];
