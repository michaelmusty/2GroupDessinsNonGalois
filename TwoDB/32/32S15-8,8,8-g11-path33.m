...
s`Degree := 32;
s`Filename := "32S15-8,8,8-g11-path33.m";
...
\[ 3, 4, 13, 6, 15, 23, 1, 14, 7, 18, 2, 17, 21, 16, 9, 30, 19, 20, 32, 11, 5, 31, 10, 25, 8, 28, 26, 29, 12, 22, 24, 27 ],
\[ 4, 7, 14, 17, 18, 3, 25, 1, 11, 21, 29, 2, 23, 28, 31, 13, 22, 26, 6, 15, 30, 5, 32, 9, 27, 8, 10, 20, 16, 12, 19, 24 ] >;
s`Name := "32S15-8,8,8-g11-path33";
s`Orders := \[ 8, 8, 8 ];
s`Parents := [ Strings() | "64S22-8,8,8-g21-path26", "64S16-8,8,8-g21-path266", "64S15-8,8,8-g21-path266" ];
...
s`PassportSize := 6;
s`PathNumber := 33;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path25", "32S15-8,8,8-g11-path33" ];
