...
s`Degree := 32;
s`Filename := "32S13-4,4,8-g7-path9.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 28, 22, 18, 4, 2, 20, 7, 17, 9, 27, 12, 30, 21, 32, 5, 15, 11, 31, 29, 23, 26, 8, 25, 19, 13 ],
\[ 4, 7, 15, 20, 10, 16, 27, 1, 12, 30, 22, 31, 2, 24, 25, 28, 9, 3, 11, 23, 18, 29, 5, 32, 6, 14, 19, 21, 13, 8, 26, 17 ] >;
s`Name := "32S13-4,4,8-g7-path9";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S46-8,4,16-g19-path33", "64S46-4,8,16-g19-path33", "64S15-8,8,8-g21-path171", "64S46-8,4,16-g19-path34", "64S46-4,8,16-g19-path34", "64S15-8,8,8-g21-path172", "64S21-4,4,8-g13-path51" ];
...
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T8-4,4,4-g3-path13", "32S13-4,4,8-g7-path9" ];
