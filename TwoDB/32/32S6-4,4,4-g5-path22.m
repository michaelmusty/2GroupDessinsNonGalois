...
s`Degree := 32;
s`Filename := "32S6-4,4,4-g5-path22.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 25, 21, 11, 12, 2, 19, 26, 24, 15, 31, 20, 29, 6, 27, 30, 16, 23, 14, 8, 28, 9, 32, 17, 22, 13 ],
\[ 4, 3, 15, 19, 20, 21, 23, 1, 10, 30, 7, 31, 2, 5, 13, 9, 18, 28, 8, 32, 25, 6, 29, 27, 22, 17, 12, 26, 11, 16, 24, 14 ] >;
s`Name := "32S6-4,4,4-g5-path22";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S8-8,4,4-g13-path33", "64S8-4,4,8-g13-path36", "64S4-8,4,8-g17-path34", "64S9-8,4,4-g13-path145", "64S9-4,4,8-g13-path148", "64S5-8,4,8-g17-path68", "64S32-8,4,4-g13-path11", "64S32-4,4,8-g13-path14", "64S36-8,4,8-g17-path11", "64S33-8,4,4-g13-path33", "64S33-4,4,8-g13-path36", "64S37-8,4,8-g17-path22", "64S23-4,4,4-g9-path290", "64S34-4,4,4-g9-path14", "64S35-4,4,4-g9-path47" ];
...
s`PassportSize := 3;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S6-4,4,4-g5-path22" ];
