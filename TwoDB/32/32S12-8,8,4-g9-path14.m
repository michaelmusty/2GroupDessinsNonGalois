...
s`Degree := 32;
s`Filename := "32S12-8,8,4-g9-path14.m";
...
\[ 3, 8, 9, 18, 15, 12, 1, 27, 13, 5, 14, 2, 32, 17, 28, 11, 31, 16, 23, 6, 24, 4, 30, 7, 20, 19, 29, 26, 25, 10, 22, 21 ],
\[ 4, 10, 6, 19, 20, 23, 25, 1, 16, 22, 7, 24, 2, 5, 18, 30, 3, 21, 8, 32, 27, 13, 17, 31, 26, 11, 15, 12, 9, 29, 28, 14 ] >;
s`Name := "32S12-8,8,4-g9-path14";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S44-16,16,8-g25-path9", "64S44-16,16,8-g25-path10", "64S45-16,16,4-g21-path9", "64S16-8,8,8-g21-path97", "64S45-16,16,4-g21-path10", "64S15-8,8,8-g21-path97", "64S17-8,8,4-g17-path5" ];
...
s`PassportSize := 2;
s`PathNumber := 14;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,4-g5-path7", "32S12-8,8,4-g9-path14" ];
