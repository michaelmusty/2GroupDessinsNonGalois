...
s`Degree := 32;
s`Filename := "32S4-4,8,8-g9-path23.m";
...
\[ 3, 10, 15, 20, 16, 8, 1, 30, 25, 23, 5, 17, 2, 26, 24, 31, 18, 22, 9, 14, 11, 6, 4, 32, 21, 13, 12, 7, 28, 27, 19, 29 ],
\[ 4, 11, 2, 21, 22, 24, 26, 1, 27, 9, 30, 7, 31, 5, 14, 12, 32, 3, 18, 19, 17, 28, 16, 23, 6, 25, 15, 10, 20, 29, 8, 13 ] >;
s`Name := "32S4-4,8,8-g9-path23";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path116", "64S28-4,16,16-g21-path29", "64S28-8,16,16-g25-path29", "64S3-8,8,8-g21-path117", "64S28-4,16,16-g21-path30", "64S28-8,16,16-g25-path30", "64S17-4,8,8-g17-path171" ];
...
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-4,8,8-g5-path3", "32S4-4,8,8-g9-path23" ];
