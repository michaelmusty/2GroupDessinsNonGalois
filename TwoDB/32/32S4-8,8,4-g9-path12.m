...
s`Degree := 32;
s`Filename := "32S4-8,8,4-g9-path12.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 31, 30, 18, 8, 2, 20, 19, 17, 29, 23, 27, 5, 22, 15, 9, 4, 28, 26, 13, 11, 21, 7, 32, 12, 25 ],
\[ 4, 7, 15, 20, 21, 25, 28, 1, 12, 5, 19, 14, 2, 24, 22, 6, 26, 3, 23, 8, 32, 18, 30, 9, 31, 27, 29, 13, 17, 11, 16, 10 ] >;
s`Name := "32S4-8,8,4-g9-path12";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path192", "64S28-16,16,4-g21-path5", "64S28-16,16,8-g25-path5", "64S3-8,8,8-g21-path193", "64S28-16,16,4-g21-path6", "64S28-16,16,8-g25-path6", "64S17-8,8,4-g17-path159" ];
...
s`PassportSize := 1;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T4-4,4,4-g3-path6", "32S4-8,8,4-g9-path12" ];
