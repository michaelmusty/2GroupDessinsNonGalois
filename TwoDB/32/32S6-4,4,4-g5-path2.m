...
s`Degree := 32;
s`Filename := "32S6-4,4,4-g5-path2.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 16, 5, 18, 29, 7, 12, 28, 4, 30, 17, 6, 27, 32, 31, 26, 23, 14, 8, 22, 10, 25, 11, 20, 19 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 27, 29, 2, 5, 21, 20, 26, 3, 32, 8, 31, 16, 30, 6, 28, 22, 13, 17, 23, 9, 11, 25, 12, 15 ] >;
s`Name := "32S6-4,4,4-g5-path2";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S8-4,8,4-g13-path33", "64S8-4,4,8-g13-path37", "64S4-4,8,8-g17-path27", "64S9-4,8,4-g13-path145", "64S9-4,4,8-g13-path149", "64S5-4,8,8-g17-path61", "64S32-4,8,4-g13-path11", "64S32-4,4,8-g13-path15", "64S36-4,8,8-g17-path4", "64S33-4,8,4-g13-path33", "64S33-4,4,8-g13-path37", "64S37-4,8,8-g17-path15", "64S23-4,4,4-g9-path298", "64S34-4,4,4-g9-path22", "64S35-4,4,4-g9-path55" ];
...
s`PassportSize := 3;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S6-4,4,4-g5-path2" ];
...
[ 2, 5, 12, 17, 6, 1, 23, 3, 22, 25, 9, 15, 32, 27, 8, 13, 19, 24, 20, 4, 11, 21, 10, 31, 7, 30, 26, 16, 18, 14, 29, 28 ]
]
];
