...
s`Degree := 32;
s`Filename := "32S9-2,8,4-g3-path16.m";
...
\[ 3, 8, 11, 10, 13, 1, 2, 17, 5, 15, 19, 7, 21, 4, 23, 6, 25, 9, 27, 14, 29, 12, 31, 16, 28, 18, 24, 22, 32, 20, 30, 26 ],
\[ 4, 9, 12, 5, 7, 2, 1, 16, 10, 6, 20, 13, 14, 3, 18, 15, 26, 8, 28, 21, 22, 11, 24, 17, 27, 23, 31, 29, 30, 19, 32, 25 ] >;
s`Name := "32S9-2,8,4-g3-path16";
s`Orders := \[ 2, 8, 4 ];
s`Parents := [ Strings() | "64S8-4,8,4-g13-path51", "64S12-2,8,8-g9-path35", "64S6-4,8,8-g17-path92", "64S21-4,8,4-g13-path156", "64S6-2,8,8-g9-path92", "64S13-4,8,8-g17-path80", "64S38-2,16,4-g7-path13", "64S41-4,16,4-g15-path7", "64S42-2,16,8-g11-path7", "64S40-4,16,8-g19-path7", "64S41-2,16,4-g7-path7", "64S39-4,16,4-g15-path19", "64S40-2,16,8-g11-path7", "64S43-4,16,8-g19-path7", "64S8-2,8,4-g5-path29" ];
...
s`PassportSize := 1;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path2", "32S9-2,8,4-g3-path16" ];
