...
s`Orders := \[ 2, 16, 16 ];
s`Parents := [ Strings() | "64S26-4,16,16-g21-path9", "64S44-4,16,16-g21-path55", "64S50-2,32,32-g15-path11", "64S50-4,32,32-g23-path11", "64S51-2,32,32-g15-path9", "64S51-4,32,32-g23-path9", "64S29-2,16,16-g13-path9" ];
