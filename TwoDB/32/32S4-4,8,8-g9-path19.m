...
s`Degree := 32;
s`Filename := "32S4-4,8,8-g9-path19.m";
...
\[ 3, 9, 13, 2, 15, 22, 1, 28, 25, 5, 27, 21, 20, 12, 18, 26, 31, 17, 6, 32, 4, 16, 30, 14, 24, 29, 7, 19, 8, 10, 23, 11 ],
\[ 4, 10, 14, 18, 19, 7, 25, 1, 31, 16, 2, 5, 9, 17, 29, 3, 28, 22, 13, 21, 23, 32, 6, 30, 15, 27, 12, 11, 20, 8, 26, 24 ] >;
s`Name := "32S4-4,8,8-g9-path19";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path106", "64S28-4,16,16-g21-path19", "64S28-8,16,16-g25-path19", "64S3-8,8,8-g21-path107", "64S28-4,16,16-g21-path20", "64S28-8,16,16-g25-path20", "64S17-4,8,8-g17-path166" ];
...
s`PassportSize := 1;
s`PathNumber := 19;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T6-2,8,8-g3-path4", "32S4-4,8,8-g9-path19" ];
