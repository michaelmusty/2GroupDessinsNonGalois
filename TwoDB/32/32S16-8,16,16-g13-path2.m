...
s`Degree := 32;
s`Filename := "32S16-8,16,16-g13-path2.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 21, 2, 23, 18, 27, 9, 4, 19, 22, 28, 5, 29, 11, 7, 26, 10, 32, 30, 24, 17, 31, 25, 20 ],
\[ 17, 20, 19, 27, 4, 30, 29, 5, 25, 7, 32, 10, 28, 6, 31, 14, 13, 24, 18, 16, 1, 26, 21, 11, 23, 2, 15, 22, 3, 9, 12, 8 ] >;
s`Name := "32S16-8,16,16-g13-path2";
s`Orders := \[ 8, 16, 16 ];
s`Parents := [ Strings() | "64S50-16,32,32-g29-path29", "64S51-16,32,32-g29-path21", "64S50-16,32,32-g29-path30", "64S51-16,32,32-g29-path22", "64S44-8,16,16-g25-path57", "64S26-8,16,16-g25-path11", "64S29-8,16,16-g25-path11" ];
...
s`PassportSize := 2;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T1-8,16,16-g7-path1", "32S16-8,16,16-g13-path2" ];
