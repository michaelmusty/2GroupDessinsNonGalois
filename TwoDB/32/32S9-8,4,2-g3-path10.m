...
s`Degree := 32;
s`Filename := "32S9-8,4,2-g3-path10.m";
...
\[ 3, 9, 12, 6, 14, 20, 1, 23, 13, 26, 2, 7, 11, 28, 30, 18, 4, 32, 5, 17, 22, 15, 25, 8, 24, 29, 10, 19, 27, 21, 16, 31 ],
\[ 4, 7, 13, 1, 16, 21, 2, 11, 25, 19, 8, 20, 3, 29, 17, 5, 15, 24, 10, 12, 6, 27, 31, 18, 9, 30, 22, 32, 14, 26, 23, 28 ] >;
s`Name := "32S9-8,4,2-g3-path10";
s`Orders := \[ 8, 4, 2 ];
s`Parents := [ Strings() | "64S12-8,8,2-g9-path29", "64S8-8,4,4-g13-path62", "64S6-8,8,4-g17-path86", "64S6-8,8,2-g9-path86", "64S21-8,4,4-g13-path167", "64S13-8,8,4-g17-path74", "64S38-16,4,2-g7-path7", "64S42-16,8,2-g11-path1", "64S41-16,4,4-g15-path18", "64S40-16,8,4-g19-path1", "64S41-16,4,2-g7-path1", "64S40-16,8,2-g11-path1", "64S39-16,4,4-g15-path30", "64S43-16,8,4-g19-path1", "64S8-8,4,2-g5-path23" ];
...
s`PassportSize := 1;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-4,4,2-g1-path8", "32S9-8,4,2-g3-path10" ];
