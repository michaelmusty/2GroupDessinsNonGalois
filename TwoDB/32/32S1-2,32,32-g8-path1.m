...
s`Degree := 32;
s`Filename := "32S1-2,32,32-g8-path1.m";
...
\[ 2, 5, 1, 6, 9, 10, 3, 4, 13, 14, 7, 8, 17, 18, 11, 12, 21, 22, 15, 16, 25, 26, 19, 20, 29, 30, 23, 24, 32, 31, 27, 28 ],
\[ 8, 4, 12, 3, 6, 1, 16, 7, 10, 2, 20, 11, 14, 5, 24, 15, 18, 9, 28, 19, 22, 13, 32, 23, 26, 17, 29, 27, 30, 21, 25, 31 ] >;
s`Name := "32S1-2,32,32-g8-path1";
s`Orders := \[ 2, 32, 32 ];
s`Parents := [ Strings() | "64S1-4,64,64-g24-path1", "64S50-2,32,32-g15-path2" ];
...
s`PassportName := "32S1-2,32,32-g8";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T1-1,16,16-g0-path1", "32S1-2,32,32-g8-path1" ];
