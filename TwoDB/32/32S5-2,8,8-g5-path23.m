...
{ IntegerRing() | 26, 32 }
@};
s`Child := "16T6-2,8,8-g3-path5";
s`Degree := 32;
s`Filename := "32S5-2,8,8-g5-path23.m";
...
\[ 3, 8, 11, 2, 13, 1, 24, 14, 27, 25, 29, 7, 16, 31, 26, 15, 9, 4, 5, 18, 12, 21, 6, 17, 19, 10, 22, 23, 32, 20, 30, 28 ],
\[ 4, 6, 12, 16, 17, 22, 1, 26, 19, 2, 8, 15, 30, 3, 18, 27, 11, 28, 14, 5, 23, 13, 20, 10, 7, 21, 32, 9, 24, 29, 25, 31 ] >;
s`Name := "32S5-2,8,8-g5-path23";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "64S17-4,8,8-g17-path196", "64S7-4,8,8-g17-path141", "64S7-4,8,8-g17-path142", "64S5-4,8,8-g17-path15", "64S29-2,16,16-g13-path31", "64S29-4,16,16-g21-path31", "64S31-2,16,16-g13-path29", "64S31-4,16,16-g21-path29", "64S31-2,16,16-g13-path30", "64S31-4,16,16-g21-path30", "64S30-2,16,16-g13-path15", "64S30-4,16,16-g21-path15", "64S6-2,8,8-g9-path51", "64S6-2,8,8-g9-path52", "64S4-2,8,8-g9-path15" ];
...
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T6-2,8,8-g3-path5", "32S5-2,8,8-g5-path23" ];
