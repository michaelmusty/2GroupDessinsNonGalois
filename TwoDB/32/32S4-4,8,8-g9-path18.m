...
s`Degree := 32;
s`Filename := "32S4-4,8,8-g9-path18.m";
...
\[ 3, 9, 13, 2, 15, 22, 1, 28, 25, 5, 27, 21, 20, 12, 18, 26, 31, 17, 6, 32, 4, 16, 30, 14, 24, 29, 7, 19, 8, 10, 23, 11 ],
\[ 4, 10, 14, 18, 19, 7, 25, 1, 31, 16, 2, 5, 9, 17, 29, 3, 28, 22, 13, 21, 23, 32, 6, 30, 15, 27, 12, 11, 20, 8, 26, 24 ] >;
s`Name := "32S4-4,8,8-g9-path18";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path104", "64S28-4,16,16-g21-path17", "64S28-8,16,16-g25-path17", "64S3-8,8,8-g21-path105", "64S28-4,16,16-g21-path18", "64S28-8,16,16-g25-path18", "64S17-4,8,8-g17-path165" ];
...
[ 3, 9, 13, 2, 15, 22, 1, 28, 25, 5, 27, 21, 20, 12, 18, 26, 31, 17, 6, 32, 4, 16, 30, 14, 24, 29, 7, 19, 8, 10, 23, 11 ],
[ 12, 23, 25, 5, 8, 11, 2, 27, 18, 6, 21, 30, 4, 15, 16, 7, 29, 19, 1, 14, 17, 13, 28, 31, 10, 32, 24, 20, 3, 26, 22, 9 ]
]
];
s`PassportName := "32S4-4,8,8-g9";
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T6-2,8,8-g3-path3", "32S4-4,8,8-g9-path18" ];
