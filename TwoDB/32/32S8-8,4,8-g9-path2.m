...
s`Degree := 32;
s`Filename := "32S8-8,4,8-g9-path2.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 28, 27, 11, 12, 2, 30, 29, 26, 15, 32, 20, 13, 6, 19, 9, 22, 31, 16, 25, 23, 14, 8, 21, 17, 24 ],
\[ 4, 3, 15, 19, 20, 22, 25, 1, 10, 31, 7, 32, 2, 5, 21, 23, 18, 27, 14, 30, 11, 29, 12, 6, 13, 9, 28, 24, 17, 8, 16, 26 ] >;
s`Name := "32S8-8,4,8-g9-path2";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S5-8,4,8-g17-path75", "64S11-8,4,8-g17-path51", "64S13-8,4,8-g17-path41", "64S13-8,4,8-g17-path42", "64S11-8,4,8-g17-path52", "64S5-8,4,8-g17-path76", "64S24-8,4,8-g17-path96" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S8-8,4,8-g9-path2" ];
...
[ 10, 27, 29, 32, 12, 3, 28, 23, 20, 19, 22, 30, 6, 9, 24, 5, 2, 7, 16, 31, 18, 25, 4, 11, 17, 1, 15, 13, 21, 26, 8, 14 ]
]
];
