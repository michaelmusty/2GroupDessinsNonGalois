...
s`Degree := 32;
s`Filename := "32S19-16,4,2-g4-path2.m";
...
\[ 3, 9, 5, 14, 7, 4, 1, 18, 10, 11, 2, 6, 16, 12, 22, 15, 26, 19, 20, 8, 30, 13, 24, 21, 29, 27, 28, 17, 32, 23, 25, 31 ],
\[ 4, 3, 2, 1, 12, 15, 10, 9, 8, 7, 19, 5, 14, 13, 6, 21, 18, 17, 11, 27, 16, 23, 22, 31, 26, 25, 20, 32, 30, 29, 24, 28 ] >;
s`Name := "32S19-16,4,2-g4-path2";
s`Orders := \[ 16, 4, 2 ];
s`Parents := [ Strings() | "64S39-16,4,4-g15-path5", "64S48-16,4,4-g15-path22", "64S38-16,4,2-g7-path5" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T13-8,2,2-g0-path2", "32S19-16,4,2-g4-path2" ];
