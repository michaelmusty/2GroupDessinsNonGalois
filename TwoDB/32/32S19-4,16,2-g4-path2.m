...
s`Degree := 32;
s`Filename := "32S19-4,16,2-g4-path2.m";
...
\[ 3, 8, 11, 2, 13, 15, 1, 17, 5, 6, 19, 10, 21, 4, 23, 7, 25, 9, 27, 14, 29, 12, 31, 16, 28, 18, 26, 22, 32, 20, 30, 24 ],
\[ 4, 9, 12, 1, 10, 7, 6, 16, 2, 5, 20, 3, 14, 13, 18, 8, 26, 15, 28, 11, 22, 21, 24, 23, 32, 17, 31, 19, 30, 29, 27, 25 ] >;
s`Name := "32S19-4,16,2-g4-path2";
s`Orders := \[ 4, 16, 2 ];
s`Parents := [ Strings() | "64S39-4,16,4-g15-path5", "64S48-4,16,4-g15-path22", "64S38-4,16,2-g7-path5" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T13-2,8,2-g0-path2", "32S19-4,16,2-g4-path2" ];
