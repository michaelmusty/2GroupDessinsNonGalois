...
s`Degree := 32;
s`Filename := "32S10-4,8,4-g7-path4.m";
...
\[ 3, 9, 13, 2, 15, 22, 1, 28, 16, 5, 31, 25, 10, 12, 27, 19, 32, 17, 6, 30, 4, 21, 18, 29, 24, 14, 7, 26, 8, 23, 20, 11 ],
\[ 4, 10, 14, 18, 19, 7, 25, 1, 30, 28, 2, 5, 22, 17, 29, 3, 16, 8, 31, 21, 15, 32, 6, 13, 23, 27, 9, 11, 20, 26, 12, 24 ] >;
s`Name := "32S10-4,8,4-g7-path4";
s`Orders := \[ 4, 8, 4 ];
s`Parents := [ Strings() | "64S7-4,8,8-g17-path57", "64S13-4,8,8-g17-path29", "64S7-4,8,8-g17-path58", "64S14-4,8,8-g17-path29", "64S9-4,8,4-g13-path57", "64S21-4,8,4-g13-path29", "64S9-4,8,4-g13-path58" ];
...
s`PassportSize := 2;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T10-2,4,4-g1-path2", "32S10-4,8,4-g7-path4" ];
