...
s`Degree := 32;
s`Filename := "32S10-4,4,8-g7-path27.m";
...
\[ 3, 10, 5, 6, 7, 18, 1, 27, 26, 11, 12, 2, 17, 15, 24, 31, 19, 20, 32, 4, 28, 9, 29, 25, 14, 30, 21, 8, 16, 22, 23, 13 ],
\[ 4, 7, 14, 17, 18, 22, 24, 1, 12, 31, 3, 29, 2, 16, 9, 20, 15, 32, 11, 26, 5, 27, 6, 23, 30, 28, 13, 19, 8, 10, 21, 25 ] >;
s`Name := "32S10-4,4,8-g7-path27";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S13-4,8,8-g17-path5", "64S7-4,8,8-g17-path9", "64S14-4,8,8-g17-path5", "64S7-4,8,8-g17-path10", "64S9-4,4,8-g13-path37", "64S21-4,4,8-g13-path19", "64S9-4,4,8-g13-path38" ];
...
s`PassportSize := 2;
s`PathNumber := 27;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-4,2,8-g2-path2", "32S10-4,4,8-g7-path27" ];
