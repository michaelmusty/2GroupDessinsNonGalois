...
s`Degree := 32;
s`Filename := "32S11-8,4,4-g7-path1.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 26, 28, 11, 12, 2, 19, 27, 25, 15, 30, 20, 29, 6, 9, 21, 31, 16, 24, 14, 8, 22, 32, 23, 17, 13 ],
\[ 4, 3, 15, 19, 20, 21, 24, 1, 10, 30, 7, 31, 2, 5, 13, 9, 18, 28, 8, 32, 26, 12, 6, 29, 22, 23, 17, 27, 11, 16, 25, 14 ] >;
s`Name := "32S11-8,4,4-g7-path1";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S6-8,4,8-g17-path14", "64S11-8,4,8-g17-path36", "64S10-8,4,8-g17-path14", "64S7-8,4,8-g17-path104", "64S9-8,4,4-g13-path101", "64S8-8,4,4-g13-path11", "64S20-8,4,4-g13-path33" ];
...
s`PassportSize := 2;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S11-8,4,4-g7-path1" ];
