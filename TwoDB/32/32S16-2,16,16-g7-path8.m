...
s`Degree := 32;
s`Filename := "32S16-2,16,16-g7-path8.m";
...
\[ 3, 7, 9, 2, 10, 1, 11, 16, 17, 18, 19, 6, 8, 4, 5, 20, 25, 26, 27, 28, 14, 15, 12, 13, 32, 29, 30, 31, 23, 24, 21, 22 ],
\[ 4, 6, 2, 12, 13, 14, 1, 15, 7, 8, 3, 21, 22, 23, 24, 5, 11, 16, 9, 10, 29, 30, 31, 32, 19, 20, 17, 18, 28, 25, 26, 27 ] >;
s`Name := "32S16-2,16,16-g7-path8";
s`Orders := \[ 2, 16, 16 ];
s`Parents := [ Strings() | "64S26-4,16,16-g21-path8", "64S44-4,16,16-g21-path54", "64S50-2,32,32-g15-path10", "64S50-4,32,32-g23-path10", "64S51-2,32,32-g15-path8", "64S51-4,32,32-g23-path8", "64S29-2,16,16-g13-path8" ];
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path6", "32S16-2,16,16-g7-path8" ];
