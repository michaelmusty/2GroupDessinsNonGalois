...
s`Degree := 32;
s`Filename := "32S12-8,8,4-g9-path4.m";
...
\[ 3, 4, 13, 6, 15, 17, 1, 14, 7, 8, 2, 5, 23, 16, 24, 26, 25, 10, 11, 12, 9, 20, 29, 27, 30, 31, 32, 18, 21, 19, 28, 22 ],
\[ 4, 7, 14, 5, 8, 3, 10, 1, 11, 12, 20, 2, 17, 15, 6, 13, 24, 9, 21, 18, 28, 19, 26, 16, 23, 27, 25, 22, 30, 32, 29, 31 ] >;
s`Name := "32S12-8,8,4-g9-path4";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path133", "64S15-8,8,8-g21-path133", "64S44-16,16,4-g21-path39", "64S45-16,16,8-g25-path39", "64S44-16,16,4-g21-path40", "64S45-16,16,8-g25-path40", "64S17-8,8,4-g17-path41" ];
...
s`PassportSize := 2;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path4", "32S12-8,8,4-g9-path4" ];
