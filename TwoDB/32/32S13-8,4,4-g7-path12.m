...
s`Degree := 32;
s`Filename := "32S13-8,4,4-g7-path12.m";
...
\[ 3, 10, 15, 20, 16, 8, 1, 30, 29, 27, 5, 17, 2, 23, 7, 21, 18, 28, 25, 14, 11, 6, 4, 9, 26, 31, 13, 12, 32, 22, 19, 24 ],
\[ 4, 11, 2, 21, 22, 24, 27, 1, 28, 9, 18, 7, 32, 5, 14, 12, 25, 3, 30, 19, 8, 15, 26, 23, 13, 6, 16, 31, 20, 29, 10, 17 ] >;
s`Name := "32S13-8,4,4-g7-path12";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S46-16,8,4-g19-path5", "64S46-16,4,8-g19-path5", "64S15-8,8,8-g21-path211", "64S46-16,8,4-g19-path6", "64S46-16,4,8-g19-path6", "64S15-8,8,8-g21-path212", "64S21-8,4,4-g13-path37" ];
...
s`PassportSize := 1;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S13-8,4,4-g7-path12" ];
