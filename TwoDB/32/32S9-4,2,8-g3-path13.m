...
{ IntegerRing() | 22, 32 }
@};
s`Child := "16T12-4,2,8-g2-path2";
s`Degree := 32;
s`Filename := "32S9-4,2,8-g3-path13.m";
...
\[ 3, 9, 1, 17, 10, 19, 21, 23, 2, 5, 24, 30, 31, 26, 29, 22, 4, 27, 6, 25, 7, 16, 8, 11, 20, 14, 18, 32, 15, 12, 13, 28 ],
\[ 4, 10, 14, 18, 19, 20, 1, 24, 22, 29, 3, 2, 5, 16, 25, 6, 23, 15, 30, 31, 12, 7, 21, 32, 9, 8, 11, 17, 28, 26, 27, 13 ] >;
s`Name := "32S9-4,2,8-g3-path13";
s`Orders := \[ 4, 2, 8 ];
s`Parents := [ Strings() | "64S12-8,2,8-g9-path15", "64S41-4,4,16-g15-path21", "64S40-8,4,16-g19-path4", "64S6-8,2,8-g9-path72", "64S39-4,4,16-g15-path33", "64S43-8,4,16-g19-path4", "64S38-4,2,16-g7-path10", "64S42-8,2,16-g11-path4", "64S8-4,4,8-g13-path65", "64S6-8,4,8-g17-path72", "64S41-4,2,16-g7-path4", "64S40-8,2,16-g11-path4", "64S21-4,4,8-g13-path170", "64S13-8,4,8-g17-path60", "64S8-4,2,8-g5-path26" ];
...
s`PassportSize := 1;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T12-4,2,8-g2-path2", "32S9-4,2,8-g3-path13" ];
