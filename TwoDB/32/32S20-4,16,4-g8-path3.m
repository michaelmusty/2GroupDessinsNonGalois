...
s`Degree := 32;
s`Filename := "32S20-4,16,4-g8-path3.m";
...
\[ 3, 9, 11, 6, 13, 15, 1, 2, 17, 5, 19, 4, 21, 8, 23, 7, 25, 10, 27, 12, 29, 14, 31, 16, 28, 18, 26, 20, 32, 22, 30, 24 ],
\[ 4, 7, 12, 5, 8, 10, 6, 1, 16, 2, 20, 13, 14, 3, 18, 15, 24, 9, 28, 21, 22, 11, 26, 23, 32, 17, 25, 29, 30, 19, 27, 31 ] >;
s`Name := "32S20-4,16,4-g8-path3";
s`Orders := \[ 4, 16, 4 ];
s`Parents := [ Strings() | "64S39-4,16,4-g15-path11", "64S47-4,16,4-g15-path23", "64S39-4,16,4-g15-path12" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T13-2,8,2-g0-path3", "32S20-4,16,4-g8-path3" ];
