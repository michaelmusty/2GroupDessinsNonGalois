...
s`Degree := 32;
s`Filename := "32S9-8,2,4-g3-path16.m";
...
\[ 3, 9, 1, 14, 10, 7, 6, 18, 2, 5, 12, 11, 16, 4, 22, 13, 26, 8, 20, 19, 30, 15, 24, 23, 29, 17, 28, 27, 25, 21, 32, 31 ],
\[ 4, 10, 2, 5, 7, 15, 1, 12, 8, 11, 3, 19, 6, 13, 14, 21, 20, 17, 9, 27, 22, 23, 16, 31, 28, 25, 18, 32, 24, 29, 30, 26 ] >;
s`Name := "32S9-8,2,4-g3-path16";
s`Orders := \[ 8, 2, 4 ];
s`Parents := [ Strings() | "64S8-8,4,4-g13-path51", "64S12-8,2,8-g9-path35", "64S6-8,4,8-g17-path92", "64S21-8,4,4-g13-path156", "64S6-8,2,8-g9-path92", "64S13-8,4,8-g17-path80", "64S38-16,2,4-g7-path13", "64S41-16,4,4-g15-path7", "64S42-16,2,8-g11-path7", "64S40-16,4,8-g19-path7", "64S41-16,2,4-g7-path7", "64S39-16,4,4-g15-path19", "64S40-16,2,8-g11-path7", "64S43-16,4,8-g19-path7", "64S8-8,2,4-g5-path29" ];
...
s`PassportSize := 1;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T13-8,2,2-g0-path2", "32S9-8,2,4-g3-path16" ];
