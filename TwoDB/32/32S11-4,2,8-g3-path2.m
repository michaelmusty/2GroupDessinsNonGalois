...
s`Degree := 32;
s`Filename := "32S11-4,2,8-g3-path2.m";
...
\[ 3, 9, 1, 6, 13, 4, 23, 21, 2, 28, 24, 14, 5, 12, 31, 18, 19, 16, 17, 32, 8, 25, 7, 11, 22, 30, 29, 10, 27, 26, 15, 20 ],
\[ 4, 3, 12, 16, 17, 21, 1, 9, 27, 13, 2, 18, 30, 25, 6, 20, 24, 10, 22, 5, 32, 23, 15, 7, 28, 8, 14, 31, 19, 11, 26, 29 ] >;
s`Name := "32S11-4,2,8-g3-path2";
s`Orders := \[ 4, 2, 8 ];
s`Parents := [ Strings() | "64S6-8,2,8-g9-path4", "64S20-4,4,8-g13-path15", "64S7-8,4,8-g17-path72", "64S10-8,2,8-g9-path4", "64S9-4,4,8-g13-path83", "64S11-8,4,8-g17-path4", "64S8-4,2,8-g5-path4" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,2,4-g1-path11", "32S11-4,2,8-g3-path2" ];
