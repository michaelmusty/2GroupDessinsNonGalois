...
s`Degree := 32;
s`Filename := "32S4-8,4,8-g9-path10.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 30, 29, 18, 8, 2, 31, 7, 17, 32, 28, 12, 5, 22, 15, 9, 4, 23, 26, 13, 11, 21, 20, 27, 25, 19 ],
\[ 4, 7, 15, 20, 21, 25, 28, 1, 12, 5, 19, 32, 2, 24, 22, 6, 26, 3, 23, 10, 31, 30, 13, 9, 18, 27, 14, 29, 11, 16, 8, 17 ] >;
s`Name := "32S4-8,4,8-g9-path10";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S28-16,8,16-g25-path1", "64S28-16,4,16-g21-path1", "64S3-8,8,8-g21-path138", "64S28-16,8,16-g25-path2", "64S28-16,4,16-g21-path2", "64S3-8,8,8-g21-path139", "64S17-8,4,8-g17-path157" ];
...
[ 16, 8, 32, 15, 3, 17, 5, 18, 13, 30, 10, 11, 20, 19, 24, 14, 23, 27, 1, 25, 6, 26, 21, 28, 9, 29, 2, 4, 31, 12, 22, 7 ],
[ 27, 25, 2, 14, 12, 19, 18, 26, 4, 9, 22, 20, 6, 8, 7, 11, 5, 13, 30, 24, 32, 28, 16, 1, 23, 21, 31, 3, 15, 29, 17, 10 ]
]
];
s`PassportName := "32S4-8,4,8-g9";
s`PassportSize := 1;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T4-4,4,4-g3-path4", "32S4-8,4,8-g9-path10" ];
