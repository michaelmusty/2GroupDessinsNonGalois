...
s`Degree := 32;
s`Filename := "32S14-4,4,8-g7-path7.m";
...
\[ 3, 4, 9, 6, 14, 11, 1, 13, 7, 17, 2, 16, 15, 24, 22, 18, 19, 27, 25, 5, 30, 8, 29, 20, 10, 23, 12, 21, 31, 32, 26, 28 ],
\[ 4, 7, 13, 16, 17, 3, 22, 1, 11, 20, 27, 2, 29, 30, 9, 21, 23, 6, 14, 28, 5, 26, 8, 25, 31, 10, 32, 12, 19, 18, 15, 24 ] >;
s`Name := "32S14-4,4,8-g7-path7";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path167", "64S16-8,8,8-g21-path168", "64S47-4,4,16-g15-path15", "64S49-8,8,16-g23-path29", "64S48-4,4,16-g15-path15", "64S49-8,8,16-g23-path30", "64S21-4,4,8-g13-path66" ];
...
s`PassportSize := 1;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T8-4,4,4-g3-path11", "32S14-4,4,8-g7-path7" ];
