...
s`Degree := 32;
s`Filename := "32S11-4,4,8-g7-path14.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 25, 21, 11, 12, 2, 19, 26, 24, 15, 32, 20, 30, 6, 28, 31, 16, 23, 14, 8, 13, 29, 9, 27, 17, 22 ],
\[ 4, 3, 15, 19, 20, 21, 23, 1, 10, 31, 7, 32, 2, 5, 30, 9, 18, 29, 14, 27, 25, 6, 13, 28, 17, 22, 8, 12, 26, 11, 24, 16 ] >;
s`Name := "32S11-4,4,8-g7-path14";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S6-8,4,8-g17-path3", "64S7-8,4,8-g17-path82", "64S10-8,4,8-g17-path3", "64S11-8,4,8-g17-path14", "64S20-4,4,8-g13-path27", "64S8-4,4,8-g13-path5", "64S9-4,4,8-g13-path95" ];
...
s`PassportSize := 2;
s`PathNumber := 14;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T10-4,2,4-g1-path1", "32S11-4,4,8-g7-path14" ];
