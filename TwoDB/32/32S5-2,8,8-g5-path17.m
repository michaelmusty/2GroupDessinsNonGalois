...
s`Degree := 32;
s`Filename := "32S5-2,8,8-g5-path17.m";
...
\[ 3, 8, 11, 2, 10, 1, 19, 12, 7, 20, 21, 23, 5, 13, 9, 4, 15, 6, 22, 24, 29, 31, 30, 32, 17, 14, 18, 16, 27, 28, 25, 26 ],
\[ 4, 6, 9, 14, 15, 17, 1, 5, 13, 2, 8, 3, 16, 25, 18, 27, 26, 28, 10, 7, 19, 11, 20, 12, 29, 30, 31, 32, 23, 21, 24, 22 ] >;
s`Name := "32S5-2,8,8-g5-path17";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "64S17-4,8,8-g17-path189", "64S7-4,8,8-g17-path127", "64S7-4,8,8-g17-path128", "64S5-4,8,8-g17-path8", "64S29-2,16,16-g13-path24", "64S29-4,16,16-g21-path24", "64S31-2,16,16-g13-path15", "64S31-4,16,16-g21-path15", "64S31-2,16,16-g13-path16", "64S31-4,16,16-g21-path16", "64S30-2,16,16-g13-path8", "64S30-4,16,16-g21-path8", "64S6-2,8,8-g9-path37", "64S6-2,8,8-g9-path38", "64S4-2,8,8-g9-path8" ];
...
s`PassportSize := 1;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T5-2,8,8-g3-path6", "32S5-2,8,8-g5-path17" ];
