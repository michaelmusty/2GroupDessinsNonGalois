...
s`Degree := 32;
s`Filename := "32S10-4,8,4-g7-path26.m";
...
\[ 3, 10, 14, 6, 16, 22, 1, 21, 28, 20, 26, 2, 5, 23, 17, 31, 11, 12, 32, 4, 25, 18, 9, 30, 15, 29, 7, 27, 8, 19, 24, 13 ],
\[ 4, 7, 15, 5, 8, 23, 11, 1, 12, 31, 13, 30, 2, 10, 16, 18, 9, 3, 20, 28, 24, 32, 21, 6, 27, 14, 22, 29, 19, 17, 26, 25 ] >;
s`Name := "32S10-4,8,4-g7-path26";
s`Orders := \[ 4, 8, 4 ];
s`Parents := [ Strings() | "64S7-4,8,8-g17-path41", "64S13-4,8,8-g17-path21", "64S7-4,8,8-g17-path42", "64S14-4,8,8-g17-path21", "64S9-4,8,4-g13-path35", "64S21-4,8,4-g13-path18", "64S9-4,8,4-g13-path36" ];
...
s`PassportSize := 2;
s`PathNumber := 26;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T12-4,8,2-g2-path1", "32S10-4,8,4-g7-path26" ];
