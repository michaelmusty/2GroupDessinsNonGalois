...
s`Degree := 32;
s`Filename := "32S1-32,32,16-g15-path4.m";
...
\[ 2, 7, 8, 9, 1, 10, 15, 4, 6, 16, 17, 5, 3, 18, 14, 23, 12, 24, 25, 13, 11, 26, 22, 31, 20, 27, 32, 21, 19, 29, 30, 28 ],
\[ 3, 8, 11, 12, 13, 1, 4, 17, 5, 2, 19, 20, 21, 6, 9, 7, 25, 10, 27, 28, 29, 14, 15, 16, 32, 18, 24, 30, 26, 22, 23, 31 ] >;
s`Name := "32S1-32,32,16-g15-path4";
s`Orders := \[ 32, 32, 16 ];
s`Parents := [ Strings() | "64S1-64,64,32-g31-path7", "64S1-64,64,32-g31-path8", "64S50-32,32,16-g29-path7", "64S50-32,32,16-g29-path8" ];
...
s`PassportSize := 8;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T1-16,16,8-g7-path2", "32S1-32,32,16-g15-path4" ];
