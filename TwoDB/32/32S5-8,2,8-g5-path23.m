...
s`Degree := 32;
s`Filename := "32S5-8,2,8-g5-path23.m";
...
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T6-8,2,8-g3-path5", "32S5-8,2,8-g5-path23" ];
...
[ 6, 1, 14, 18, 19, 22, 3, 2, 15, 5, 9, 16, 29, 21, 4, 10, 23, 20, 25, 13, 28, 31, 7, 27, 24, 8, 12, 30, 11, 17, 32, 26 ],
[ 3, 9, 1, 6, 13, 4, 24, 23, 2, 28, 25, 14, 5, 12, 27, 18, 19, 16, 17, 31, 22, 21, 8, 7, 11, 29, 15, 10, 26, 32, 20, 30 ],
[ 9, 23, 24, 27, 28, 3, 8, 29, 25, 18, 26, 15, 31, 1, 2, 14, 32, 6, 13, 16, 12, 4, 19, 11, 17, 30, 7, 22, 5, 10, 21, 20 ]
]
];
