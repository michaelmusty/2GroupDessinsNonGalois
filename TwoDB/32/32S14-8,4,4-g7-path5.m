...
{ IntegerRing() | 23, 29 }
@};
s`Child := "16T14-8,4,4-g4-path2";
s`Degree := 32;
s`Filename := "32S14-8,4,4-g7-path5.m";
...
\[ 3, 10, 16, 19, 14, 15, 1, 21, 18, 27, 5, 26, 2, 28, 30, 7, 24, 31, 8, 6, 4, 29, 9, 12, 32, 17, 13, 11, 25, 20, 23, 22 ],
\[ 4, 11, 12, 16, 20, 18, 17, 1, 24, 25, 27, 7, 22, 2, 5, 8, 3, 30, 32, 28, 29, 10, 6, 31, 13, 9, 14, 15, 19, 23, 26, 21 ] >;
s`Name := "32S14-8,4,4-g7-path5";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path231", "64S16-8,8,8-g21-path232", "64S47-16,4,4-g15-path13", "64S49-16,8,8-g23-path25", "64S48-16,4,4-g15-path13", "64S49-16,8,8-g23-path26", "64S21-8,4,4-g13-path64" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T14-8,4,4-g4-path2", "32S14-8,4,4-g7-path5" ];
