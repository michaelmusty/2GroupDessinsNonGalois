...
s`Degree := 32;
s`Filename := "32S16-16,16,4-g11-path3.m";
...
\[ 3, 4, 13, 14, 15, 16, 1, 6, 10, 5, 8, 2, 23, 24, 17, 25, 26, 7, 20, 11, 9, 12, 31, 27, 32, 29, 30, 18, 28, 19, 21, 22 ],
\[ 4, 10, 14, 5, 8, 3, 2, 1, 20, 11, 7, 9, 24, 15, 6, 13, 16, 12, 28, 18, 19, 21, 27, 17, 23, 25, 26, 22, 32, 29, 30, 31 ] >;
s`Name := "32S16-16,16,4-g11-path3";
s`Orders := \[ 16, 16, 4 ];
s`Parents := [ Strings() | "64S50-32,32,8-g27-path9", "64S51-32,32,8-g27-path5", "64S50-32,32,8-g27-path10", "64S51-32,32,8-g27-path6", "64S44-16,16,4-g21-path58", "64S26-16,16,4-g21-path12", "64S29-16,16,4-g21-path3" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1", "16T5-8,8,2-g3-path1", "32S16-16,16,4-g11-path3" ];
