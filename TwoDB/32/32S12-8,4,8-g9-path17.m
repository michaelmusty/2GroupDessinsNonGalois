...
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path17.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 25, 27, 11, 12, 2, 32, 26, 24, 15, 30, 19, 6, 9, 13, 31, 16, 23, 14, 8, 28, 20, 21, 22, 17, 29 ],
\[ 4, 3, 15, 9, 19, 13, 23, 1, 10, 30, 7, 31, 2, 5, 27, 32, 18, 29, 28, 25, 8, 6, 20, 21, 17, 22, 26, 12, 11, 24, 16, 14 ] >;
s`Name := "32S12-8,4,8-g9-path17";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path54", "64S15-8,8,8-g21-path54", "64S45-16,4,16-g21-path15", "64S44-16,8,16-g25-path15", "64S45-16,4,16-g21-path16", "64S44-16,8,16-g25-path16", "64S17-8,4,8-g17-path8" ];
...
s`PassportSize := 2;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T6-8,2,8-g3-path3", "32S12-8,4,8-g9-path17" ];
