...
s`Degree := 32;
s`Filename := "32S20-4,4,16-g8-path3.m";
...
\[ 3, 9, 5, 2, 7, 4, 1, 12, 6, 17, 15, 11, 10, 13, 8, 20, 14, 25, 23, 19, 18, 21, 16, 28, 22, 32, 31, 27, 26, 29, 24, 30 ],
\[ 4, 3, 12, 13, 9, 7, 15, 1, 17, 2, 5, 20, 21, 6, 23, 8, 25, 10, 11, 28, 29, 14, 31, 16, 32, 18, 19, 30, 27, 22, 26, 24 ] >;
s`Name := "32S20-4,4,16-g8-path3";
s`Orders := \[ 4, 4, 16 ];
s`Parents := [ Strings() | "64S39-4,4,16-g15-path11", "64S47-4,4,16-g15-path23", "64S39-4,4,16-g15-path12" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path3", "32S20-4,4,16-g8-path3" ];
