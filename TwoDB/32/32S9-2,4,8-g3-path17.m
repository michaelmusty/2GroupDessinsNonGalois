...
{ IntegerRing() | 30, 32 }
@};
s`Child := "16T13-2,2,8-g0-path3";
s`Degree := 32;
s`Filename := "32S9-2,4,8-g3-path17.m";
...
\[ 3, 4, 5, 8, 6, 1, 15, 9, 2, 17, 12, 7, 14, 10, 11, 20, 13, 22, 23, 19, 25, 21, 16, 31, 18, 32, 28, 24, 30, 26, 27, 29 ],
\[ 4, 3, 12, 14, 9, 15, 1, 6, 17, 2, 5, 20, 8, 22, 23, 7, 25, 10, 11, 28, 13, 30, 31, 16, 32, 18, 19, 26, 21, 24, 29, 27 ] >;
s`Name := "32S9-2,4,8-g3-path17";
s`Orders := \[ 2, 4, 8 ];
s`Parents := [ Strings() | "64S8-4,4,8-g13-path52", "64S12-2,8,8-g9-path19", "64S6-4,8,8-g17-path76", "64S21-4,4,8-g13-path157", "64S6-2,8,8-g9-path76", "64S13-4,8,8-g17-path64", "64S38-2,4,16-g7-path14", "64S41-4,4,16-g15-path8", "64S42-2,8,16-g11-path8", "64S40-4,8,16-g19-path8", "64S41-2,4,16-g7-path8", "64S39-4,4,16-g15-path20", "64S40-2,8,16-g11-path8", "64S43-4,8,16-g19-path8", "64S8-2,4,8-g5-path30" ];
...
s`PassportSize := 1;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path3", "32S9-2,4,8-g3-path17" ];
