...
s`Degree := 32;
s`Filename := "32S6-4,2,4-g1-path5.m";
...
\[ 3, 9, 1, 6, 13, 4, 23, 21, 2, 27, 29, 14, 5, 12, 30, 18, 19, 16, 17, 32, 8, 24, 7, 22, 31, 28, 10, 26, 11, 15, 25, 20 ],
\[ 4, 3, 12, 16, 17, 21, 1, 9, 26, 13, 2, 11, 31, 24, 6, 7, 29, 10, 22, 5, 32, 23, 28, 27, 8, 25, 30, 19, 20, 14, 18, 15 ] >;
s`Name := "32S6-4,2,4-g1-path5";
s`Orders := \[ 4, 2, 4 ];
s`Parents := [ Strings() | "64S32-8,2,4-g5-path7", "64S23-4,4,4-g9-path261", "64S33-8,4,4-g13-path7", "64S32-4,2,8-g5-path7", "64S4-8,2,8-g9-path30", "64S33-4,4,8-g13-path18", "64S5-8,4,8-g17-path53", "64S8-8,2,4-g5-path18", "64S35-4,4,4-g9-path18", "64S9-8,4,4-g13-path119", "64S8-4,2,8-g5-path18", "64S36-8,2,8-g9-path7", "64S9-4,4,8-g13-path130", "64S37-8,4,8-g17-path7", "64S34-4,2,4-g1-path7" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S6-4,2,4-g1-path5" ];
...
[ 13, 27, 5, 19, 3, 17, 32, 22, 10, 9, 16, 25, 1, 31, 26, 11, 6, 29, 4, 23, 24, 8, 20, 21, 12, 15, 2, 30, 18, 28, 14, 7 ],
[ 9, 21, 23, 30, 27, 3, 24, 4, 29, 22, 19, 15, 32, 1, 10, 25, 26, 6, 13, 8, 31, 12, 18, 17, 5, 7, 16, 2, 14, 20, 28, 11 ]
]
];
