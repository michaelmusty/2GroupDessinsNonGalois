...
s`Degree := 32;
s`Filename := "32S4-4,8,8-g9-path4.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 30, 29, 18, 8, 2, 31, 19, 17, 28, 23, 26, 5, 22, 15, 32, 4, 27, 9, 11, 21, 7, 20, 12, 25, 13 ],
\[ 4, 7, 15, 20, 21, 25, 27, 1, 12, 5, 19, 14, 2, 24, 22, 6, 9, 3, 23, 10, 31, 30, 13, 32, 18, 28, 29, 17, 11, 16, 8, 26 ] >;
s`Name := "32S4-4,8,8-g9-path4";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path126", "64S28-4,16,16-g21-path39", "64S28-8,16,16-g25-path39", "64S3-8,8,8-g21-path127", "64S28-4,16,16-g21-path40", "64S28-8,16,16-g25-path40", "64S17-4,8,8-g17-path176" ];
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T4-4,4,4-g3-path13", "32S4-4,8,8-g9-path4" ];
...
[ 3, 10, 14, 6, 16, 24, 1, 30, 29, 18, 8, 2, 31, 19, 17, 28, 23, 26, 5, 22, 15, 32, 4, 27, 9, 11, 21, 7, 20, 12, 25, 13 ],
[ 8, 13, 18, 1, 10, 16, 2, 31, 17, 20, 29, 9, 23, 12, 3, 30, 28, 25, 11, 4, 5, 15, 19, 14, 6, 32, 7, 26, 27, 22, 21, 24 ]
]
];
