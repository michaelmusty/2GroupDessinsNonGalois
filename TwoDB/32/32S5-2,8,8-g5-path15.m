...
s`Degree := 32;
s`Filename := "32S5-2,8,8-g5-path15.m";
...
\[ 3, 8, 11, 2, 10, 1, 19, 12, 7, 20, 21, 23, 5, 13, 9, 4, 15, 6, 22, 24, 29, 31, 30, 32, 17, 14, 18, 16, 27, 28, 25, 26 ],
\[ 4, 6, 9, 14, 15, 17, 1, 5, 13, 2, 8, 3, 16, 25, 18, 27, 26, 28, 10, 7, 19, 11, 20, 12, 29, 30, 31, 32, 23, 21, 24, 22 ] >;
s`Name := "32S5-2,8,8-g5-path15";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "64S17-4,8,8-g17-path187", "64S7-4,8,8-g17-path123", "64S7-4,8,8-g17-path124", "64S5-4,8,8-g17-path6", "64S29-2,16,16-g13-path22", "64S29-4,16,16-g21-path22", "64S31-2,16,16-g13-path11", "64S31-4,16,16-g21-path11", "64S31-2,16,16-g13-path12", "64S31-4,16,16-g21-path12", "64S30-2,16,16-g13-path6", "64S30-4,16,16-g21-path6", "64S6-2,8,8-g9-path33", "64S6-2,8,8-g9-path34", "64S4-2,8,8-g9-path6" ];
...
s`PassportSize := 1;
s`PathNumber := 15;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-2,8,8-g3-path4", "32S5-2,8,8-g5-path15" ];
