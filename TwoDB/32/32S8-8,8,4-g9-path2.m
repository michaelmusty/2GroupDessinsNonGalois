...
s`Degree := 32;
s`Filename := "32S8-8,8,4-g9-path2.m";
...
\[ 3, 10, 14, 20, 16, 22, 1, 6, 29, 18, 5, 27, 2, 11, 13, 28, 12, 17, 31, 26, 4, 21, 9, 19, 24, 30, 15, 7, 32, 8, 23, 25 ],
\[ 4, 11, 15, 5, 8, 23, 2, 1, 17, 31, 12, 7, 9, 22, 16, 18, 24, 3, 30, 25, 19, 28, 20, 13, 6, 14, 32, 26, 21, 29, 27, 10 ] >;
s`Name := "32S8-8,8,4-g9-path2";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S5-8,8,4-g17-path75", "64S11-8,8,4-g17-path51", "64S13-8,8,4-g17-path41", "64S13-8,8,4-g17-path42", "64S11-8,8,4-g17-path52", "64S5-8,8,4-g17-path76", "64S24-8,8,4-g17-path96" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S8-8,8,4-g9-path2" ];
