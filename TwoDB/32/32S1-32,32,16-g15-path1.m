...
s`Degree := 32;
s`Filename := "32S1-32,32,16-g15-path1.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 20, 2, 22, 24, 25, 26, 27, 10, 4, 5, 28, 7, 29, 9, 11, 31, 21, 23, 32, 30, 19, 17, 18 ],
\[ 4, 7, 6, 17, 9, 10, 18, 1, 11, 19, 21, 2, 15, 12, 20, 3, 30, 31, 23, 5, 32, 8, 24, 26, 22, 28, 13, 14, 16, 27, 29, 25 ] >;
s`Name := "32S1-32,32,16-g15-path1";
s`Orders := \[ 32, 32, 16 ];
s`Parents := [ Strings() | "64S1-64,64,32-g31-path1", "64S1-64,64,32-g31-path2", "64S50-32,32,16-g29-path1", "64S50-32,32,16-g29-path2" ];
...
s`PassportSize := 8;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T1-16,16,8-g7-path1", "32S1-32,32,16-g15-path1" ];
