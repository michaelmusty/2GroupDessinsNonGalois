...
s`Degree := 32;
s`Filename := "32S16-16,16,4-g11-path9.m";
...
\[ 3, 4, 13, 14, 15, 16, 1, 6, 10, 5, 8, 2, 23, 24, 17, 25, 26, 7, 20, 11, 9, 12, 31, 27, 32, 29, 30, 18, 28, 19, 21, 22 ],
\[ 4, 10, 14, 5, 8, 3, 2, 1, 20, 11, 7, 9, 24, 15, 6, 13, 16, 12, 28, 18, 19, 21, 27, 17, 23, 25, 26, 22, 32, 29, 30, 31 ] >;
s`Name := "32S16-16,16,4-g11-path9";
s`Orders := \[ 16, 16, 4 ];
s`Parents := [ Strings() | "64S50-32,32,8-g27-path21", "64S51-32,32,8-g27-path17", "64S50-32,32,8-g27-path22", "64S51-32,32,8-g27-path18", "64S44-16,16,4-g21-path64", "64S26-16,16,4-g21-path18", "64S29-16,16,4-g21-path9" ];
...
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T5-8,8,2-g3-path7", "32S16-16,16,4-g11-path9" ];
