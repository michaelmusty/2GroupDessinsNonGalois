...
s`Degree := 32;
s`Filename := "32S3-8,8,4-g9-path17.m";
...
\[ 3, 4, 13, 14, 15, 16, 1, 6, 10, 5, 8, 2, 23, 24, 17, 25, 26, 7, 20, 11, 9, 12, 29, 27, 30, 31, 32, 18, 28, 19, 21, 22 ],
\[ 4, 10, 14, 5, 8, 3, 2, 1, 20, 11, 7, 9, 24, 15, 6, 13, 16, 12, 28, 18, 19, 21, 27, 17, 23, 25, 26, 22, 32, 29, 30, 31 ] >;
s`Name := "32S3-8,8,4-g9-path17";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path66", "64S3-8,8,8-g21-path66", "64S26-16,16,4-g21-path26", "64S26-16,16,8-g25-path26", "64S27-16,16,4-g21-path22", "64S27-16,16,8-g25-path22", "64S17-8,8,4-g17-path135" ];
...
s`PassportSize := 1;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2", "32S3-8,8,4-g9-path17" ];
