...
{ IntegerRing() | 30, 31 }
@};
s`Child := "16T10-4,2,4-g1-path9";
s`Degree := 32;
s`Filename := "32S2-4,4,4-g5-path22.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 27, 22, 11, 12, 2, 32, 28, 25, 15, 30, 20, 13, 6, 19, 29, 31, 16, 24, 9, 14, 8, 26, 23, 17, 21 ],
\[ 4, 3, 15, 19, 20, 22, 24, 1, 10, 30, 7, 31, 2, 5, 13, 29, 18, 26, 8, 32, 11, 28, 6, 21, 9, 27, 17, 23, 12, 25, 16, 14 ] >;
s`Name := "32S2-4,4,4-g5-path22";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S20-8,4,4-g13-path71", "64S21-4,8,4-g13-path82", "64S25-8,8,4-g17-path27", "64S21-4,4,8-g13-path82", "64S17-8,4,8-g17-path60", "64S24-4,8,8-g17-path14", "64S22-8,8,8-g21-path106", "64S21-8,4,4-g13-path82", "64S18-4,8,4-g13-path14", "64S24-8,8,4-g17-path14", "64S20-4,4,8-g13-path71", "64S24-8,4,8-g17-path14", "64S25-4,8,8-g17-path27", "64S19-8,8,8-g21-path14", "64S20-8,4,4-g13-path72", "64S20-4,8,4-g13-path71", "64S17-8,8,4-g17-path60", "64S20-4,4,8-g13-path72", "64S25-8,4,8-g17-path27", "64S17-4,8,8-g17-path60", "64S22-8,8,8-g21-path107", "64S18-8,4,4-g13-path14", "64S20-4,8,4-g13-path72", "64S25-8,8,4-g17-path28", "64S18-4,4,8-g13-path14", "64S25-8,4,8-g17-path28", "64S25-4,8,8-g17-path28", "64S22-8,8,8-g21-path108", "64S23-4,4,4-g9-path40", "64S23-4,4,4-g9-path41", "64S23-4,4,4-g9-path42" ];
...
s`PassportSize := 1;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,2,4-g1-path9", "32S2-4,4,4-g5-path22" ];
...
[ 28, 19, 12, 7, 27, 30, 10, 21, 15, 26, 32, 22, 16, 13, 1, 23, 8, 31, 6, 3, 25, 20, 14, 5, 17, 4, 29, 9, 24, 2, 11, 18 ],
[ 3, 10, 5, 18, 7, 4, 1, 27, 22, 11, 12, 2, 32, 28, 25, 15, 30, 20, 13, 6, 19, 29, 31, 16, 24, 9, 14, 8, 26, 23, 17, 21 ],
[ 16, 17, 18, 29, 25, 21, 6, 31, 14, 5, 23, 1, 27, 30, 26, 19, 15, 13, 12, 9, 28, 11, 24, 22, 32, 2, 3, 7, 8, 20, 4, 10 ]
]
];
