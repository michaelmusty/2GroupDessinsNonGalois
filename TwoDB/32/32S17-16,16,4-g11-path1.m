...
s`Degree := 32;
s`Filename := "32S17-16,16,4-g11-path1.m";
...
\[ 3, 8, 13, 16, 14, 17, 1, 6, 7, 5, 4, 2, 23, 24, 26, 15, 25, 11, 12, 10, 9, 20, 32, 27, 31, 30, 29, 18, 21, 19, 28, 22 ],
\[ 4, 10, 6, 5, 8, 14, 2, 1, 18, 11, 7, 9, 15, 16, 24, 3, 13, 20, 22, 12, 19, 28, 25, 17, 27, 23, 26, 21, 31, 29, 32, 30 ] >;
s`Name := "32S17-16,16,4-g11-path1";
s`Orders := \[ 16, 16, 4 ];
s`Parents := [ Strings() | "64S29-16,16,4-g21-path10", "64S44-16,16,4-g21-path72", "64S27-16,16,4-g21-path8" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1", "16T5-8,8,2-g3-path1", "32S17-16,16,4-g11-path1" ];
