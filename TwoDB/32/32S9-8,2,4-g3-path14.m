...
s`Degree := 32;
s`Filename := "32S9-8,2,4-g3-path14.m";
...
\[ 3, 9, 1, 17, 10, 19, 22, 16, 2, 5, 23, 28, 30, 25, 27, 8, 4, 26, 6, 32, 29, 7, 11, 31, 14, 18, 15, 12, 21, 13, 24, 20 ],
\[ 4, 10, 14, 18, 19, 20, 1, 23, 21, 27, 3, 2, 5, 26, 24, 6, 29, 7, 28, 30, 15, 31, 32, 9, 8, 11, 12, 13, 22, 16, 17, 25 ] >;
s`Name := "32S9-8,2,4-g3-path14";
s`Orders := \[ 8, 2, 4 ];
s`Parents := [ Strings() | "64S8-8,4,4-g13-path49", "64S12-8,2,8-g9-path33", "64S6-8,4,8-g17-path90", "64S21-8,4,4-g13-path154", "64S6-8,2,8-g9-path90", "64S13-8,4,8-g17-path78", "64S38-16,2,4-g7-path11", "64S41-16,4,4-g15-path5", "64S42-16,2,8-g11-path5", "64S40-16,4,8-g19-path5", "64S41-16,2,4-g7-path5", "64S39-16,4,4-g15-path17", "64S40-16,2,8-g11-path5", "64S43-16,4,8-g19-path5", "64S8-8,2,4-g5-path27" ];
...
s`PassportSize := 1;
s`PathNumber := 14;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T12-8,2,4-g2-path3", "32S9-8,2,4-g3-path14" ];
