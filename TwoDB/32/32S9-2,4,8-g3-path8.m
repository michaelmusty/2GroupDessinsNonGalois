...
s`Degree := 32;
s`Filename := "32S9-2,4,8-g3-path8.m";
...
\[ 3, 8, 11, 2, 13, 1, 21, 14, 24, 16, 6, 7, 27, 4, 23, 15, 9, 5, 26, 12, 20, 29, 10, 31, 22, 32, 18, 25, 28, 19, 17, 30 ],
\[ 4, 6, 12, 16, 17, 21, 1, 23, 18, 2, 8, 29, 30, 3, 14, 19, 22, 26, 5, 11, 25, 7, 32, 28, 9, 10, 24, 20, 31, 15, 13, 27 ] >;
s`Name := "32S9-2,4,8-g3-path8";
s`Orders := \[ 2, 4, 8 ];
s`Parents := [ Strings() | "64S8-4,4,8-g13-path60", "64S12-2,8,8-g9-path27", "64S6-4,8,8-g17-path84", "64S21-4,4,8-g13-path165", "64S6-2,8,8-g9-path84", "64S13-4,8,8-g17-path72", "64S38-2,4,16-g7-path22", "64S41-4,4,16-g15-path16", "64S42-2,8,16-g11-path16", "64S40-4,8,16-g19-path16", "64S41-2,4,16-g7-path16", "64S39-4,4,16-g15-path28", "64S40-2,8,16-g11-path16", "64S43-4,8,16-g19-path16", "64S8-2,4,8-g5-path38" ];
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S9-2,4,8-g3-path8" ];
