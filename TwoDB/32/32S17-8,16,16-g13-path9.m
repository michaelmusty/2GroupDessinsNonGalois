...
s`Degree := 32;
s`Filename := "32S17-8,16,16-g13-path9.m";
...
\[ 3, 8, 15, 19, 16, 23, 1, 22, 13, 5, 14, 2, 29, 18, 24, 31, 32, 20, 17, 6, 25, 4, 30, 9, 28, 11, 7, 27, 10, 12, 21, 26 ],
\[ 4, 10, 6, 15, 20, 24, 18, 1, 26, 22, 7, 27, 2, 5, 17, 19, 9, 3, 21, 31, 32, 16, 25, 30, 12, 29, 8, 11, 14, 13, 23, 28 ] >;
s`Name := "32S17-8,16,16-g13-path9";
s`Orders := \[ 8, 16, 16 ];
s`Parents := [ Strings() | "64S27-8,16,16-g25-path14", "64S44-8,16,16-g25-path78", "64S29-8,16,16-g25-path32" ];
...
s`PassportSize := 2;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T5-4,8,8-g5-path5", "32S17-8,16,16-g13-path9" ];
