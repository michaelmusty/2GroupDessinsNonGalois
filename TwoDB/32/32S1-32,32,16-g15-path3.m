...
s`Degree := 32;
s`Filename := "32S1-32,32,16-g15-path3.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 26, 28, 9, 10, 29, 19, 21, 24, 4, 11, 5, 27, 22, 7, 30, 17, 32, 31, 18, 25, 20 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 25, 2, 15, 21, 24, 3, 9, 29, 12, 27, 31, 30, 5, 26, 32, 8, 14, 10, 13, 16, 28, 23 ] >;
s`Name := "32S1-32,32,16-g15-path3";
s`Orders := \[ 32, 32, 16 ];
s`Parents := [ Strings() | "64S1-64,64,32-g31-path5", "64S1-64,64,32-g31-path6", "64S50-32,32,16-g29-path5", "64S50-32,32,16-g29-path6" ];
...
s`PassportSize := 8;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T1-16,16,8-g7-path2", "32S1-32,32,16-g15-path3" ];
...
\[ 2, 9, 8, 7, 10, 1, 11, 12, 27, 13, 14, 17, 16, 23, 3, 26, 20, 22, 4, 25, 5, 15, 28, 6, 21, 19, 32, 29, 30, 24, 18, 31 ],
\[ 12, 17, 26, 2, 28, 8, 9, 19, 20, 29, 27, 4, 30, 32, 16, 24, 7, 10, 1, 11, 23, 13, 31, 3, 14, 6, 25, 18, 22, 15, 5, 21 ]:
 Order := 32 >;
