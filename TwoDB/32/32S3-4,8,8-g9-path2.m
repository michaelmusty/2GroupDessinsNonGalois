...
s`Degree := 32;
s`Filename := "32S3-4,8,8-g9-path2.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 25, 22, 24, 30, 27, 19, 21, 9, 4, 31, 5, 29, 7, 32, 28, 10, 17, 11, 18, 20, 26 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 24, 2, 15, 21, 9, 3, 23, 25, 29, 28, 32, 30, 5, 31, 8, 27, 13, 10, 14, 12, 26, 16 ] >;
s`Name := "32S3-4,8,8-g9-path2";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path22", "64S3-8,8,8-g21-path22", "64S26-4,16,16-g21-path40", "64S26-8,16,16-g25-path40", "64S27-4,16,16-g21-path36", "64S27-8,16,16-g25-path36", "64S17-4,8,8-g17-path149" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T4-4,4,4-g3-path11", "32S3-4,8,8-g9-path2" ];
