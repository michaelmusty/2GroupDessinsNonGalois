...
s`Degree := 32;
s`Filename := "32S10-4,4,8-g7-path25.m";
...
\[ 3, 9, 12, 6, 14, 22, 1, 27, 16, 2, 18, 7, 15, 31, 25, 10, 30, 19, 29, 4, 5, 20, 32, 28, 26, 13, 24, 8, 11, 23, 21, 17 ],
\[ 4, 7, 13, 18, 10, 21, 25, 1, 30, 32, 2, 22, 11, 28, 5, 3, 20, 24, 16, 14, 27, 29, 6, 12, 19, 31, 17, 23, 8, 15, 9, 26 ] >;
s`Name := "32S10-4,4,8-g7-path25";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S7-8,4,8-g17-path27", "64S13-8,4,8-g17-path14", "64S7-8,4,8-g17-path28", "64S14-8,4,8-g17-path14", "64S9-4,4,8-g13-path33", "64S21-4,4,8-g13-path17", "64S9-4,4,8-g13-path34" ];
...
s`PassportSize := 2;
s`PathNumber := 25;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T12-2,4,8-g2-path3", "32S10-4,4,8-g7-path25" ];
