...
s`Degree := 32;
s`Filename := "32S10-8,4,4-g7-path31.m";
...
\[ 3, 10, 14, 6, 13, 23, 1, 30, 24, 16, 15, 2, 18, 7, 27, 12, 32, 20, 22, 5, 4, 8, 21, 25, 29, 31, 28, 11, 9, 19, 17, 26 ],
\[ 4, 7, 11, 18, 19, 24, 27, 1, 12, 31, 20, 32, 2, 23, 9, 3, 21, 8, 14, 16, 29, 17, 5, 30, 10, 6, 13, 25, 22, 26, 28, 15 ] >;
s`Name := "32S10-8,4,4-g7-path31";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S7-8,4,8-g17-path51", "64S13-8,4,8-g17-path26", "64S7-8,4,8-g17-path52", "64S14-8,4,8-g17-path26", "64S9-8,4,4-g13-path47", "64S21-8,4,4-g13-path24", "64S9-8,4,4-g13-path48" ];
...
s`PassportSize := 2;
s`PathNumber := 31;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T14-8,4,4-g4-path2", "32S10-8,4,4-g7-path31" ];
