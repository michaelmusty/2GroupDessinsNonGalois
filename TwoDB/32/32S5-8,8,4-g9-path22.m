...
{ IntegerRing() | 26, 29 }
@};
s`Child := "16T6-8,8,4-g5-path4";
s`Degree := 32;
s`Filename := "32S5-8,8,4-g9-path22.m";
...
\[ 3, 4, 15, 19, 17, 23, 1, 28, 10, 5, 21, 2, 32, 16, 18, 30, 24, 20, 31, 25, 6, 9, 26, 13, 27, 14, 7, 12, 8, 11, 29, 22 ],
\[ 4, 10, 16, 20, 21, 3, 26, 1, 30, 29, 7, 15, 2, 5, 31, 25, 28, 11, 17, 8, 32, 19, 9, 23, 6, 18, 12, 22, 13, 24, 27, 14 ] >;
s`Name := "32S5-8,8,4-g9-path22";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S29-16,16,8-g25-path59", "64S31-16,16,8-g25-path53", "64S31-16,16,8-g25-path54", "64S29-16,16,8-g25-path60", "64S31-16,16,8-g25-path55", "64S30-16,16,8-g25-path27", "64S30-16,16,8-g25-path28", "64S31-16,16,8-g25-path56", "64S7-8,8,4-g17-path185", "64S6-8,8,4-g17-path49", "64S17-8,8,4-g17-path218", "64S6-8,8,4-g17-path50", "64S5-8,8,4-g17-path37", "64S4-8,8,4-g17-path14", "64S7-8,8,4-g17-path186" ];
...
s`PassportSize := 1;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T6-8,8,4-g5-path4", "32S5-8,8,4-g9-path22" ];
