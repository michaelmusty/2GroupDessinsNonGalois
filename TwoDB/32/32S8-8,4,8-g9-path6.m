...
s`Degree := 32;
s`Filename := "32S8-8,4,8-g9-path6.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 28, 27, 11, 12, 2, 30, 29, 26, 15, 32, 20, 13, 6, 19, 9, 22, 31, 16, 25, 23, 14, 8, 21, 17, 24 ],
\[ 4, 3, 15, 19, 20, 22, 25, 1, 10, 31, 7, 32, 2, 5, 21, 23, 18, 27, 14, 30, 11, 29, 12, 6, 13, 9, 28, 24, 17, 8, 16, 26 ] >;
s`Name := "32S8-8,4,8-g9-path6";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S5-8,4,8-g17-path83", "64S11-8,4,8-g17-path59", "64S13-8,4,8-g17-path49", "64S13-8,4,8-g17-path50", "64S11-8,4,8-g17-path60", "64S5-8,4,8-g17-path84", "64S24-8,4,8-g17-path100" ];
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S8-8,4,8-g9-path6" ];
