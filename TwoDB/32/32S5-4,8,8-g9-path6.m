...
s`Degree := 32;
s`Filename := "32S5-4,8,8-g9-path6.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 29, 5, 18, 31, 10, 12, 26, 4, 30, 17, 6, 32, 16, 28, 14, 23, 27, 7, 8, 20, 19, 22, 25, 11 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 30, 31, 2, 5, 9, 17, 27, 3, 29, 12, 28, 16, 32, 6, 13, 11, 26, 21, 20, 8, 15, 25, 22, 23 ] >;
s`Name := "32S5-4,8,8-g9-path6";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S29-8,16,16-g25-path71", "64S31-8,16,16-g25-path77", "64S31-8,16,16-g25-path78", "64S30-8,16,16-g25-path39", "64S31-8,16,16-g25-path79", "64S29-8,16,16-g25-path72", "64S30-8,16,16-g25-path40", "64S31-8,16,16-g25-path80", "64S7-4,8,8-g17-path197", "64S6-4,8,8-g17-path61", "64S5-4,8,8-g17-path43", "64S6-4,8,8-g17-path62", "64S17-4,8,8-g17-path224", "64S4-4,8,8-g17-path20", "64S7-4,8,8-g17-path198" ];
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T10-2,4,4-g1-path4", "32S5-4,8,8-g9-path6" ];
