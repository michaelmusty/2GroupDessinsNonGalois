...
s`Degree := 32;
s`Filename := "32S5-8,4,8-g9-path1.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 26, 29, 11, 12, 2, 19, 27, 25, 15, 31, 20, 30, 6, 9, 21, 32, 16, 24, 14, 8, 13, 22, 28, 23, 17 ],
\[ 4, 3, 15, 19, 20, 21, 24, 1, 10, 31, 7, 32, 2, 5, 30, 9, 18, 29, 14, 28, 26, 12, 6, 13, 22, 17, 23, 8, 27, 11, 25, 16 ] >;
s`Name := "32S5-8,4,8-g9-path1";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S29-16,8,16-g25-path53", "64S31-16,8,16-g25-path41", "64S31-16,8,16-g25-path42", "64S29-16,8,16-g25-path54", "64S31-16,8,16-g25-path43", "64S30-16,8,16-g25-path21", "64S30-16,8,16-g25-path22", "64S31-16,8,16-g25-path44", "64S7-8,4,8-g17-path179", "64S6-8,4,8-g17-path43", "64S17-8,4,8-g17-path215", "64S6-8,4,8-g17-path44", "64S5-8,4,8-g17-path34", "64S4-8,4,8-g17-path11", "64S7-8,4,8-g17-path180" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S5-8,4,8-g9-path1" ];
