...
s`Degree := 32;
s`Filename := "32S16-8,16,16-g13-path18.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 26, 27, 17, 31, 18, 19, 21, 24, 4, 28, 5, 20, 30, 7, 22, 9, 32, 10, 25, 11, 29 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 25, 2, 15, 21, 24, 3, 28, 13, 32, 14, 27, 16, 5, 29, 23, 8, 31, 9, 26, 10, 30, 12 ] >;
s`Name := "32S16-8,16,16-g13-path18";
s`Orders := \[ 8, 16, 16 ];
s`Parents := [ Strings() | "64S50-16,32,32-g29-path25", "64S51-16,32,32-g29-path17", "64S50-16,32,32-g29-path26", "64S51-16,32,32-g29-path18", "64S29-8,16,16-g25-path9", "64S26-8,16,16-g25-path9", "64S44-8,16,16-g25-path55" ];
...
s`PassportSize := 2;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path7", "32S16-8,16,16-g13-path18" ];
