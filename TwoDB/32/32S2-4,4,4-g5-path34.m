...
{ IntegerRing() | 23, 27 }
@};
s`Child := "16T4-4,4,4-g3-path10";
s`Degree := 32;
s`Filename := "32S2-4,4,4-g5-path34.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 29, 28, 18, 8, 2, 20, 7, 17, 32, 27, 12, 5, 22, 15, 30, 4, 23, 9, 11, 21, 31, 26, 13, 25, 19 ],
\[ 4, 7, 15, 20, 21, 25, 27, 1, 12, 5, 19, 32, 2, 24, 22, 6, 9, 3, 23, 8, 31, 18, 28, 30, 29, 14, 13, 11, 16, 26, 10, 17 ] >;
s`Name := "32S2-4,4,4-g5-path34";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S20-8,4,4-g13-path97", "64S21-4,8,4-g13-path95", "64S25-8,8,4-g17-path53", "64S21-4,4,8-g13-path95", "64S17-8,4,8-g17-path73", "64S24-4,8,8-g17-path27", "64S22-8,8,8-g21-path145", "64S21-8,4,4-g13-path95", "64S18-4,8,4-g13-path27", "64S24-8,8,4-g17-path27", "64S20-4,4,8-g13-path97", "64S24-8,4,8-g17-path27", "64S25-4,8,8-g17-path53", "64S19-8,8,8-g21-path27", "64S20-8,4,4-g13-path98", "64S20-4,8,4-g13-path97", "64S17-8,8,4-g17-path73", "64S20-4,4,8-g13-path98", "64S25-8,4,8-g17-path53", "64S17-4,8,8-g17-path73", "64S22-8,8,8-g21-path146", "64S18-8,4,4-g13-path27", "64S20-4,8,4-g13-path98", "64S25-8,8,4-g17-path54", "64S18-4,4,8-g13-path27", "64S25-8,4,8-g17-path54", "64S25-4,8,8-g17-path54", "64S22-8,8,8-g21-path147", "64S23-4,4,4-g9-path79", "64S23-4,4,4-g9-path80", "64S23-4,4,4-g9-path81" ];
...
s`PassportSize := 1;
s`PathNumber := 34;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T4-4,4,4-g3-path10", "32S2-4,4,4-g5-path34" ];
