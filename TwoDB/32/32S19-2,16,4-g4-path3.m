...
s`Degree := 32;
s`Filename := "32S19-2,16,4-g4-path3.m";
...
\[ 3, 8, 11, 10, 13, 1, 2, 17, 5, 15, 19, 7, 21, 4, 23, 6, 25, 9, 27, 14, 29, 12, 31, 16, 30, 18, 26, 22, 32, 20, 28, 24 ],
\[ 4, 9, 12, 5, 7, 2, 1, 16, 10, 6, 20, 13, 14, 3, 18, 15, 26, 8, 28, 21, 22, 11, 24, 17, 32, 23, 25, 29, 30, 19, 27, 31 ] >;
s`Name := "32S19-2,16,4-g4-path3";
s`Orders := \[ 2, 16, 4 ];
s`Parents := [ Strings() | "64S48-4,16,4-g15-path20", "64S39-4,16,4-g15-path3", "64S38-2,16,4-g7-path6" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T13-2,8,2-g0-path3", "32S19-2,16,4-g4-path3" ];
