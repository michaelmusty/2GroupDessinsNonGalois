...
{ IntegerRing() | 26, 29 }
@};
s`Child := "16T6-8,8,4-g5-path5";
s`Degree := 32;
s`Filename := "32S5-8,8,4-g9-path23.m";
...
\[ 3, 4, 15, 19, 17, 23, 1, 28, 10, 5, 21, 2, 32, 16, 18, 30, 24, 20, 31, 25, 6, 9, 26, 13, 27, 14, 7, 12, 8, 11, 29, 22 ],
\[ 4, 10, 16, 20, 21, 3, 26, 1, 30, 29, 7, 15, 2, 5, 31, 25, 28, 11, 17, 8, 32, 19, 9, 23, 6, 18, 12, 22, 13, 24, 27, 14 ] >;
s`Name := "32S5-8,8,4-g9-path23";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S29-16,16,8-g25-path61", "64S31-16,16,8-g25-path57", "64S31-16,16,8-g25-path58", "64S29-16,16,8-g25-path62", "64S31-16,16,8-g25-path59", "64S30-16,16,8-g25-path29", "64S30-16,16,8-g25-path30", "64S31-16,16,8-g25-path60", "64S7-8,8,4-g17-path187", "64S6-8,8,4-g17-path51", "64S17-8,8,4-g17-path219", "64S6-8,8,4-g17-path52", "64S5-8,8,4-g17-path38", "64S4-8,8,4-g17-path15", "64S7-8,8,4-g17-path188" ];
...
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,4,2-g1-path5", "16T6-8,8,4-g5-path5", "32S5-8,8,4-g9-path23" ];
