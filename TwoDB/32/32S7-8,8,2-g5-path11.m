...
s`Degree := 32;
s`Filename := "32S7-8,8,2-g5-path11.m";
...
\[ 3, 9, 12, 6, 14, 20, 1, 24, 26, 28, 2, 19, 11, 23, 27, 18, 4, 30, 5, 32, 22, 15, 7, 31, 8, 29, 25, 13, 10, 17, 21, 16 ],
\[ 4, 7, 13, 1, 16, 21, 2, 11, 27, 19, 8, 30, 3, 26, 17, 5, 15, 25, 10, 23, 6, 29, 20, 32, 18, 14, 9, 31, 22, 12, 28, 24 ] >;
s`Name := "32S7-8,8,2-g5-path11";
s`Orders := \[ 8, 8, 2 ];
s`Parents := [ Strings() | "64S4-8,8,4-g17-path36", "64S24-8,8,4-g17-path83", "64S10-8,8,4-g17-path24", "64S14-8,8,4-g17-path36", "64S4-8,8,2-g9-path36", "64S12-8,8,2-g9-path2", "64S10-8,8,2-g9-path24" ];
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T10-4,4,2-g1-path9", "32S7-8,8,2-g5-path11" ];
