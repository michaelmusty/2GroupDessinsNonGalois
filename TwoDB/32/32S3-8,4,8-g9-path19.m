...
s`Degree := 32;
s`Filename := "32S3-8,4,8-g9-path19.m";
...
\[ 3, 10, 5, 13, 7, 4, 1, 2, 20, 11, 8, 9, 15, 23, 6, 14, 16, 12, 28, 18, 19, 21, 17, 27, 24, 25, 26, 22, 32, 29, 30, 31 ],
\[ 4, 3, 13, 14, 15, 16, 6, 1, 10, 5, 7, 2, 23, 24, 17, 25, 26, 8, 20, 11, 9, 12, 27, 29, 30, 31, 32, 18, 28, 19, 21, 22 ] >;
s`Name := "32S3-8,4,8-g9-path19";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path39", "64S3-8,8,8-g21-path39", "64S26-16,4,16-g21-path28", "64S26-16,8,16-g25-path28", "64S27-16,4,16-g21-path24", "64S27-16,8,16-g25-path24", "64S17-8,4,8-g17-path137" ];
...
s`PassportSize := 1;
s`PathNumber := 19;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path4", "32S3-8,4,8-g9-path19" ];
...
[ 13, 5, 15, 23, 6, 14, 4, 3, 11, 7, 1, 10, 17, 27, 16, 24, 25, 2, 18, 8, 20, 9, 26, 32, 29, 30, 31, 12, 22, 28, 19, 21 ],
[ 3, 10, 5, 13, 7, 4, 1, 2, 20, 11, 8, 9, 15, 23, 6, 14, 16, 12, 28, 18, 19, 21, 17, 27, 24, 25, 26, 22, 32, 29, 30, 31 ],
[ 10, 20, 11, 5, 8, 3, 2, 9, 28, 18, 12, 19, 7, 15, 1, 13, 4, 21, 32, 22, 29, 30, 6, 17, 23, 14, 16, 31, 26, 27, 24, 25 ]
]
];
