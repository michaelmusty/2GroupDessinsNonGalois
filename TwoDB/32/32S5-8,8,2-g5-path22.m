...
{ IntegerRing() | 27, 32 }
@};
s`Child := "16T6-8,8,2-g3-path4";
s`Degree := 32;
s`Filename := "32S5-8,8,2-g5-path22.m";
...
\[ 3, 9, 12, 6, 14, 21, 1, 16, 13, 28, 2, 30, 15, 8, 31, 27, 19, 4, 11, 5, 10, 23, 20, 18, 7, 24, 22, 26, 25, 32, 17, 29 ],
\[ 4, 7, 13, 1, 17, 22, 2, 11, 27, 20, 8, 21, 3, 26, 23, 18, 5, 16, 29, 10, 12, 6, 15, 25, 24, 14, 9, 32, 19, 31, 30, 28 ] >;
s`Name := "32S5-8,8,2-g5-path22";
s`Orders := \[ 8, 8, 2 ];
s`Parents := [ Strings() | "64S17-8,8,4-g17-path195", "64S7-8,8,4-g17-path139", "64S7-8,8,4-g17-path140", "64S5-8,8,4-g17-path14", "64S29-16,16,2-g13-path30", "64S29-16,16,4-g21-path30", "64S31-16,16,2-g13-path27", "64S31-16,16,4-g21-path27", "64S31-16,16,2-g13-path28", "64S31-16,16,4-g21-path28", "64S30-16,16,2-g13-path14", "64S30-16,16,4-g21-path14", "64S6-8,8,2-g9-path49", "64S6-8,8,2-g9-path50", "64S4-8,8,2-g9-path14" ];
...
s`PassportSize := 1;
s`PathNumber := 22;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T6-8,8,2-g3-path4", "32S5-8,8,2-g5-path22" ];
