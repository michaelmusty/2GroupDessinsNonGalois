...
s`Degree := 32;
s`Filename := "32S5-8,4,8-g9-path13.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 28, 24, 18, 8, 2, 29, 7, 17, 32, 27, 12, 5, 13, 15, 4, 22, 25, 30, 11, 21, 26, 31, 9, 20, 19 ],
\[ 4, 7, 15, 20, 21, 24, 27, 1, 12, 5, 19, 32, 2, 23, 13, 6, 25, 3, 22, 26, 9, 30, 29, 11, 10, 14, 31, 16, 8, 28, 18, 17 ] >;
s`Name := "32S5-8,4,8-g9-path13";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S29-16,8,16-g25-path39", "64S31-16,8,16-g25-path13", "64S31-16,8,16-g25-path14", "64S29-16,8,16-g25-path40", "64S31-16,8,16-g25-path15", "64S30-16,8,16-g25-path7", "64S30-16,8,16-g25-path8", "64S31-16,8,16-g25-path16", "64S7-8,4,8-g17-path165", "64S6-8,4,8-g17-path29", "64S17-8,4,8-g17-path208", "64S6-8,4,8-g17-path30", "64S5-8,4,8-g17-path27", "64S4-8,4,8-g17-path4", "64S7-8,4,8-g17-path166" ];
...
s`PassportSize := 1;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path2", "32S5-8,4,8-g9-path13" ];
