...
s`Degree := 32;
s`Filename := "32S14-8,4,4-g7-path16.m";
...
\[ 3, 10, 13, 6, 14, 8, 1, 18, 24, 15, 26, 2, 7, 29, 12, 22, 19, 4, 21, 5, 32, 23, 31, 27, 9, 30, 25, 11, 20, 28, 16, 17 ],
\[ 4, 7, 2, 13, 17, 16, 15, 1, 12, 9, 20, 27, 8, 11, 3, 18, 29, 23, 25, 30, 5, 28, 6, 19, 32, 22, 10, 31, 21, 14, 26, 24 ] >;
s`Name := "32S14-8,4,4-g7-path16";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path219", "64S16-8,8,8-g21-path220", "64S47-16,4,4-g15-path7", "64S49-16,8,8-g23-path13", "64S48-16,4,4-g15-path7", "64S49-16,8,8-g23-path14", "64S21-8,4,4-g13-path58" ];
...
s`PassportSize := 1;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T8-4,4,4-g3-path4", "32S14-8,4,4-g7-path16" ];
