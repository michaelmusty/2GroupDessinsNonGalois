...
s`Degree := 32;
s`Filename := "32S11-8,4,4-g7-path12.m";
...
\[ 3, 10, 14, 19, 16, 21, 1, 6, 18, 17, 5, 25, 2, 7, 28, 32, 13, 30, 31, 4, 27, 9, 26, 23, 15, 29, 8, 12, 24, 22, 20, 11 ],
\[ 4, 11, 15, 5, 8, 22, 2, 1, 28, 29, 12, 7, 9, 21, 16, 17, 3, 27, 24, 18, 32, 19, 13, 6, 30, 20, 26, 23, 25, 10, 14, 31 ] >;
s`Name := "32S11-8,4,4-g7-path12";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S6-8,8,4-g17-path12", "64S11-8,8,4-g17-path34", "64S10-8,8,4-g17-path12", "64S7-8,8,4-g17-path102", "64S9-8,4,4-g13-path93", "64S8-8,4,4-g13-path3", "64S20-8,4,4-g13-path25" ];
...
s`PassportSize := 2;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S11-8,4,4-g7-path12" ];
