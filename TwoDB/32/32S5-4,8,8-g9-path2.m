...
s`Degree := 32;
s`Filename := "32S5-4,8,8-g9-path2.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 29, 5, 18, 31, 10, 12, 26, 4, 30, 17, 6, 32, 16, 28, 14, 23, 27, 7, 8, 20, 19, 22, 25, 11 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 30, 31, 2, 5, 9, 17, 27, 3, 29, 12, 28, 16, 32, 6, 13, 11, 26, 21, 20, 8, 15, 25, 22, 23 ] >;
s`Name := "32S5-4,8,8-g9-path2";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S29-8,16,16-g25-path63", "64S31-8,16,16-g25-path61", "64S31-8,16,16-g25-path62", "64S30-8,16,16-g25-path31", "64S31-8,16,16-g25-path63", "64S29-8,16,16-g25-path64", "64S30-8,16,16-g25-path32", "64S31-8,16,16-g25-path64", "64S7-4,8,8-g17-path189", "64S6-4,8,8-g17-path53", "64S5-4,8,8-g17-path39", "64S6-4,8,8-g17-path54", "64S17-4,8,8-g17-path220", "64S4-4,8,8-g17-path16", "64S7-4,8,8-g17-path190" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S5-4,8,8-g9-path2" ];
