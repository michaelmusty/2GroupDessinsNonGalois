...
s`Degree := 32;
s`Filename := "32S7-8,2,8-g5-path1.m";
...
\[ 3, 9, 1, 6, 13, 4, 22, 24, 2, 26, 16, 14, 5, 12, 30, 11, 18, 17, 32, 21, 20, 7, 28, 8, 27, 10, 25, 23, 31, 15, 29, 19 ],
\[ 4, 3, 12, 16, 17, 20, 1, 9, 25, 13, 2, 28, 29, 8, 6, 19, 23, 24, 5, 22, 26, 27, 7, 32, 31, 30, 18, 10, 11, 14, 21, 15 ] >;
s`Name := "32S7-8,2,8-g5-path1";
s`Orders := \[ 8, 2, 8 ];
s`Parents := [ Strings() | "64S10-8,4,8-g17-path25", "64S14-8,4,8-g17-path37", "64S4-8,4,8-g17-path37", "64S24-8,4,8-g17-path84", "64S4-8,2,8-g9-path37", "64S12-8,2,8-g9-path3", "64S10-8,2,8-g9-path25" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,2,4-g1-path10", "32S7-8,2,8-g5-path1" ];
