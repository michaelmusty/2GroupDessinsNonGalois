...
s`Degree := 32;
s`Filename := "32S9-8,2,4-g3-path15.m";
...
\[ 3, 9, 1, 14, 10, 7, 6, 18, 2, 5, 12, 11, 16, 4, 22, 13, 26, 8, 20, 19, 30, 15, 24, 23, 29, 17, 28, 27, 25, 21, 32, 31 ],
\[ 4, 10, 2, 5, 7, 15, 1, 12, 8, 11, 3, 19, 6, 13, 14, 21, 20, 17, 9, 27, 22, 23, 16, 31, 28, 25, 18, 32, 24, 29, 30, 26 ] >;
s`Name := "32S9-8,2,4-g3-path15";
s`Orders := \[ 8, 2, 4 ];
s`Parents := [ Strings() | "64S8-8,4,4-g13-path50", "64S12-8,2,8-g9-path34", "64S6-8,4,8-g17-path91", "64S21-8,4,4-g13-path155", "64S6-8,2,8-g9-path91", "64S13-8,4,8-g17-path79", "64S38-16,2,4-g7-path12", "64S41-16,4,4-g15-path6", "64S42-16,2,8-g11-path6", "64S40-16,4,8-g19-path6", "64S41-16,2,4-g7-path6", "64S39-16,4,4-g15-path18", "64S40-16,2,8-g11-path6", "64S43-16,4,8-g19-path6", "64S8-8,2,4-g5-path28" ];
...
s`PassportSize := 1;
s`PathNumber := 15;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S9-8,2,4-g3-path15" ];
