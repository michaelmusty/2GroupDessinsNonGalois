...
s`Degree := 32;
s`Filename := "32S4-4,8,8-g9-path16.m";
...
\[ 3, 9, 13, 2, 15, 22, 1, 28, 25, 5, 27, 21, 20, 12, 18, 26, 31, 17, 6, 32, 4, 16, 30, 14, 24, 29, 7, 19, 8, 10, 23, 11 ],
\[ 4, 10, 14, 18, 19, 7, 25, 1, 31, 16, 2, 5, 9, 17, 29, 3, 28, 22, 13, 21, 23, 32, 6, 30, 15, 27, 12, 11, 20, 8, 26, 24 ] >;
s`Name := "32S4-4,8,8-g9-path16";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path100", "64S28-4,16,16-g21-path13", "64S28-8,16,16-g25-path13", "64S3-8,8,8-g21-path101", "64S28-4,16,16-g21-path14", "64S28-8,16,16-g25-path14", "64S17-4,8,8-g17-path163" ];
...
s`PassportSize := 1;
s`PathNumber := 16;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-2,8,8-g3-path1", "32S4-4,8,8-g9-path16" ];
