...
s`Degree := 32;
s`Filename := "32S5-8,4,8-g9-path9.m";
...
[ 12, 21, 26, 32, 10, 7, 27, 22, 4, 19, 29, 28, 6, 9, 17, 1, 2, 3, 16, 31, 24, 20, 11, 23, 5, 13, 30, 25, 15, 18, 14, 8 ]
]
];
s`PassportName := "32S5-8,4,8-g9";
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S5-8,4,8-g9-path9" ];
