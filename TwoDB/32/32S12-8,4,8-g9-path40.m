...
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path40.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 11, 19, 18, 25, 2, 24, 7, 17, 29, 21, 12, 30, 4, 26, 5, 20, 31, 27, 15, 8, 9, 22, 28, 32, 13 ],
\[ 4, 7, 15, 9, 17, 13, 21, 1, 12, 29, 22, 5, 2, 23, 19, 20, 24, 3, 27, 31, 28, 6, 30, 8, 14, 32, 16, 11, 26, 10, 18, 25 ] >;
s`Name := "32S12-8,4,8-g9-path40";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path80", "64S15-8,8,8-g21-path80", "64S45-16,4,16-g21-path35", "64S44-16,8,16-g25-path35", "64S45-16,4,16-g21-path36", "64S44-16,8,16-g25-path36", "64S17-8,4,8-g17-path34" ];
...
[ 7, 12, 1, 20, 22, 4, 14, 27, 28, 2, 8, 18, 32, 3, 26, 5, 15, 10, 9, 23, 17, 29, 6, 13, 11, 21, 25, 30, 16, 19, 24, 31 ],
...
\[ 4, 7, 15, 9, 17, 13, 21, 1, 12, 29, 22, 5, 2, 23, 19, 20, 24, 3, 27, 31, 28, 6, 30, 8, 14, 32, 16, 11, 26, 10, 18, 25 ]:
 Order := 32 > |
[ 6, 1, 17, 19, 21, 24, 26, 3, 2, 22, 5, 16, 10, 20, 30, 4, 31, 14, 8, 32, 9, 23, 28, 11, 7, 13, 29, 25, 15, 18, 12, 27 ],
[ 13, 4, 24, 27, 28, 8, 32, 15, 7, 6, 17, 20, 29, 31, 10, 9, 18, 23, 1, 25, 12, 30, 11, 22, 21, 2, 26, 14, 19, 3, 5, 16 ],
...
s`PassportSize := 2;
s`PathNumber := 40;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S12-8,4,8-g9-path40" ];
