...
s`Degree := 32;
s`Filename := "32S15-8,8,8-g11-path28.m";
...
\[ 3, 10, 15, 20, 16, 8, 1, 22, 28, 29, 5, 17, 2, 31, 11, 27, 18, 13, 24, 14, 6, 4, 9, 25, 30, 12, 7, 32, 26, 23, 21, 19 ],
\[ 4, 11, 2, 15, 21, 23, 18, 1, 26, 9, 29, 7, 30, 5, 14, 12, 24, 3, 31, 19, 27, 28, 22, 13, 6, 32, 8, 20, 16, 10, 25, 17 ] >;
s`Name := "32S15-8,8,8-g11-path28";
s`Orders := \[ 8, 8, 8 ];
s`Parents := [ Strings() | "64S15-8,8,8-g21-path260", "64S16-8,8,8-g21-path260", "64S22-8,8,8-g21-path20" ];
...
s`PassportSize := 6;
s`PathNumber := 28;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T8-4,4,4-g3-path22", "32S15-8,8,8-g11-path28" ];
