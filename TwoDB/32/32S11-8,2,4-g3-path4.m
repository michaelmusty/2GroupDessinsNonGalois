...
s`Degree := 32;
s`Filename := "32S11-8,2,4-g3-path4.m";
...
\[ 3, 9, 1, 6, 13, 4, 24, 23, 2, 27, 28, 14, 5, 12, 26, 18, 19, 16, 17, 32, 22, 21, 8, 7, 30, 15, 10, 11, 31, 25, 29, 20 ],
\[ 4, 3, 12, 16, 17, 21, 1, 9, 26, 13, 2, 11, 30, 22, 6, 7, 28, 10, 23, 5, 32, 27, 24, 31, 8, 25, 29, 20, 14, 18, 19, 15 ] >;
s`Name := "32S11-8,2,4-g3-path4";
s`Orders := \[ 8, 2, 4 ];
s`Parents := [ Strings() | "64S20-8,4,4-g13-path6", "64S6-8,2,8-g9-path17", "64S7-8,4,8-g17-path96", "64S9-8,4,4-g13-path74", "64S10-8,2,8-g9-path17", "64S11-8,4,8-g17-path28", "64S8-8,2,4-g5-path6" ];
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T10-4,2,4-g1-path2", "32S11-8,2,4-g3-path4" ];
