...
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path75", "64S3-8,8,8-g21-path75", "64S26-16,16,4-g21-path35", "64S26-16,16,8-g25-path35", "64S27-16,16,4-g21-path31", "64S27-16,16,8-g25-path31", "64S17-8,8,4-g17-path144" ];
