...
s`Degree := 32;
s`Filename := "32S5-2,8,8-g5-path2.m";
...
\[ 3, 8, 11, 2, 13, 1, 24, 14, 27, 25, 19, 7, 23, 17, 26, 15, 9, 4, 5, 22, 12, 21, 6, 29, 31, 10, 18, 16, 30, 20, 32, 28 ],
\[ 4, 6, 12, 16, 17, 22, 1, 26, 19, 2, 8, 15, 30, 3, 18, 20, 25, 13, 24, 5, 23, 28, 27, 10, 7, 21, 32, 9, 11, 31, 14, 29 ] >;
s`Name := "32S5-2,8,8-g5-path2";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "64S17-4,8,8-g17-path197", "64S7-4,8,8-g17-path143", "64S7-4,8,8-g17-path144", "64S5-4,8,8-g17-path16", "64S29-2,16,16-g13-path32", "64S29-4,16,16-g21-path32", "64S31-2,16,16-g13-path31", "64S31-4,16,16-g21-path31", "64S31-2,16,16-g13-path32", "64S31-4,16,16-g21-path32", "64S30-2,16,16-g13-path16", "64S30-4,16,16-g21-path16", "64S6-2,8,8-g9-path53", "64S6-2,8,8-g9-path54", "64S4-2,8,8-g9-path16" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S5-2,8,8-g5-path2" ];
