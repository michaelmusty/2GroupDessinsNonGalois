...
s`Degree := 32;
s`Filename := "32S16-16,16,8-g13-path9.m";
...
\[ 3, 8, 9, 6, 13, 11, 1, 14, 12, 21, 2, 23, 24, 25, 17, 19, 22, 4, 26, 5, 29, 7, 30, 27, 28, 10, 15, 16, 31, 32, 18, 20 ],
\[ 4, 7, 6, 15, 16, 17, 18, 1, 11, 20, 22, 2, 19, 3, 21, 23, 29, 27, 30, 28, 5, 31, 8, 26, 9, 32, 10, 12, 13, 14, 24, 25 ] >;
s`Name := "32S16-16,16,8-g13-path9";
s`Orders := \[ 16, 16, 8 ];
s`Parents := [ Strings() | "64S50-32,32,16-g29-path43", "64S51-32,32,16-g29-path35", "64S50-32,32,16-g29-path44", "64S51-32,32,16-g29-path36", "64S44-16,16,8-g25-path64", "64S26-16,16,8-g25-path18", "64S29-16,16,8-g25-path18" ];
...
s`PassportSize := 2;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,4-g5-path3", "32S16-16,16,8-g13-path9" ];
