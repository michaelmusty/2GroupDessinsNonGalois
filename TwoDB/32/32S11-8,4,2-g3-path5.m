...
s`Degree := 32;
s`Filename := "32S11-8,4,2-g3-path5.m";
...
\[ 3, 9, 12, 6, 14, 21, 1, 16, 26, 28, 2, 7, 15, 29, 10, 31, 19, 4, 24, 5, 18, 23, 32, 30, 8, 11, 22, 13, 20, 17, 25, 27 ],
\[ 4, 7, 13, 1, 17, 22, 2, 11, 27, 20, 8, 24, 3, 26, 23, 18, 5, 16, 25, 10, 29, 6, 15, 12, 19, 14, 9, 31, 21, 32, 28, 30 ] >;
s`Name := "32S11-8,4,2-g3-path5";
s`Orders := \[ 8, 4, 2 ];
s`Parents := [ Strings() | "64S6-8,8,2-g9-path18", "64S20-8,4,4-g13-path18", "64S7-8,8,4-g17-path97", "64S10-8,8,2-g9-path18", "64S9-8,4,4-g13-path86", "64S11-8,8,4-g17-path29", "64S8-8,4,2-g5-path7" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T10-4,4,2-g1-path3", "32S11-8,4,2-g3-path5" ];
