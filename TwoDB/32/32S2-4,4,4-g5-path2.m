...
{ IntegerRing() | 29, 32 }
@};
s`Child := "16T10-2,4,4-g1-path11";
s`Degree := 32;
s`Filename := "32S2-4,4,4-g5-path2.m";
...
\[ 3, 9, 13, 2, 15, 22, 1, 27, 21, 5, 31, 25, 7, 12, 30, 19, 29, 17, 6, 32, 4, 16, 18, 14, 24, 28, 26, 8, 23, 10, 20, 11 ],
\[ 4, 10, 14, 18, 19, 7, 25, 1, 29, 27, 2, 5, 9, 17, 28, 3, 16, 8, 31, 21, 15, 32, 6, 30, 23, 13, 11, 20, 26, 22, 12, 24 ] >;
s`Name := "32S2-4,4,4-g5-path2";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S20-8,4,4-g13-path87", "64S21-4,8,4-g13-path90", "64S25-8,8,4-g17-path43", "64S21-4,4,8-g13-path90", "64S17-8,4,8-g17-path68", "64S24-4,8,8-g17-path22", "64S22-8,8,8-g21-path130", "64S21-8,4,4-g13-path90", "64S18-4,8,4-g13-path22", "64S24-8,8,4-g17-path22", "64S20-4,4,8-g13-path87", "64S24-8,4,8-g17-path22", "64S25-4,8,8-g17-path43", "64S19-8,8,8-g21-path22", "64S20-8,4,4-g13-path88", "64S20-4,8,4-g13-path87", "64S17-8,8,4-g17-path68", "64S20-4,4,8-g13-path88", "64S25-8,4,8-g17-path43", "64S17-4,8,8-g17-path68", "64S22-8,8,8-g21-path131", "64S18-8,4,4-g13-path22", "64S20-4,8,4-g13-path88", "64S25-8,8,4-g17-path44", "64S18-4,4,8-g13-path22", "64S25-8,4,8-g17-path44", "64S25-4,8,8-g17-path44", "64S22-8,8,8-g21-path132", "64S23-4,4,4-g9-path64", "64S23-4,4,4-g9-path65", "64S23-4,4,4-g9-path66" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S2-4,4,4-g5-path2" ];
