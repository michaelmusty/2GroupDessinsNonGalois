...
s`Degree := 32;
s`Filename := "32S7-2,8,8-g5-path10.m";
...
\[ 3, 8, 11, 2, 13, 1, 21, 24, 26, 16, 18, 7, 22, 4, 32, 15, 9, 5, 28, 31, 20, 6, 30, 17, 10, 14, 23, 29, 12, 25, 19, 27 ],
\[ 4, 6, 12, 16, 17, 21, 1, 25, 18, 2, 26, 30, 31, 3, 14, 19, 23, 28, 5, 22, 27, 8, 7, 13, 29, 32, 9, 10, 11, 24, 15, 20 ] >;
s`Name := "32S7-2,8,8-g5-path10";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "64S10-4,8,8-g17-path23", "64S14-4,8,8-g17-path35", "64S4-4,8,8-g17-path35", "64S24-4,8,8-g17-path82", "64S4-2,8,8-g9-path35", "64S12-2,8,8-g9-path1", "64S10-2,8,8-g9-path23" ];
...
s`PassportSize := 1;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path8", "32S7-2,8,8-g5-path10" ];
