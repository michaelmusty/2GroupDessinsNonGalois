...
s`Degree := 32;
s`Filename := "32S17-16,16,8-g13-path10.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 29, 28, 17, 8, 2, 30, 13, 12, 9, 31, 5, 21, 15, 27, 4, 11, 25, 18, 20, 7, 19, 32, 24, 22, 26 ],
\[ 4, 7, 15, 19, 20, 24, 26, 1, 12, 5, 18, 25, 2, 23, 21, 6, 3, 22, 10, 30, 29, 13, 27, 17, 32, 28, 31, 11, 16, 8, 9, 14 ] >;
s`Name := "32S17-16,16,8-g13-path10";
s`Orders := \[ 16, 16, 8 ];
s`Parents := [ Strings() | "64S27-16,16,8-g25-path1", "64S29-16,16,8-g25-path19", "64S44-16,16,8-g25-path65" ];
...
s`PassportSize := 2;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,4,2-g1-path3", "16T5-8,8,4-g5-path5", "32S17-16,16,8-g13-path10" ];
