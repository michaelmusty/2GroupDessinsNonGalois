...
s`Degree := 32;
s`Filename := "32S16-16,16,8-g13-path10.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 26, 29, 9, 10, 31, 19, 21, 24, 4, 11, 5, 27, 22, 7, 32, 28, 30, 17, 18, 20, 25 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 25, 2, 15, 21, 24, 3, 23, 26, 27, 29, 32, 30, 5, 28, 31, 8, 14, 9, 10, 12, 13, 16 ] >;
s`Name := "32S16-16,16,8-g13-path10";
s`Orders := \[ 16, 16, 8 ];
s`Parents := [ Strings() | "64S50-32,32,16-g29-path9", "64S51-32,32,16-g29-path1", "64S50-32,32,16-g29-path10", "64S51-32,32,16-g29-path2", "64S29-16,16,8-g25-path1", "64S26-16,16,8-g25-path1", "64S44-16,16,8-g25-path47" ];
...
s`PassportSize := 2;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T5-8,8,4-g5-path3", "32S16-16,16,8-g13-path10" ];
