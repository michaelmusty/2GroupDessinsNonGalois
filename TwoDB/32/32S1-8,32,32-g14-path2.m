...
s`Degree := 32;
s`Filename := "32S1-8,32,32-g14-path2.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 22, 2, 19, 27, 29, 30, 18, 20, 23, 4, 26, 5, 31, 28, 7, 9, 24, 10, 32, 11, 21, 25, 17 ],
\[ 4, 7, 6, 16, 17, 18, 19, 1, 11, 21, 24, 2, 15, 20, 23, 3, 31, 13, 8, 25, 32, 5, 27, 12, 29, 9, 30, 10, 26, 28, 14, 22 ] >;
s`Name := "32S1-8,32,32-g14-path2";
s`Orders := \[ 8, 32, 32 ];
s`Parents := [ Strings() | "64S1-16,64,64-g30-path3", "64S1-16,64,64-g30-path4", "64S50-8,32,32-g27-path21", "64S50-8,32,32-g27-path22" ];
...
s`PassportSize := 4;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1", "16T1-4,16,16-g6-path1", "32S1-8,32,32-g14-path2" ];
