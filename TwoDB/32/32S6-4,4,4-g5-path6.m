...
s`Degree := 32;
s`Filename := "32S6-4,4,4-g5-path6.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 16, 5, 18, 29, 7, 12, 28, 4, 30, 17, 6, 27, 32, 31, 26, 23, 14, 8, 22, 10, 25, 11, 20, 19 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 27, 29, 2, 5, 21, 20, 26, 3, 32, 8, 31, 16, 30, 6, 28, 22, 13, 17, 23, 9, 11, 25, 12, 15 ] >;
s`Name := "32S6-4,4,4-g5-path6";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S8-4,8,4-g13-path41", "64S8-4,4,8-g13-path41", "64S4-4,8,8-g17-path31", "64S9-4,8,4-g13-path153", "64S9-4,4,8-g13-path153", "64S5-4,8,8-g17-path65", "64S32-4,8,4-g13-path19", "64S32-4,4,8-g13-path19", "64S36-4,8,8-g17-path8", "64S33-4,8,4-g13-path41", "64S33-4,4,8-g13-path41", "64S37-4,8,8-g17-path19", "64S23-4,4,4-g9-path306", "64S34-4,4,4-g9-path30", "64S35-4,4,4-g9-path63" ];
...
s`PassportSize := 3;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T10-2,4,4-g1-path4", "32S6-4,4,4-g5-path6" ];
