...
{ IntegerRing() | 22, 32 }
@};
s`Child := "16T12-4,2,8-g2-path1";
s`Degree := 32;
s`Filename := "32S9-4,2,8-g3-path12.m";
...
\[ 3, 9, 1, 17, 10, 19, 21, 23, 2, 5, 24, 30, 31, 26, 29, 22, 4, 27, 6, 25, 7, 16, 8, 11, 20, 14, 18, 32, 15, 12, 13, 28 ],
\[ 4, 10, 14, 18, 19, 20, 1, 24, 22, 29, 3, 2, 5, 16, 25, 6, 23, 15, 30, 31, 12, 7, 21, 32, 9, 8, 11, 17, 28, 26, 27, 13 ] >;
s`Name := "32S9-4,2,8-g3-path12";
s`Orders := \[ 4, 2, 8 ];
s`Parents := [ Strings() | "64S12-8,2,8-g9-path14", "64S41-4,4,16-g15-path20", "64S40-8,4,16-g19-path3", "64S6-8,2,8-g9-path71", "64S39-4,4,16-g15-path32", "64S43-8,4,16-g19-path3", "64S38-4,2,16-g7-path9", "64S42-8,2,16-g11-path3", "64S8-4,4,8-g13-path64", "64S6-8,4,8-g17-path71", "64S41-4,2,16-g7-path3", "64S40-8,2,16-g11-path3", "64S21-4,4,8-g13-path169", "64S13-8,4,8-g17-path59", "64S8-4,2,8-g5-path25" ];
...
s`PassportSize := 1;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T12-4,2,8-g2-path1", "32S9-4,2,8-g3-path12" ];
