...
s`Degree := 32;
s`Filename := "32S6-4,2,4-g1-path9.m";
...
\[ 3, 9, 1, 6, 13, 4, 23, 21, 2, 27, 29, 14, 5, 12, 30, 18, 19, 16, 17, 32, 8, 24, 7, 22, 31, 28, 10, 26, 11, 15, 25, 20 ],
\[ 4, 3, 12, 16, 17, 21, 1, 9, 26, 13, 2, 11, 31, 24, 6, 7, 29, 10, 22, 5, 32, 23, 28, 27, 8, 25, 30, 19, 20, 14, 18, 15 ] >;
s`Name := "32S6-4,2,4-g1-path9";
s`Orders := \[ 4, 2, 4 ];
s`Parents := [ Strings() | "64S32-8,2,4-g5-path11", "64S23-4,4,4-g9-path265", "64S33-8,4,4-g13-path11", "64S32-4,2,8-g5-path11", "64S4-8,2,8-g9-path34", "64S33-4,4,8-g13-path22", "64S5-8,4,8-g17-path57", "64S8-8,2,4-g5-path22", "64S35-4,4,4-g9-path22", "64S9-8,4,4-g13-path123", "64S8-4,2,8-g5-path22", "64S36-8,2,8-g9-path11", "64S9-4,4,8-g13-path134", "64S37-8,4,8-g17-path11", "64S34-4,2,4-g1-path11" ];
...
s`PassportSize := 1;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2", "16T10-4,2,4-g1-path7", "32S6-4,2,4-g1-path9" ];
