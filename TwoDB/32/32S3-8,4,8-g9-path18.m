...
s`Degree := 32;
s`Filename := "32S3-8,4,8-g9-path18.m";
...
\[ 3, 10, 5, 13, 7, 4, 1, 2, 20, 11, 8, 9, 15, 23, 6, 14, 16, 12, 28, 18, 19, 21, 17, 27, 24, 25, 26, 22, 32, 29, 30, 31 ],
\[ 4, 3, 13, 14, 15, 16, 6, 1, 10, 5, 7, 2, 23, 24, 17, 25, 26, 8, 20, 11, 9, 12, 27, 29, 30, 31, 32, 18, 28, 19, 21, 22 ] >;
s`Name := "32S3-8,4,8-g9-path18";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path38", "64S3-8,8,8-g21-path38", "64S26-16,4,16-g21-path27", "64S26-16,8,16-g25-path27", "64S27-16,4,16-g21-path23", "64S27-16,8,16-g25-path23", "64S17-8,4,8-g17-path136" ];
...
s`PassportSize := 1;
s`PathNumber := 18;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path3", "32S3-8,4,8-g9-path18" ];
