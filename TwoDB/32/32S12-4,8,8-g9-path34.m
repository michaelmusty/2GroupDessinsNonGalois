...
s`Degree := 32;
s`Filename := "32S12-4,8,8-g9-path34.m";
...
\[ 3, 10, 15, 20, 16, 8, 1, 22, 24, 29, 5, 17, 2, 31, 11, 26, 18, 13, 9, 14, 6, 4, 28, 32, 12, 7, 30, 27, 25, 19, 21, 23 ],
\[ 4, 11, 2, 15, 21, 23, 18, 1, 25, 9, 29, 7, 30, 5, 14, 12, 28, 3, 31, 19, 26, 27, 22, 6, 32, 8, 20, 13, 16, 10, 24, 17 ] >;
s`Name := "32S12-4,8,8-g9-path34";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S44-8,16,16-g25-path29", "64S44-8,16,16-g25-path30", "64S45-4,16,16-g21-path29", "64S16-8,8,8-g21-path27", "64S45-4,16,16-g21-path30", "64S15-8,8,8-g21-path27", "64S17-4,8,8-g17-path27" ];
...
s`PassportSize := 2;
s`PathNumber := 34;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T5-4,4,4-g2-path1", "16T8-4,4,4-g3-path26", "32S12-4,8,8-g9-path34" ];
