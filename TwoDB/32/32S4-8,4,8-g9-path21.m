...
s`Degree := 32;
s`Filename := "32S4-8,4,8-g9-path21.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 11, 29, 18, 27, 2, 31, 7, 17, 32, 22, 12, 20, 9, 4, 28, 5, 21, 26, 13, 30, 15, 19, 8, 25, 23 ],
\[ 4, 7, 15, 19, 17, 25, 22, 1, 12, 32, 23, 5, 2, 24, 20, 21, 26, 3, 10, 11, 13, 29, 6, 9, 18, 27, 14, 31, 30, 16, 8, 28 ] >;
s`Name := "32S4-8,4,8-g9-path21";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S28-16,8,16-g25-path25", "64S28-16,4,16-g21-path25", "64S3-8,8,8-g21-path162", "64S28-16,8,16-g25-path26", "64S28-16,4,16-g21-path26", "64S3-8,8,8-g21-path163", "64S17-8,4,8-g17-path169" ];
...
s`PassportSize := 1;
s`PathNumber := 21;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T6-8,4,8-g5-path1", "32S4-8,4,8-g9-path21" ];
