...
s`Degree := 32;
s`Filename := "32S17-2,16,16-g7-path7.m";
...
\[ 3, 7, 12, 9, 13, 1, 19, 5, 11, 2, 14, 21, 20, 23, 8, 4, 10, 6, 22, 24, 29, 31, 30, 32, 17, 15, 18, 16, 26, 25, 28, 27 ],
\[ 4, 8, 2, 15, 10, 17, 1, 16, 6, 18, 5, 11, 9, 3, 25, 27, 26, 28, 13, 7, 19, 12, 20, 14, 32, 31, 30, 29, 23, 21, 24, 22 ] >;
s`Name := "32S17-2,16,16-g7-path7";
s`Orders := \[ 2, 16, 16 ];
s`Parents := [ Strings() | "64S44-4,16,16-g21-path71", "64S27-4,16,16-g21-path7", "64S29-2,16,16-g13-path16" ];
...
s`PassportSize := 1;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-2,8,8-g3-path7", "32S17-2,16,16-g7-path7" ];
