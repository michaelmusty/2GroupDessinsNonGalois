...
s`Degree := 32;
s`Filename := "32S6-2,4,4-g1-path11.m";
...
\[ 3, 8, 11, 2, 13, 1, 23, 18, 25, 28, 6, 7, 26, 17, 32, 15, 9, 4, 5, 22, 30, 21, 31, 10, 14, 19, 16, 29, 24, 20, 12, 27 ],
\[ 4, 6, 12, 16, 17, 22, 1, 24, 19, 2, 25, 29, 30, 3, 18, 7, 28, 13, 23, 5, 11, 10, 27, 31, 32, 8, 9, 20, 14, 15, 26, 21 ] >;
s`Name := "32S6-2,4,4-g1-path11";
s`Orders := \[ 2, 4, 4 ];
s`Parents := [ Strings() | "64S35-4,4,4-g9-path2", "64S8-2,8,4-g5-path13", "64S33-4,8,4-g13-path2", "64S8-2,4,8-g5-path13", "64S33-4,4,8-g13-path2", "64S4-2,8,8-g9-path25", "64S37-4,8,8-g17-path2", "64S23-4,4,4-g9-path245", "64S32-2,8,4-g5-path2", "64S9-4,8,4-g13-path114", "64S32-2,4,8-g5-path2", "64S9-4,4,8-g13-path114", "64S36-2,8,8-g9-path2", "64S5-4,8,8-g17-path48", "64S34-2,4,4-g1-path2" ];
...
s`PassportSize := 1;
s`PathNumber := 11;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T10-2,4,4-g1-path9", "32S6-2,4,4-g1-path11" ];
