...
s`Degree := 32;
s`Filename := "32S16-8,16,16-g13-path10.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 26, 27, 17, 31, 18, 19, 21, 24, 4, 28, 5, 20, 30, 7, 22, 9, 32, 10, 25, 11, 29 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 25, 2, 15, 21, 24, 3, 28, 13, 32, 14, 27, 16, 5, 29, 23, 8, 31, 9, 26, 10, 30, 12 ] >;
s`Name := "32S16-8,16,16-g13-path10";
s`Orders := \[ 8, 16, 16 ];
s`Parents := [ Strings() | "64S50-16,32,32-g29-path9", "64S51-16,32,32-g29-path1", "64S50-16,32,32-g29-path10", "64S51-16,32,32-g29-path2", "64S29-8,16,16-g25-path1", "64S26-8,16,16-g25-path1", "64S44-8,16,16-g25-path47" ];
...
s`PassportSize := 2;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T5-4,8,8-g5-path3", "32S16-8,16,16-g13-path10" ];
