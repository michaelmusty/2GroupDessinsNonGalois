...
s`Degree := 32;
s`Filename := "32S11-4,8,4-g7-path7.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 28, 5, 18, 30, 10, 12, 26, 4, 29, 17, 6, 31, 16, 32, 14, 23, 27, 7, 8, 19, 22, 25, 11, 20 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 29, 30, 2, 5, 9, 20, 27, 3, 28, 8, 32, 16, 31, 6, 13, 22, 26, 21, 17, 15, 23, 11, 25, 12 ] >;
s`Name := "32S11-4,8,4-g7-path7";
s`Orders := \[ 4, 8, 4 ];
s`Parents := [ Strings() | "64S6-4,8,8-g17-path20", "64S7-4,8,8-g17-path110", "64S10-4,8,8-g17-path20", "64S11-4,8,8-g17-path42", "64S20-4,8,4-g13-path42", "64S8-4,8,4-g13-path20", "64S9-4,8,4-g13-path110" ];
...
s`PassportSize := 2;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T10-2,4,4-g1-path5", "32S11-4,8,4-g7-path7" ];
