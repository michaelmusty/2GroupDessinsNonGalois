...
s`Degree := 32;
s`Filename := "32S16-16,16,2-g7-path6.m";
...
\[ 3, 4, 11, 6, 12, 13, 1, 7, 14, 2, 21, 22, 23, 15, 24, 5, 10, 16, 8, 9, 29, 30, 31, 32, 19, 20, 17, 18, 28, 25, 26, 27 ],
\[ 4, 7, 6, 1, 14, 3, 2, 10, 16, 8, 13, 15, 11, 5, 12, 9, 19, 20, 17, 18, 23, 24, 21, 22, 27, 28, 25, 26, 31, 32, 29, 30 ] >;
s`Name := "32S16-16,16,2-g7-path6";
s`Orders := \[ 16, 16, 2 ];
s`Parents := [ Strings() | "64S26-16,16,4-g21-path6", "64S44-16,16,4-g21-path52", "64S50-32,32,2-g15-path8", "64S50-32,32,4-g23-path8", "64S51-32,32,2-g15-path6", "64S51-32,32,4-g23-path6", "64S29-16,16,2-g13-path6" ];
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T5-8,8,2-g3-path4", "32S16-16,16,2-g7-path6" ];
