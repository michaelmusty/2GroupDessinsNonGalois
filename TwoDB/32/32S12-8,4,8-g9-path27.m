...
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path27.m";
...
\[ 3, 10, 13, 6, 15, 23, 1, 2, 25, 16, 26, 9, 7, 4, 29, 8, 19, 20, 31, 28, 5, 11, 14, 17, 27, 32, 12, 30, 21, 18, 24, 22 ],
\[ 4, 7, 14, 17, 18, 24, 6, 1, 8, 13, 21, 2, 23, 19, 30, 3, 22, 9, 32, 12, 20, 5, 31, 11, 16, 29, 10, 27, 28, 25, 26, 15 ] >;
s`Name := "32S12-8,4,8-g9-path27";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S45-16,8,16-g25-path15", "64S45-16,8,16-g25-path16", "64S44-16,4,16-g21-path15", "64S16-8,8,8-g21-path65", "64S44-16,4,16-g21-path16", "64S15-8,8,8-g21-path65", "64S17-8,4,8-g17-path19" ];
...
s`PassportSize := 2;
s`PathNumber := 27;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,4,2-g0-path1", "16T8-4,4,4-g3-path19", "32S12-8,4,8-g9-path27" ];
