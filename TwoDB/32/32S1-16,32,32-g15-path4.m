...
s`Degree := 32;
s`Filename := "32S1-16,32,32-g15-path4.m";
...
\[ 3, 8, 12, 6, 13, 14, 1, 15, 4, 19, 2, 25, 26, 27, 28, 17, 29, 5, 30, 7, 16, 9, 10, 11, 21, 22, 23, 31, 24, 32, 18, 20 ],
\[ 4, 7, 6, 2, 16, 8, 9, 1, 11, 18, 20, 14, 17, 15, 3, 10, 19, 21, 5, 22, 23, 24, 31, 32, 27, 29, 28, 12, 30, 13, 25, 26 ] >;
s`Name := "32S1-16,32,32-g15-path4";
s`Orders := \[ 16, 32, 32 ];
s`Parents := [ Strings() | "64S1-32,64,64-g31-path7", "64S1-32,64,64-g31-path8", "64S50-16,32,32-g29-path7", "64S50-16,32,32-g29-path8" ];
...
s`PassportSize := 8;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T1-4,8,8-g3-path1", "16T1-8,16,16-g7-path2", "32S1-16,32,32-g15-path4" ];
