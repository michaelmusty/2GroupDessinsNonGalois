...
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path23.m";
...
\[ 3, 10, 13, 6, 15, 23, 1, 2, 25, 16, 29, 9, 7, 4, 31, 8, 19, 20, 27, 28, 5, 11, 14, 17, 30, 18, 24, 26, 32, 12, 21, 22 ],
\[ 4, 7, 14, 17, 18, 24, 6, 1, 8, 13, 21, 2, 23, 19, 26, 3, 29, 30, 11, 25, 20, 5, 27, 32, 16, 12, 22, 9, 31, 10, 28, 15 ] >;
s`Name := "32S12-8,4,8-g9-path23";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S45-16,8,16-g25-path9", "64S45-16,8,16-g25-path10", "64S44-16,4,16-g21-path9", "64S16-8,8,8-g21-path61", "64S44-16,4,16-g21-path10", "64S15-8,8,8-g21-path61", "64S17-8,4,8-g17-path15" ];
...
s`PassportSize := 2;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T6-8,4,8-g5-path4", "32S12-8,4,8-g9-path23" ];
