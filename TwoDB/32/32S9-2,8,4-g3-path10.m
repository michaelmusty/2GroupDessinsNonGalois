...
s`Degree := 32;
s`Filename := "32S9-2,8,4-g3-path10.m";
...
\[ 3, 8, 11, 2, 13, 1, 21, 23, 25, 16, 18, 7, 22, 4, 28, 15, 9, 5, 32, 29, 20, 6, 17, 10, 14, 31, 12, 26, 19, 24, 30, 27 ],
\[ 4, 6, 12, 16, 17, 21, 1, 24, 18, 2, 25, 15, 29, 3, 14, 7, 31, 32, 5, 22, 10, 8, 13, 20, 28, 9, 11, 27, 30, 23, 19, 26 ] >;
s`Name := "32S9-2,8,4-g3-path10";
s`Orders := \[ 2, 8, 4 ];
s`Parents := [ Strings() | "64S8-4,8,4-g13-path45", "64S12-2,8,8-g9-path29", "64S6-4,8,8-g17-path86", "64S21-4,8,4-g13-path150", "64S6-2,8,8-g9-path86", "64S13-4,8,8-g17-path74", "64S38-2,16,4-g7-path7", "64S41-4,16,4-g15-path1", "64S42-2,16,8-g11-path1", "64S40-4,16,8-g19-path1", "64S41-2,16,4-g7-path1", "64S39-4,16,4-g15-path13", "64S40-2,16,8-g11-path1", "64S43-4,16,8-g19-path1", "64S8-2,8,4-g5-path23" ];
...
s`PassportSize := 1;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T10-2,4,4-g1-path8", "32S9-2,8,4-g3-path10" ];
