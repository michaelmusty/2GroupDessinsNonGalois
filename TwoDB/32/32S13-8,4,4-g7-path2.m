...
s`Degree := 32;
s`Filename := "32S13-8,4,4-g7-path2.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 28, 17, 11, 12, 2, 32, 29, 26, 15, 30, 20, 13, 6, 19, 31, 22, 9, 16, 25, 23, 14, 8, 24, 27, 21 ],
\[ 4, 3, 15, 19, 20, 22, 25, 1, 10, 31, 7, 23, 2, 5, 13, 30, 18, 27, 8, 32, 11, 29, 16, 6, 21, 9, 28, 17, 24, 12, 26, 14 ] >;
s`Name := "32S13-8,4,4-g7-path2";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S46-16,8,4-g19-path19", "64S46-16,4,8-g19-path19", "64S15-8,8,8-g21-path225", "64S46-16,8,4-g19-path20", "64S46-16,4,8-g19-path20", "64S15-8,8,8-g21-path226", "64S21-8,4,4-g13-path44" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T12-8,2,4-g2-path2", "32S13-8,4,4-g7-path2" ];
