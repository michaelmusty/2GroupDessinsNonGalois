...
s`Degree := 32;
s`Filename := "32S6-4,4,2-g1-path2.m";
...
\[ 3, 9, 12, 6, 14, 21, 1, 24, 26, 28, 2, 7, 15, 30, 10, 27, 19, 4, 23, 5, 18, 8, 31, 32, 16, 11, 29, 13, 25, 20, 17, 22 ],
\[ 4, 7, 13, 1, 17, 22, 2, 11, 27, 20, 8, 23, 3, 26, 25, 18, 5, 16, 29, 10, 30, 6, 12, 31, 15, 14, 9, 32, 19, 21, 24, 28 ] >;
s`Name := "32S6-4,4,2-g1-path2";
s`Orders := \[ 4, 4, 2 ];
s`Parents := [ Strings() | "64S8-8,4,2-g5-path15", "64S8-4,8,2-g5-path15", "64S4-8,8,2-g9-path27", "64S35-4,4,4-g9-path26", "64S33-8,4,4-g13-path15", "64S33-4,8,4-g13-path15", "64S37-8,8,4-g17-path4", "64S32-8,4,2-g5-path4", "64S32-4,8,2-g5-path4", "64S36-8,8,2-g9-path4", "64S23-4,4,4-g9-path269", "64S9-8,4,4-g13-path127", "64S9-4,8,4-g13-path127", "64S5-8,8,4-g17-path50", "64S34-4,4,2-g1-path4" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S6-4,4,2-g1-path2" ];
