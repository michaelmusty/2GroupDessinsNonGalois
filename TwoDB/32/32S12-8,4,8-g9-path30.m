...
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path30.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 11, 19, 18, 25, 2, 24, 7, 17, 29, 21, 12, 30, 4, 26, 5, 20, 31, 27, 15, 8, 9, 22, 28, 32, 13 ],
\[ 4, 7, 15, 9, 17, 13, 21, 1, 12, 29, 22, 5, 2, 23, 19, 20, 24, 3, 27, 31, 28, 6, 30, 8, 14, 32, 16, 11, 26, 10, 18, 25 ] >;
s`Name := "32S12-8,4,8-g9-path30";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path69", "64S15-8,8,8-g21-path69", "64S45-16,4,16-g21-path25", "64S44-16,8,16-g25-path25", "64S45-16,4,16-g21-path26", "64S44-16,8,16-g25-path26", "64S17-8,4,8-g17-path23" ];
...
s`PassportSize := 2;
s`PathNumber := 30;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path20", "32S12-8,4,8-g9-path30" ];
