...
s`Degree := 32;
s`Filename := "32S16-16,8,16-g13-path5.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 21, 2, 22, 20, 23, 29, 26, 19, 4, 30, 5, 28, 31, 7, 27, 9, 10, 32, 11, 17, 18, 24, 25 ],
\[ 4, 7, 6, 9, 17, 12, 18, 1, 11, 20, 23, 2, 15, 19, 22, 3, 24, 25, 27, 29, 5, 8, 30, 26, 28, 13, 10, 14, 31, 32, 16, 21 ] >;
s`Name := "32S16-16,8,16-g13-path5";
s`Orders := \[ 16, 8, 16 ];
s`Parents := [ Strings() | "64S50-32,16,32-g29-path35", "64S51-32,16,32-g29-path27", "64S50-32,16,32-g29-path36", "64S51-32,16,32-g29-path28", "64S44-16,8,16-g25-path60", "64S26-16,8,16-g25-path14", "64S29-16,8,16-g25-path14" ];
...
s`PassportSize := 2;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T1-8,4,8-g3-path1", "16T5-8,4,8-g5-path1", "32S16-16,8,16-g13-path5" ];
