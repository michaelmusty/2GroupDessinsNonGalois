...
s`Degree := 32;
s`Filename := "32S6-4,4,4-g5-path17.m";
...
\[ 3, 10, 5, 18, 7, 4, 1, 25, 21, 11, 12, 2, 19, 26, 24, 15, 31, 20, 29, 6, 27, 30, 16, 23, 14, 8, 28, 9, 32, 17, 22, 13 ],
\[ 4, 3, 15, 19, 20, 21, 23, 1, 10, 30, 7, 31, 2, 5, 13, 9, 18, 28, 8, 32, 25, 6, 29, 27, 22, 17, 12, 26, 11, 16, 24, 14 ] >;
s`Name := "32S6-4,4,4-g5-path17";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S8-8,4,4-g13-path28", "64S8-4,4,8-g13-path30", "64S4-8,4,8-g17-path29", "64S9-8,4,4-g13-path140", "64S9-4,4,8-g13-path142", "64S5-8,4,8-g17-path63", "64S32-8,4,4-g13-path6", "64S32-4,4,8-g13-path8", "64S36-8,4,8-g17-path6", "64S33-8,4,4-g13-path28", "64S33-4,4,8-g13-path30", "64S37-8,4,8-g17-path17", "64S23-4,4,4-g9-path284", "64S34-4,4,4-g9-path8", "64S35-4,4,4-g9-path41" ];
...
s`PassportSize := 3;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T10-4,2,4-g1-path4", "32S6-4,4,4-g5-path17" ];
