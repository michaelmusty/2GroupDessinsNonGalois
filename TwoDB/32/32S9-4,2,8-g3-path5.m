...
s`Degree := 32;
s`Filename := "32S9-4,2,8-g3-path5.m";
...
\[ 3, 9, 1, 6, 13, 4, 21, 20, 2, 25, 16, 14, 5, 12, 24, 11, 18, 17, 31, 8, 7, 26, 32, 15, 10, 22, 29, 30, 27, 28, 19, 23 ],
\[ 4, 3, 12, 16, 17, 20, 1, 9, 24, 13, 2, 26, 27, 8, 6, 19, 22, 32, 5, 21, 30, 7, 25, 29, 28, 10, 11, 14, 23, 18, 15, 31 ] >;
s`Name := "32S9-4,2,8-g3-path5";
s`Orders := \[ 4, 2, 8 ];
s`Parents := [ Strings() | "64S12-8,2,8-g9-path24", "64S41-4,4,16-g15-path30", "64S40-8,4,16-g19-path13", "64S6-8,2,8-g9-path81", "64S39-4,4,16-g15-path42", "64S43-8,4,16-g19-path13", "64S38-4,2,16-g7-path19", "64S42-8,2,16-g11-path13", "64S8-4,4,8-g13-path74", "64S6-8,4,8-g17-path81", "64S41-4,2,16-g7-path13", "64S40-8,2,16-g11-path13", "64S21-4,4,8-g13-path179", "64S13-8,4,8-g17-path69", "64S8-4,2,8-g5-path35" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T10-4,2,4-g1-path3", "32S9-4,2,8-g3-path5" ];
