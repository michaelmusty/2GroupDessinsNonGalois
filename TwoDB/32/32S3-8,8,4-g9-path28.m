...
s`Degree := 32;
s`Filename := "32S3-8,8,4-g9-path28.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 17, 28, 9, 10, 29, 19, 21, 24, 4, 11, 5, 26, 22, 7, 27, 20, 30, 32, 31, 25, 18 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 25, 2, 15, 21, 24, 3, 8, 30, 16, 12, 31, 32, 5, 29, 27, 14, 9, 10, 13, 23, 26, 28 ] >;
s`Name := "32S3-8,8,4-g9-path28";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path78", "64S3-8,8,8-g21-path78", "64S26-16,16,4-g21-path38", "64S26-16,16,8-g25-path38", "64S27-16,16,4-g21-path34", "64S27-16,16,8-g25-path34", "64S17-8,8,4-g17-path147" ];
...
s`PassportSize := 1;
s`PathNumber := 28;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T5-8,8,4-g5-path6", "32S3-8,8,4-g9-path28" ];
