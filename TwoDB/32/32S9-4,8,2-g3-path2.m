...
s`Degree := 32;
s`Filename := "32S9-4,8,2-g3-path2.m";
...
\[ 3, 9, 12, 6, 14, 20, 1, 15, 24, 26, 2, 19, 11, 22, 29, 18, 4, 28, 5, 31, 8, 7, 30, 27, 21, 13, 10, 17, 32, 25, 16, 23 ],
\[ 4, 7, 13, 1, 16, 21, 2, 11, 25, 19, 8, 28, 3, 24, 17, 5, 15, 32, 10, 22, 6, 20, 27, 14, 9, 29, 23, 12, 26, 31, 30, 18 ] >;
s`Name := "32S9-4,8,2-g3-path2";
s`Orders := \[ 4, 8, 2 ];
s`Parents := [ Strings() | "64S12-8,8,2-g9-path21", "64S8-4,8,4-g13-path71", "64S6-8,8,4-g17-path78", "64S6-8,8,2-g9-path78", "64S21-4,8,4-g13-path176", "64S13-8,8,4-g17-path66", "64S38-4,16,2-g7-path16", "64S42-8,16,2-g11-path10", "64S41-4,16,4-g15-path27", "64S40-8,16,4-g19-path10", "64S41-4,16,2-g7-path10", "64S40-8,16,2-g11-path10", "64S39-4,16,4-g15-path39", "64S43-8,16,4-g19-path10", "64S8-4,8,2-g5-path32" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S9-4,8,2-g3-path2" ];
