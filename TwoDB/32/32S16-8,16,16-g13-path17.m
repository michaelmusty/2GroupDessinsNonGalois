...
s`Degree := 32;
s`Filename := "32S16-8,16,16-g13-path17.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 21, 2, 23, 18, 29, 30, 4, 19, 22, 25, 5, 31, 27, 7, 9, 28, 10, 32, 11, 24, 26, 17, 20 ],
\[ 4, 7, 6, 13, 17, 18, 16, 1, 11, 20, 23, 2, 15, 19, 22, 3, 29, 30, 24, 31, 5, 26, 8, 28, 9, 32, 10, 12, 25, 27, 14, 21 ] >;
s`Name := "32S16-8,16,16-g13-path17";
s`Orders := \[ 8, 16, 16 ];
s`Parents := [ Strings() | "64S50-16,32,32-g29-path23", "64S51-16,32,32-g29-path15", "64S50-16,32,32-g29-path24", "64S51-16,32,32-g29-path16", "64S44-8,16,16-g25-path54", "64S26-8,16,16-g25-path8", "64S29-8,16,16-g25-path8" ];
...
s`PassportSize := 2;
s`PathNumber := 17;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-2,4,4-g1-path5", "16T5-4,8,8-g5-path7", "32S16-8,16,16-g13-path17" ];
