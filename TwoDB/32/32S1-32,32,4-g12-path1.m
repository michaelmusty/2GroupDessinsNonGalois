...
s`Degree := 32;
s`Filename := "32S1-32,32,4-g12-path1.m";
...
\[ 3, 4, 13, 14, 15, 16, 1, 6, 10, 5, 8, 2, 23, 24, 17, 25, 26, 7, 20, 11, 9, 12, 30, 27, 31, 32, 29, 18, 28, 19, 21, 22 ],
\[ 4, 10, 14, 5, 8, 3, 2, 1, 20, 11, 7, 9, 24, 15, 6, 13, 16, 12, 28, 18, 19, 21, 27, 17, 23, 25, 26, 22, 32, 29, 30, 31 ] >;
s`Name := "32S1-32,32,4-g12-path1";
s`Orders := \[ 32, 32, 4 ];
s`Parents := [ Strings() | "64S1-64,64,8-g28-path1", "64S1-64,64,8-g28-path2", "64S50-32,32,4-g23-path1", "64S50-32,32,4-g23-path2" ];
...
s`PassportName := "32S1-32,32,4-g12";
s`PassportSize := 2;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1", "16T1-16,16,2-g4-path1", "32S1-32,32,4-g12-path1" ];
