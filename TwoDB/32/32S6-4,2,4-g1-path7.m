...
s`Degree := 32;
s`Filename := "32S6-4,2,4-g1-path7.m";
...
\[ 3, 9, 1, 6, 13, 4, 23, 21, 2, 27, 29, 14, 5, 12, 30, 18, 19, 16, 17, 32, 8, 24, 7, 22, 31, 28, 10, 26, 11, 15, 25, 20 ],
\[ 4, 3, 12, 16, 17, 21, 1, 9, 26, 13, 2, 11, 31, 24, 6, 7, 29, 10, 22, 5, 32, 23, 28, 27, 8, 25, 30, 19, 20, 14, 18, 15 ] >;
s`Name := "32S6-4,2,4-g1-path7";
s`Orders := \[ 4, 2, 4 ];
s`Parents := [ Strings() | "64S32-8,2,4-g5-path9", "64S23-4,4,4-g9-path263", "64S33-8,4,4-g13-path9", "64S32-4,2,8-g5-path9", "64S4-8,2,8-g9-path32", "64S33-4,4,8-g13-path20", "64S5-8,4,8-g17-path55", "64S8-8,2,4-g5-path20", "64S35-4,4,4-g9-path20", "64S9-8,4,4-g13-path121", "64S8-4,2,8-g5-path20", "64S36-8,2,8-g9-path9", "64S9-4,4,8-g13-path132", "64S37-8,4,8-g17-path9", "64S34-4,2,4-g1-path9" ];
...
s`PassportSize := 1;
s`PathNumber := 7;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T2-4,2,4-g1-path5", "16T10-4,2,4-g1-path5", "32S6-4,2,4-g1-path7" ];
