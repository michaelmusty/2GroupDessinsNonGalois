...
{ IntegerRing() | 30, 31 }
@};
s`Child := "16T10-4,4,2-g1-path11";
s`Degree := 32;
s`Filename := "32S2-4,4,4-g5-path24.m";
...
\[ 3, 10, 14, 20, 16, 22, 1, 6, 19, 15, 5, 26, 2, 7, 13, 32, 12, 17, 30, 25, 4, 28, 29, 9, 21, 18, 31, 8, 27, 24, 23, 11 ],
\[ 4, 11, 15, 5, 8, 23, 2, 1, 17, 30, 12, 7, 9, 25, 16, 18, 29, 3, 28, 24, 19, 14, 20, 6, 32, 31, 21, 27, 13, 26, 10, 22 ] >;
s`Name := "32S2-4,4,4-g5-path24";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S20-8,4,4-g13-path75", "64S21-4,8,4-g13-path84", "64S25-8,8,4-g17-path31", "64S21-4,4,8-g13-path84", "64S17-8,4,8-g17-path62", "64S24-4,8,8-g17-path16", "64S22-8,8,8-g21-path112", "64S21-8,4,4-g13-path84", "64S18-4,8,4-g13-path16", "64S24-8,8,4-g17-path16", "64S20-4,4,8-g13-path75", "64S24-8,4,8-g17-path16", "64S25-4,8,8-g17-path31", "64S19-8,8,8-g21-path16", "64S20-8,4,4-g13-path76", "64S20-4,8,4-g13-path75", "64S17-8,8,4-g17-path62", "64S20-4,4,8-g13-path76", "64S25-8,4,8-g17-path31", "64S17-4,8,8-g17-path62", "64S22-8,8,8-g21-path113", "64S18-8,4,4-g13-path16", "64S20-4,8,4-g13-path76", "64S25-8,8,4-g17-path32", "64S18-4,4,8-g13-path16", "64S25-8,4,8-g17-path32", "64S25-4,8,8-g17-path32", "64S22-8,8,8-g21-path114", "64S23-4,4,4-g9-path46", "64S23-4,4,4-g9-path47", "64S23-4,4,4-g9-path48" ];
...
s`PassportSize := 1;
s`PathNumber := 24;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T10-4,4,2-g1-path11", "32S2-4,4,4-g5-path24" ];
