...
s`Degree := 32;
s`Filename := "32S3-8,4,8-g9-path13.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 25, 7, 31, 20, 11, 19, 21, 24, 4, 27, 5, 32, 29, 26, 9, 30, 10, 17, 18, 22, 28 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 13, 2, 15, 21, 24, 3, 23, 25, 32, 29, 26, 30, 5, 28, 8, 16, 9, 31, 10, 12, 27, 14 ] >;
s`Name := "32S3-8,4,8-g9-path13";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path33", "64S3-8,8,8-g21-path33", "64S26-16,4,16-g21-path22", "64S26-16,8,16-g25-path22", "64S27-16,4,16-g21-path18", "64S27-16,8,16-g25-path18", "64S17-8,4,8-g17-path131" ];
...
s`PassportSize := 1;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T4-4,4,4-g3-path7", "32S3-8,4,8-g9-path13" ];
