...
{ IntegerRing() | 27, 32 }
@};
s`Child := "16T6-8,8,2-g3-path2";
s`Degree := 32;
s`Filename := "32S5-8,8,2-g5-path20.m";
...
\[ 3, 9, 12, 6, 14, 21, 1, 16, 13, 28, 2, 30, 15, 8, 31, 27, 19, 4, 11, 5, 10, 23, 20, 18, 7, 24, 22, 26, 25, 32, 17, 29 ],
\[ 4, 7, 13, 1, 17, 22, 2, 11, 27, 20, 8, 21, 3, 26, 23, 18, 5, 16, 29, 10, 12, 6, 15, 25, 24, 14, 9, 32, 19, 31, 30, 28 ] >;
s`Name := "32S5-8,8,2-g5-path20";
s`Orders := \[ 8, 8, 2 ];
s`Parents := [ Strings() | "64S17-8,8,4-g17-path193", "64S7-8,8,4-g17-path135", "64S7-8,8,4-g17-path136", "64S5-8,8,4-g17-path12", "64S29-16,16,2-g13-path28", "64S29-16,16,4-g21-path28", "64S31-16,16,2-g13-path23", "64S31-16,16,4-g21-path23", "64S31-16,16,2-g13-path24", "64S31-16,16,4-g21-path24", "64S30-16,16,2-g13-path12", "64S30-16,16,4-g21-path12", "64S6-8,8,2-g9-path45", "64S6-8,8,2-g9-path46", "64S4-8,8,2-g9-path12" ];
...
s`PassportSize := 1;
s`PathNumber := 20;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T2-4,4,2-g1-path2", "16T6-8,8,2-g3-path2", "32S5-8,8,2-g5-path20" ];
