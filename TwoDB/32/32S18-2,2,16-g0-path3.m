...
s`Degree := 32;
s`Filename := "32S18-2,2,16-g0-path3.m";
...
\[ 3, 7, 1, 9, 8, 12, 2, 5, 4, 16, 17, 6, 15, 20, 13, 10, 11, 24, 25, 14, 23, 28, 21, 18, 19, 30, 32, 22, 31, 26, 29, 27 ],
\[ 4, 8, 12, 13, 7, 1, 16, 17, 3, 2, 5, 20, 21, 6, 9, 24, 25, 10, 11, 28, 29, 14, 15, 30, 32, 18, 19, 26, 27, 22, 23, 31 ] >;
s`Name := "32S18-2,2,16-g0-path3";
s`Orders := \[ 2, 2, 16 ];
s`Parents := [ Strings() | "64S38-4,2,16-g7-path3", "64S38-2,4,16-g7-path3", "64S47-4,4,16-g15-path20", "64S52-2,2,32-g0-path3", "64S53-4,2,32-g8-path3", "64S53-2,4,32-g8-path3", "64S54-4,4,32-g16-path3" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T13-2,2,8-g0-path3", "32S18-2,2,16-g0-path3" ];
