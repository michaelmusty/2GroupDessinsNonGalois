...
s`Degree := 32;
s`Filename := "32S17-8,16,16-g13-path8.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 27, 29, 18, 8, 2, 30, 24, 17, 20, 31, 4, 5, 22, 15, 9, 32, 25, 13, 11, 21, 7, 28, 19, 12, 26 ],
\[ 4, 7, 15, 20, 21, 24, 27, 1, 12, 5, 19, 30, 2, 23, 22, 6, 25, 3, 18, 17, 14, 32, 9, 31, 26, 28, 16, 10, 11, 8, 29, 13 ] >;
s`Name := "32S17-8,16,16-g13-path8";
s`Orders := \[ 8, 16, 16 ];
s`Parents := [ Strings() | "64S27-8,16,16-g25-path13", "64S29-8,16,16-g25-path31", "64S44-8,16,16-g25-path77" ];
...
s`PassportSize := 2;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-2,4,4-g1-path1", "8T2-2,4,4-g1-path2", "16T5-4,8,8-g5-path4", "32S17-8,16,16-g13-path8" ];
