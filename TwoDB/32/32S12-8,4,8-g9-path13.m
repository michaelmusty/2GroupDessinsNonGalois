...
{ IntegerRing() | 29, 31 }
@};
s`Child := "16T5-8,4,8-g5-path6";
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path13.m";
...
\[ 3, 8, 15, 19, 16, 23, 1, 27, 13, 5, 14, 2, 32, 18, 7, 30, 22, 25, 17, 6, 24, 4, 26, 31, 11, 20, 12, 21, 9, 10, 28, 29 ],
\[ 4, 10, 6, 9, 20, 13, 26, 1, 25, 22, 7, 15, 2, 5, 17, 19, 32, 3, 21, 28, 11, 31, 24, 8, 30, 29, 16, 12, 27, 23, 18, 14 ] >;
s`Name := "32S12-8,4,8-g9-path13";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path50", "64S15-8,8,8-g21-path50", "64S45-16,4,16-g21-path7", "64S44-16,8,16-g25-path7", "64S45-16,4,16-g21-path8", "64S44-16,8,16-g25-path8", "64S17-8,4,8-g17-path4" ];
...
[ 7, 12, 1, 22, 10, 20, 15, 2, 29, 30, 25, 27, 9, 11, 3, 5, 19, 14, 4, 26, 28, 17, 6, 21, 18, 23, 8, 31, 32, 16, 24, 13 ],
[ 14, 21, 27, 5, 8, 16, 2, 32, 20, 11, 13, 9, 19, 24, 25, 18, 30, 29, 3, 1, 6, 7, 15, 17, 28, 10, 31, 4, 22, 12, 26, 23 ]
],
[ PermutationGroup<32 |  
\[ 11, 28, 8, 10, 2, 5, 12, 13, 26, 25, 9, 29, 4, 21, 18, 14, 16, 32, 1, 7, 20, 15, 3, 19, 31, 30, 24, 22, 17, 27, 23, 6 ],
\[ 3, 8, 15, 19, 16, 23, 1, 27, 13, 5, 14, 2, 32, 18, 7, 30, 22, 25, 17, 6, 24, 4, 26, 31, 11, 20, 12, 21, 9, 10, 28, 29 ],
\[ 4, 10, 6, 9, 20, 13, 26, 1, 25, 22, 7, 15, 2, 5, 17, 19, 32, 3, 21, 28, 11, 31, 24, 8, 30, 29, 16, 12, 27, 23, 18, 14 ]:
 Order := 32 > |
[ 19, 5, 23, 13, 6, 32, 20, 3, 11, 4, 1, 7, 8, 16, 22, 17, 29, 15, 24, 21, 14, 28, 31, 27, 10, 9, 30, 2, 12, 26, 25, 18 ],
[ 21, 20, 24, 2, 13, 14, 28, 6, 7, 9, 4, 26, 1, 19, 31, 32, 27, 17, 8, 11, 5, 12, 18, 16, 22, 25, 23, 10, 15, 29, 30, 3 ],
...
s`PassportSize := 2;
s`PathNumber := 13;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,2,4-g1-path4", "16T5-8,4,8-g5-path6", "32S12-8,4,8-g9-path13" ];
