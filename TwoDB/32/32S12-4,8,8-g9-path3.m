...
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path33", "64S44-4,16,16-g21-path31", "64S45-8,16,16-g25-path31", "64S44-4,16,16-g21-path32", "64S45-8,16,16-g25-path32", "64S15-8,8,8-g21-path33", "64S17-4,8,8-g17-path33" ];
