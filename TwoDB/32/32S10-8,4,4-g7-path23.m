...
s`Degree := 32;
s`Filename := "32S10-8,4,4-g7-path23.m";
...
\[ 3, 10, 5, 6, 7, 18, 1, 28, 16, 11, 12, 2, 17, 15, 25, 30, 19, 20, 32, 4, 29, 23, 27, 9, 26, 14, 31, 21, 8, 24, 22, 13 ],
\[ 4, 7, 14, 17, 18, 22, 25, 1, 12, 31, 3, 23, 2, 19, 9, 20, 8, 32, 11, 27, 5, 28, 15, 6, 13, 30, 29, 24, 16, 10, 26, 21 ] >;
s`Name := "32S10-8,4,4-g7-path23";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S13-8,8,4-g17-path29", "64S7-8,8,4-g17-path57", "64S14-8,8,4-g17-path29", "64S7-8,8,4-g17-path58", "64S9-8,4,4-g13-path29", "64S21-8,4,4-g13-path15", "64S9-8,4,4-g13-path30" ];
...
s`PassportSize := 2;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T12-8,2,4-g2-path1", "32S10-8,4,4-g7-path23" ];
