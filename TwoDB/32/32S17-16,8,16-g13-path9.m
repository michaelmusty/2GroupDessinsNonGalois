...
s`Degree := 32;
s`Filename := "32S17-16,8,16-g13-path9.m";
...
\[ 3, 8, 15, 19, 16, 23, 1, 28, 13, 5, 14, 2, 32, 18, 10, 27, 26, 12, 17, 6, 24, 4, 22, 30, 11, 20, 7, 25, 21, 9, 29, 31 ],
\[ 4, 10, 6, 9, 20, 13, 26, 1, 25, 22, 7, 27, 2, 5, 17, 19, 32, 3, 21, 29, 11, 31, 24, 8, 15, 30, 23, 16, 12, 18, 28, 14 ] >;
s`Name := "32S17-16,8,16-g13-path9";
s`Orders := \[ 16, 8, 16 ];
s`Parents := [ Strings() | "64S27-16,8,16-g25-path14", "64S44-16,8,16-g25-path78", "64S29-16,8,16-g25-path32" ];
...
s`PassportSize := 2;
s`PathNumber := 9;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-4,2,4-g1-path3", "16T5-8,4,8-g5-path5", "32S17-16,8,16-g13-path9" ];
