...
s`Degree := 32;
s`Filename := "32S5-8,8,4-g9-path12.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 29, 28, 17, 8, 2, 19, 13, 12, 9, 30, 5, 21, 15, 27, 4, 11, 25, 18, 20, 7, 31, 32, 26, 24, 22 ],
\[ 4, 7, 15, 19, 20, 24, 26, 1, 12, 5, 18, 25, 2, 23, 21, 6, 3, 22, 8, 31, 17, 28, 27, 29, 30, 13, 32, 11, 16, 9, 10, 14 ] >;
s`Name := "32S5-8,8,4-g9-path12";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S29-16,16,8-g25-path37", "64S31-16,16,8-g25-path9", "64S31-16,16,8-g25-path10", "64S29-16,16,8-g25-path38", "64S31-16,16,8-g25-path11", "64S30-16,16,8-g25-path5", "64S30-16,16,8-g25-path6", "64S31-16,16,8-g25-path12", "64S7-8,8,4-g17-path163", "64S6-8,8,4-g17-path27", "64S17-8,8,4-g17-path207", "64S6-8,8,4-g17-path28", "64S5-8,8,4-g17-path26", "64S4-8,8,4-g17-path3", "64S7-8,8,4-g17-path164" ];
...
s`PassportSize := 1;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path1", "32S5-8,8,4-g9-path12" ];
