...
s`Degree := 32;
s`Filename := "32S10-4,4,8-g7-path29.m";
...
\[ 3, 4, 15, 20, 17, 24, 1, 28, 10, 5, 22, 2, 31, 16, 7, 26, 9, 29, 21, 12, 25, 6, 32, 11, 30, 27, 14, 18, 8, 19, 23, 13 ],
\[ 4, 10, 16, 21, 22, 3, 27, 1, 24, 29, 7, 30, 2, 5, 12, 19, 28, 15, 11, 17, 18, 31, 20, 32, 6, 9, 25, 13, 23, 8, 26, 14 ] >;
s`Name := "32S10-4,4,8-g7-path29";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S7-8,4,8-g17-path29", "64S13-8,4,8-g17-path15", "64S7-8,4,8-g17-path30", "64S14-8,4,8-g17-path15", "64S9-4,4,8-g13-path41", "64S21-4,4,8-g13-path21", "64S9-4,4,8-g13-path42" ];
...
s`PassportSize := 2;
s`PathNumber := 29;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T14-4,4,8-g4-path1", "32S10-4,4,8-g7-path29" ];
