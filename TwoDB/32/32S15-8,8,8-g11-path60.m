...
s`Degree := 32;
s`Filename := "32S15-8,8,8-g11-path60.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 11, 19, 28, 25, 2, 24, 22, 17, 27, 21, 12, 32, 4, 26, 5, 15, 31, 18, 20, 7, 8, 9, 29, 30, 13 ],
\[ 4, 7, 15, 9, 17, 13, 21, 1, 12, 14, 22, 5, 2, 26, 19, 20, 24, 3, 28, 31, 29, 6, 30, 8, 27, 32, 23, 16, 11, 10, 18, 25 ] >;
s`Name := "32S15-8,8,8-g11-path60";
s`Orders := \[ 8, 8, 8 ];
s`Parents := [ Strings() | "64S15-8,8,8-g21-path296", "64S16-8,8,8-g21-path296", "64S22-8,8,8-g21-path56" ];
...
s`PassportSize := 6;
s`PathNumber := 60;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S15-8,8,8-g11-path60" ];
