...
s`Degree := 32;
s`Filename := "32S16-16,4,16-g11-path1.m";
...
\[ 14, 22, 27, 20, 3, 28, 5, 29, 26, 8, 10, 30, 21, 13, 31, 25, 6, 32, 17, 15, 1, 16, 24, 12, 2, 18, 7, 19, 11, 23, 4, 9 ],
\[ 17, 21, 20, 26, 4, 30, 31, 5, 25, 7, 27, 10, 28, 6, 32, 14, 12, 22, 24, 18, 19, 1, 29, 11, 13, 2, 15, 23, 3, 8, 9, 16 ] >;
s`Name := "32S16-16,4,16-g11-path1";
s`Orders := \[ 16, 4, 16 ];
s`Parents := [ Strings() | "64S50-32,8,32-g27-path5", "64S51-32,8,32-g27-path1", "64S50-32,8,32-g27-path6", "64S51-32,8,32-g27-path2", "64S44-16,4,16-g21-path56", "64S26-16,4,16-g21-path10", "64S29-16,4,16-g21-path1" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,2,8-g2-path1", "16T1-16,4,16-g6-path1", "32S16-16,4,16-g11-path1" ];
