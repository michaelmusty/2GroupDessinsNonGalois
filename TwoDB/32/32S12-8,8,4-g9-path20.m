...
s`Degree := 32;
s`Filename := "32S12-8,8,4-g9-path20.m";
...
\[ 3, 4, 13, 6, 15, 23, 1, 14, 7, 18, 2, 17, 29, 16, 30, 10, 19, 20, 27, 24, 5, 26, 31, 25, 8, 11, 21, 9, 32, 12, 22, 28 ],
\[ 4, 7, 14, 17, 18, 3, 25, 1, 11, 21, 30, 2, 23, 19, 26, 13, 8, 32, 6, 15, 31, 5, 27, 9, 12, 28, 16, 20, 10, 24, 29, 22 ] >;
s`Name := "32S12-8,8,4-g9-path20";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path104", "64S15-8,8,8-g21-path104", "64S44-16,16,4-g21-path3", "64S45-16,16,8-g25-path3", "64S44-16,16,4-g21-path4", "64S45-16,16,8-g25-path4", "64S17-8,8,4-g17-path12" ];
...
s`PassportSize := 2;
s`PathNumber := 20;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T2-4,4,2-g1-path1", "16T6-8,8,4-g5-path1", "32S12-8,8,4-g9-path20" ];
