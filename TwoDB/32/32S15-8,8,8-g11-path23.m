...
s`Degree := 32;
s`Filename := "32S15-8,8,8-g11-path23.m";
...
\[ 3, 10, 13, 6, 15, 23, 1, 2, 26, 27, 28, 9, 21, 4, 25, 8, 19, 20, 29, 30, 5, 11, 31, 17, 7, 32, 22, 16, 12, 14, 18, 24 ],
\[ 4, 7, 14, 17, 18, 24, 6, 1, 8, 25, 21, 2, 30, 19, 31, 3, 22, 9, 27, 12, 20, 5, 32, 11, 23, 16, 15, 13, 10, 29, 26, 28 ] >;
s`Name := "32S15-8,8,8-g11-path23";
s`Orders := \[ 8, 8, 8 ];
s`Parents := [ Strings() | "64S22-8,8,8-g21-path15", "64S16-8,8,8-g21-path255", "64S15-8,8,8-g21-path255" ];
...
[ 2, 9, 8, 3, 11, 1, 10, 26, 20, 12, 17, 30, 16, 13, 22, 32, 6, 15, 4, 5, 28, 19, 7, 23, 27, 18, 29, 24, 14, 21, 25, 31 ],
[ 28, 19, 11, 25, 10, 15, 16, 29, 23, 17, 26, 31, 22, 7, 2, 12, 30, 13, 20, 3, 27, 32, 5, 14, 8, 6, 24, 9, 18, 1, 21, 4 ],
[ 26, 30, 32, 2, 19, 10, 9, 20, 15, 14, 23, 5, 24, 8, 29, 18, 3, 11, 13, 28, 17, 6, 27, 1, 12, 25, 4, 31, 21, 16, 22, 7 ]
]
];
s`PassportName := "32S15-8,8,8-g11";
s`PassportSize := 6;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2", "16T8-4,4,4-g3-path20", "32S15-8,8,8-g11-path23" ];
