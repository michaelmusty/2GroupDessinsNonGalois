...
{ IntegerRing() | 27, 32 }
@};
s`Child := "16T1-16,16,2-g4-path1";
s`Degree := 32;
s`Filename := "32S16-16,16,2-g7-path2.m";
...
\[ 12, 14, 22, 15, 3, 24, 5, 16, 4, 9, 29, 11, 30, 6, 13, 1, 20, 7, 18, 2, 32, 21, 31, 23, 28, 10, 26, 8, 27, 25, 19, 17 ],
\[ 14, 16, 15, 5, 4, 12, 9, 20, 7, 18, 24, 6, 22, 1, 3, 2, 28, 10, 26, 8, 30, 13, 29, 11, 32, 19, 31, 17, 23, 21, 27, 25 ] >;
s`Name := "32S16-16,16,2-g7-path2";
s`Orders := \[ 16, 16, 2 ];
s`Parents := [ Strings() | "64S26-16,16,4-g21-path2", "64S44-16,16,4-g21-path48", "64S50-32,32,2-g15-path4", "64S50-32,32,4-g23-path4", "64S51-32,32,2-g15-path2", "64S51-32,32,4-g23-path2", "64S29-16,16,2-g13-path2" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1", "16T1-16,16,2-g4-path1", "32S16-16,16,2-g7-path2" ];
