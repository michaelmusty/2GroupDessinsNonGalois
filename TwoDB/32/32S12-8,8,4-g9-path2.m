...
s`Degree := 32;
s`Filename := "32S12-8,8,4-g9-path2.m";
...
\[ 3, 4, 13, 6, 15, 17, 1, 14, 7, 8, 2, 5, 23, 16, 24, 26, 25, 10, 11, 12, 9, 20, 29, 27, 30, 31, 32, 18, 21, 19, 28, 22 ],
\[ 4, 7, 14, 5, 8, 3, 10, 1, 11, 12, 20, 2, 17, 15, 6, 13, 24, 9, 21, 18, 28, 19, 26, 16, 23, 27, 25, 22, 30, 32, 29, 31 ] >;
s`Name := "32S12-8,8,4-g9-path2";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path114", "64S15-8,8,8-g21-path114", "64S44-16,16,4-g21-path19", "64S45-16,16,8-g25-path19", "64S44-16,16,4-g21-path20", "64S45-16,16,8-g25-path20", "64S17-8,8,4-g17-path22" ];
...
s`PassportSize := 2;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,2-g2-path1", "16T5-8,8,2-g3-path2", "32S12-8,8,4-g9-path2" ];
