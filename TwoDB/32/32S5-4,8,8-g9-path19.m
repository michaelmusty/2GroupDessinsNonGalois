...
{ IntegerRing() | 25, 31 }
@};
s`Child := "16T6-4,8,8-g5-path1";
s`Degree := 32;
s`Filename := "32S5-4,8,8-g9-path19.m";
...
\[ 3, 10, 14, 6, 13, 22, 1, 25, 28, 16, 15, 2, 29, 23, 32, 4, 30, 20, 21, 5, 8, 31, 9, 18, 26, 11, 7, 27, 17, 24, 12, 19 ],
\[ 4, 7, 11, 18, 19, 23, 25, 1, 12, 30, 20, 29, 2, 22, 9, 3, 16, 15, 27, 31, 17, 5, 32, 6, 24, 14, 10, 21, 8, 26, 28, 13 ] >;
s`Name := "32S5-4,8,8-g9-path19";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S29-8,16,16-g25-path51", "64S31-8,16,16-g25-path37", "64S31-8,16,16-g25-path38", "64S30-8,16,16-g25-path19", "64S31-8,16,16-g25-path39", "64S29-8,16,16-g25-path52", "64S30-8,16,16-g25-path20", "64S31-8,16,16-g25-path40", "64S7-4,8,8-g17-path177", "64S6-4,8,8-g17-path41", "64S5-4,8,8-g17-path33", "64S6-4,8,8-g17-path42", "64S17-4,8,8-g17-path214", "64S4-4,8,8-g17-path10", "64S7-4,8,8-g17-path178" ];
...
s`PassportSize := 1;
s`PathNumber := 19;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T6-4,8,8-g5-path1", "32S5-4,8,8-g9-path19" ];
