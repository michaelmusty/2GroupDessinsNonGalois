...
s`Degree := 32;
s`Filename := "32S17-16,2,16-g7-path4.m";
...
\[ 3, 9, 1, 6, 13, 4, 10, 19, 2, 7, 20, 14, 5, 12, 16, 15, 18, 17, 8, 11, 23, 24, 21, 22, 26, 25, 28, 27, 31, 32, 29, 30 ],
\[ 4, 3, 12, 15, 14, 17, 1, 9, 5, 13, 2, 16, 6, 18, 25, 27, 26, 28, 10, 7, 19, 8, 20, 11, 32, 31, 30, 29, 23, 21, 24, 22 ] >;
s`Name := "32S17-16,2,16-g7-path4";
s`Orders := \[ 16, 2, 16 ];
s`Parents := [ Strings() | "64S44-16,4,16-g21-path68", "64S27-16,4,16-g21-path4", "64S29-16,2,16-g13-path13" ];
...
s`PassportSize := 1;
s`PathNumber := 4;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path4", "32S17-16,2,16-g7-path4" ];
