...
s`Degree := 32;
s`Filename := "32S15-8,8,8-g11-path59.m";
...
\[ 3, 10, 13, 6, 15, 23, 1, 2, 26, 27, 28, 9, 21, 4, 25, 8, 19, 20, 29, 30, 5, 11, 31, 17, 7, 32, 22, 16, 12, 14, 18, 24 ],
\[ 4, 7, 14, 17, 18, 24, 6, 1, 8, 25, 21, 2, 30, 19, 31, 3, 22, 9, 27, 12, 20, 5, 32, 11, 23, 16, 15, 13, 10, 29, 26, 28 ] >;
s`Name := "32S15-8,8,8-g11-path59";
s`Orders := \[ 8, 8, 8 ];
s`Parents := [ Strings() | "64S22-8,8,8-g21-path54", "64S16-8,8,8-g21-path294", "64S15-8,8,8-g21-path294" ];
...
s`PassportSize := 6;
s`PathNumber := 59;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T8-4,4,4-g3-path6", "32S15-8,8,8-g11-path59" ];
