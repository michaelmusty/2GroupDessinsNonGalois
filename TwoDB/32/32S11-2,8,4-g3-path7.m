...
s`Orders := \[ 2, 8, 4 ];
s`Parents := [ Strings() | "64S20-4,8,4-g13-path9", "64S6-2,8,8-g9-path20", "64S7-4,8,8-g17-path88", "64S9-4,8,4-g13-path77", "64S10-2,8,8-g9-path20", "64S11-4,8,8-g17-path20", "64S8-2,8,4-g5-path9" ];
