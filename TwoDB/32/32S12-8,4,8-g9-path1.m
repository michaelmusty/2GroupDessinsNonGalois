...
s`Degree := 32;
s`Filename := "32S12-8,4,8-g9-path1.m";
...
\[ 3, 10, 5, 6, 7, 15, 1, 2, 18, 11, 8, 9, 4, 16, 13, 23, 14, 20, 22, 12, 19, 28, 17, 25, 27, 24, 26, 21, 31, 29, 32, 30 ],
\[ 4, 7, 13, 14, 15, 17, 6, 1, 8, 5, 3, 2, 16, 24, 23, 26, 25, 11, 12, 10, 9, 20, 27, 29, 30, 31, 32, 18, 21, 19, 28, 22 ] >;
s`Name := "32S12-8,4,8-g9-path1";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S45-16,8,16-g25-path1", "64S45-16,8,16-g25-path2", "64S44-16,4,16-g21-path1", "64S16-8,8,8-g21-path57", "64S44-16,4,16-g21-path2", "64S15-8,8,8-g21-path57", "64S17-8,4,8-g17-path11" ];
...
s`PassportSize := 2;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T1-8,1,8-g0-path1", "16T5-8,2,8-g3-path1", "32S12-8,4,8-g9-path1" ];
