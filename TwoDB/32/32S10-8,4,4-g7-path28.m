...
s`Degree := 32;
s`Filename := "32S10-8,4,4-g7-path28.m";
...
\[ 3, 10, 14, 6, 16, 22, 1, 21, 23, 18, 27, 2, 5, 7, 17, 32, 11, 12, 30, 4, 26, 20, 24, 28, 31, 29, 15, 9, 8, 25, 19, 13 ],
\[ 4, 7, 15, 5, 8, 23, 11, 1, 12, 31, 13, 30, 2, 22, 16, 18, 9, 3, 20, 28, 25, 32, 21, 10, 6, 14, 24, 29, 19, 17, 27, 26 ] >;
s`Name := "32S10-8,4,4-g7-path28";
s`Orders := \[ 8, 4, 4 ];
s`Parents := [ Strings() | "64S7-8,4,8-g17-path45", "64S13-8,4,8-g17-path23", "64S7-8,4,8-g17-path46", "64S14-8,4,8-g17-path23", "64S9-8,4,4-g13-path39", "64S21-8,4,4-g13-path20", "64S9-8,4,4-g13-path40" ];
...
s`PassportSize := 2;
s`PathNumber := 28;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-4,2,2-g0-path3", "16T12-8,4,2-g2-path3", "32S10-8,4,4-g7-path28" ];
