...
s`Degree := 32;
s`Filename := "32S16-4,16,16-g11-path3.m";
...
\[ 3, 9, 11, 2, 12, 8, 1, 13, 19, 5, 21, 18, 22, 10, 6, 4, 7, 23, 28, 15, 29, 30, 31, 20, 14, 16, 17, 32, 25, 26, 27, 24 ],
\[ 4, 10, 2, 14, 15, 7, 16, 1, 5, 20, 9, 6, 3, 24, 17, 25, 26, 8, 12, 27, 19, 11, 13, 31, 32, 29, 30, 18, 28, 21, 22, 23 ] >;
s`Name := "32S16-4,16,16-g11-path3";
s`Orders := \[ 4, 16, 16 ];
s`Parents := [ Strings() | "64S50-8,32,32-g27-path5", "64S51-8,32,32-g27-path5", "64S50-8,32,32-g27-path6", "64S51-8,32,32-g27-path6", "64S44-4,16,16-g21-path58", "64S26-4,16,16-g21-path12", "64S29-4,16,16-g21-path3" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-1,8,8-g0-path1", "16T5-2,8,8-g3-path1", "32S16-4,16,16-g11-path3" ];
