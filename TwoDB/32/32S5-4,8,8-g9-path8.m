...
{ IntegerRing() | 30, 32 }
@};
s`Child := "16T10-2,4,4-g1-path6";
s`Degree := 32;
s`Filename := "32S5-4,8,8-g9-path8.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 29, 5, 18, 31, 10, 12, 26, 4, 30, 17, 6, 32, 16, 28, 14, 23, 27, 7, 8, 20, 19, 22, 25, 11 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 30, 31, 2, 5, 9, 17, 27, 3, 29, 12, 28, 16, 32, 6, 13, 11, 26, 21, 20, 8, 15, 25, 22, 23 ] >;
s`Name := "32S5-4,8,8-g9-path8";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S29-8,16,16-g25-path75", "64S31-8,16,16-g25-path85", "64S31-8,16,16-g25-path86", "64S30-8,16,16-g25-path43", "64S31-8,16,16-g25-path87", "64S29-8,16,16-g25-path76", "64S30-8,16,16-g25-path44", "64S31-8,16,16-g25-path88", "64S7-4,8,8-g17-path201", "64S6-4,8,8-g17-path65", "64S5-4,8,8-g17-path45", "64S6-4,8,8-g17-path66", "64S17-4,8,8-g17-path226", "64S4-4,8,8-g17-path22", "64S7-4,8,8-g17-path202" ];
...
s`PassportSize := 1;
s`PathNumber := 8;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-2,2,4-g0-path1", "16T10-2,4,4-g1-path6", "32S5-4,8,8-g9-path8" ];
...
[ 3, 9, 13, 2, 15, 21, 1, 24, 29, 5, 18, 31, 10, 12, 26, 4, 30, 17, 6, 32, 16, 28, 14, 23, 27, 7, 8, 20, 19, 22, 25, 11 ],
[ 25, 20, 6, 26, 23, 17, 29, 30, 1, 16, 27, 32, 8, 7, 2, 22, 24, 21, 13, 31, 5, 14, 28, 15, 18, 12, 10, 9, 11, 4, 3, 19 ]
]
];
