...
s`Degree := 32;
s`Filename := "32S9-2,8,4-g3-path2.m";
...
\[ 3, 8, 11, 2, 13, 1, 21, 23, 25, 16, 18, 7, 22, 4, 28, 15, 9, 5, 32, 29, 20, 6, 17, 10, 14, 31, 12, 26, 19, 24, 30, 27 ],
\[ 4, 6, 12, 16, 17, 21, 1, 24, 18, 2, 25, 15, 29, 3, 14, 7, 31, 32, 5, 22, 10, 8, 13, 20, 28, 9, 11, 27, 30, 23, 19, 26 ] >;
s`Name := "32S9-2,8,4-g3-path2";
s`Orders := \[ 2, 8, 4 ];
s`Parents := [ Strings() | "64S8-4,8,4-g13-path54", "64S12-2,8,8-g9-path38", "64S6-4,8,8-g17-path95", "64S21-4,8,4-g13-path159", "64S6-2,8,8-g9-path95", "64S13-4,8,8-g17-path83", "64S38-2,16,4-g7-path16", "64S41-4,16,4-g15-path10", "64S42-2,16,8-g11-path10", "64S40-4,16,8-g19-path10", "64S41-2,16,4-g7-path10", "64S39-4,16,4-g15-path22", "64S40-2,16,8-g11-path10", "64S43-4,16,8-g19-path10", "64S8-2,8,4-g5-path32" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,4,2-g0-path3", "16T10-2,4,4-g1-path11", "32S9-2,8,4-g3-path2" ];
