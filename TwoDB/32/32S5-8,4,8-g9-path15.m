...
s`Degree := 32;
s`Filename := "32S5-8,4,8-g9-path15.m";
...
\[ 3, 10, 14, 6, 16, 23, 1, 28, 24, 18, 8, 2, 29, 7, 17, 32, 27, 12, 5, 13, 15, 4, 22, 25, 30, 11, 21, 26, 31, 9, 20, 19 ],
\[ 4, 7, 15, 20, 21, 24, 27, 1, 12, 5, 19, 32, 2, 23, 13, 6, 25, 3, 22, 26, 9, 30, 29, 11, 10, 14, 31, 16, 8, 28, 18, 17 ] >;
s`Name := "32S5-8,4,8-g9-path15";
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S29-16,8,16-g25-path43", "64S31-16,8,16-g25-path21", "64S31-16,8,16-g25-path22", "64S29-16,8,16-g25-path44", "64S31-16,8,16-g25-path23", "64S30-16,8,16-g25-path11", "64S30-16,8,16-g25-path12", "64S31-16,8,16-g25-path24", "64S7-8,4,8-g17-path169", "64S6-8,4,8-g17-path33", "64S17-8,4,8-g17-path210", "64S6-8,4,8-g17-path34", "64S5-8,4,8-g17-path29", "64S4-8,4,8-g17-path6", "64S7-8,4,8-g17-path170" ];
...
s`PassportSize := 1;
s`PathNumber := 15;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,4,8-g5-path4", "32S5-8,4,8-g9-path15" ];
