...
s`Degree := 32;
s`Filename := "32S16-16,4,16-g11-path5.m";
...
\[ 3, 10, 5, 13, 7, 4, 1, 2, 20, 11, 8, 9, 15, 23, 6, 14, 16, 12, 28, 18, 19, 21, 17, 27, 24, 25, 26, 22, 32, 29, 30, 31 ],
\[ 4, 3, 13, 14, 15, 16, 6, 1, 10, 5, 7, 2, 23, 24, 17, 25, 26, 8, 20, 11, 9, 12, 27, 31, 32, 29, 30, 18, 28, 19, 21, 22 ] >;
s`Name := "32S16-16,4,16-g11-path5";
s`Orders := \[ 16, 4, 16 ];
s`Parents := [ Strings() | "64S50-32,8,32-g27-path13", "64S51-32,8,32-g27-path9", "64S50-32,8,32-g27-path14", "64S51-32,8,32-g27-path10", "64S44-16,4,16-g21-path60", "64S26-16,4,16-g21-path14", "64S29-16,4,16-g21-path5" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,1,4-g0-path1", "8T2-4,2,4-g1-path1", "16T5-8,2,8-g3-path3", "32S16-16,4,16-g11-path5" ];
