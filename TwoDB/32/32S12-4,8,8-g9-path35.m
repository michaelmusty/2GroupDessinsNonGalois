...
s`Degree := 32;
s`Filename := "32S12-4,8,8-g9-path35.m";
...
\[ 3, 10, 13, 6, 14, 8, 1, 25, 23, 15, 27, 2, 21, 17, 29, 9, 7, 20, 4, 22, 5, 19, 28, 12, 18, 32, 24, 31, 11, 16, 26, 30 ],
\[ 4, 7, 2, 17, 18, 16, 24, 1, 12, 9, 21, 30, 8, 11, 3, 19, 22, 13, 32, 31, 15, 5, 6, 14, 23, 29, 26, 10, 28, 27, 25, 20 ] >;
s`Name := "32S12-4,8,8-g9-path35";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path28", "64S44-4,16,16-g21-path25", "64S45-8,16,16-g25-path25", "64S44-4,16,16-g21-path26", "64S45-8,16,16-g25-path26", "64S15-8,8,8-g21-path28", "64S17-4,8,8-g17-path28" ];
...
s`PassportSize := 2;
s`PathNumber := 35;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path29", "32S12-4,8,8-g9-path35" ];
