...
s`Degree := 32;
s`Filename := "32S4-4,8,8-g9-path10.m";
...
\[ 3, 10, 14, 6, 16, 24, 1, 30, 29, 18, 8, 2, 31, 19, 17, 28, 23, 26, 5, 22, 15, 32, 4, 27, 9, 11, 21, 7, 20, 12, 25, 13 ],
\[ 4, 7, 15, 20, 21, 25, 27, 1, 12, 5, 19, 14, 2, 24, 22, 6, 9, 3, 23, 10, 31, 30, 13, 32, 18, 28, 29, 17, 11, 16, 8, 26 ] >;
s`Name := "32S4-4,8,8-g9-path10";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S3-8,8,8-g21-path88", "64S28-4,16,16-g21-path1", "64S28-8,16,16-g25-path1", "64S3-8,8,8-g21-path89", "64S28-4,16,16-g21-path2", "64S28-8,16,16-g25-path2", "64S17-4,8,8-g17-path157" ];
...
s`PassportSize := 1;
s`PathNumber := 10;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T4-4,4,4-g3-path4", "32S4-4,8,8-g9-path10" ];
