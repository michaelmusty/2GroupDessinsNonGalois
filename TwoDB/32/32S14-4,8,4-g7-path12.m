...
s`Degree := 32;
s`Filename := "32S14-4,8,4-g7-path12.m";
...
\[ 3, 10, 13, 6, 15, 22, 1, 2, 18, 25, 26, 9, 20, 4, 23, 8, 19, 31, 29, 5, 11, 30, 7, 32, 21, 16, 12, 24, 14, 17, 28, 27 ],
\[ 4, 7, 14, 9, 17, 12, 6, 1, 8, 23, 20, 2, 29, 18, 30, 3, 24, 16, 28, 19, 5, 27, 22, 21, 15, 13, 10, 11, 31, 32, 26, 25 ] >;
s`Name := "32S14-4,8,4-g7-path12";
s`Orders := \[ 4, 8, 4 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path177", "64S48-4,16,4-g15-path3", "64S49-8,16,8-g23-path5", "64S47-4,16,4-g15-path3", "64S49-8,16,8-g23-path6", "64S16-8,8,8-g21-path178", "64S21-4,8,4-g13-path54" ];
...
s`PassportSize := 1;
s`PathNumber := 12;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T5-4,4,4-g2-path2", "16T8-4,4,4-g3-path30", "32S14-4,8,4-g7-path12" ];
