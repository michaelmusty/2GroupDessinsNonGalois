...
s`Degree := 32;
s`Filename := "32S16-16,16,8-g13-path6.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 26, 29, 9, 10, 31, 19, 21, 24, 4, 11, 5, 27, 22, 7, 32, 28, 30, 17, 18, 20, 25 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 25, 2, 15, 21, 24, 3, 23, 26, 27, 29, 32, 30, 5, 28, 31, 8, 14, 9, 10, 12, 13, 16 ] >;
s`Name := "32S16-16,16,8-g13-path6";
s`Orders := \[ 16, 16, 8 ];
s`Parents := [ Strings() | "64S50-32,32,16-g29-path37", "64S51-32,32,16-g29-path29", "64S50-32,32,16-g29-path38", "64S51-32,32,16-g29-path30", "64S29-16,16,8-g25-path15", "64S26-16,16,8-g25-path15", "64S44-16,16,8-g25-path61" ];
...
s`PassportSize := 2;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,2-g1-path1", "8T1-8,8,4-g3-path1", "16T5-8,8,4-g5-path1", "32S16-16,16,8-g13-path6" ];
