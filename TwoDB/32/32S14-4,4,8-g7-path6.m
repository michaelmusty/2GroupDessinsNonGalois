...
{ IntegerRing() | 23, 32 }
@};
s`Child := "16T14-4,4,8-g4-path3";
s`Degree := 32;
s`Filename := "32S14-4,4,8-g7-path6.m";
...
\[ 3, 10, 9, 19, 17, 13, 1, 16, 7, 6, 5, 4, 2, 28, 31, 26, 25, 30, 24, 29, 23, 8, 14, 12, 11, 22, 20, 21, 32, 15, 18, 27 ],
\[ 4, 11, 16, 20, 10, 17, 22, 1, 24, 28, 30, 7, 23, 2, 5, 14, 31, 25, 3, 18, 6, 21, 8, 32, 13, 9, 12, 26, 19, 29, 27, 15 ] >;
s`Name := "32S14-4,4,8-g7-path6";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S16-8,8,8-g21-path165", "64S16-8,8,8-g21-path166", "64S47-4,4,16-g15-path14", "64S49-8,8,16-g23-path27", "64S48-4,4,16-g15-path14", "64S49-8,8,16-g23-path28", "64S21-4,4,8-g13-path65" ];
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T4-2,2,4-g0-path3", "16T14-4,4,8-g4-path3", "32S14-4,4,8-g7-path6" ];
