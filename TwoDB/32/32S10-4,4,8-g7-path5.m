...
s`Degree := 32;
s`Filename := "32S10-4,4,8-g7-path5.m";
...
\[ 3, 9, 13, 2, 15, 22, 1, 27, 21, 5, 29, 25, 7, 12, 31, 19, 30, 17, 6, 32, 4, 16, 18, 14, 24, 28, 26, 8, 20, 23, 10, 11 ],
\[ 4, 10, 14, 18, 19, 7, 25, 1, 30, 27, 2, 5, 9, 20, 28, 3, 16, 12, 29, 21, 15, 32, 6, 31, 11, 13, 23, 17, 8, 24, 22, 26 ] >;
s`Name := "32S10-4,4,8-g7-path5";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S13-4,8,8-g17-path13", "64S7-4,8,8-g17-path25", "64S14-4,8,8-g17-path13", "64S7-4,8,8-g17-path26", "64S9-4,4,8-g13-path59", "64S21-4,4,8-g13-path30", "64S9-4,4,8-g13-path60" ];
...
s`PassportSize := 2;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S10-4,4,8-g7-path5" ];
