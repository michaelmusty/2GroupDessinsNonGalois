...
s`Degree := 32;
s`Filename := "32S6-4,4,4-g5-path23.m";
...
\[ 3, 10, 14, 19, 16, 21, 1, 6, 25, 17, 5, 24, 2, 7, 27, 32, 13, 29, 31, 4, 26, 28, 9, 15, 30, 8, 12, 18, 22, 23, 20, 11 ],
\[ 4, 11, 15, 5, 8, 22, 2, 1, 27, 29, 12, 7, 9, 21, 16, 17, 3, 26, 23, 18, 32, 19, 6, 30, 20, 25, 28, 13, 24, 10, 14, 31 ] >;
s`Name := "32S6-4,4,4-g5-path23";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S8-8,4,4-g13-path34", "64S8-4,8,4-g13-path26", "64S4-8,8,4-g17-path24", "64S9-8,4,4-g13-path146", "64S9-4,8,4-g13-path138", "64S5-8,8,4-g17-path58", "64S32-8,4,4-g13-path12", "64S32-4,8,4-g13-path4", "64S36-8,8,4-g17-path1", "64S33-8,4,4-g13-path34", "64S33-4,8,4-g13-path26", "64S37-8,8,4-g17-path12", "64S23-4,4,4-g9-path291", "64S34-4,4,4-g9-path15", "64S35-4,4,4-g9-path48" ];
...
s`PassportSize := 3;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S6-4,4,4-g5-path23" ];
