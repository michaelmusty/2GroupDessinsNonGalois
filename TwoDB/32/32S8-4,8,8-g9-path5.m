...
s`Degree := 32;
s`Filename := "32S8-4,8,8-g9-path5.m";
...
\[ 3, 9, 13, 2, 15, 22, 1, 28, 16, 5, 30, 25, 10, 12, 27, 19, 32, 17, 6, 31, 4, 21, 18, 29, 24, 14, 7, 26, 8, 20, 23, 11 ],
\[ 4, 10, 14, 18, 19, 7, 25, 1, 31, 28, 2, 5, 22, 20, 29, 3, 16, 12, 30, 21, 15, 32, 6, 13, 11, 27, 9, 23, 17, 8, 24, 26 ] >;
s`Name := "32S8-4,8,8-g9-path5";
s`Orders := \[ 4, 8, 8 ];
s`Parents := [ Strings() | "64S11-4,8,8-g17-path57", "64S5-4,8,8-g17-path81", "64S13-4,8,8-g17-path47", "64S13-4,8,8-g17-path48", "64S5-4,8,8-g17-path82", "64S11-4,8,8-g17-path58", "64S24-4,8,8-g17-path99" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T2-2,4,4-g1-path3", "16T10-2,4,4-g1-path3", "32S8-4,8,8-g9-path5" ];
