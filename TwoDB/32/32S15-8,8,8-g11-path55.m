...
s`Degree := 32;
s`Filename := "32S15-8,8,8-g11-path55.m";
...
\[ 3, 10, 13, 6, 14, 8, 1, 26, 27, 15, 29, 2, 21, 17, 31, 23, 7, 20, 4, 22, 5, 19, 24, 32, 12, 18, 30, 9, 25, 16, 11, 28 ],
\[ 4, 7, 2, 17, 18, 16, 25, 1, 12, 9, 21, 32, 8, 11, 3, 19, 22, 13, 27, 28, 15, 5, 31, 6, 14, 24, 20, 26, 23, 10, 30, 29 ] >;
s`Name := "32S15-8,8,8-g11-path55";
s`Orders := \[ 8, 8, 8 ];
s`Parents := [ Strings() | "64S22-8,8,8-g21-path50", "64S16-8,8,8-g21-path290", "64S15-8,8,8-g21-path290" ];
...
s`PassportSize := 6;
s`PathNumber := 55;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-2,4,4-g1-path4", "16T8-4,4,4-g3-path4", "32S15-8,8,8-g11-path55" ];
