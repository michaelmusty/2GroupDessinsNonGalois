...
s`Degree := 32;
s`Filename := "32S3-8,8,4-g9-path5.m";
...
\[ 3, 8, 13, 6, 14, 15, 1, 16, 12, 23, 2, 17, 22, 25, 31, 28, 19, 21, 24, 4, 27, 5, 30, 29, 7, 9, 20, 10, 32, 11, 18, 26 ],
\[ 4, 7, 6, 17, 18, 19, 20, 1, 11, 22, 25, 2, 15, 21, 24, 3, 8, 32, 16, 12, 26, 31, 5, 28, 27, 30, 9, 13, 10, 14, 29, 23 ] >;
s`Name := "32S3-8,8,4-g9-path5";
s`Orders := \[ 8, 8, 4 ];
s`Parents := [ Strings() | "64S2-8,8,8-g21-path83", "64S3-8,8,8-g21-path83", "64S26-16,16,4-g21-path43", "64S26-16,16,8-g25-path43", "64S27-16,16,4-g21-path39", "64S27-16,16,8-g25-path39", "64S17-8,8,4-g17-path152" ];
...
s`PassportSize := 1;
s`PathNumber := 5;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T2-4,4,2-g1-path4", "16T4-4,4,4-g3-path14", "32S3-8,8,4-g9-path5" ];
