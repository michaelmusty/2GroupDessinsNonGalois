...
s`Degree := 32;
s`Filename := "32S16-16,2,16-g7-path6.m";
...
\[ 3, 7, 1, 6, 11, 4, 2, 10, 16, 8, 5, 14, 15, 12, 13, 9, 19, 20, 17, 18, 23, 24, 21, 22, 27, 28, 25, 26, 31, 32, 29, 30 ],
\[ 4, 3, 6, 12, 13, 14, 1, 7, 11, 2, 15, 21, 22, 23, 24, 5, 10, 16, 8, 9, 29, 30, 31, 32, 19, 20, 17, 18, 28, 25, 26, 27 ] >;
s`Name := "32S16-16,2,16-g7-path6";
s`Orders := \[ 16, 2, 16 ];
s`Parents := [ Strings() | "64S26-16,4,16-g21-path6", "64S44-16,4,16-g21-path52", "64S50-32,2,32-g15-path8", "64S50-32,4,32-g23-path8", "64S51-32,2,32-g15-path6", "64S51-32,4,32-g23-path6", "64S29-16,2,16-g13-path6" ];
...
s`PassportSize := 1;
s`PathNumber := 6;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T1-4,2,4-g1-path1", "8T2-4,2,4-g1-path2", "16T5-8,2,8-g3-path4", "32S16-16,2,16-g7-path6" ];
