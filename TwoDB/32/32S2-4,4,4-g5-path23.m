...
{ IntegerRing() | 30, 31 }
@};
s`Child := "16T10-4,4,2-g1-path10";
s`Degree := 32;
s`Filename := "32S2-4,4,4-g5-path23.m";
...
\[ 3, 10, 14, 20, 16, 22, 1, 6, 19, 15, 5, 26, 2, 7, 13, 32, 12, 17, 30, 25, 4, 28, 29, 9, 21, 18, 31, 8, 27, 24, 23, 11 ],
\[ 4, 11, 15, 5, 8, 23, 2, 1, 17, 30, 12, 7, 9, 25, 16, 18, 29, 3, 28, 24, 19, 14, 20, 6, 32, 31, 21, 27, 13, 26, 10, 22 ] >;
s`Name := "32S2-4,4,4-g5-path23";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "64S20-8,4,4-g13-path73", "64S21-4,8,4-g13-path83", "64S25-8,8,4-g17-path29", "64S21-4,4,8-g13-path83", "64S17-8,4,8-g17-path61", "64S24-4,8,8-g17-path15", "64S22-8,8,8-g21-path109", "64S21-8,4,4-g13-path83", "64S18-4,8,4-g13-path15", "64S24-8,8,4-g17-path15", "64S20-4,4,8-g13-path73", "64S24-8,4,8-g17-path15", "64S25-4,8,8-g17-path29", "64S19-8,8,8-g21-path15", "64S20-8,4,4-g13-path74", "64S20-4,8,4-g13-path73", "64S17-8,8,4-g17-path61", "64S20-4,4,8-g13-path74", "64S25-8,4,8-g17-path29", "64S17-4,8,8-g17-path61", "64S22-8,8,8-g21-path110", "64S18-8,4,4-g13-path15", "64S20-4,8,4-g13-path74", "64S25-8,8,4-g17-path30", "64S18-4,4,8-g13-path15", "64S25-8,4,8-g17-path30", "64S25-4,8,8-g17-path30", "64S22-8,8,8-g21-path111", "64S23-4,4,4-g9-path43", "64S23-4,4,4-g9-path44", "64S23-4,4,4-g9-path45" ];
...
s`PassportSize := 1;
s`PathNumber := 23;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-4,2,2-g0-path2", "16T10-4,4,2-g1-path10", "32S2-4,4,4-g5-path23" ];
