...
s`Degree := 32;
s`Filename := "32S11-4,4,8-g7-path3.m";
...
\[ 3, 9, 13, 2, 15, 21, 1, 24, 16, 5, 18, 30, 7, 12, 29, 4, 31, 17, 6, 28, 32, 27, 26, 23, 14, 8, 20, 22, 10, 25, 11, 19 ],
\[ 4, 10, 14, 18, 19, 7, 24, 1, 28, 30, 2, 5, 21, 17, 26, 3, 32, 12, 27, 16, 31, 6, 29, 11, 13, 20, 8, 25, 9, 22, 23, 15 ] >;
s`Name := "32S11-4,4,8-g7-path3";
s`Orders := \[ 4, 4, 8 ];
s`Parents := [ Strings() | "64S6-4,8,8-g17-path5", "64S11-4,8,8-g17-path27", "64S10-4,8,8-g17-path5", "64S7-4,8,8-g17-path95", "64S9-4,4,8-g13-path106", "64S8-4,4,8-g13-path16", "64S20-4,4,8-g13-path38" ];
...
s`PassportSize := 2;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T2-2,4,4-g1-path1", "16T10-2,4,4-g1-path1", "32S11-4,4,8-g7-path3" ];
