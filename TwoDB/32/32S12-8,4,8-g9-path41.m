...
s`Orders := \[ 8, 4, 8 ];
s`Parents := [ Strings() | "64S45-16,8,16-g25-path33", "64S45-16,8,16-g25-path34", "64S44-16,4,16-g21-path33", "64S16-8,8,8-g21-path81", "64S44-16,4,16-g21-path34", "64S15-8,8,8-g21-path81", "64S17-8,4,8-g17-path35" ];
