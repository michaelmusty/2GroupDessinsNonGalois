...
s`Degree := 32;
s`Filename := "32S20-16,4,4-g8-path1.m";
...
\[ 3, 10, 5, 6, 7, 8, 1, 14, 18, 11, 12, 2, 15, 4, 16, 22, 26, 19, 20, 9, 23, 13, 24, 30, 29, 27, 28, 17, 31, 21, 32, 25 ],
\[ 4, 7, 2, 5, 8, 13, 11, 1, 12, 9, 3, 19, 14, 16, 21, 6, 20, 17, 10, 27, 22, 24, 29, 15, 28, 25, 18, 31, 30, 32, 26, 23 ] >;
s`Name := "32S20-16,4,4-g8-path1";
s`Orders := \[ 16, 4, 4 ];
s`Parents := [ Strings() | "64S39-16,4,4-g15-path7", "64S47-16,4,4-g15-path21", "64S39-16,4,4-g15-path8" ];
...
s`PassportName := "32S20-16,4,4-g8";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1", "16T13-8,2,2-g0-path1", "32S20-16,4,4-g8-path1" ];
