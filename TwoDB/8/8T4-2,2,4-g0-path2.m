...
s`Degree := 8;
s`Filename := "8T4-2,2,4-g0-path2.m";
...
\[ 3, 4, 1, 2, 8, 7, 6, 5 ],
\[ 4, 3, 7, 5, 6, 1, 8, 2 ] >;
s`Name := "8T4-2,2,4-g0-path2";
s`Orders := \[ 2, 2, 4 ];
s`Parents := [ Strings() | "16T12-4,2,8-g2-path2", "16T12-2,4,8-g2-path2", "16T8-4,4,4-g3-path17", "16T13-2,2,8-g0-path2", "16T10-4,2,4-g1-path7", "16T10-2,4,4-g1-path7", "16T14-4,4,8-g4-path2" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,2,4-g0-path2" ];
