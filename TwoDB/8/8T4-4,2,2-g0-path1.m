...
s`Degree := 8;
s`Filename := "8T4-4,2,2-g0-path1.m";
...
\[ 3, 7, 1, 6, 8, 4, 2, 5 ],
\[ 4, 3, 2, 1, 7, 8, 5, 6 ] >;
s`Name := "8T4-4,2,2-g0-path1";
s`Orders := \[ 4, 2, 2 ];
s`Parents := [ Strings() | "16T10-4,4,2-g1-path9", "16T10-4,2,4-g1-path9", "16T8-4,4,4-g3-path22", "16T13-8,2,2-g0-path1", "16T12-8,4,2-g2-path1", "16T12-8,2,4-g2-path1", "16T14-8,4,4-g4-path1" ];
...
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T2-2,2,2-g0-path1", "8T4-4,2,2-g0-path1" ];
