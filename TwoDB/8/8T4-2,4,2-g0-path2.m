...
s`Degree := 8;
s`Filename := "8T4-2,4,2-g0-path2.m";
...
\[ 3, 7, 5, 2, 6, 1, 8, 4 ],
\[ 4, 6, 8, 1, 7, 2, 5, 3 ] >;
s`Name := "8T4-2,4,2-g0-path2";
s`Orders := \[ 2, 4, 2 ];
s`Parents := [ Strings() | "16T10-4,4,2-g1-path7", "16T10-2,4,4-g1-path10", "16T8-4,4,4-g3-path20", "16T13-2,8,2-g0-path2", "16T12-4,8,2-g2-path2", "16T12-2,8,4-g2-path2", "16T14-4,8,4-g4-path2" ];
...
s`PassportSize := 1;
s`PathNumber := 2;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,1,2-g0-path1", "4T2-2,2,2-g0-path2", "8T4-2,4,2-g0-path2" ];
