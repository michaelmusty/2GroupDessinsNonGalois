...
s`Degree := 8;
s`Filename := "8T5-4,4,4-g2-path3.m";
...
\[ 3, 4, 5, 6, 7, 8, 1, 2 ],
\[ 4, 7, 2, 5, 8, 3, 6, 1 ] >;
s`Name := "8T5-4,4,4-g2-path3";
s`Orders := \[ 4, 4, 4 ];
s`Parents := [ Strings() | "16T8-4,4,4-g3-path31", "16T8-4,4,4-g3-path32", "16T8-4,4,4-g3-path33" ];
...
s`PassportSize := 1;
s`PathNumber := 3;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T2-2,2,2-g0-path3", "8T5-4,4,4-g2-path3" ];
