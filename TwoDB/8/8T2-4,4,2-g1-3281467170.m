...
s`Name := "8T2-4,4,2-g1-3281467170";
s`Filename := "8T2-4,4,2-g1-3281467170.m";
s`Degree := 8;
s`Orders := \[ 4, 4, 2 ];
...
edge1`UpstairsFilename := "8T2-4,4,2-g1-3281467170.m";
...
edge2`UpstairsFilename := "8T2-4,4,2-g1-563098754.m";
...
edge3`UpstairsFilename := "8T2-4,4,2-g1-3130938352.m";
...
edge3`DownstairsFilename := "4T1-4,4,2-g1-1323523021.m";
