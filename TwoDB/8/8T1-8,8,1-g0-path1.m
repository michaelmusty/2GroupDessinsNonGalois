...
s`Degree := 8;
s`Filename := "8T1-8,8,1-g0-path1.m";
...
\[ 3, 1, 7, 8, 2, 4, 6, 5 ],
\[ 1, 2, 3, 4, 5, 6, 7, 8 ] >;
s`Name := "8T1-8,8,1-g0-path1";
s`Orders := \[ 8, 8, 1 ];
s`Parents := [ Strings() | "16T5-8,8,2-g3-path1", "16T1-16,16,1-g0-path1", "16T1-16,16,2-g4-path1" ];
...
s`PassportName := "8T1-8,8,1-g0";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1", "4T1-4,4,1-g0-path1", "8T1-8,8,1-g0-path1" ];
