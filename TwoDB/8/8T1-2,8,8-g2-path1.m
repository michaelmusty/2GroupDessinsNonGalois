...
s`Degree := 8;
s`Filename := "8T1-2,8,8-g2-path1.m";
...
\[ 2, 5, 1, 6, 8, 7, 3, 4 ],
\[ 8, 4, 5, 3, 6, 1, 2, 7 ] >;
s`Name := "8T1-2,8,8-g2-path1";
s`Orders := \[ 2, 8, 8 ];
s`Parents := [ Strings() | "16T1-4,16,16-g6-path1", "16T5-2,8,8-g3-path2" ];
...
s`PassportName := "8T1-2,8,8-g2";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-1,2,2-g0-path1", "4T1-1,4,4-g0-path1", "8T1-2,8,8-g2-path1" ];
