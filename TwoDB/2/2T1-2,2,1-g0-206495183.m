...
s`FunctionField := FunctionField((x^2 + 2)*y + 2*x^2);
s`BelyiMap := s`FunctionField!(x^2/(x^2 + 2));

/*
Magma printing
*/

s`Name := "2T1-2,2,1-g0-206495183";
s`Filename := "2T1-2,2,1-g0-206495183.m";
s`Degree := 2;
s`Orders := \[ 2, 2, 1 ];
...
edge1`UpstairsFilename := "2T1-2,2,1-g0-206495183.m";
