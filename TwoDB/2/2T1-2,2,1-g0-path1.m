...
s`Degree := 2;
s`Filename := "2T1-2,2,1-g0-path1.m";
...
\[ 1, 2 ]:
 Order := 2 >;
s`Name := "2T1-2,2,1-g0-path1";
s`Orders := \[ 2, 2, 1 ];
s`Parents := [ Strings() | "4T2-2,2,2-g0-path3", "4T1-4,4,1-g0-path1", "4T1-4,4,2-g1-path1" ];
...
s`PassportName := "2T1-2,2,1-g0";
s`PassportSize := 1;
s`PathNumber := 1;
s`PathToPP1 := [ Strings() | "PP1", "2T1-2,2,1-g0-path1" ];
